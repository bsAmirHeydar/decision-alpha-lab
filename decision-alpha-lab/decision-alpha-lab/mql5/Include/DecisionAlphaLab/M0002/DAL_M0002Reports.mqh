...
string DAL_M0002AuditText(const DALM0002Audit &audit, const DALM0002Config &config)
{
   return "AUDIT"
      ...
      + "*postOutcomeSampleBars=" + IntegerToString(config.post_outcome_sample_bars)
      ...
      + "*logic=neutralExitCompletion_nodeSide_branching_M0001EventRtvDefault_noHuntFiltering";
}
