#ifndef __DAL_M0005_ATOMIC_NO_SAMPLE_MQH__
#define __DAL_M0005_ATOMIC_NO_SAMPLE_MQH__
...
#define DAL_D0009_BUILD "M0005_MAIN_ATOMIC_1.00"
...
struct DALM0005AtomicNoSampleConfig
{
   string symbol;
   ...
   bool use_causal_direction_filter;
   ENUM_DALD0009Family families_to_audit;
   ENUM_DALD0009ContinuationBreakMode continuation_break_mode;
   ENUM_DALD0009ContinuationRiskMode continuation_risk_mode;
   int reversal_buy_slots;
   int reversal_sell_slots;
   int continuation_buy_slots;
   int continuation_sell_slots;
   bool skip_touched_or_closed_nodes_before_decision;
   bool one_activation_per_node_family;
   int max_bars_to_wait_for_entry;
   int max_bars_to_measure_after_entry;
   double reward_r;
   int audit_spread_points;
   bool same_bar_stop_first;
   int atr_period;
   double atr_multiplier;
   bool print_only_summary;
   int print_every_n_steps;
   bool write_csv;
   string csv_file_name;
};

DALM0005AtomicNoSampleConfig g_dal_m0005_atomic_cfg;

#define InpSymbol g_dal_m0005_atomic_cfg.symbol
#define InpTimeframe g_dal_m0005_atomic_cfg.timeframe
#define InpReplayClosedBars g_dal_m0005_atomic_cfg.replay_closed_bars
#define InpWarmupClosedBars g_dal_m0005_atomic_cfg.warmup_closed_bars
#define InpL g_dal_m0005_atomic_cfg.L
#define InpZoneRatio g_dal_m0005_atomic_cfg.zone_ratio
#define InpExitGap g_dal_m0005_atomic_cfg.exit_gap
#define InpConsumeMode g_dal_m0005_atomic_cfg.consume_mode
#define InpOutcomeCandleOffsetAfterExit g_dal_m0005_atomic_cfg.outcome_candle_offset_after_exit
#define InpRequireEventRtvReady g_dal_m0005_atomic_cfg.require_event_rtv_ready
#define InpSkipAmbiguousEnergyBatch g_dal_m0005_atomic_cfg.skip_ambiguous_energy_batch
#define InpUseCausalDirectionFilter g_dal_m0005_atomic_cfg.use_causal_direction_filter
#define InpFamiliesToAudit g_dal_m0005_atomic_cfg.families_to_audit
#define InpContinuationBreakMode g_dal_m0005_atomic_cfg.continuation_break_mode
#define InpContinuationRiskMode g_dal_m0005_atomic_cfg.continuation_risk_mode
#define InpReversalBuySlots g_dal_m0005_atomic_cfg.reversal_buy_slots
#define InpReversalSellSlots g_dal_m0005_atomic_cfg.reversal_sell_slots
#define InpContinuationBuySlots g_dal_m0005_atomic_cfg.continuation_buy_slots
#define InpContinuationSellSlots g_dal_m0005_atomic_cfg.continuation_sell_slots
#define InpSkipTouchedOrClosedNodesBeforeDecision g_dal_m0005_atomic_cfg.skip_touched_or_closed_nodes_before_decision
#define InpOneActivationPerNodeFamily g_dal_m0005_atomic_cfg.one_activation_per_node_family
#define InpMaxBarsToWaitForEntry g_dal_m0005_atomic_cfg.max_bars_to_wait_for_entry
#define InpMaxBarsToMeasureAfterEntry g_dal_m0005_atomic_cfg.max_bars_to_measure_after_entry
#define InpRewardR g_dal_m0005_atomic_cfg.reward_r
#define InpAuditSpreadPoints g_dal_m0005_atomic_cfg.audit_spread_points
#define InpSameBarStopFirst g_dal_m0005_atomic_cfg.same_bar_stop_first
#define InpAtrPeriod g_dal_m0005_atomic_cfg.atr_period
#define InpAtrMultiplier g_dal_m0005_atomic_cfg.atr_multiplier
#define InpPrintOnlySummary g_dal_m0005_atomic_cfg.print_only_summary
#define InpPrintEveryNSteps g_dal_m0005_atomic_cfg.print_every_n_steps
#define InpWriteCsv g_dal_m0005_atomic_cfg.write_csv
#define InpCsvFileName g_dal_m0005_atomic_cfg.csv_file_name
...
bool DAL_M0005RunAtomicNoSampleReplay(const DALM0005AtomicNoSampleConfig &config)
{
   g_dal_m0005_atomic_cfg = config;
   return D0009_Run();
}

void DAL_M0005CloseAtomicNoSampleReplay()
{
   if(g_csv != INVALID_HANDLE)
   {
      FileClose(g_csv);
...
#undef InpUseCausalDirectionFilter
#undef InpFamiliesToAudit
#undef InpContinuationBreakMode
#undef InpContinuationRiskMode
#undef InpReversalBuySlots
#undef InpReversalSellSlots
#undef InpContinuationBuySlots
#undef InpContinuationSellSlots
#undef InpSkipTouchedOrClosedNodesBeforeDecision
#undef InpOneActivationPerNodeFamily
#undef InpMaxBarsToWaitForEntry
#undef InpMaxBarsToMeasureAfterEntry
#undef InpRewardR
#undef InpAuditSpreadPoints
#undef InpSameBarStopFirst
#undef InpAtrPeriod
#undef InpAtrMultiplier
#undef InpPrintOnlySummary
#undef InpPrintEveryNSteps
#undef InpWriteCsv
