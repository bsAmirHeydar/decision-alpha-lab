...
bool STC_ValidateConfig(STC_Config &cfg, string &error, string &warning)
{
   ...
   if(cfg.max_smt_backfill_on_init < 0) cfg.max_smt_backfill_on_init = 0;
   if(cfg.max_smt_backfill_on_init > 500) cfg.max_smt_backfill_on_init = 500;
   if(cfg.max_smt_catchup_per_pulse < 1) cfg.max_smt_catchup_per_pulse = 1;
   if(cfg.max_smt_catchup_per_pulse > 500) cfg.max_smt_catchup_per_pulse = 500;
   if(cfg.max_signal_backfill_on_init < 0) cfg.max_signal_backfill_on_init = 0;
   if(cfg.max_signal_backfill_on_init > 500) cfg.max_signal_backfill_on_init = 500;
   if(cfg.max_signal_catchup_per_pulse < 1) cfg.max_signal_catchup_per_pulse = 1;
   if(cfg.max_signal_catchup_per_pulse > 500) cfg.max_signal_catchup_per_pulse = 500;
   if(cfg.max_paper_entry_backfill_on_init < 0) cfg.max_paper_entry_backfill_on_init = 0;
   ...
   if(cfg.max_partial_backfill_on_init < 0) cfg.max_partial_backfill_on_init = 0;
