                     ...
                     const int drawn)
{
   ...
   msg += " staticqa_attempted=" + IntegerToString(result.staticqa_attempted_total);
   msg += " staticqa_ok=" + IntegerToString(result.staticqa_ok_total);
   msg += " staticqa_checks=" + IntegerToString(result.staticqa_checks_total);
   msg += " staticqa_pass=" + IntegerToString(result.staticqa_pass_total);
   msg += " staticqa_fail=" + IntegerToString(result.staticqa_fail_total);
   msg += " staticqa_warn=" + IntegerToString(result.staticqa_warn_total);
   msg += " staticqa_skipped=" + IntegerToString(result.staticqa_skipped_total);
   msg += " staticqa_file_errors=" + IntegerToString(result.staticqa_file_errors_total);
   msg += " staticqa_compile_failures=" + IntegerToString(result.staticqa_compile_failures_total);
   msg += " staticqa_runtime_failures=" + IntegerToString(result.staticqa_runtime_failures_total);
   msg += " staticqa_print_failures=" + IntegerToString(result.staticqa_print_failures_total);
   msg += " staticqa_input_failures=" + IntegerToString(result.staticqa_input_failures_total);
   msg += " staticqa_dependency_failures=" + IntegerToString(result.staticqa_dependency_failures_total);
   msg += " staticqa_io_failures=" + IntegerToString(result.staticqa_io_failures_total);
   msg += " staticqa_report_failures=" + IntegerToString(result.staticqa_report_alignment_failures_total);
   msg += " staticqa_toolchain_failures=" + IntegerToString(result.staticqa_toolchain_failures_total);
   msg += " staticqa_blockers=" + IntegerToString(result.staticqa_blockers_total);
