                                ...
                                FP_HookPhase06Config &p06)
{
   if(cfg.view_profile == FP_HOOK_P07_VIEW_MINIMAL_ALL_HOOKS)
   {
      ...
      p02.cycle_arc_use_sequence_color = false;
      ...
      p02.responsive_label_offsets = true;
      p02.responsive_label_lookback_bars = 12;
      p02.responsive_label_min_offset_points = 16;
      p02.responsive_label_max_offset_points = 120;
      p02.responsive_label_min_step_points = 10;
      p02.responsive_label_max_step_points = 80;
      p02.responsive_label_offset_range_ratio = 0.35;
      p02.responsive_label_step_range_ratio = 0.22;
      p02.label_time_cluster_seconds = 0;
      p02.label_time_cluster_bars = 2;
      p02.label_price_cluster_points = 36;
      p02.cycle_arc_align_to_bar_index = true;
      ...
      p02.min_x_count_to_draw = 1;
      p02.arc_min_x_count_to_draw = 1;
      ...
      p02.node2_label_color = clrGold;
      p02.node3_label_color = clrOrchid;
      p02.node4_label_color = clrTomato;
