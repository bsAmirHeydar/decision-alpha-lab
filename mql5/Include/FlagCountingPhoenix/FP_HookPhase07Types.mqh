...
enum FP_HookPhase07ViewProfile
{
   ...
   FP_HOOK_P07_VIEW_SEQUENCE_CYCLE_DEBUG = 9,
   FP_HOOK_P07_VIEW_MINIMAL_ALL_HOOKS = 10
};
...
string FP_HookP07ViewProfileName(const FP_HookPhase07ViewProfile p)
{
   ...
   if(p == FP_HOOK_P07_VIEW_SEQUENCE_CYCLE_DEBUG) return "SEQUENCE_CYCLE_DEBUG";
   if(p == FP_HOOK_P07_VIEW_MINIMAL_ALL_HOOKS) return "MINIMAL_ALL_HOOKS";
