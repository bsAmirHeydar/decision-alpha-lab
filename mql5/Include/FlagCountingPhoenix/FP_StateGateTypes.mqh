...
#define FP_STATE_GATE_VERSION "19.280-phase28"
...
#define FP_STATE_GATE_MAX_PAPER_PERFORMANCE_ROWS 8
#define FP_STATE_GATE_MAX_PAPER_PATH_QUALITY_ROWS 24
#define FP_STATE_GATE_MAX_CONTEXT_PERFORMANCE_ROWS 16
...
#define FP_STATE_GATE_REASON_PHASE26 "phase26_paper_performance_report"
#define FP_STATE_GATE_REASON_PHASE27 "phase27_paper_mfe_mae_path_quality"
#define FP_STATE_GATE_REASON_PHASE28 "phase28_context_performance_matrix"
...
struct FP_StateGateConfig
{
   ...
   bool export_paper_performance_csv;
   bool export_paper_path_quality_csv;
   bool export_context_performance_csv;
...
struct FP_StateGateTimeframeState
{
   ...
   string paper_policy_status;
   string paper_policy_key;
   string paper_policy_name;
   string paper_policy_family;
   bool paper_policy_allowed_dry_run;
   double paper_policy_score;
   string paper_policy_score_status;
   string paper_policy_block_reason;
   string paper_policy_required_context;
   string paper_policy_source_filter;
   string paper_policy_execution_status;
   string paper_policy_notes;
   int persistent_paper_trade_row_count;
   string persistent_paper_trade_status;
   string persistent_paper_trade_key;
   string persistent_paper_trade_id;
   string persistent_paper_trade_lifecycle_status;
   string persistent_paper_trade_direction;
   string persistent_paper_trade_type;
   double persistent_paper_trade_entry_price;
   double persistent_paper_trade_invalidation_price;
   double persistent_paper_trade_destination_price;
...
struct FP_StateGatePaperPolicyRow
{
   int slot_index;
   ENUM_TIMEFRAMES timeframe;
   string timeframe_label;
   ...
   string policy_family;
   bool policy_allowed_dry_run;
   string policy_direction;
   string policy_decision_type;
   double policy_score;
   string policy_score_status;
   string policy_block_reason;
   ...
   string r_status;
   double r_multiple;
   string source_regime_key;
   string source_result_key;
   string source_filter_key;
   string source_portfolio_key;
   string policy_key;
   string execution_status;
   string label;
...
struct FP_StateGatePersistentPaperTradeRow
{
   int slot_index;
   ENUM_TIMEFRAMES timeframe;
   string timeframe_label;
...
struct FP_StateGatePaperPerformanceRow
{
   int row_index;
   datetime summarized_at;
   int status;
   ...
   int source_lifecycle_rows;
   int closed_rows;
   int open_rows;
   int pending_entry_rows;
   int blocked_rows;
   int ambiguous_rows;
   int win_rows;
   int loss_rows;
   int r_ready_rows;
   int r_pending_rows;
   double win_rate_like;
   double closed_win_rate_like;
   double net_delta;
   double avg_delta;
   double net_R;
   double avg_R;
   ...
   double worst_R;
   string distribution;
   string r_distribution;
   string execution_status;
   string label;
};


struct FP_StateGatePaperPathQualityRow
{
   int slot_index;
   ENUM_TIMEFRAMES timeframe;
   string timeframe_label;
   datetime evaluated_at;
   int status;
   string path_quality_status;
   string path_quality_bucket;
   string pullback_pressure_status;
   string trade_id;
   string direction;
   string terminal_status;
   string lifecycle_status;
   ...
   double signed_delta;
   double risk_distance;
   double favorable_delta;
   double adverse_delta;
   double mfe_proxy;
   double mae_proxy;
   double mfe_R;
   double mae_R;
   double net_R;
   double path_smoothness_score;
   string source_lifecycle_key;
   string path_quality_key;
   string execution_status;
   string label;
};


struct FP_StateGateContextPerformanceRow
{
   int row_index;
   ...
   int r_pending_rows;
   int clean_path_rows;
   int adverse_path_rows;
   int pending_path_rows;
   int ambiguous_path_rows;
   double net_delta;
   double avg_delta;
   double net_R;
   double avg_R;
   double avg_mfe_R;
   double avg_mae_R;
   double avg_smoothness_score;
   double win_rate_like;
   double pass_rate;
   string distribution;
   string context_performance_key;
   string execution_status;
   string label;
};
...
struct FP_StateGateSnapshot
{
   ...
   FP_StateGatePaperPerformanceRow paper_performance_rows[FP_STATE_GATE_MAX_PAPER_PERFORMANCE_ROWS];
   FP_StateGatePaperPathQualityRow paper_path_quality_rows[FP_STATE_GATE_MAX_PAPER_PATH_QUALITY_ROWS];
   FP_StateGateContextPerformanceRow context_performance_rows[FP_STATE_GATE_MAX_CONTEXT_PERFORMANCE_ROWS];
   int rally_row_count;
   int hook_row_count;
   int extreme_candidate_row_count;
   int mtf_alignment_row_count;
   ...
   string paper_policy_status;
   string paper_policy_key;
   int paper_policy_total_rows;
   int paper_policy_allowed_dry_run_rows;
   int paper_policy_blocked_rows;
   string paper_policy_best_policy;
   double paper_policy_best_score;
   string paper_policy_distribution;
   string paper_policy_execution_status;
   string paper_policy_notes;
   string persistent_paper_trade_status;
   string persistent_paper_trade_key;
   int persistent_paper_trade_total_rows;
   int persistent_paper_trade_registered_rows;
   int persistent_paper_trade_blocked_rows;
   int persistent_paper_trade_open_like_rows;
   int persistent_paper_trade_policy_allowed_rows;
   string persistent_paper_trade_distribution;
   string persistent_paper_trade_execution_status;
   string persistent_paper_trade_notes;
   int persistent_paper_trade_lifecycle_row_count;
   int paper_performance_row_count;
   int paper_path_quality_row_count;
   int context_performance_row_count;
   string persistent_paper_trade_lifecycle_status;
   string persistent_paper_trade_lifecycle_key;
   ...
   string persistent_paper_trade_lifecycle_execution_status;
   string persistent_paper_trade_lifecycle_notes;
   string paper_performance_status;
   string paper_performance_key;
   int paper_performance_source_lifecycle_rows;
   int paper_performance_closed_rows;
   int paper_performance_open_rows;
   int paper_performance_pending_entry_rows;
   int paper_performance_blocked_rows;
   int paper_performance_ambiguous_rows;
   int paper_performance_win_rows;
   int paper_performance_loss_rows;
   int paper_performance_r_ready_rows;
   int paper_performance_r_pending_rows;
   double paper_performance_win_rate_like;
   double paper_performance_closed_win_rate_like;
   double paper_performance_net_delta;
   double paper_performance_avg_delta;
   double paper_performance_net_R;
   double paper_performance_avg_R;
   double paper_performance_expectancy_R;
   double paper_performance_best_R;
   double paper_performance_worst_R;
   string paper_performance_distribution;
   string paper_performance_r_distribution;
   string paper_performance_execution_status;
   string paper_performance_notes;
   string paper_path_quality_status;
   string paper_path_quality_key;
   int paper_path_quality_total_rows;
   int paper_path_quality_clean_rows;
   int paper_path_quality_adverse_rows;
   int paper_path_quality_pending_rows;
   int paper_path_quality_blocked_rows;
   int paper_path_quality_ambiguous_rows;
   int paper_path_quality_r_ready_rows;
   int paper_path_quality_r_pending_rows;
   double paper_path_quality_avg_mfe_R;
   double paper_path_quality_avg_mae_R;
   double paper_path_quality_avg_net_R;
   double paper_path_quality_best_mfe_R;
   double paper_path_quality_worst_mae_R;
   double paper_path_quality_avg_smoothness_score;
   string paper_path_quality_distribution;
   string paper_path_quality_execution_status;
   string paper_path_quality_notes;
   string context_performance_status;
   string context_performance_key;
   int context_performance_total_rows;
   int context_performance_active_rows;
   string context_performance_best_context;
   string context_performance_best_dimension;
   double context_performance_best_avg_R;
   double context_performance_best_smoothness;
   string context_performance_distribution;
   string context_performance_execution_status;
   string context_performance_notes;
   string status;
   string reason;
};
...
struct FP_StateGateReport
{
   ...
   int paper_performance_rows;
   int paper_path_quality_rows;
   int context_performance_rows;
...
void FP_ResetStateGateTimeframeState(FP_StateGateTimeframeState &s)
{
   ...
   s.paper_policy_row_count = 0;
   s.paper_policy_status = "PAPER_POLICY_PENDING";
   s.paper_policy_key = "PAPER_POLICY_KEY_PENDING";
   s.paper_policy_name = "NO_PAPER_POLICY";
   s.paper_policy_family = "NO_PAPER_POLICY_FAMILY";
   s.paper_policy_allowed_dry_run = false;
   s.paper_policy_score = 0.0;
   s.paper_policy_score_status = "PAPER_POLICY_SCORE_PENDING";
   s.paper_policy_block_reason = "PAPER_POLICY_PENDING";
   s.paper_policy_required_context = "PAPER_POLICY_CONTEXT_PENDING";
   s.paper_policy_source_filter = "NO_SOURCE_FILTER";
   s.paper_policy_execution_status = "REAL_EXECUTION_DISABLED_PHASE23_POLICY_ONLY";
   s.paper_policy_notes = "PAPER_POLICY_PENDING";
   s.persistent_paper_trade_row_count = 0;
   s.persistent_paper_trade_status = "PERSISTENT_PAPER_TRADE_PENDING";
   s.persistent_paper_trade_key = "PERSISTENT_PAPER_TRADE_KEY_PENDING";
   s.persistent_paper_trade_id = "NO_PERSISTENT_PAPER_TRADE_ID";
   s.persistent_paper_trade_lifecycle_status = "PAPER_TRADE_LIFECYCLE_PENDING";
   s.persistent_paper_trade_direction = "NO_PERSISTENT_PAPER_TRADE_DIRECTION";
   s.persistent_paper_trade_type = "NO_PERSISTENT_PAPER_TRADE_TYPE";
   s.persistent_paper_trade_entry_price = 0.0;
   s.persistent_paper_trade_invalidation_price = 0.0;
   s.persistent_paper_trade_destination_price = 0.0;
...
void FP_ResetStateGatePaperPolicyRow(FP_StateGatePaperPolicyRow &p)
{
   p.slot_index = -1;
   p.timeframe = PERIOD_CURRENT;
   p.timeframe_label = "TF?";
   ...
   p.last_closed_bar_close = 0.0;
   p.status = FP_STATE_GATE_ROW_EMPTY;
   p.policy_status = "PAPER_POLICY_PENDING";
   p.policy_name = "NO_PAPER_POLICY";
   p.policy_version = "PAPER_POLICY_V1_DRY_RUN_ONLY";
   p.policy_family = "NO_POLICY_FAMILY";
   p.policy_allowed_dry_run = false;
   p.policy_direction = "NO_POLICY_DIRECTION";
   p.policy_decision_type = "NO_POLICY_DECISION_TYPE";
   p.policy_score = 0.0;
   p.policy_score_status = "PAPER_POLICY_SCORE_PENDING";
   p.policy_block_reason = "PAPER_POLICY_PENDING";
   p.required_context = "PAPER_POLICY_CONTEXT_PENDING";
   p.filter_context = "NO_FILTER_CONTEXT";
   p.context_family = "NO_REGIME_CONTEXT";
   p.result_bucket = "NO_RESULT_BUCKET";
   p.r_status = "NO_R_STATUS";
   p.r_multiple = 0.0;
   p.source_regime_key = "NO_SOURCE_REGIME_KEY";
   p.source_result_key = "NO_SOURCE_RESULT_KEY";
   p.source_filter_key = "NO_SOURCE_FILTER_KEY";
   p.source_portfolio_key = "NO_SOURCE_PORTFOLIO_KEY";
   p.policy_key = "NO_PAPER_POLICY_KEY";
   p.execution_status = "REAL_EXECUTION_DISABLED_PHASE23_POLICY_ONLY";
   p.label = "Paper policy pending";
}


void FP_ResetStateGatePersistentPaperTradeRow(FP_StateGatePersistentPaperTradeRow &t)
{
   t.slot_index = -1;
   t.timeframe = PERIOD_CURRENT;
   t.timeframe_label = "TF?";
   t.registered_at = 0;
   t.opened_bar_time = 0;
   t.last_seen_bar_time = 0;
   t.last_closed_bar_close = 0.0;
   t.status = FP_STATE_GATE_ROW_EMPTY;
   t.trade_status = "PERSISTENT_PAPER_TRADE_PENDING";
   t.lifecycle_status = "PAPER_TRADE_LIFECYCLE_PENDING";
   t.trade_id = "NO_PERSISTENT_PAPER_TRADE_ID";
   t.trade_key = "NO_PERSISTENT_PAPER_TRADE_KEY";
   t.trade_mode = "PERSISTENT_PAPER_DRY_RUN_ONLY";
   t.policy_allowed_dry_run = false;
   t.policy_status = "NO_POLICY_STATUS";
   t.policy_name = "NO_POLICY_NAME";
   t.direction = "NO_TRADE_DIRECTION";
   t.decision_type = "NO_DECISION_TYPE";
   t.entry_price = 0.0;
   t.invalidation_price = 0.0;
   t.destination_price = 0.0;
   t.current_close = 0.0;
   t.unrealized_delta = 0.0;
   t.r_status = "PAPER_TRADE_R_PENDING";
   t.r_multiple = 0.0;
   t.source_policy_key = "NO_SOURCE_POLICY_KEY";
   t.source_decision_key = "NO_SOURCE_DECISION_KEY";
   t.source_ledger_key = "NO_SOURCE_LEDGER_KEY";
   t.source_result_key = "NO_SOURCE_RESULT_KEY";
   t.block_reason = "PERSISTENT_PAPER_TRADE_PENDING";
   t.execution_status = "REAL_EXECUTION_DISABLED_PHASE24_PERSISTENT_PAPER_ONLY";
...
void FP_ResetStateGatePaperPerformanceRow(FP_StateGatePaperPerformanceRow &p)
{
   p.row_index = -1;
   p.summarized_at = 0;
   p.status = FP_STATE_GATE_ROW_EMPTY;
   p.performance_status = "PAPER_PERFORMANCE_PENDING";
   p.performance_key = "NO_PAPER_PERFORMANCE_KEY";
   p.source_lifecycle_rows = 0;
   p.closed_rows = 0;
   p.open_rows = 0;
   p.pending_entry_rows = 0;
   p.blocked_rows = 0;
   p.ambiguous_rows = 0;
   p.win_rows = 0;
   p.loss_rows = 0;
   ...
   p.best_R = 0.0;
   p.worst_R = 0.0;
   p.distribution = "PAPER_PERFORMANCE_DISTRIBUTION_PENDING";
   p.r_distribution = "PAPER_PERFORMANCE_R_DISTRIBUTION_PENDING";
   p.execution_status = "REAL_EXECUTION_DISABLED_PHASE26_PERFORMANCE_ONLY";
   p.label = "Paper performance pending";
}


void FP_ResetStateGatePaperPathQualityRow(FP_StateGatePaperPathQualityRow &p)
{
   p.slot_index = -1;
   p.timeframe = PERIOD_CURRENT;
   p.timeframe_label = "TF?";
   p.evaluated_at = 0;
   p.status = FP_STATE_GATE_ROW_EMPTY;
   p.path_quality_status = "PAPER_PATH_QUALITY_PENDING";
   p.path_quality_bucket = "PAPER_PATH_BUCKET_PENDING";
   p.pullback_pressure_status = "PAPER_PULLBACK_PRESSURE_PENDING";
   p.trade_id = "NO_TRADE_ID";
   p.direction = "NO_DIRECTION";
   p.terminal_status = "NO_TERMINAL_STATUS";
   p.lifecycle_status = "NO_LIFECYCLE_STATUS";
   p.entry_price = 0.0;
   p.current_close = 0.0;
   p.destination_price = 0.0;
   p.invalidation_price = 0.0;
   ...
   p.mae_R = 0.0;
   p.net_R = 0.0;
   p.path_smoothness_score = 0.0;
   p.source_lifecycle_key = "NO_SOURCE_LIFECYCLE_KEY";
   p.path_quality_key = "NO_PAPER_PATH_QUALITY_KEY";
   p.execution_status = "REAL_EXECUTION_DISABLED_PHASE27_PATH_QUALITY_ONLY";
   p.label = "Paper path quality pending";
}


void FP_ResetStateGateContextPerformanceRow(FP_StateGateContextPerformanceRow &r)
{
   r.row_index = -1;
   r.dimension_name = "NO_DIMENSION";
   r.dimension_value = "NO_VALUE";
   r.matrix_status = "CONTEXT_PERFORMANCE_PENDING";
   r.context_rule = "NO_CONTEXT_RULE";
   r.source_regime_rows = 0;
   r.rows_after = 0;
   r.win_like_rows = 0;
   r.loss_like_rows = 0;
   r.open_rows = 0;
   ...
   r.r_pending_rows = 0;
   r.clean_path_rows = 0;
   r.adverse_path_rows = 0;
   r.pending_path_rows = 0;
   r.ambiguous_path_rows = 0;
   r.net_delta = 0.0;
   r.avg_delta = 0.0;
   r.net_R = 0.0;
   r.avg_R = 0.0;
   r.avg_mfe_R = 0.0;
   r.avg_mae_R = 0.0;
   r.avg_smoothness_score = 0.0;
   r.win_rate_like = 0.0;
   r.pass_rate = 0.0;
   r.distribution = "CONTEXT_PERFORMANCE_DISTRIBUTION_PENDING";
   r.context_performance_key = "NO_CONTEXT_PERFORMANCE_KEY";
   r.execution_status = "REAL_EXECUTION_DISABLED_PHASE28_CONTEXT_MATRIX_ONLY";
   r.label = "Context performance pending";
}
...
void FP_ResetStateGateSnapshot(FP_StateGateSnapshot &s)
{
   ...
   for(int d2=0; d2<FP_STATE_GATE_MAX_PAPER_POLICY_ROWS; d2++)
   ...
   for(int g2=0; g2<FP_STATE_GATE_MAX_PAPER_PERFORMANCE_ROWS; g2++)
      FP_ResetStateGatePaperPerformanceRow(s.paper_performance_rows[g2]);
   for(int h2=0; h2<FP_STATE_GATE_MAX_PAPER_PATH_QUALITY_ROWS; h2++)
      FP_ResetStateGatePaperPathQualityRow(s.paper_path_quality_rows[h2]);
   for(int i2=0; i2<FP_STATE_GATE_MAX_CONTEXT_PERFORMANCE_ROWS; i2++)
      FP_ResetStateGateContextPerformanceRow(s.context_performance_rows[i2]);
   s.rally_row_count = 0;
   s.hook_row_count = 0;
   s.extreme_candidate_row_count = 0;
   s.mtf_alignment_row_count = 0;
   ...
   s.paper_policy_status = "PAPER_POLICY_PENDING";
   s.paper_policy_key = "PAPER_POLICY_KEY_PENDING";
   s.paper_policy_total_rows = 0;
   s.paper_policy_allowed_dry_run_rows = 0;
   s.paper_policy_blocked_rows = 0;
   s.paper_policy_best_policy = "NO_BEST_POLICY";
   s.paper_policy_best_score = 0.0;
   s.paper_policy_distribution = "PAPER_POLICY_DISTRIBUTION_PENDING";
   s.paper_policy_execution_status = "REAL_EXECUTION_DISABLED_PHASE23_POLICY_ONLY";
   s.paper_policy_notes = "PAPER_POLICY_PENDING";
   s.persistent_paper_trade_row_count = 0;
   s.persistent_paper_trade_status = "PERSISTENT_PAPER_TRADE_PENDING";
   s.persistent_paper_trade_key = "PERSISTENT_PAPER_TRADE_KEY_PENDING";
   s.persistent_paper_trade_total_rows = 0;
   s.persistent_paper_trade_registered_rows = 0;
   s.persistent_paper_trade_blocked_rows = 0;
   s.persistent_paper_trade_open_like_rows = 0;
   s.persistent_paper_trade_policy_allowed_rows = 0;
   s.persistent_paper_trade_distribution = "PERSISTENT_PAPER_TRADE_DISTRIBUTION_PENDING";
   s.persistent_paper_trade_execution_status = "REAL_EXECUTION_DISABLED_PHASE24_PERSISTENT_PAPER_ONLY";
   s.persistent_paper_trade_notes = "PERSISTENT_PAPER_TRADE_PENDING";
   s.persistent_paper_trade_lifecycle_row_count = 0;
   s.paper_performance_row_count = 0;
   s.paper_path_quality_row_count = 0;
   s.context_performance_row_count = 0;
   ...
   s.persistent_paper_trade_lifecycle_execution_status = "REAL_EXECUTION_DISABLED_PHASE25_PAPER_TRADE_LIFECYCLE_ONLY";
   s.persistent_paper_trade_lifecycle_notes = "PERSISTENT_PAPER_TRADE_LIFECYCLE_PENDING";
   s.paper_performance_status = "PAPER_PERFORMANCE_PENDING";
   s.paper_performance_key = "PAPER_PERFORMANCE_KEY_PENDING";
   s.paper_performance_source_lifecycle_rows = 0;
   s.paper_performance_closed_rows = 0;
   s.paper_performance_open_rows = 0;
   s.paper_performance_pending_entry_rows = 0;
   s.paper_performance_blocked_rows = 0;
   s.paper_performance_ambiguous_rows = 0;
   s.paper_performance_win_rows = 0;
   s.paper_performance_loss_rows = 0;
   s.paper_performance_r_ready_rows = 0;
   s.paper_performance_r_pending_rows = 0;
   s.paper_performance_win_rate_like = 0.0;
   s.paper_performance_closed_win_rate_like = 0.0;
   s.paper_performance_net_delta = 0.0;
   s.paper_performance_avg_delta = 0.0;
   s.paper_performance_net_R = 0.0;
   s.paper_performance_avg_R = 0.0;
   s.paper_performance_expectancy_R = 0.0;
   s.paper_performance_best_R = 0.0;
   s.paper_performance_worst_R = 0.0;
   s.paper_performance_distribution = "PAPER_PERFORMANCE_DISTRIBUTION_PENDING";
   s.paper_performance_r_distribution = "PAPER_PERFORMANCE_R_DISTRIBUTION_PENDING";
   s.paper_performance_execution_status = "REAL_EXECUTION_DISABLED_PHASE26_PERFORMANCE_ONLY";
   s.paper_performance_notes = "PAPER_PERFORMANCE_PENDING";
   s.paper_path_quality_status = "PAPER_PATH_QUALITY_PENDING";
   s.paper_path_quality_key = "PAPER_PATH_QUALITY_KEY_PENDING";
   s.paper_path_quality_total_rows = 0;
   s.paper_path_quality_clean_rows = 0;
   s.paper_path_quality_adverse_rows = 0;
   s.paper_path_quality_pending_rows = 0;
   s.paper_path_quality_blocked_rows = 0;
   s.paper_path_quality_ambiguous_rows = 0;
   s.paper_path_quality_r_ready_rows = 0;
   s.paper_path_quality_r_pending_rows = 0;
   s.paper_path_quality_avg_mfe_R = 0.0;
   s.paper_path_quality_avg_mae_R = 0.0;
   s.paper_path_quality_avg_net_R = 0.0;
   s.paper_path_quality_best_mfe_R = 0.0;
   s.paper_path_quality_worst_mae_R = 0.0;
   s.paper_path_quality_avg_smoothness_score = 0.0;
   s.paper_path_quality_distribution = "PAPER_PATH_QUALITY_DISTRIBUTION_PENDING";
   s.paper_path_quality_execution_status = "REAL_EXECUTION_DISABLED_PHASE27_PATH_QUALITY_ONLY";
   s.paper_path_quality_notes = "PAPER_PATH_QUALITY_PENDING";
   s.context_performance_status = "CONTEXT_PERFORMANCE_PENDING";
   s.context_performance_key = "CONTEXT_PERFORMANCE_KEY_PENDING";
   s.context_performance_total_rows = 0;
   s.context_performance_active_rows = 0;
   s.context_performance_best_context = "NO_BEST_CONTEXT";
   s.context_performance_best_dimension = "NO_BEST_DIMENSION";
   s.context_performance_best_avg_R = 0.0;
   s.context_performance_best_smoothness = 0.0;
   s.context_performance_distribution = "CONTEXT_PERFORMANCE_DISTRIBUTION_PENDING";
   s.context_performance_execution_status = "REAL_EXECUTION_DISABLED_PHASE28_CONTEXT_MATRIX_ONLY";
   s.context_performance_notes = "CONTEXT_PERFORMANCE_PENDING";
   s.status = "reset";
   s.reason = "reset";
}
...
void FP_ResetStateGateReport(FP_StateGateReport &r)
{
   ...
   r.paper_performance_rows = 0;
   r.paper_path_quality_rows = 0;
   r.context_performance_rows = 0;
...
void FP_DefaultStateGateConfig(FP_StateGateConfig &cfg)
{
   ...
   cfg.export_paper_performance_csv = true;
   cfg.export_paper_path_quality_csv = true;
   cfg.export_context_performance_csv = true;
