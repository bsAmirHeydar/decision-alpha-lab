...
struct DAL_AstroBodyState
{
   ...
   string dispositor;
   string triplicity_role;
   double triplicity_score;
   string decan_ruler;
   string solar_condition;
...
struct DAL_AstroMapRow
{
   ...
   double   nodal_pressure_score;
   string   nodal_state;
   double   eclipse_proximity_score;
   string   eclipse_state;
   string   eclipse_family_phase;
...
void DAL_AstroBodyState_Reset(DAL_AstroBodyState &b, const string name)
{
   ...
   b.dispositor = "";
   b.triplicity_role = "";
   b.triplicity_score = 0.0;
   b.decan_ruler = "";
   b.solar_condition = "";
   b.solar_separation = 0.0;
   b.sign = "";
   b.sign_index = -1;
   b.degree = 0.0;
   b.retro = 0;
...
void DAL_AstroMapRow_Reset(DAL_AstroMapRow &r)
{
   ...
   r.node_axis_sign = "";
   r.nodal_pressure_score = 0.0;
   r.nodal_state = "";
   r.eclipse_proximity_score = 0.0;
   r.eclipse_state = "";
   r.eclipse_family_phase = "";
