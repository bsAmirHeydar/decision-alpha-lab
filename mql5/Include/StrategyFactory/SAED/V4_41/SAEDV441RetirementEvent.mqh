#ifndef __SAEDV441_RETIREMENTEVENT_MQH__
#define __SAEDV441_RETIREMENTEVENT_MQH__
// SAEDV441 static parity mirror: RetirementEvent
...
struct SAEDV441RetirementEventRecord
{
   string record_id;
   string cell_id;
   string tenant_id;
...
bool SAEDV441ValidateRetirementEvent(const SAEDV441RetirementEventRecord &value)
{
