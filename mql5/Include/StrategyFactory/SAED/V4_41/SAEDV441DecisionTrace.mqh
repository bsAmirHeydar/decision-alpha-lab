#ifndef __SAEDV441_DECISIONTRACE_MQH__
#define __SAEDV441_DECISIONTRACE_MQH__
// SAEDV441 static parity mirror: DecisionTrace
...
struct SAEDV441DecisionTraceRecord
{
   string record_id;
   string cell_id;
   string tenant_id;
...
bool SAEDV441ValidateDecisionTrace(const SAEDV441DecisionTraceRecord &value)
{
