#ifndef __SAEDV441_RESTRICTION_MQH__
#define __SAEDV441_RESTRICTION_MQH__
// SAEDV441 static parity mirror: Restriction
...
struct SAEDV441RestrictionRecord
{
   string record_id;
   string cell_id;
   string tenant_id;
...
bool SAEDV441ValidateRestriction(const SAEDV441RestrictionRecord &value)
{
