#ifndef __SAEDV441_KNOWNTIME_MQH__
#define __SAEDV441_KNOWNTIME_MQH__
// SAEDV441 static parity mirror: KnownTime
...
struct SAEDV441KnownTimeRecord
{
   string record_id;
   string cell_id;
   string tenant_id;
...
bool SAEDV441ValidateKnownTime(const SAEDV441KnownTimeRecord &value)
{
