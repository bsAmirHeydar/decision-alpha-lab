#ifndef __SAEDV441_OBSERVATION_MQH__
#define __SAEDV441_OBSERVATION_MQH__
// SAEDV441 static parity mirror: Observation
...
struct SAEDV441ObservationRecord
{
   string record_id;
   string cell_id;
   string tenant_id;
...
bool SAEDV441ValidateObservation(const SAEDV441ObservationRecord &value)
{
