#ifndef __SAEDV441_CERTIFICATE_MQH__
#define __SAEDV441_CERTIFICATE_MQH__
// SAEDV441 static parity mirror: Certificate
...
struct SAEDV441CertificateRecord
{
   string record_id;
   string cell_id;
   string tenant_id;
...
bool SAEDV441ValidateCertificate(const SAEDV441CertificateRecord &value)
{
