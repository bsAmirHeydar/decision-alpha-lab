#ifndef __SAEDV441_DEPENDENCYEDGE_MQH__
#define __SAEDV441_DEPENDENCYEDGE_MQH__
// SAEDV441 static parity mirror: DependencyEdge
...
struct SAEDV441DependencyEdgeRecord
{
   string record_id;
   string cell_id;
   string tenant_id;
...
bool SAEDV441ValidateDependencyEdge(const SAEDV441DependencyEdgeRecord &value)
{
