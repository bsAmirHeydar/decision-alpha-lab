#ifndef __SAEDV441_DEPENDENCYNODE_MQH__
#define __SAEDV441_DEPENDENCYNODE_MQH__
// SAEDV441 static parity mirror: DependencyNode
...
struct SAEDV441DependencyNodeRecord
{
   string record_id;
   string cell_id;
   string tenant_id;
...
bool SAEDV441ValidateDependencyNode(const SAEDV441DependencyNodeRecord &value)
{
