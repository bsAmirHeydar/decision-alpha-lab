#ifndef __SAEDV441_METRICSPEC_MQH__
#define __SAEDV441_METRICSPEC_MQH__
// SAEDV441 static parity mirror: MetricSpec
...
struct SAEDV441MetricSpecRecord
{
   string record_id;
   string cell_id;
   string tenant_id;
...
bool SAEDV441ValidateMetricSpec(const SAEDV441MetricSpecRecord &value)
{
