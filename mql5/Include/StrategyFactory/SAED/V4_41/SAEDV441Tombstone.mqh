#ifndef __SAEDV441_TOMBSTONE_MQH__
#define __SAEDV441_TOMBSTONE_MQH__
// SAEDV441 static parity mirror: Tombstone
...
struct SAEDV441TombstoneRecord
{
   string record_id;
   string cell_id;
   string tenant_id;
...
bool SAEDV441ValidateTombstone(const SAEDV441TombstoneRecord &value)
{
