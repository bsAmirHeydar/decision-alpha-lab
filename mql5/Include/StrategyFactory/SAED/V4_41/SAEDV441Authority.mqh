#ifndef __SAEDV441_AUTHORITY_MQH__
#define __SAEDV441_AUTHORITY_MQH__
// SAEDV441 static parity mirror: Authority
...
struct SAEDV441AuthorityRecord
{
   string record_id;
   string cell_id;
   string tenant_id;
...
bool SAEDV441ValidateAuthority(const SAEDV441AuthorityRecord &value)
{
