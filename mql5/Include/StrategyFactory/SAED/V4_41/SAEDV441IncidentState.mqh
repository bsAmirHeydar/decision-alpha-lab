#ifndef __SAEDV441_INCIDENTSTATE_MQH__
#define __SAEDV441_INCIDENTSTATE_MQH__
// SAEDV441 static parity mirror: IncidentState
...
struct SAEDV441IncidentStateRecord
{
   string record_id;
   string cell_id;
   string tenant_id;
...
bool SAEDV441ValidateIncidentState(const SAEDV441IncidentStateRecord &value)
{
