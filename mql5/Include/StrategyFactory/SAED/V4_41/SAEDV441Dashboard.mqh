#ifndef __SAEDV441_DASHBOARD_MQH__
#define __SAEDV441_DASHBOARD_MQH__
// SAEDV441 static parity mirror: Dashboard
...
struct SAEDV441DashboardRecord
{
   string record_id;
   string cell_id;
   string tenant_id;
...
bool SAEDV441ValidateDashboard(const SAEDV441DashboardRecord &value)
{
