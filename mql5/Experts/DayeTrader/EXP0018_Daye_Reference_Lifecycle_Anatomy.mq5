...
void DAYE_BuildP07Config(DAYE_LifecycleConfig &config)
{
   ...
   config.confirmation_config.hunt_config.enable_high_side=InpEnableHighSide; c.hunt_config.enable_low_side=InpEnableLowSide;
   ...
   config.confirmation_config.host_timeframe=InpHostTimeframe; c.require_exact_host_symbol_alignment=InpRequireExactHostSymbolAlignment;
   config.confirmation_config.require_closed_host_bars=InpRequireClosedHostBars; c.persist_checkpoint=InpPersistConfirmationCheckpoint;
   config.confirmation_config.checkpoint_prefix=InpConfirmationCheckpointPrefix; c.publish_nonconfirmed_results=InpPublishNonconfirmedResults;
   config.confirmation_config.fail_closed_on_missed_host_close=InpFailClosedOnMissedHostClose;
   config.confirmation_config.maximum_pending_candidates=InpMaximumPendingCandidates; c.maximum_results_to_publish=InpMaximumResultsToPublish;
