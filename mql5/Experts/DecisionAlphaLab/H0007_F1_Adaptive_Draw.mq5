...
#property description "H0007 F1 Adaptive Flag Counting - Expert Advisor visual audit tool"
...
bool H0007_RunF1Detector()
{
   ...
   Print("H0007 F1 Adaptive EA | symbol=", _Symbol,
...
int OnInit()
{
   if(InpLMin < 2)
   {
      Print("H0007 F1: InpLMin must be >= 2");
      return INIT_PARAMETERS_INCORRECT;
   }

   if(InpLMax < InpLMin)
   {
      Print("H0007 F1: InpLMax must be >= InpLMin");
      return INIT_PARAMETERS_INCORRECT;
   }
