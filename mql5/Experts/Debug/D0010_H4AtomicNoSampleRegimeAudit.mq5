//+------------------------------------------------------------------+
//| Decision Alpha Lab — D0010 H4 Atomic No-Sample Regime Audit       |
//| H0004 validator with ZERO M0002 branch samples.                   |
//+------------------------------------------------------------------+
#property strict
#property version   "1.00"
#property description "D0010: H4 regime-memory audit without M0002 samples. Raw M0001 events only; same known-time events are simultaneous batches."
...
input int InpReplayClosedBars = 2500;
...
input int InpPrintEveryNBatches = 100;
input bool InpWriteCsv = true;
input string InpCsvFileName = "D0010_H4_Atomic_NoSample_Regime.csv";
