...
input bool   InpHookPhase02DrawNodeMarkers = false;
input bool   InpHookPhase02DrawXLines = false;
input bool   InpHookPhase02DrawDeathBoundary = false;
input bool   InpHookPhase02DrawCycleArc = true;
input bool   InpHookPhase02CycleArcUseSequenceColor = false;
input bool   InpHookPhase02GroupCycleArcByOrigin = true;
input bool   InpHookPhase02DrawSequenceCountLabel = false;
...
input int    InpHookPhase02MinXCountToDraw = 1;
input int    InpHookPhase02ArcMinXCountToDraw = 1;
input FP_HookPhase02SequenceDrawMode InpHookPhase02SequenceDrawMode = FP_HOOK_P02_DRAW_RECENT_N;
...
input bool   InpHookPhase02UseSequencePaletteColors = true;
input bool   InpHookPhase02ColorOriginWithSequence = false;
input bool   InpHookPhase02ColorNodeLabelsWithSequence = true;
input bool   InpHookPhase02ColorNodeNumbersByIndex = false;
...
input bool   InpHookPhase02ResponsiveLabelOffsets = true;
input int    InpHookPhase02ResponsiveLabelLookbackBars = 12;
input int    InpHookPhase02ResponsiveLabelMinOffsetPoints = 16;
input int    InpHookPhase02ResponsiveLabelMaxOffsetPoints = 120;
input int    InpHookPhase02ResponsiveLabelMinStepPoints = 10;
input int    InpHookPhase02ResponsiveLabelMaxStepPoints = 80;
input double InpHookPhase02ResponsiveLabelOffsetRangeRatio = 0.35;
input double InpHookPhase02ResponsiveLabelStepRangeRatio = 0.22;
input int    InpHookPhase02LabelTimeClusterSeconds = 0;
input int    InpHookPhase02LabelTimeClusterBars = 2;
...
input bool   InpHookPhase02ShowOnlyValidHooks = true;
input bool   InpHookPhase02ValidOnlyRequireNearDeath = false;
input bool   InpHookPhase02ValidF3RequireSameScale = false;
input bool   InpHookPhase02ValidF3RequireOppositeDirection = true;
input bool   InpHookPhase02ValidOnlyFallbackToStructural = false;
input FP_HookPostF3RecognitionMode InpHookPostF3RecognitionMode = FP_HOOK_POST_F3_STRUCTURAL_OR_GEOMETRIC_80;
input FP_HookPostF3SelectionPriority InpHookPostF3SelectionPriority = FP_HOOK_POST_F3_PRIORITY_STRUCTURAL_FIRST;
input bool   InpHookPostF3AllowDirectTerminalHook = true;
input bool   InpHookPostF3AllowDelayedReboundHook = true;
input int    InpHookPostF3MaxSearchBars = 180;
input int    InpHookPostF3TerminalToleranceBars = 3;
input int    InpHookPostF3TerminalTolerancePricePoints = 20;
input double InpHookPostF3GeometricMinCompletionPct = 80.0;
...
input color  InpHookPhase02CycleArcColor = C'40,40,40';
...
void FP_LoadHookPhase02Config(FP_HookPhase02Config &cfg)
{
   ...
   cfg.draw_node_markers = InpHookPhase02DrawNodeMarkers;
   ...
   cfg.group_cycle_arc_by_origin = InpHookPhase02GroupCycleArcByOrigin;
   ...
   cfg.responsive_label_offsets = InpHookPhase02ResponsiveLabelOffsets;
   cfg.responsive_label_lookback_bars = InpHookPhase02ResponsiveLabelLookbackBars;
   cfg.responsive_label_min_offset_points = InpHookPhase02ResponsiveLabelMinOffsetPoints;
   cfg.responsive_label_max_offset_points = InpHookPhase02ResponsiveLabelMaxOffsetPoints;
   cfg.responsive_label_min_step_points = InpHookPhase02ResponsiveLabelMinStepPoints;
   cfg.responsive_label_max_step_points = InpHookPhase02ResponsiveLabelMaxStepPoints;
   cfg.responsive_label_offset_range_ratio = InpHookPhase02ResponsiveLabelOffsetRangeRatio;
   cfg.responsive_label_step_range_ratio = InpHookPhase02ResponsiveLabelStepRangeRatio;
   cfg.label_time_cluster_seconds = InpHookPhase02LabelTimeClusterSeconds;
   cfg.label_time_cluster_bars = InpHookPhase02LabelTimeClusterBars;
   ...
   cfg.valid_only_require_near_death = InpHookPhase02ValidOnlyRequireNearDeath;
   cfg.valid_f3_require_same_scale = InpHookPhase02ValidF3RequireSameScale;
   cfg.valid_f3_require_opposite_direction = InpHookPhase02ValidF3RequireOppositeDirection;
   cfg.valid_only_fallback_to_structural = InpHookPhase02ValidOnlyFallbackToStructural;
   cfg.post_f3_recognition_mode = InpHookPostF3RecognitionMode;
   cfg.post_f3_selection_priority = InpHookPostF3SelectionPriority;
   cfg.post_f3_allow_direct_terminal_hook = InpHookPostF3AllowDirectTerminalHook;
   cfg.post_f3_allow_delayed_rebound_hook = InpHookPostF3AllowDelayedReboundHook;
   cfg.post_f3_max_search_bars = InpHookPostF3MaxSearchBars;
   cfg.post_f3_terminal_tolerance_bars = InpHookPostF3TerminalToleranceBars;
   cfg.post_f3_terminal_tolerance_price_points = InpHookPostF3TerminalTolerancePricePoints;
   cfg.post_f3_geometric_min_completion_pct = InpHookPostF3GeometricMinCompletionPct;
