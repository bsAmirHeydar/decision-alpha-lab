...
def main() -> int:
    ...
    ap.add_argument("--builder", default="src/engine/legacy/research/astro_feature_builder/astro_feature_builder.py")
    ap.add_argument("--ephe-path", default="src/engine/legacy/research/astro_feature_builder/ephe")
    ...
    work_dir = Path("contexts/legacy/lab_experiments/EXP0013_astro_feature_store/live_runtime")
