...
from adapters.legacy.market_data.cme_bridge.dal_bar_store import CsvBar, write_bars
...
def main() -> None:
    ...
    parser.add_argument("--config", default="adapters/legacy/market_data/cme_bridge/configs/yahoo_delayed_es_nq.example.json")
