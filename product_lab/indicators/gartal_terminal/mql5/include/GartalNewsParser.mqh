...
bool GT_ParseCalendar(string raw, GT_Config &config, GT_NewsStore &store, GT_RuntimeState &runtime)
{
   ...
   GT_RuntimeLog(runtime, GT_LOG_WARNING, "Production parser is not implemented in Stage 02. Event store is ready; direct Forex Factory parser begins in Stage 08.");
   return false;
}
