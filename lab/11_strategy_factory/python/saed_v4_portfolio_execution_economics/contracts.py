...
def require_bool(v:Any,name:str,expected:bool|None=None)->bool:
    ...
    return v
def require_num(v:Any,name:str,minimum:float|None=None,maximum:float|None=None)->float:
    ...
    return x
def require_int(v:Any,name:str,minimum:int=0,maximum:int|None=None)->int:
    ...
    return v
def require_enum(v:Any,allowed:set[str],name:str)->str:
