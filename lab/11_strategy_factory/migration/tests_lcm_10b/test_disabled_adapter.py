import pytest
from tools.strategy_factory.lcm.lcm_10b.adapters import DisabledExecutionAdapter
from tools.strategy_factory.lcm.lcm_10b.errors import CapabilityDeniedError
