import json
from tools.strategy_factory.lcm.lcm_06.alias_resolver import AliasResolver
def resolver(repo_root): return AliasResolver(json.loads((repo_root/"lab/11_strategy_factory/migration/fixtures/lcm_06/aliases/reference_alias_records.json").read_text())["records"])
