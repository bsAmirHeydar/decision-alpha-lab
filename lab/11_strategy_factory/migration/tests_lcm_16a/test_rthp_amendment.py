...
def test_rthp_protected_engine_amendment_is_exact(root):
    path = root / "lab/11_strategy_factory/generated_contexts/rthp_cross_symbol_cycle_divergence/ai_input/generated/engine_extended_baseline_amendment_lcm16a.json"
