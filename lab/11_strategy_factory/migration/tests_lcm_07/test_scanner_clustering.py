...
def test_exact_cluster_fixture():
    root=Path(__file__).resolve().parents[4];records=read_json(root/"lab/11_strategy_factory/migration/fixtures/lcm_07/scanner/reference_functions.json")["records"]
