...
def test_file_index(repo_root): assert validate_file_index(repo_root,repo_root/'LCM_03_FILE_INDEX.txt')['passed']
...
def test_mql_contracts(repo_root): assert len(list((repo_root/'lab/11_strategy_factory/mql5/Include/AlphaLab/LCM/LCM03').glob('*.mqh')))>=10
