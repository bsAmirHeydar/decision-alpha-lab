...
@pytest.fixture(scope='session')
def acl05_root(): return ROOT/'lab/11_strategy_factory/acl_os/fixtures/acl_05/reference_batch'
@pytest.fixture(scope='session')
def fixture_root(): return ROOT/'lab/11_strategy_factory/acl_os/fixtures/acl_06'
@pytest.fixture(scope='session')
