...
def test_no_live_authority_in_phase08():
    paths=list((ROOT/"mql5/Include/AlphaLab/StrategyFactory/Candidate").rglob("*.mqh"))+list((ROOT/"mql5/Experts/StrategyFactory").glob("SF08_*.mq5"))+list((ROOT/"mql5/Experts/StrategyFactoryTests").glob("SF08_*.mq5"))
