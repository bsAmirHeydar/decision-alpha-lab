...
import pytest
ROOT=Path(__file__).resolve().parents[4];EX=ROOT/'lab/11_strategy_factory/examples/saed_v4_40';SC=ROOT/'lab/11_strategy_factory/schemas/saed_v4_40'
...
def test_pair_count():assert len(PAIRS)>=50
