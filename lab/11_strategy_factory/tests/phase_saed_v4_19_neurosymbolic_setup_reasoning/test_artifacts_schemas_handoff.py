...
def test_upstream(load,root):validate_upstream(load('lab/11_strategy_factory/artifacts/saed_v4_18/V4_18_TO_V4_19_HANDOFF.JSON'))
def test_upstream_authority_mutation(load,root):
 x=load('lab/11_strategy_factory/artifacts/saed_v4_18/V4_18_TO_V4_19_HANDOFF.JSON');x['authority']['send_order']=True
