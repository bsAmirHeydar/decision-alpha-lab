...
def test_budget_pass(load):assert load('lab/11_strategy_factory/artifacts/saed_v4_16/GOLDEN_COMPUTE_EXPOSURE_LEDGER.JSON')['passed']
def test_zero_protected_exposure(load):
 x=load('lab/11_strategy_factory/artifacts/saed_v4_16/GOLDEN_COMPUTE_EXPOSURE_LEDGER.JSON');assert x['actual']['protected_evidence_exposures']==0==x['limits']['protected_evidence_exposures']
