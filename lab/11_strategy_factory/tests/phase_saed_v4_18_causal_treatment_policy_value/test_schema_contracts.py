...
def test_all_schema_pairs(load,root,art):
 spec=importlib.util.spec_from_file_location('_schema_validator',root/'tools/strategy_factory/saed_v4_18/_schema_validator.py');m=importlib.util.module_from_spec(spec);spec.loader.exec_module(m)
