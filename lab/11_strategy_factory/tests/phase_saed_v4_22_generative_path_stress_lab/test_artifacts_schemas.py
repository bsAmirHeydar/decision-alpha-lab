...
def test_schema_pairs(root):
    dirs=[root/'lab/11_strategy_factory/examples/saed_v4_22',root/'lab/11_strategy_factory/artifacts/saed_v4_22'];schema=root/'lab/11_strategy_factory/schemas/saed_v4_22'
    for d in dirs:
...
def test_material_artifact_exists(root,name):assert (root/f'lab/11_strategy_factory/artifacts/saed_v4_22/{name}.JSON').exists()
