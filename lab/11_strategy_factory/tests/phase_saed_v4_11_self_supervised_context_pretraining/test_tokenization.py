...
def setup(records,load):
 o=[CorpusRecord.from_mapping(x) for x in records];s=assign_splits(o,load('lab/11_strategy_factory/examples/saed_v4_11/reference_split_policy.json'));streams=build_token_streams(o,s);return streams,build_tokenizer_spec(streams)
