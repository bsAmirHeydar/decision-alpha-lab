...
def test_vectors(root):
 v=json.loads((root/'lab/11_strategy_factory/test_vectors/saed_v4_02/SAED_V4_02_CONFORMANCE_VECTORS.json').read_text());r=run_vectors(v);assert all(x['passed'] for x in r)
