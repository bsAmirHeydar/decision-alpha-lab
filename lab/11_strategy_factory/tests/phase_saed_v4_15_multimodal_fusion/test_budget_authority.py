...
def test_budget_pass(load):assert load('lab/11_strategy_factory/artifacts/saed_v4_15/GOLDEN_COMPUTE_EXPOSURE_LEDGER.JSON')['passed']
def test_zero_protected_exposure(load):
 l=load('lab/11_strategy_factory/artifacts/saed_v4_15/GOLDEN_COMPUTE_EXPOSURE_LEDGER.JSON');assert l['protected_evidence_exposures']==0 and l['outcome_label_exposures']==0
