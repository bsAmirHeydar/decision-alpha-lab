...
def test_budget_passed(load):assert load('lab/11_strategy_factory/artifacts/saed_v4_17/GOLDEN_COMPUTE_EXPOSURE_LEDGER.JSON')['passed']
def test_zero_protected_and_hidden(load):
 x=load('lab/11_strategy_factory/artifacts/saed_v4_17/GOLDEN_COMPUTE_EXPOSURE_LEDGER.JSON')['usage'];assert x['protected_evidence_exposures']==0 and x['hidden_evaluation_queries']==0
