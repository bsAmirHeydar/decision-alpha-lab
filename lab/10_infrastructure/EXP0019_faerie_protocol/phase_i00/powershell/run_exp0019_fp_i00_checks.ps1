...
$PhaseRoot = Join-Path $Repo "lab\10_infrastructure\EXP0019_faerie_protocol\phase_i00"
...
"@ | python -
    ...
    if (-not $SkipPreviousContextPythonTest) {
        $PreviousTest = Join-Path $Repo "lab\10_infrastructure\EXP0018_daye_trader\tests\test_exp0018_phase00_doctrine_v2.py"
