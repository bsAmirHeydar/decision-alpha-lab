...
VALIDATOR = ROOT / "lab/10_infrastructure/EXP0018_daye_trader/tools/validate_exp0018_phase04_relationship_registry_v2.py"
...
def test_registry_cardinality_and_blockers():
    path = ROOT / "lab/10_infrastructure/EXP0018_daye_trader/contracts/daye_relationship_registry_contract_v2.json"
...
def test_registry_chain_is_canonical():
    path = ROOT / "lab/10_infrastructure/EXP0018_daye_trader/contracts/daye_relationship_registry_v2.csv"
...
def test_fixture_has_fail_closed_cases():
    path = ROOT / "lab/10_infrastructure/EXP0018_daye_trader/fixtures/daye_relationship_resolution_cases_v2.csv"
    with path.open(encoding="utf-8-sig", newline="") as f:
