...
def test_contract_authority_and_rules():
    c=json.loads((ROOT/'lab/10_infrastructure/EXP0018_daye_trader/contracts/daye_reference_lifecycle_contract_v2.json').read_text())
...
def test_fixture_transition_coverage():
    rows=list(csv.DictReader((ROOT/'lab/10_infrastructure/EXP0018_daye_trader/fixtures/daye_reference_lifecycle_cases_v2.csv').open()))
