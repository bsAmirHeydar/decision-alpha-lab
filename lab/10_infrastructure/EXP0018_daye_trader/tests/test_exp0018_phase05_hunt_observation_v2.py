...
def test_validator_passes():
    script=ROOT/'lab/10_infrastructure/EXP0018_daye_trader/tools/validate_exp0018_phase05_hunt_observation_v2.py'
...
def test_contract_boundaries():
    c=json.loads((ROOT/'lab/10_infrastructure/EXP0018_daye_trader/contracts/daye_hunt_observation_contract_v2.json').read_text())
...
def test_equality_fixtures_exist():
    rows=list(csv.DictReader((ROOT/'lab/10_infrastructure/EXP0018_daye_trader/fixtures/daye_hunt_observation_cases_v2.csv').open()))
