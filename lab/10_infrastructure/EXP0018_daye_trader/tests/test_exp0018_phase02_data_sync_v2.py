...
MODULE_PATH = ROOT / "lab/10_infrastructure/EXP0018_daye_trader/tools/validate_exp0018_phase02_data_sync_v2.py"
...
def test_missing_bar_is_not_forward_filled():
    datasets = module.load_fixture(ROOT / "lab/10_infrastructure/EXP0018_daye_trader/fixtures/daye_multi_symbol_alignment_cases_v2.csv")
