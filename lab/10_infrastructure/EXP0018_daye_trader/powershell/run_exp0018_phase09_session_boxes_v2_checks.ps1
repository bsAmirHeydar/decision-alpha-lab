...
& $Python.Source "$RepoRoot/lab/10_infrastructure/EXP0018_daye_trader/tools/validate_exp0018_phase09_session_boxes_v2.py" "$RepoRoot"
& $Python.Source -m pytest "$RepoRoot/lab/10_infrastructure/EXP0018_daye_trader/tests/test_exp0018_phase09_session_boxes_v2.py" -q
