...
contract_path=req('lab/10_infrastructure/EXP0018_daye_trader/contracts/daye_unified_visual_contract_v2.json')
fixture_path=req('lab/10_infrastructure/EXP0018_daye_trader/fixtures/daye_unified_visual_cases_v2.csv')
