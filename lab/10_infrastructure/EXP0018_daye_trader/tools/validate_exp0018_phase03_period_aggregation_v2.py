...
def main():
    ...
    cpath=root/'lab/10_infrastructure/EXP0018_daye_trader/contracts/daye_period_aggregation_contract_v2.json'
    fpath=root/'lab/10_infrastructure/EXP0018_daye_trader/fixtures/daye_period_aggregation_cases_v2.csv'
    errors=[]
