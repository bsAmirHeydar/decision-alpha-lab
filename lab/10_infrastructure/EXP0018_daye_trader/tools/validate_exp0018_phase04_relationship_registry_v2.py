...
def validate(repo: Path) -> list[str]:
    errors: list[str] = []
    contract_path = repo / "lab/10_infrastructure/EXP0018_daye_trader/contracts/daye_relationship_registry_contract_v2.json"
    csv_path = repo / "lab/10_infrastructure/EXP0018_daye_trader/contracts/daye_relationship_registry_v2.csv"
    fixture_path = repo / "lab/10_infrastructure/EXP0018_daye_trader/fixtures/daye_relationship_resolution_cases_v2.csv"
