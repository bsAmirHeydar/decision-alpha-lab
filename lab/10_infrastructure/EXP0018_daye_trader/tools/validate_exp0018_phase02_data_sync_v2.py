...
def validate(repo_root: Path) -> list[str]:
    errors: list[str] = []
    contract_path = repo_root / "lab/10_infrastructure/EXP0018_daye_trader/contracts/daye_multi_symbol_data_contract_v2.json"
    fixture_path = repo_root / "lab/10_infrastructure/EXP0018_daye_trader/fixtures/daye_multi_symbol_alignment_cases_v2.csv"
