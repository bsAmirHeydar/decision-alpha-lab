...
errors=[]
contract=json.loads((root/'lab/10_infrastructure/EXP0018_daye_trader/contracts/daye_session_box_contract_v2.json').read_text(encoding='utf-8'))
...
rows=list(csv.DictReader((root/'lab/10_infrastructure/EXP0018_daye_trader/fixtures/daye_session_box_cases_v2.csv').open(encoding='utf-8')))
