...
def test_protected_platform():
 r=classify(row('src/engine/legacy/acl_os_reference/x.py','ACL_OS_PLATFORM','PYTHON'),set(),set(),0,False); assert r['protected_platform_asset']; assert r['primary_disposition']=='KEEP_CANONICAL'
