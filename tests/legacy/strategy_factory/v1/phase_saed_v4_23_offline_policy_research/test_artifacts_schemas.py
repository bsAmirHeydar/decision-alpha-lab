...
import json,pytest
ROOT=find_repository_root(__file__);ART=ROOT/'releases/history/strategy_factory/artifacts/saed_v4_23';EX=ROOT/'examples/legacy/strategy_factory/saed_v4_23';SCH=ROOT/'schemas/legacy/strategy_factory/saed_v4_23'
