...
def streams(records,load):
 o=[CorpusRecord.from_mapping(x) for x in records];s=assign_splits(o,load('examples/legacy/strategy_factory/saed_v4_11/reference_split_policy.json'));return build_token_streams(o,s)
