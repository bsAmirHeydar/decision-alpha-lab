...
def build(records,config,upstream,load):return build_reference_bundle(records,upstream[0],upstream[1],config,load('examples/legacy/strategy_factory/saed_v4_11/reference_split_policy.json'),load('examples/legacy/strategy_factory/saed_v4_11/membership_canaries.json')['tokens'])
