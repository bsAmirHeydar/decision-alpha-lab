...
def setup(records,load):
 o=[CorpusRecord.from_mapping(x) for x in records];sp=assign_splits(o,load('examples/legacy/strategy_factory/saed_v4_11/reference_split_policy.json'));ss=build_token_streams(o,sp);return ss,build_tokenizer_spec(ss)
