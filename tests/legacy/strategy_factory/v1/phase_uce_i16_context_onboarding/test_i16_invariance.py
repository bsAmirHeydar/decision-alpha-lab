...
@pytest.mark.parametrize('path',['src/engine/packages/strategy_factory_contracts_v3/x.py','src/engine/packages/strategy_factory_economics_v3/x.py','src/engine/packages/strategy_factory_runtime_v3/x.py'])
...
def test_core_change_with_adr_is_reported():
 path='src/engine/packages/strategy_factory_contracts_v3/x.py';h=canonical_sha256('x');a=CoreSnapshot('a','1.0.0',canonical_sha256({}),{},0);b=CoreSnapshot('b','1.0.0',canonical_sha256({path:h}),{path:h},0)
