...
def args(load):return [load(p) for p in ['releases/history/strategy_factory/artifacts/saed_v4_16/V4_16_TO_V4_17_HANDOFF.JSON','releases/history/strategy_factory/artifacts/saed_v4_16/GOLDEN_SURVIVAL_DATASET.JSON','releases/history/strategy_factory/artifacts/saed_v4_16/GOLDEN_CHECKPOINT_REGISTRY.JSON','releases/history/strategy_factory/artifacts/saed_v4_16/GOLDEN_INTEGRITY_RECEIPT.JSON','releases/history/strategy_factory/artifacts/saed_v4_16/GOLDEN_TAIL_CALIBRATION_REPORT.JSON','releases/history/strategy_factory/artifacts/saed_v4_16/GOLDEN_TIME_CALIBRATION_REPORT.JSON']]
