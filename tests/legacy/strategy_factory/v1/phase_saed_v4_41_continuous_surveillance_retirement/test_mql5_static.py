...
import pytest
ROOT=find_repository_root(__file__);FILES=sorted(list((ROOT/'mql5/Include/StrategyFactory/SAED/V4_41').glob('*'))+list((ROOT/'mql5/Experts/StrategyFactory/SAED/V4_41').glob('*')))
