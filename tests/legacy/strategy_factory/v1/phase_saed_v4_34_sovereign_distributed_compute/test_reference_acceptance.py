...
def test_golden_exact(inputs,root):
    r=run(inputs); ar=root/"releases/history/strategy_factory/artifacts/saed_v4_34"
    mapping=json.loads((root/"src/engine/tooling/strategy_factory/saed_v4_34/artifact_map.json").read_text())
