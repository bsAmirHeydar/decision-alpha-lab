...
def test_golden_exact(outputs,request):
    ar=request.config.rootpath/"releases/history/strategy_factory/artifacts/saed_v4_28"
...
def test_artifact_exists(request,name): assert (request.config.rootpath/"releases/history/strategy_factory/artifacts/saed_v4_28"/name).is_file()
