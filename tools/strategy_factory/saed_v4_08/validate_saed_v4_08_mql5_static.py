...
ROOT=Path(__file__).resolve().parents[3];files=sorted((ROOT/'mql5/Include/AlphaLab/StrategyFactory/SAEDV4OutcomeCube').glob('*.mqh'))+sorted((ROOT/'mql5/Experts/AlphaLab/StrategyFactory/Diagnostics').glob('EXP_SAED_V4_08_*.mq5'))
