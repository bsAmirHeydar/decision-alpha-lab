...
import hashlib,json
ROOT=Path(__file__).resolve().parents[3];index=ROOT/'SAED_V4_13_FILE_INDEX.txt';ledger=ROOT/'SAED_V4_13_FILE_HASHES.sha256';manifest_path=ROOT/'SAED_V4_13_PATCH_MANIFEST.json'
...
assert set(expected)==set(paths)-{'SAED_V4_13_FILE_HASHES.sha256'}
