...
commands=[[sys.executable,'tools/strategy_factory/saed_v4_18/validate_saed_v4_18_contracts.py'],[sys.executable,'tools/strategy_factory/saed_v4_18/check_saed_v4_18_boundaries.py'],[sys.executable,'tools/strategy_factory/saed_v4_18/validate_saed_v4_18_mql5_static.py'],[sys.executable,'tools/strategy_factory/saed_v4_18/validate_saed_v4_18_obsidian.py'],[sys.executable,'tools/strategy_factory/saed_v4_18/run_saed_v4_18_tests.py'],[sys.executable,'tools/strategy_factory/saed_v4_18/reproduce_saed_v4_18_golden.py'],[sys.executable,'tools/strategy_factory/saed_v4_18/validate_saed_v4_18_status.py']]
results=[]
