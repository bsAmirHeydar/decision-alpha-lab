...
index=ROOT/'SAED_V4_18_FILE_INDEX.txt';ledger=ROOT/'SAED_V4_18_FILE_HASHES.sha256';manifest_path=ROOT/'SAED_V4_18_PATCH_MANIFEST.json';qa_path=ROOT/'SAED_V4_18_QA_REPORT.json'
...
assert set(expected)==set(paths)-{'SAED_V4_18_FILE_HASHES.sha256'}
...
h=json.loads((ROOT/'lab/11_strategy_factory/artifacts/saed_v4_18/V4_18_TO_V4_19_HANDOFF.JSON').read_text(encoding='utf-8'))
