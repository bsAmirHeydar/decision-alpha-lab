...
import hashlib,json
ROOT=Path(__file__).resolve().parents[3];index=ROOT/'releases/history/saed/indexes/SAED_V4_15_FILE_INDEX.txt';ledger=ROOT/'releases/history/saed/hashes/SAED_V4_15_FILE_HASHES.sha256';manifest_path=ROOT/'releases/history/saed/manifests/SAED_V4_15_PATCH_MANIFEST.json'
