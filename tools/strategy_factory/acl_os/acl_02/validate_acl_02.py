...
def validate(root:Path=REPO_ROOT)->dict:
    ...
    mql=list((root/"lab/11_strategy_factory/mql5/Include/AlphaLab/ACL_OS/ACL02").glob("*.mqh"));add(len(mql)>=8,"MQL5_STATIC",f"{len(mql)} files")
