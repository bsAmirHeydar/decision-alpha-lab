...
def validate(root: Path=REPO_ROOT) -> dict:
    ...
    mql=list((root/"lab/11_strategy_factory/mql5/Include/AlphaLab/ACL_OS/ACL04").glob("*.mqh")); add(len(mql)>=12,"ACL04_MQL5_STATIC",f"{len(mql)} files")
    ...
    module=root/"tools/strategy_factory/acl_os/acl_04"; add((module/"service.py").is_file(),"ACL04_SERVICE_EXISTS","service exists")
    fixture=root/"lab/11_strategy_factory/acl_os/fixtures/acl_04"; add((fixture/"human_setup.yaml").is_file(),"ACL04_FIXTURE_EXISTS","fixture exists")
