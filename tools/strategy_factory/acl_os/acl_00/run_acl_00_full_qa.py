...
def main()->int:
    cmd=[sys.executable,"-m","pytest","-q","lab/11_strategy_factory/acl_os/tests_acl_00"]
    ...
    dump_json(REPO_ROOT/"ACL_OS_00_QA_REPORT.json",out); print(json.dumps(out,indent=2,sort_keys=True)); return 0 if out["passed"] else 1
