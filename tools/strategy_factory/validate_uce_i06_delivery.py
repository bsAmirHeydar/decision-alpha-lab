...
required=[
 ...
 'lab/11_strategy_factory/python/strategy_factory_dataset_v3/dataset.py',
 'lab/11_strategy_factory/schemas/v3/dataset_manifest.schema.json',
 'lab/11_strategy_factory/test_vectors/v3/uce_i06_golden_dataset_vectors.json',
 ...
 'lab/11_strategy_factory/implementation_program/universal_context_exploitation_engine/v3_implementation/phase_status/UCE_I06.json']
for rel in required:
 if not (root/rel).is_file():errors.append('missing '+rel)
for p in (root/'lab/11_strategy_factory/schemas/v3').glob('*.schema.json'):
