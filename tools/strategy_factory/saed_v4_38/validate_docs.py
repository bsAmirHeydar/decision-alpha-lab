...
ROOT=Path(__file__).resolve().parents[3];phase=ROOT/'docs/strategy_factory_sovereign_context_intelligence_v4/62_PHASE_DELIVERIES_V4/V4_38';atomic=ROOT/'docs/strategy_factory_sovereign_context_intelligence_v4/63_ATOMIC_CONCEPTS_V4/V4_38';pd=list(phase.glob('*.md'));ad=list(atomic.glob('*.md'))
