...
ROOT=Path(__file__).resolve().parents[3];idx=ROOT/'releases/history/saed/indexes/SAED_V4_38_FILE_INDEX.txt';hashes=ROOT/'releases/history/saed/hashes/SAED_V4_38_FILE_HASHES.sha256';manifest=ROOT/'releases/history/saed/manifests/SAED_V4_38_PATCH_MANIFEST.json'
for p in [idx,hashes,manifest,ROOT/'releases/history/saed/reports/SAED_V4_38_QA_REPORT.json',ROOT/'releases/history/saed/inventories/SAED_V4_38_ARTIFACT_INVENTORY.csv']:
