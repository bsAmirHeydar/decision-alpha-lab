...
ROOT=Path(__file__).resolve().parents[2];INC=ROOT/'mql5/Include/AlphaLab/StrategyFactory/ImmutableRuntime'
FILES=sorted(INC.glob('UCEI14_*.mqh'))+[ROOT/'mql5/Experts/StrategyFactory/UCE_I14_ImmutableRuntimeDiagnostic.mq5',ROOT/'mql5/Experts/StrategyFactoryTests/UCE_I14_PreprocessingParitySelfTest.mq5',ROOT/'mql5/Experts/StrategyFactoryTests/UCE_I14_AtomicActivationRollbackSelfTest.mq5',ROOT/'mql5/Experts/StrategyFactoryTests/UCE_I14_DuplicateDecisionKillSwitchSelfTest.mq5'];errors=[]
