...
ROOT=Path(__file__).resolve().parents[2];INC=ROOT/'mql5/Include/AlphaLab/StrategyFactory/ContextTournament'
FILES=sorted(INC.glob('UCEI15_*.mqh'))+[ROOT/'mql5/Experts/StrategyFactory/UCE_I15_ContextTournamentDiagnostic.mq5',ROOT/'mql5/Experts/StrategyFactoryTests/UCE_I15_FixtureCannotPromoteSelfTest.mq5',ROOT/'mql5/Experts/StrategyFactoryTests/UCE_I15_FreezeAndCountSelfTest.mq5',ROOT/'mql5/Experts/StrategyFactoryTests/UCE_I15_ProspectiveReconciliationSelfTest.mq5'];errors=[]
