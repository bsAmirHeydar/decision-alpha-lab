...
ROOT=Path(__file__).resolve().parents[3];files=sorted(list((ROOT/'mql5/Include/StrategyFactory/SAED/V4_39').glob('*'))+list((ROOT/'mql5/Experts/StrategyFactory/SAED/V4_39').glob('*')));assert len(files)>=28
