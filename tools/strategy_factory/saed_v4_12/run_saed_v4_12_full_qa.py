...
commands=[
 [sys.executable,'tools/strategy_factory/saed_v4_12/validate_saed_v4_12_contracts.py'],[sys.executable,'tools/strategy_factory/saed_v4_12/check_saed_v4_12_boundaries.py'],[sys.executable,'tools/strategy_factory/saed_v4_12/validate_saed_v4_12_mql5_static.py'],[sys.executable,'tools/strategy_factory/saed_v4_12/validate_saed_v4_12_obsidian.py'],[sys.executable,'tools/strategy_factory/saed_v4_12/run_saed_v4_12_tests.py'],[sys.executable,'tools/strategy_factory/saed_v4_12/reproduce_saed_v4_12_golden.py'],[sys.executable,'tools/strategy_factory/saed_v4_12/validate_saed_v4_12_status.py']]
results=[]
...
(ROOT/'SAED_V4_12_QA_REPORT.json').write_text(json.dumps(report,indent=2,sort_keys=True)+'\n',encoding='utf-8')
