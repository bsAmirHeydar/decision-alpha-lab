...
def _ambiguity_targets(ambiguities):
    ...
    for a in ambiguities:
        aid=a['ambiguity_id'];family=(a.get('family_candidate') or 'UNKNOWN').upper();target=f"lab/11_strategy_factory/migration/quarantine/identity_ambiguity/{family[:40]}/{aid}.json"
        validate(target)
