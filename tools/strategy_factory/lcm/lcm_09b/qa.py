...
def run(repo_root:Path,package_root:Path)->dict:
    ...
    schemas=validate_schema_directory(repo_root/"registry/legacy_context_migration/lcm_09b/schemas/v1")
    static=scan_module(repo_root/"tools/strategy_factory/lcm/lcm_09b")
