...
ROOT=Path(__file__).resolve().parents[3];a=json.loads((ROOT/'lab/11_strategy_factory/artifacts/saed_v4_36/GOLDEN_AUTHORITY.JSON').read_text());c=json.loads((ROOT/'lab/11_strategy_factory/artifacts/saed_v4_36/GOLDEN_CERTIFICATE.JSON').read_text());h=json.loads((ROOT/'lab/11_strategy_factory/artifacts/saed_v4_36/GOLDEN_HANDOFF.JSON').read_text());p=json.loads((ROOT/'lab/11_strategy_factory/artifacts/saed_v4_36/GOLDEN_PLAN.JSON').read_text())
