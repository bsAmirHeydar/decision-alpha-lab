...
ROOT=Path(__file__).resolve().parents[3];m=json.loads((ROOT/'lab/11_strategy_factory/artifacts/saed_v4_36/GOLDEN_MEMORY.JSON').read_text());n=json.loads((ROOT/'lab/11_strategy_factory/artifacts/saed_v4_36/GOLDEN_NEGATIVE_KNOWLEDGE.JSON').read_text());r=json.loads((ROOT/'lab/11_strategy_factory/artifacts/saed_v4_36/GOLDEN_RETRIEVAL_RECEIPT.JSON').read_text())
