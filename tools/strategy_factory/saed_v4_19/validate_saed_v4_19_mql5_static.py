...
ROOT=Path(__file__).resolve().parents[3];inc=ROOT/'mql5/Include/DecisionAlphaLab/StrategyFactory/SAED/V4_19';exp=ROOT/'mql5/Experts/DecisionAlphaLab/StrategyFactory/SAED/V4_19'
