...
ROOT=Path(__file__).resolve().parents[3];files=list((ROOT/'mql5/Include/DecisionAlphaLab/StrategyFactory/SAED/V4_14').glob('*.mqh'))+list((ROOT/'mql5/Experts/DecisionAlphaLab/StrategyFactory/SAED/V4_14').glob('*.mq5'));assert files
for p in files:
