...
b=json.loads((ROOT/'lab/11_strategy_factory/artifacts/saed_v4_14/AUTHORITY_BOUNDARY.JSON').read_text());assert not b['decision_authority'] and not b['runtime_authority'] and not b['execution_authority']
