...
import hashlib,json
ROOT=Path(__file__).resolve().parents[3];index=ROOT/'releases/history/saed/indexes/SAED_V4_14_FILE_INDEX.txt';ledger=ROOT/'releases/history/saed/hashes/SAED_V4_14_FILE_HASHES.sha256';manifest_path=ROOT/'releases/history/saed/manifests/SAED_V4_14_PATCH_MANIFEST.json'
...
s=json.loads((ROOT/'lab/11_strategy_factory/phase_status/SAED_V4_14.json').read_text());assert s['claims']['foundation_model_adapter_boundary_implemented'] and not s['claims']['production_authorization']
