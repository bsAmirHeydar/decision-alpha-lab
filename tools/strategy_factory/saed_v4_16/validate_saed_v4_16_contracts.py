...
import json,sys
ROOT=Path(__file__).resolve().parents[3];sys.path.insert(0,str(ROOT/'tools/strategy_factory/saed_v4_16'))
from _schema_validator import validate
load=lambda p:json.loads((ROOT/p).read_text(encoding='utf-8'))
m=load('lab/11_strategy_factory/artifacts/saed_v4_16/CONTRACT_VALIDATION_MAP.JSON')
