...
owned=list((root/'mql5/Include/AlphaLab/StrategyFactory/Candidate').rglob('*.mqh'))+list((root/'mql5/Experts/StrategyFactory').glob('SF08_*.mq5'))+list((root/'mql5/Experts/StrategyFactoryTests').glob('SF08_*.mq5'))
