...
commands=[
 [sys.executable,'tools/strategy_factory/saed_v4_11/validate_saed_v4_11_contracts.py'],
 [sys.executable,'tools/strategy_factory/saed_v4_11/check_saed_v4_11_boundaries.py'],
 [sys.executable,'tools/strategy_factory/saed_v4_11/validate_saed_v4_11_mql5_static.py'],
 [sys.executable,'tools/strategy_factory/saed_v4_11/validate_saed_v4_11_obsidian.py'],
 [sys.executable,'tools/strategy_factory/saed_v4_11/run_saed_v4_11_tests.py'],
 [sys.executable,'tools/strategy_factory/saed_v4_11/reproduce_saed_v4_11_golden.py']
]
results=[]
