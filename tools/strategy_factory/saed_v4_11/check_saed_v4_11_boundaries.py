...
paths=list((ROOT/'lab/11_strategy_factory/python/saed_v4_self_supervised_pretraining').glob('*.py'))+list((ROOT/'mql5/Include/DecisionAlphaLab/StrategyFactory/SAED/V4_11').glob('*.mqh'))+list((ROOT/'mql5/Experts/DecisionAlphaLab/StrategyFactory/SAED/V4_11').glob('*.mq5'))
