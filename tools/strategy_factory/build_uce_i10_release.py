...
def owned_paths(root: Path) -> list[Path]:
    paths: set[Path] = set()
    dirs = (
        'lab/11_strategy_factory/python/strategy_factory_deep_views_v3',
        'lab/11_strategy_factory/tests/phase_uce_i10_deep_views',
        'lab/11_strategy_factory/examples/uce_i10',
    ...
    specific = [
        ...
        'tools/strategy_factory/check_uce_i10_boundaries.py','tools/strategy_factory/check_uce_i10_mql5_static.py',
        'tools/strategy_factory/compile_uce_i10_deep_views.ps1','tools/strategy_factory/generate_uce_i10_vectors.py',
        'tools/strategy_factory/run_uce_i10_tests.ps1','tools/strategy_factory/validate_uce_i10_delivery.py',
        'tools/strategy_factory/apply_uce_i10_patch.ps1','tools/strategy_factory/build_uce_i10_release.py',
    ]
    specific += [f'lab/11_strategy_factory/schemas/v3/{name}.schema.json' for name in SCHEMAS]
