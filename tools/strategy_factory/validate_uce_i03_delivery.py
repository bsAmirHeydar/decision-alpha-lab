...
'mql5/Experts/StrategyFactoryTests/UCE_I03_TreatmentAtomsSelfTest.mq5',
'lab/11_strategy_factory/python/strategy_factory_treatments_v3/catalog.py',
'lab/11_strategy_factory/test_vectors/v3/uce_i03_treatment_atom_vectors.json',
...
'lab/11_strategy_factory/implementation_program/universal_context_exploitation_engine/v3_implementation/phase_status/UCE_I03_HANDOFF_TO_UCE_I04.json']
def main():
 ...
 vec=root/'lab/11_strategy_factory/test_vectors/v3/uce_i03_treatment_atom_vectors.json'
 if vec.exists():
