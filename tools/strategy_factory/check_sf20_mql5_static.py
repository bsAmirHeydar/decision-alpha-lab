...
files=list((root/"mql5/Include/AlphaLab/StrategyFactory/Integration").rglob("*.mqh"))+list((root/"mql5/Experts/StrategyFactory").glob("SF20_*.mq5"))+list((root/"mql5/Experts/StrategyFactoryTests").glob("SF20_*.mq5"))
errors=[]
for p in files:
