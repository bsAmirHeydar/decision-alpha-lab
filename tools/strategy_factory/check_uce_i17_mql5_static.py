...
ROOT=Path(__file__).resolve().parents[2];INC=ROOT/'mql5/Include/AlphaLab/StrategyFactory/Portfolio';EXP=ROOT/'mql5/Experts/AlphaLab/StrategyFactory/Diagnostics';files=sorted(INC.glob('*.mqh'))+sorted(EXP.glob('EXP_UCE_I17_*.mq5'));errors=[]
