...
import json,re
ROOT=Path(__file__).resolve().parents[3];bases=[ROOT/'mql5/Include/DecisionAlphaLab/StrategyFactory/SAED/V4_21',ROOT/'mql5/Experts/DecisionAlphaLab/StrategyFactory/SAED/V4_21']
