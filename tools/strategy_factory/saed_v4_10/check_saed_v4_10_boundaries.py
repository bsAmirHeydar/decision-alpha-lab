...
paths=list((ROOT/'lab/11_strategy_factory/python/saed_v4_baseline_manual').glob('*.py'))+list((ROOT/'mql5/Include/DecisionAlphaLab/StrategyFactory/SAED/V4_10').glob('*.mqh'))
