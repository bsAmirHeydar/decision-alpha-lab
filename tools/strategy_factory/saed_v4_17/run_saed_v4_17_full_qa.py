...
commands=[[sys.executable,'tools/strategy_factory/saed_v4_17/validate_saed_v4_17_contracts.py'],[sys.executable,'tools/strategy_factory/saed_v4_17/check_saed_v4_17_boundaries.py'],[sys.executable,'tools/strategy_factory/saed_v4_17/validate_saed_v4_17_mql5_static.py'],[sys.executable,'tools/strategy_factory/saed_v4_17/validate_saed_v4_17_obsidian.py'],[sys.executable,'tools/strategy_factory/saed_v4_17/run_saed_v4_17_tests.py'],[sys.executable,'tools/strategy_factory/saed_v4_17/reproduce_saed_v4_17_golden.py'],[sys.executable,'tools/strategy_factory/saed_v4_17/validate_saed_v4_17_status.py']]
results=[]
