...
index=ROOT/'SAED_V4_17_FILE_INDEX.txt';ledger=ROOT/'SAED_V4_17_FILE_HASHES.sha256';manifest_path=ROOT/'SAED_V4_17_PATCH_MANIFEST.json';qa_path=ROOT/'SAED_V4_17_QA_REPORT.json'
...
assert set(expected)==set(paths)-{'SAED_V4_17_FILE_HASHES.sha256'}
