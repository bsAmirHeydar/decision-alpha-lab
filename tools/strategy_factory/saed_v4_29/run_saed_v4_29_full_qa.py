...
TOOL = ROOT / "tools/strategy_factory/saed_v4_29"
...
completed = subprocess.run(
    [
        ...
        "pytest",
        "-q",
        str(ROOT / "lab/11_strategy_factory/tests/phase_saed_v4_29_hidden_evaluation_air_gap"),
    ],
    cwd=ROOT,
    env=env,
    text=True,
...
status_path = ROOT / "lab/11_strategy_factory/phase_status/SAED_V4_29.json"
