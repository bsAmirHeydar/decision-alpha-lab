...
def main()->int:
    ...
    owned=[root/"mql5/Include/AlphaLab/StrategyFactory/ContextPackage",root/"mql5/Experts/StrategyFactory/UCE_I02_ContextPackageDiagnostic.mq5",root/"mql5/Experts/StrategyFactoryTests/UCE_I02_ContextPackageSelfTest.mq5",root/"mql5/Experts/StrategyFactoryTests/UCE_I02_EXP0017ReferenceSelfTest.mq5",root/"lab/11_strategy_factory/python/strategy_factory_contexts_v3"]
    files=[]
    for path in owned:
