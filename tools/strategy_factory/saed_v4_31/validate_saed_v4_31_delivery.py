...
INDEX=ROOT/"SAED_V4_31_FILE_INDEX.txt"; LEDGER=ROOT/"SAED_V4_31_FILE_HASHES.sha256"; INVENTORY=ROOT/"SAED_V4_31_ARTIFACT_INVENTORY.csv"; MANIFEST=ROOT/"SAED_V4_31_PATCH_MANIFEST.json"
...
assert set(expected)==set(paths)-{"SAED_V4_31_FILE_HASHES.sha256"}
...
status=json.loads((ROOT/"lab/11_strategy_factory/phase_status/SAED_V4_31.json").read_text()); qa=json.loads((ROOT/"SAED_V4_31_QA_REPORT.json").read_text()); assert status["qa_passed"] and qa["passed"]
