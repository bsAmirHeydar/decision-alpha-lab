...
owned=list((root/'mql5/Include/AlphaLab/StrategyFactory/Outcome').rglob('*.mqh'))+list((root/'mql5/Experts/StrategyFactory').glob('SF09_*.mq5'))+list((root/'mql5/Experts/StrategyFactoryTests').glob('SF09_*.mq5'))
