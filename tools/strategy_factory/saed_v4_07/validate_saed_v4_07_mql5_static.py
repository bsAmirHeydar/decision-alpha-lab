...
ROOT=Path(__file__).resolve().parents[3];I=ROOT/'mql5/Include/AlphaLab/StrategyFactory/SAEDV4ActionLattice';E=ROOT/'mql5/Experts/AlphaLab/StrategyFactory/Diagnostics';files=sorted(I.glob('*.mqh'))+sorted(E.glob('EXP_SAED_V4_07_*.mq5'))
