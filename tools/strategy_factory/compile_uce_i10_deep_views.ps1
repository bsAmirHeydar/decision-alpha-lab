...
$targets=@('mql5/Experts/StrategyFactory/UCE_I10_DeepViewsDiagnostic.mq5','mql5/Experts/StrategyFactoryTests/UCE_I10_DeepViewsSelfTest.mq5','mql5/Experts/StrategyFactoryTests/UCE_I10_CausalitySafetySelfTest.mq5')
