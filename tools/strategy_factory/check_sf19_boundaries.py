...
for p in (root/'lab/11_strategy_factory/python/strategy_factory_monitoring').rglob('*.py'):
    text=p.read_text(encoding='utf-8',errors='ignore')
...
required={
 ...
 root/'lab/11_strategy_factory/python/strategy_factory_monitoring/models.py':'automatic_mutation_allowed: bool=False'}
