...
tool = ROOT / "tools/strategy_factory/saed_v4_32"
env = dict(os.environ)
env["PYTHONPATH"] = str(PY_ROOT) + os.pathsep + env.get("PYTHONPATH", "")
completed = subprocess.run(
    [sys.executable, "-m", "pytest", "-q", str(ROOT / "lab/11_strategy_factory/tests/phase_saed_v4_32_multi_agent_research_constitution")],
...
status_path = ROOT / "lab/11_strategy_factory/phase_status/SAED_V4_32.json"
