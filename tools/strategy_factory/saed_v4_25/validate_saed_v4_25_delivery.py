...
INDEX = ROOT / "SAED_V4_25_FILE_INDEX.txt"
LEDGER = ROOT / "SAED_V4_25_FILE_HASHES.sha256"
MANIFEST = ROOT / "SAED_V4_25_PATCH_MANIFEST.json"
QA = ROOT / "SAED_V4_25_QA_REPORT.json"
INVENTORY = ROOT / "SAED_V4_25_ARTIFACT_INVENTORY.csv"
...
assert set(expected) == set(paths) - {"SAED_V4_25_FILE_HASHES.sha256"}
