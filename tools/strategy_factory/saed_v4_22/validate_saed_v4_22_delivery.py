...
index=ROOT/'SAED_V4_22_FILE_INDEX.txt';ledger=ROOT/'SAED_V4_22_FILE_HASHES.sha256';manifest_path=ROOT/'SAED_V4_22_PATCH_MANIFEST.json';qa_path=ROOT/'SAED_V4_22_QA_REPORT.json';inventory=ROOT/'SAED_V4_22_ARTIFACT_INVENTORY.csv'
...
assert set(expected)==set(paths)-{'SAED_V4_22_FILE_HASHES.sha256'}
