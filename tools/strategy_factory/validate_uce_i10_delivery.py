...
required = [
    ...
    'mql5/Experts/StrategyFactoryTests/UCE_I10_CausalitySafetySelfTest.mq5',
    'lab/11_strategy_factory/python/strategy_factory_deep_views_v3/catalog.py',
    'lab/11_strategy_factory/python/strategy_factory_deep_views_v3/sequence.py',
    'lab/11_strategy_factory/python/strategy_factory_deep_views_v3/raster.py',
    'lab/11_strategy_factory/python/strategy_factory_deep_views_v3/graph.py',
    'lab/11_strategy_factory/python/strategy_factory_deep_views_v3/regime.py',
    'lab/11_strategy_factory/python/strategy_factory_deep_views_v3/fusion.py',
    'lab/11_strategy_factory/python/strategy_factory_deep_views_v3/qualification.py',
    'lab/11_strategy_factory/python/strategy_factory_deep_views_v3/trainer_plugins.py',
    'lab/11_strategy_factory/schemas/v3/sequence_artifact.schema.json',
    'lab/11_strategy_factory/schemas/v3/pixel_audit_report.schema.json',
    'lab/11_strategy_factory/schemas/v3/dependency_probe.schema.json',
    'lab/11_strategy_factory/schemas/v3/transfer_boundary.schema.json',
    'lab/11_strategy_factory/test_vectors/v3/uce_i10_deep_view_conformance_vectors.json',
    ...
    'tools/strategy_factory/apply_uce_i10_patch.ps1',
    'tools/strategy_factory/build_uce_i10_release.py',
    ...
    'lab/11_strategy_factory/implementation_program/universal_context_exploitation_engine/v3_implementation/artifacts/UCE_I10_ARTIFACT_INVENTORY.csv',
]
...
package = root / 'lab/11_strategy_factory/python/strategy_factory_deep_views_v3'
expected_modules = {
...
phase_tests = list((root / 'lab/11_strategy_factory/tests/phase_uce_i10_deep_views').glob('test_*.py'))
...
catalog_path = root / 'lab/11_strategy_factory/python/strategy_factory_deep_views_v3/catalog.py'
...
inventory = root / 'lab/11_strategy_factory/implementation_program/universal_context_exploitation_engine/v3_implementation/artifacts/UCE_I10_ARTIFACT_INVENTORY.csv'
if inventory.exists():
    try:
