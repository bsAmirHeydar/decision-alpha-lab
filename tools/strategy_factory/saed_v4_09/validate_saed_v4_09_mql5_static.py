...
ROOT=Path(__file__).resolve().parents[3];files=list((ROOT/'mql5/Include/AlphaLab/StrategyFactory/SAEDV4ExecutionTwin').glob('*.mqh'))+list((ROOT/'mql5/Experts/AlphaLab/StrategyFactory/Diagnostics').glob('EXP_SAED_V4_09_*.mq5'))
errors=[]
for p in files:
