...
import hashlib,json
ROOT=Path(__file__).resolve().parents[3];index=[x.strip() for x in (ROOT/'releases/history/saed/indexes/SAED_V4_09_FILE_INDEX.txt').read_text().splitlines() if x.strip()]
