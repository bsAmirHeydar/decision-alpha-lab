...
commands=[[sys.executable,'tools/strategy_factory/saed_v4_20/validate_saed_v4_20_contracts.py'],[sys.executable,'tools/strategy_factory/saed_v4_20/check_saed_v4_20_boundaries.py'],[sys.executable,'tools/strategy_factory/saed_v4_20/validate_saed_v4_20_mql5_static.py'],[sys.executable,'tools/strategy_factory/saed_v4_20/validate_saed_v4_20_obsidian.py'],[sys.executable,'tools/strategy_factory/saed_v4_20/run_saed_v4_20_tests.py'],[sys.executable,'tools/strategy_factory/saed_v4_20/reproduce_saed_v4_20_golden.py'],[sys.executable,'tools/strategy_factory/saed_v4_20/validate_saed_v4_20_status.py']]
results=[]
