...
```powershell
pip install -r .\tools\cme_bridge\requirements.txt
```
...
python .\tools\cme_bridge\dal_cme_live_prices.py databento_historical `
  --start 2026-01-01 `
  --end 2026-06-26
```
...
python tools/cme_bridge/dal_cme_live_prices.py databento_historical \
  --start 2026-01-01 \
  --end 2026-06-26
```
...
```text
lab/03_experiments/EXP0015_intermarket_time_divergence/out/imd001_divergence_events.csv
lab/03_experiments/EXP0015_intermarket_time_divergence/out/imd001_summary.csv
lab/03_experiments/EXP0015_intermarket_time_divergence/out/imd001_summary.json
```
...
```powershell
python .\tools\cme_bridge\dal_cme_bridge.py `
  --config .\tools\cme_bridge\dal_cme_config.example.json `
  --mode copy_once
```
...
python .\tools\cme_bridge\dal_cme_live_prices.py databento_live
```
...
```powershell
python .\tools\cme_bridge\dal_cme_historical_poller.py `
  --config .\tools\cme_bridge\configs\databento_es_nq.example.json `
  --interval-seconds 300 `
  --overlap-minutes 10 `
  --bootstrap-minutes 180 `
  --end-delay-seconds 90
...
```powershell
python .\tools\cme_bridge\dal_cme_live_prices.py yahoo_delayed
```
...
```text
tools/cme_bridge/dal_cme_config.example.json
```
