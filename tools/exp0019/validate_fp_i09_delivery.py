...
ph=root/'lab/10_infrastructure/EXP0019_faerie_protocol/phase_i09'
checks={
 ...
 'entrypoints':(root/'mql5/Experts/EXP0019/FaerieProtocol/EXP0019_FP_I09_LedgerDiagnostic.mq5').exists() and (root/'mql5/Experts/EXP0019/FaerieProtocolTests/EXP0019_FP_I09_LedgerSelfTest.mq5').exists(),
