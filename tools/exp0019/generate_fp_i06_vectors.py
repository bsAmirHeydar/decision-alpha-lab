...
def main() -> int:
    ...
    for rel in (
        ...
        'lab/10_infrastructure/EXP0019_faerie_protocol/phase_i05/python',
        'lab/10_infrastructure/EXP0019_faerie_protocol/phase_i06/python',
    ):
        sys.path.insert(0, str(root / rel))
    from fp_i06_relations.conformance import run_conformance

    report = run_conformance()
    target = root / 'lab/10_infrastructure/EXP0019_faerie_protocol/phase_i06/artifacts/FP_I06_GOLDEN_RELATION_VECTORS.v1.json'
    if args.verify_only:
