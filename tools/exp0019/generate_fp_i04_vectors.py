...
for rel in ('lab/10_infrastructure/EXP0019_faerie_protocol/phase_i02/python','lab/10_infrastructure/EXP0019_faerie_protocol/phase_i03/python','lab/10_infrastructure/EXP0019_faerie_protocol/phase_i04/python'):sys.path.insert(0,str(root/rel))
...
base=root/'lab/10_infrastructure/EXP0019_faerie_protocol/phase_i04/artifacts';errors=[]
