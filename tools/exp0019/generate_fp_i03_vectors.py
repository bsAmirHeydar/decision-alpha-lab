...
root=Path(args.root).resolve();sys.path[:0]=[str(root/'lab/10_infrastructure/EXP0019_faerie_protocol/phase_i02/python'),str(root/'lab/10_infrastructure/EXP0019_faerie_protocol/phase_i03/python')]
from fp_i02_kernel.canonical import canonical_value
from fp_i03_time.golden import golden_vector_material
path=root/'lab/10_infrastructure/EXP0019_faerie_protocol/phase_i03/artifacts/FP_I03_GOLDEN_TIME_VECTORS.v1.json'
