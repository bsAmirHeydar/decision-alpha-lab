...
```text
src/engine/legacy/research/astro_ml/fetch_mt5_rates.py
src/engine/legacy/research/astro_ml/resolve_astro_feature_store.py
src/engine/legacy/research/astro_ml/build_astro_ml_dataset.py
src/engine/legacy/research/astro_ml/astro_ml_audit_dataset.py
src/engine/legacy/research/astro_ml/train_astro_meta_learner.py
src/engine/legacy/research/astro_ml/evaluate_walk_forward.py
src/engine/legacy/research/astro_ml/explain_astro_model.py
src/engine/legacy/research/astro_ml/build_cognitive_astro_memory.py
src/engine/legacy/research/astro_ml/build_antifragile_astro_learning.py
src/engine/legacy/research/astro_ml/run_astro_human_learning_protocol.py
```

Windows wrappers:

```text
src/engine/legacy/research/astro_ml/*_common.ps1
```
