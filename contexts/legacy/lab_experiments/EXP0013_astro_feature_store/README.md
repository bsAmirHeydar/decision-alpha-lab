...
```text
src/engine/legacy/research/astro_feature_builder/astro_feature_builder.py
adapters/legacy/market_data/astro_live_bridge/astro_live_bridge.py
...
```powershell
python -m pip install -r src/engine/legacy/research/astro_feature_builder/requirements.txt

python src/engine/legacy/research/astro_feature_builder/astro_feature_builder.py `
  ...
  --ephe-path "src/engine/legacy/research/astro_feature_builder/ephe" `
...
- research-side paper replay through `tests/legacy/astro_validation/astro_paper_family_runner.py`
- offline validation through `tests/legacy/astro_validation/astro_signal_validator.py`
- batch family suite validation through `tests/legacy/astro_validation/astro_family_validation_suite.py`
- offline entry / exit workbook generation through `tests/legacy/astro_validation/astro_family_entry_exit_excel_suite.py`
- offline final-entry consensus generation through `tests/legacy/astro_validation/astro_final_entry_report.py`
...
You can already inspect family entry and exit windows without Strategy Tester by exporting a workbook from the raw astro CSV through `tests/legacy/astro_validation/astro_family_entry_exit_excel_suite.py`.

You can also generate a final astro-only consensus entry report from the same raw CSV through `tests/legacy/astro_validation/astro_final_entry_report.py`.
