...
Example:
    python contexts/legacy/lab_experiments/EXP0015_intermarket_time_divergence/experiment.py \
      ...
      --output-dir contexts/legacy/lab_experiments/EXP0015_intermarket_time_divergence/out
"""
...
def parse_args() -> argparse.Namespace:
    ...
    p.add_argument("--output-dir", default="contexts/legacy/lab_experiments/EXP0015_intermarket_time_divergence/out")
