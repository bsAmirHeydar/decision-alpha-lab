...
REQUIRED_FILES = (
    ...
    "contexts/legacy/tools/flag_counting/nds_hook_864_cycle_r1_reference.py",
    "contexts/legacy/tools/flag_counting/analyze_nds_hook_864_tester_log.py",
    "tests/flag_counting/test_nds_hook_864_cycle_r1_reference.py",
    "tests/flag_counting/test_nds_hook_864_tester_log_analyzer.py",
    "contexts/legacy/lab_experiments/EXP_flag_counting/hook_864_cycle_r1/test_vectors.json",
    "contexts/legacy/lab_experiments/EXP_flag_counting/hook_864_cycle_r1/profile_contract.json",
    "contexts/legacy/lab_experiments/EXP_flag_counting/hook_864_cycle_r1/acceptance_matrix.json",
    "contexts/legacy/tools/flag_counting/compile_nds_hook_864_cycle_r1.ps1",
    "docs/contexts/legacy/nds/entry/phase55_hook_864_cycle_r1_execution/README.md",
    "docs/contexts/legacy/nds/hook/73_phase55_hook_864_cycle_r1_execution.md",
    "docs/history/obsidian/hook/03_architecture/Phase 55 NDS Hook 86.4 Cycle R1 Execution.md",
    "docs/history/obsidian/hook/08_entry_execution/NDS Hook 86.4 Cycle R1 Entry Contract.md",
    "docs/history/obsidian/hook/08_entry_execution/NDS Hook 86.4 Cycle R1 State Machine.md",
    "docs/history/obsidian/hook/08_entry_execution/NDS Hook 86.4 Cycle R1 Audit Ledger.md",
    "docs/history/obsidian/hook/08_entry_execution/NDS Hook 86.4 Cycle R1 Operator Checklist.md",
    "docs/contexts/legacy/nds/entry/phase55_hook_864_cycle_r1_execution/17_no_trade_root_cause_and_engine_fix.md",
    "docs/contexts/legacy/nds/entry/phase55_hook_864_cycle_r1_execution/18_phase04_closure_and_first_arrival_contract.md",
    "docs/history/obsidian/hook/08_entry_execution/NDS Hook 86.4 No Trade Diagnostic Funnel.md",
    "tests/flag_counting/test_nds_hook_864_exact_acceleration.py",
    "contexts/legacy/tools/flag_counting/compare_nds_hook_864_acceleration_logs.py",
    "tests/flag_counting/test_nds_hook_864_acceleration_log_compare.py",
    "docs/contexts/legacy/nds/entry/phase55_hook_864_cycle_r1_execution/20_exact_acceleration_and_maximum_speed_contract.md",
    "docs/history/obsidian/hook/08_entry_execution/NDS Hook 86.4 Exact Acceleration.md",
)
...
def run(root: Path) -> list[Check]:
    ...
    reference = "contexts/legacy/tools/flag_counting/nds_hook_864_cycle_r1_reference.py"
    ...
    contains(checks, root, "contexts/legacy/tools/flag_counting/compile_nds_hook_864_cycle_r1.ps1",
