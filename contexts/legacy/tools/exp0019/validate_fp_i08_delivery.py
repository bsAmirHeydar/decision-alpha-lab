...
docrel = 'docs/operations/execution/EXP0019_faerie_protocol_contextual_divergence/implementation_program/phase_deliveries/fp_i08'
required = [
    ...
    'contexts/legacy/tools/exp0019/check_fp_i08_boundaries.py',
    'contexts/legacy/tools/exp0019/check_fp_i08_mql5_static.py',
    'contexts/legacy/tools/exp0019/validate_fp_i08_delivery.py',
    'contexts/legacy/tools/exp0019/build_fp_i08_release.py',
]
for rel in required:
...
concepts = list((root / 'docs/history/obsidian/deep/01_concepts').glob('FP-I08_*.md'))
