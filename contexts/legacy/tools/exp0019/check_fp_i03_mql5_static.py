...
entries=[root/'mql5/Tests/Experts/FaerieProtocol/EXP0019_FP_I03_TimeCalendarSelfTest.mq5',root/'mql5/Experts/FaerieProtocol/EXP0019_FP_I03_TimeCalendarDiagnostic.mq5']
for path in entries:
