...
Write-Host "Compile PASS. Run the FP-I14 self-test and Diagnostic EA on the same pair/config as the Indicator. Export both traces and compare them with contexts/legacy/tools/exp0019/compare_fp_i14_traces.py."
