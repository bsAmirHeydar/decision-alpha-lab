...
'contexts/legacy/infrastructure/exp0019_faerie_protocol/phase_i01/config/FP_I01_COMPATIBILITY_POLICY.v1.json',
'contexts/legacy/infrastructure/exp0019_faerie_protocol/phase_i01/artifacts/FP_I01_ADAPTER_REGISTRY.v1.json',
'contexts/legacy/infrastructure/exp0019_faerie_protocol/phase_i01/artifacts/FP_I01_GOLDEN_ADAPTER_FIXTURES.v1.json',
'contexts/legacy/infrastructure/exp0019_faerie_protocol/phase_i01/artifacts/FP_I01_COMPATIBILITY_REPORT.json',
'contexts/legacy/infrastructure/exp0019_faerie_protocol/phase_i01/artifacts/FP_I01_PHASE_STATUS.json',
'contexts/legacy/infrastructure/exp0019_faerie_protocol/phase_i01/artifacts/FP_I01_HANDOFF_TO_FP_I02.json',
...
base=root/'contexts/legacy/infrastructure/exp0019_faerie_protocol/phase_i01/python/fp_i01_compatibility'
...
for name in ['FP_I01_ADAPTER_REGISTRY.v1.json','FP_I01_GOLDEN_ADAPTER_FIXTURES.v1.json','FP_I01_COMPATIBILITY_REPORT.json','FP_I01_PHASE_STATUS.json','FP_I01_HANDOFF_TO_FP_I02.json']:
 p=root/'contexts/legacy/infrastructure/exp0019_faerie_protocol/phase_i01/artifacts'/name
 if p.exists():
  try:json.loads(p.read_text())
  except Exception as e:errors.append(f'invalid json {name}: {e}')
report=root/'contexts/legacy/infrastructure/exp0019_faerie_protocol/phase_i01/artifacts/FP_I01_COMPATIBILITY_REPORT.json'
if report.exists():
...
status=root/'contexts/legacy/infrastructure/exp0019_faerie_protocol/phase_i01/artifacts/FP_I01_PHASE_STATUS.json'
if status.exists():
...
for p in (root/'contexts/legacy/infrastructure/exp0019_faerie_protocol/phase_i01').rglob('__pycache__'):errors.append('cache in release '+str(p.relative_to(root)))
