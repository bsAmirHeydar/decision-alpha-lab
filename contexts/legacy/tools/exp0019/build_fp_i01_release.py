...
def owned(root):
 ...
 for rel in [
 'mql5/Tests/Experts/FaerieProtocol/EXP0019_FP_I01_CompatibilitySelfTest.mq5','mql5/Experts/FaerieProtocol/EXP0019_FP_I01_CompatibilityDiagnostic.mq5',
...
def main():
 ...
 inv=root/'contexts/legacy/infrastructure/exp0019_faerie_protocol/phase_i01/artifacts/FP_I01_ARTIFACT_INVENTORY.csv'
 rows=[]
 for p in owned(root):
