...
python "$root\contexts\legacy\infrastructure\exp0018_daye_trader\tools\validate_exp0018_phase10_unified_visual_v2.py" "$root"
python -m pytest "$root\contexts\legacy\infrastructure\exp0018_daye_trader\tests\test_exp0018_phase10_unified_visual_v2.py" -q
