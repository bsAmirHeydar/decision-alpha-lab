...
& $Python.Source "$RepoRoot/contexts/legacy/infrastructure/exp0018_daye_trader/tools/validate_exp0018_phase08_divergence_drawing_v2.py" "$RepoRoot"
& $Python.Source -m pytest "$RepoRoot/contexts/legacy/infrastructure/exp0018_daye_trader/tests/test_exp0018_phase08_divergence_drawing_v2.py" -q
