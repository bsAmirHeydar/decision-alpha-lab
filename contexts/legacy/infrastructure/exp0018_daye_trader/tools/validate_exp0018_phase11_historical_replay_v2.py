...
'contexts/legacy/infrastructure/exp0018_daye_trader/contracts/daye_historical_replay_contract_v2.json']
for x in required:
...
with (root/'contexts/legacy/infrastructure/exp0018_daye_trader/fixtures/daye_historical_replay_cases_v2.csv').open() as f:
