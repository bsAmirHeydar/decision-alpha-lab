...
errors=[]
contract_path=root/'contexts/legacy/infrastructure/exp0018_daye_trader/contracts/daye_divergence_drawing_contract_v2.json'
fixture_path=root/'contexts/legacy/infrastructure/exp0018_daye_trader/fixtures/daye_divergence_drawing_cases_v2.csv'
