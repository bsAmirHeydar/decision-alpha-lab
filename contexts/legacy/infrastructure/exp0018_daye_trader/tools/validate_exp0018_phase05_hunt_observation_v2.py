...
contract_path = root/'contexts/legacy/infrastructure/exp0018_daye_trader/contracts/daye_hunt_observation_contract_v2.json'
fixture_path = root/'contexts/legacy/infrastructure/exp0018_daye_trader/fixtures/daye_hunt_observation_cases_v2.csv'
