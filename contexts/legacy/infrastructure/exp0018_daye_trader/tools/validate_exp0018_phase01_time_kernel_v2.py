...
def validate(repo_root: Path) -> list[str]:
    errors: list[str] = []
    contract_path = repo_root / "contexts/legacy/infrastructure/exp0018_daye_trader/contracts/daye_time_contract_v2.json"
    fixtures_path = repo_root / "contexts/legacy/infrastructure/exp0018_daye_trader/fixtures/daye_time_golden_cases_v2.csv"
