...
CONTRACT=ROOT/'contexts/legacy/infrastructure/exp0018_daye_trader/contracts/daye_reference_lifecycle_contract_v2.json'
FIXTURES=ROOT/'contexts/legacy/infrastructure/exp0018_daye_trader/fixtures/daye_reference_lifecycle_cases_v2.csv'
