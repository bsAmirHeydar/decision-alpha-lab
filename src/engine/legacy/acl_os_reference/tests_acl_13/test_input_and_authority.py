import copy,pytest
from tools.strategy_factory.acl_os.acl_13.handoff_input import load_acl12_bundle
from tools.strategy_factory.acl_os.acl_13.authority import validate_permit
from tools.strategy_factory.acl_os.acl_13.input_contract import validate_request
from tools.strategy_factory.acl_os.acl_13.errors import AuthorityError,ContractError
...
def test_known_time_violation_denied(assessment_request):
    ...
    from tools.strategy_factory.acl_os.acl_13.canonical import with_digest
