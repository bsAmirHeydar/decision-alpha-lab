from src.engine.tooling.strategy_factory.acl_os.acl_13.static_validation import validate_registry
from src.engine.tooling.strategy_factory.acl_os.acl_13.delivery_validation import validate_delivery
...
def test_acl14_dependency_doc(root): assert (root/'docs/architecture/master/context_lifecycle_os/11_IMPLEMENTATION_PROGRAM/ACL_14_FIRST_REAL_CONTEXT_PILOT.md').is_file()
