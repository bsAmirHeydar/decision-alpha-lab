...
@pytest.fixture(scope="session")
def acl04_root(): return ROOT/"src/engine/legacy/acl_os_reference/fixtures/acl_04/reference_factory"
@pytest.fixture(scope="session")
def fixture_root(): return ROOT/"src/engine/legacy/acl_os_reference/fixtures/acl_05"
@pytest.fixture(scope="session")
