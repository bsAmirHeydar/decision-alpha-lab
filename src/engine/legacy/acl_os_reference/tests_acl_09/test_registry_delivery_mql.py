from src.engine.tooling.strategy_factory.acl_os.acl_09.delivery_validator import validate_delivery
from src.engine.tooling.strategy_factory.acl_os.acl_09.static_validator import validate_registry_files
...
def test_mql_guards_present(repo_root):
    root=repo_root/'mql5/legacy/strategy_factory_lab/Include/AlphaLab/ACL_OS/ACL09'
