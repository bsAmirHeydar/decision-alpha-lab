...
def register_two(registry,descriptor,permit_factory):
    ...
    d2=replace(descriptor,identity=replace(descriptor.identity,artifact_id=descriptor.identity.artifact_id.replace("@1.0.0","-copy@1.0.0"),name="ctx-test-copy",digest="sha256:"+"2"*64),canonical_path="contexts/legacy/strategy_factory/authored/ctx-test-copy/doctrine/context.md")
