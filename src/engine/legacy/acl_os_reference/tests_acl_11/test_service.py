from src.engine.tooling.strategy_factory.acl_os.acl_11.service import ACL11RuntimeCustodyService
from src.engine.tooling.strategy_factory.acl_os.acl_11.verify import verify_output
...
def test_atomic_destination_guard(tmp_path,acl10,permit):
    from src.engine.tooling.strategy_factory.acl_os.acl_11.errors import PublicationError
