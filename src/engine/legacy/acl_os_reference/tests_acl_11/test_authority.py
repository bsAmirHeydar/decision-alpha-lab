...
from src.engine.tooling.strategy_factory.acl_os.acl_11.authority import validate_permit
from src.engine.tooling.strategy_factory.acl_os.acl_11.errors import AuthorityError
...
def test_capability_escalation_fails(acl10,permit,field):
    from src.engine.tooling.strategy_factory.acl_os.acl_11.canonical import with_digest
