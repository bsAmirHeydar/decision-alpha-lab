...
from src.engine.tooling.strategy_factory.acl_os.acl_15.errors import AuthorityError,IntegrityError
...
def test_permit_capability_escalation_denied(acl14_root,permit):
    from src.engine.tooling.strategy_factory.acl_os.acl_15.canonical import with_digest
