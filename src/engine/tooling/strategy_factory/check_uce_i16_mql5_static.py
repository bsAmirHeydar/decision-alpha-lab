...
ROOT=find_repository_root(__file__);INC=ROOT/'mql5/Include/AlphaLab/StrategyFactory/ContextOnboarding'
FILES=sorted(INC.glob('UCEI16_*.mqh'))+[ROOT/'mql5/Experts/StrategyFactory/UCE_I16_ContextOnboardingDiagnostic.mq5',ROOT/'mql5/Tests/Experts/StrategyFactory/UCE_I16_ScaffoldIdentitySelfTest.mq5',ROOT/'mql5/Tests/Experts/StrategyFactory/UCE_I16_LegacyParitySelfTest.mq5',ROOT/'mql5/Tests/Experts/StrategyFactory/UCE_I16_CoreInvarianceSelfTest.mq5'];errors=[]
