...
m=json.loads(manifest_path.read_text(encoding='utf-8'));q=json.loads(qa_path.read_text(encoding='utf-8'));s=json.loads((ROOT/'releases/history/strategy_factory/program/status/SAED_V4_23.json').read_text(encoding='utf-8'))
...
A=ROOT/'releases/history/strategy_factory/artifacts/saed_v4_23'
