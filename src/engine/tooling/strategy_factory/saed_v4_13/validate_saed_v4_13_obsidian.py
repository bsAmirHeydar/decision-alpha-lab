...
import re
ROOT=find_repository_root(__file__);docs=list((ROOT/'docs/history/systems/saed_v4/62_PHASE_DELIVERIES_V4/V4_13').glob('*.md'))+list((ROOT/'docs/history/systems/saed_v4/63_ATOMIC_CONCEPTS_V4/V4_13').glob('*.md'))+[ROOT/'docs/history/systems/saed_v4/60_IMPLEMENTATION_PROGRAM_V4/V4_13_Graph_And_Hypergraph_Models.md'];names={p.stem for p in (ROOT/'docs/history/systems/saed_v4').rglob('*.md')}
broken=[]
for p in docs:
