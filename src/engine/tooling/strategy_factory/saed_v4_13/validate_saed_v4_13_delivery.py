...
import hashlib,json
ROOT=find_repository_root(__file__);index=ROOT/'releases/history/saed/indexes/SAED_V4_13_FILE_INDEX.txt';ledger=ROOT/'releases/history/saed/hashes/SAED_V4_13_FILE_HASHES.sha256';manifest_path=ROOT/'releases/history/saed/manifests/SAED_V4_13_PATCH_MANIFEST.json'
...
s=json.loads((ROOT/'releases/history/strategy_factory/program/status/SAED_V4_13.json').read_text());assert s['claims']['graph_hypergraph_reference_implemented'] and not s['claims']['production_authorization']
