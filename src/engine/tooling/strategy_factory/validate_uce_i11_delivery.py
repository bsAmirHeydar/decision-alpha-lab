...
required = [
    ...
    "src/engine/tooling/strategy_factory/check_uce_i11_boundaries.py",
    "src/engine/tooling/strategy_factory/check_uce_i11_mql5_static.py",
    "src/engine/tooling/strategy_factory/compile_uce_i11_experiment_orchestration.ps1",
    "src/engine/tooling/strategy_factory/generate_uce_i11_vectors.py",
    "src/engine/tooling/strategy_factory/run_uce_i11_tests.ps1",
    "src/engine/tooling/strategy_factory/validate_uce_i11_delivery.py",
...
json_paths.extend(f"examples/legacy/strategy_factory/uce_i11/{name}" for name in (
