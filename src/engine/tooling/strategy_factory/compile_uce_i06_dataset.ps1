...
$targets=@("mql5\Experts\StrategyFactory\UCE_I06_OutcomeDatasetDiagnostic.mq5","mql5\Tests\Experts\StrategyFactory\UCE_I06_OutcomeDatasetSelfTest.mq5","mql5\Tests\Experts\StrategyFactory\UCE_I06_LongShortCounterfactualSelfTest.mq5")
