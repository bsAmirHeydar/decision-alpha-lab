...
def main():
 ...
 files=list(owned.glob('*.mqh'))+[root/'mql5/Experts/StrategyFactory/UCE_I04_TreatmentCompilerDiagnostic.mq5',root/'mql5/Tests/Experts/StrategyFactory/UCE_I04_TreatmentCompilerSelfTest.mq5']
