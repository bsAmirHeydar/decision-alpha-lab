...
OWNED=(Path('mql5/Include/AlphaLab/StrategyFactory/TreatmentAtoms'),Path('mql5/Experts/StrategyFactory/UCE_I03_TreatmentAtomsDiagnostic.mq5'),Path('mql5/Tests/Experts/StrategyFactory/UCE_I03_TreatmentAtomsSelfTest.mq5'),Path('src/engine/packages/strategy_factory_treatments_v3'))
def main():
