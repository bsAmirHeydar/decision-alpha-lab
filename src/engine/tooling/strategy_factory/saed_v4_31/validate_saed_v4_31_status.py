...
status=json.loads((ROOT/"releases/history/strategy_factory/program/status/SAED_V4_31.json").read_text()); qa=json.loads((ROOT/"releases/history/saed/reports/SAED_V4_31_QA_REPORT.json").read_text())
