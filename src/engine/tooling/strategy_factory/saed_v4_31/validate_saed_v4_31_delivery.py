...
status=json.loads((ROOT/"releases/history/strategy_factory/program/status/SAED_V4_31.json").read_text()); qa=json.loads((ROOT/"releases/history/saed/reports/SAED_V4_31_QA_REPORT.json").read_text()); assert status["qa_passed"] and qa["passed"]
cert=json.loads((ROOT/"releases/history/strategy_factory/artifacts/saed_v4_31/GOLDEN_FORMAL_VERIFICATION_SAFETY_CASE_CERTIFICATE.JSON").read_text()); handoff=json.loads((ROOT/"releases/history/strategy_factory/artifacts/saed_v4_31/V4_31_TO_V4_32_HANDOFF.JSON").read_text())
