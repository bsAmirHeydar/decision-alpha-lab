...
index=ROOT/'releases/history/saed/indexes/SAED_V4_16_FILE_INDEX.txt';ledger=ROOT/'releases/history/saed/hashes/SAED_V4_16_FILE_HASHES.sha256';manifest_path=ROOT/'releases/history/saed/manifests/SAED_V4_16_PATCH_MANIFEST.json';qa_path=ROOT/'releases/history/saed/reports/SAED_V4_16_QA_REPORT.json'
...
assert set(expected)==set(paths)-{'releases/history/saed/hashes/SAED_V4_16_FILE_HASHES.sha256'}
...
s=json.loads((ROOT/'releases/history/strategy_factory/program/status/SAED_V4_16.json').read_text(encoding='utf-8'))
