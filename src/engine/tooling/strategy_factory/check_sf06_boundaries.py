...
files=list((root/'mql5/Include/AlphaLab/StrategyFactory/Anatomy').rglob('*.mqh'))+list((root/'mql5/Experts/StrategyFactory').glob('SF06_*.mq5'))+list((root/'mql5/Tests/Experts/StrategyFactory').glob('SF06_*.mq5'))
