...
excluded={"releases/history/saed/hashes/SAED_V4_34_FILE_HASHES.sha256","releases/history/saed/manifests/SAED_V4_34_PATCH_MANIFEST.json","releases/history/saed/reports/SAED_V4_34_QA_REPORT.json","releases/history/strategy_factory/program/status/SAED_V4_34.json"}
for p in paths:
