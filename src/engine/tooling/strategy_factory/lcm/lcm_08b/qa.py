...
def run(repo_root:Path,pilot_root:Path):
    ...
    module_root=repo_root/'src/engine/tooling/strategy_factory/lcm/lcm_08b'
    ...
    phase_doc=repo_root/'docs/architecture/master/context_lifecycle_os/17_LEGACY_MIGRATION_PROGRAM/05_PHASES/LCM_08B_PILOT_CONTEXT_MIGRATION_COMPATIBILITY_ADAPTER_AND_BEHAVIORAL_PARITY.md'
