...
def run(repo_root: Path, inventory_root: Path) -> dict:
    ...
    schemas=validate_schema_directory(repo_root/'registry/history/lcm/lcm_10a/schemas/v1')
    static=scan_module(repo_root/'src/engine/tooling/strategy_factory/lcm/lcm_10a')
