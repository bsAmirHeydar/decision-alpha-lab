...
$targets = @("mql5\Tests\Experts\StrategyFactory\SF13_TrainingContractsSelfTest.mq5","mql5\Experts\StrategyFactory\SF13_TrainingDiagnostic.mq5","mql5\Experts\StrategyFactory\SF13_DatasetExportResearchHost.mq5")
