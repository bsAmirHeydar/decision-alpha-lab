...
index=ROOT/'releases/history/saed/indexes/SAED_V4_19_FILE_INDEX.txt';ledger=ROOT/'releases/history/saed/hashes/SAED_V4_19_FILE_HASHES.sha256';manifest_path=ROOT/'releases/history/saed/manifests/SAED_V4_19_PATCH_MANIFEST.json';qa_path=ROOT/'releases/history/saed/reports/SAED_V4_19_QA_REPORT.json'
...
assert set(expected)==set(paths)-{'releases/history/saed/hashes/SAED_V4_19_FILE_HASHES.sha256'}
...
s=json.loads((ROOT/'releases/history/strategy_factory/program/status/SAED_V4_19.json').read_text(encoding='utf-8'))
...
h=json.loads((ROOT/'releases/history/strategy_factory/artifacts/saed_v4_19/V4_19_TO_V4_20_HANDOFF.JSON').read_text(encoding='utf-8'))
...
p=json.loads((ROOT/'releases/history/strategy_factory/artifacts/saed_v4_19/GOLDEN_PROOF_ENVELOPE.JSON').read_text(encoding='utf-8'))
