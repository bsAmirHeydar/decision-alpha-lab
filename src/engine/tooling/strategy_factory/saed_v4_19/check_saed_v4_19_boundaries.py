...
bases=[ROOT/'src/engine/packages/saed_v4_neurosymbolic_setup_reasoning',ROOT/'mql5/Include/DecisionAlphaLab/StrategyFactory/SAED/V4_19',ROOT/'mql5/Experts/DecisionAlphaLab/StrategyFactory/SAED/V4_19']
