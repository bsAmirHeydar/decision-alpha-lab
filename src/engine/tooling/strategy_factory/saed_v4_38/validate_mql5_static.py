...
ROOT=find_repository_root(__file__);roots=[ROOT/'mql5/Include/StrategyFactory/SAED/V4_38',ROOT/'mql5/Experts/StrategyFactory/SAED/V4_38'];files=[p for r in roots for p in r.rglob('*') if p.suffix.lower() in {'.mqh','.mq5'}]
