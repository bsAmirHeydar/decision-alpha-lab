...
ROOT=find_repository_root(__file__);phase=ROOT/'docs/history/systems/saed_v4/62_PHASE_DELIVERIES_V4/V4_38';atomic=ROOT/'docs/history/systems/saed_v4/63_ATOMIC_CONCEPTS_V4/V4_38';pd=list(phase.glob('*.md'));ad=list(atomic.glob('*.md'))
