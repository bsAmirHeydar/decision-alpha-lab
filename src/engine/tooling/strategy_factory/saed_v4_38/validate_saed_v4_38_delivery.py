...
ROOT=find_repository_root(__file__);idx=ROOT/'releases/history/saed/indexes/SAED_V4_38_FILE_INDEX.txt';hashes=ROOT/'releases/history/saed/hashes/SAED_V4_38_FILE_HASHES.sha256';manifest=ROOT/'releases/history/saed/manifests/SAED_V4_38_PATCH_MANIFEST.json'
