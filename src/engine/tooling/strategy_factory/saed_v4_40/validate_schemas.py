...
ROOT=find_repository_root(__file__);ex=ROOT/'examples/legacy/strategy_factory/saed_v4_40';sch=ROOT/'schemas/legacy/strategy_factory/saed_v4_40';ps=sorted(ex.glob('*.example.json'));assert len(ps)>=50
for p in ps:
