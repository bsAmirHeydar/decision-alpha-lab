...
index=ROOT/'releases/history/saed/indexes/SAED_V4_20_FILE_INDEX.txt';ledger=ROOT/'releases/history/saed/hashes/SAED_V4_20_FILE_HASHES.sha256';manifest_path=ROOT/'releases/history/saed/manifests/SAED_V4_20_PATCH_MANIFEST.json';qa_path=ROOT/'releases/history/saed/reports/SAED_V4_20_QA_REPORT.json'
...
assert set(expected)==set(paths)-{'releases/history/saed/hashes/SAED_V4_20_FILE_HASHES.sha256'}
...
h=json.loads((ROOT/'releases/history/strategy_factory/artifacts/saed_v4_20/V4_20_TO_V4_21_HANDOFF.JSON').read_text(encoding='utf-8'))
assert h['next_phase']=='SAED_V4_21' and all(h['entry_gates'].values()) and h['research_only'] and not any(h['authority'].values())
c=json.loads((ROOT/'releases/history/strategy_factory/artifacts/saed_v4_20/GOLDEN_SELECTION_CERTIFICATE.JSON').read_text(encoding='utf-8'))
