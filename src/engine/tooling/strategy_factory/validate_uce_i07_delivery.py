...
required=[
 ...
 'mql5/Tests/Experts/StrategyFactory/UCE_I07_TrainerSDKSelfTest.mq5',
 'src/engine/packages/strategy_factory_trainers_v3/orchestrator.py',
 'src/engine/packages/strategy_factory_trainers_v3/conformance.py',
 'schemas/legacy/strategy_factory/v3/trainer_capability_descriptor.schema.json',
