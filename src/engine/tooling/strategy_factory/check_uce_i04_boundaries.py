...
OWNED=(Path('mql5/Include/AlphaLab/StrategyFactory/TreatmentCompiler'),Path('mql5/Experts/StrategyFactory/UCE_I04_TreatmentCompilerDiagnostic.mq5'),Path('mql5/Tests/Experts/StrategyFactory/UCE_I04_TreatmentCompilerSelfTest.mq5'),Path('src/engine/packages/strategy_factory_treatment_compiler_v3'))
def main():
