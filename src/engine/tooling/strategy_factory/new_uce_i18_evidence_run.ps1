...
Copy-Item -LiteralPath (Join-Path $Root 'releases/history/strategy_factory/program/implementation/universal_context_exploitation_engine/v3_implementation/artifacts/uce_i18/external_evidence_template.json') -Destination (Join-Path $RunRoot 'external_evidence_template.json')
$Claims = [ordered]@{
