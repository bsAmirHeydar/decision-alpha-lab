...
$Targets=@(
 ...
 "mql5\Tests\Experts\StrategyFactory\UCE_I16_ScaffoldIdentitySelfTest.mq5",
 "mql5\Tests\Experts\StrategyFactory\UCE_I16_LegacyParitySelfTest.mq5",
 "mql5\Tests\Experts\StrategyFactory\UCE_I16_CoreInvarianceSelfTest.mq5")
