...
ROOT=find_repository_root(__file__); targets=[ROOT/"src/engine/packages/saed_v4_hidden_evaluation_air_gap",ROOT/"src/engine/tooling/strategy_factory/saed_v4_29",ROOT/"mql5/Include/DecisionAlphaLab/StrategyFactory/SAED/V4_29"]
