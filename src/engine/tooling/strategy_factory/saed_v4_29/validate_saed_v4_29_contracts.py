...
EX=ROOT/"examples/legacy/strategy_factory/saed_v4_29"; AR=ROOT/"releases/history/strategy_factory/artifacts/saed_v4_29"; SC=ROOT/"schemas/legacy/strategy_factory/saed_v4_29"
...
print(f"V4-29 closed contracts passed: {len(files)} schema pairs")
