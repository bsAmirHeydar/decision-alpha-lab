...
def main()->int:
    ...
    docs=list((root/'docs/history/systems/ucee/implementation_program/phase_deliveries/uce_i12').glob('*.md')); concepts=list((root/'docs/history/obsidian/deep/01_concepts').glob('UCE-I12_*.md'))
