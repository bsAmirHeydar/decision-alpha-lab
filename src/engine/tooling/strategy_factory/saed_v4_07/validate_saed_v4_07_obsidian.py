...
import re
ROOT=find_repository_root(__file__);DOC=ROOT/'docs';P=DOC/'strategy_factory_sovereign_context_intelligence_v4/62_PHASE_DELIVERIES_V4/V4_07';A=DOC/'strategy_factory_sovereign_context_intelligence_v4/63_ATOMIC_CONCEPTS_V4/V4_07';phase=sorted(P.glob('*.md'));atomic=sorted(A.glob('*.md'));files=phase+atomic
