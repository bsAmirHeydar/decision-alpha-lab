...
import hashlib,json
ROOT=find_repository_root(__file__);index=[x.strip() for x in (ROOT/'releases/history/saed/indexes/SAED_V4_07_FILE_INDEX.txt').read_text().splitlines() if x.strip()]
