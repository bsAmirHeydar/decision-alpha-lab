...
FILES=sorted(INC.glob('UCEI13_*.mqh'))+[ROOT/'mql5/Experts/StrategyFactory/UCE_I13_HybridPolicyDiagnostic.mq5',ROOT/'mql5/Tests/Experts/StrategyFactory/UCE_I13_ManualParitySelfTest.mq5',ROOT/'mql5/Tests/Experts/StrategyFactory/UCE_I13_AuthorityFallbackSelfTest.mq5']
errors=[]
