...
ROOT=find_repository_root(__file__);A=ROOT/'releases/history/strategy_factory/artifacts/saed_v4_35';S=ROOT/'schemas/legacy/strategy_factory/saed_v4_35';pairs=0
