...
def main() -> int:
    ...
    for rel in (
        "tests/fixtures/legacy/strategy_factory/v3/uce_i01_cross_language_vectors.json",
        "tests/fixtures/legacy/strategy_factory/v3/uce_i01_negative_vectors.json",
        "releases/history/strategy_factory/program/implementation/universal_context_exploitation_engine/v3_implementation/phase_status/UCE_I01.json",
        "releases/history/strategy_factory/program/implementation/universal_context_exploitation_engine/v3_implementation/phase_status/UCE_I01_HANDOFF_TO_UCE_I02.json",
    ...
    status_path = root / "releases/history/strategy_factory/program/implementation/universal_context_exploitation_engine/v3_implementation/phase_status/UCE_I01.json"
