...
m=load('releases/history/strategy_factory/artifacts/saed_v4_18/CONTRACT_VALIDATION_MAP.JSON')
...
print(f"SAED V4-18 closed contract validation passed: {m['contract_count']} pairs")
