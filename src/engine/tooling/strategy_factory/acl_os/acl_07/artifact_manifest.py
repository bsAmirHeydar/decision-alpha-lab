...
def build_output_manifest(root:Path,validation_id:str)->dict:
    excluded={'output_manifest.json','validation_receipt.json'}; files=[]
    ...
    body={'schema_version':'1.0.0','validation_id':validation_id,'artifact_count':len(files),'files':files,'self_reference_policy':'MANIFEST_AND_RECEIPT_EXCLUDED_AND_MUTUALLY_BOUND'}
