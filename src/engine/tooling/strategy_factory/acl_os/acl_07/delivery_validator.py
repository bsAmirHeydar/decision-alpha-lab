...
def validate_delivery(repo_root:Path)->dict:
    ...
    required=[repo_root/'src/engine/tooling/strategy_factory/acl_os/acl_07',repo_root/'registry/history/acl/acl_07',repo_root/'docs/architecture/master/context_lifecycle_os/12_PHASE_DELIVERIES/ACL_07']
