...
def validate_delivery(repo_root:Path)->dict:
    root=repo_root/'src/engine/legacy/acl_os_reference/fixtures/acl_07/reference_validation'
    a=verify_generated_root(root); b=validate_registry_files()
    required=[repo_root/'src/engine/tooling/strategy_factory/acl_os/acl_07',repo_root/'registry/acl_os/acl_07',repo_root/'docs/alpha_lab_master_architecture/context_lifecycle_os/12_PHASE_DELIVERIES/ACL_07']
