...
root=Path(a.root).resolve();sys.path.insert(0,str(root/'src/engine/packages'))
...
path=root/'tests/fixtures/legacy/strategy_factory/v3/uce_i10_deep_view_conformance_vectors.json'
