...
$files=@('mql5\Experts\StrategyFactory\UCE_I05_EconomicsDiagnostic.mq5','mql5\Tests\Experts\StrategyFactory\UCE_I05_EconomicsSelfTest.mq5','mql5\Tests\Experts\StrategyFactory\UCE_I05_LongShortSymmetrySelfTest.mq5')
