...
status = json.loads((ROOT / "releases/history/strategy_factory/program/status/SAED_V4_26.json").read_text(encoding="utf-8"))
...
A = ROOT / "releases/history/strategy_factory/artifacts/saed_v4_26"
