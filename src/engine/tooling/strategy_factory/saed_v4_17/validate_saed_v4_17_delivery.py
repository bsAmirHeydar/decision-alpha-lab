...
s=json.loads((ROOT/'releases/history/strategy_factory/program/status/SAED_V4_17.json').read_text(encoding='utf-8'))
...
h=json.loads((ROOT/'releases/history/strategy_factory/artifacts/saed_v4_17/V4_17_TO_V4_18_HANDOFF.JSON').read_text(encoding='utf-8'))
