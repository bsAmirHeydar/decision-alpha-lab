...
ROOT=find_repository_root(__file__);base=ROOT/'mql5/Include/DecisionAlphaLab/StrategyFactory/SAED/V4_17';files=list(base.glob('*.mqh'));expert=ROOT/'mql5/Experts/DecisionAlphaLab/StrategyFactory/SAED/V4_17/SAEDV417StaticConformanceExpert.mq5';assert len(files)>=16 and expert.is_file()
