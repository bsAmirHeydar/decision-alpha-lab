...
index=ROOT/'releases/history/saed/indexes/SAED_V4_12_FILE_INDEX.txt';ledger=ROOT/'releases/history/saed/hashes/SAED_V4_12_FILE_HASHES.sha256';manifest_path=ROOT/'releases/history/saed/manifests/SAED_V4_12_PATCH_MANIFEST.json'
...
assert set(expected)==set(paths)-{'releases/history/saed/hashes/SAED_V4_12_FILE_HASHES.sha256'}
...
s=json.loads((ROOT/'releases/history/strategy_factory/program/status/SAED_V4_12.json').read_text());assert s['claims']['deep_sequence_reference_implemented'] and not s['claims']['production_authorization']
