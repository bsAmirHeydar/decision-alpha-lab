...
import re,json
ROOT=find_repository_root(__file__);dirs=[ROOT/'docs/history/systems/saed_v4/62_PHASE_DELIVERIES_V4/V4_22',ROOT/'docs/history/systems/saed_v4/63_ATOMIC_CONCEPTS_V4/V4_22'];files=sorted(p for d in dirs for p in d.glob('*.md'))
