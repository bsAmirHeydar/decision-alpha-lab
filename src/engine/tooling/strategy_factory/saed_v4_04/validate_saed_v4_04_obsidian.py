...
import re,yaml
ROOT=find_repository_root(__file__);folders=[ROOT/'docs/history/systems/saed_v4/62_PHASE_DELIVERIES_V4/V4_04',ROOT/'docs/history/systems/saed_v4/63_ATOMIC_CONCEPTS_V4/V4_04']
