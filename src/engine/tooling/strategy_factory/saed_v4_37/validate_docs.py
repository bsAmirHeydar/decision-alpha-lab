...
ROOT=find_repository_root(__file__); phase=ROOT/'docs/strategy_factory_sovereign_context_intelligence_v4/62_PHASE_DELIVERIES_V4/V4_37'; atomic=ROOT/'docs/strategy_factory_sovereign_context_intelligence_v4/63_ATOMIC_CONCEPTS_V4/V4_37'; docs=list(phase.glob('*.md'))+list(atomic.glob('*.md'))
