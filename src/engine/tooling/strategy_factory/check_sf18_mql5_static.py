...
owned=[root/'mql5/Include/AlphaLab/StrategyFactory/Live',root/'mql5/Experts/StrategyFactory/SF18_MicroLiveHost.mq5',root/'mql5/Experts/StrategyFactory/SF18_LiveSafetyDiagnostic.mq5',root/'mql5/Tests/Experts/StrategyFactory/SF18_LiveSafetySelfTest.mq5']
errors=[]
for base in owned:
