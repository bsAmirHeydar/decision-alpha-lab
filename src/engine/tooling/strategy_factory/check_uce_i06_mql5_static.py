...
for f in list(owned.rglob('*.mqh'))+[root/'mql5/Experts/StrategyFactory/UCE_I06_OutcomeDatasetDiagnostic.mq5',root/'mql5/Tests/Experts/StrategyFactory/UCE_I06_OutcomeDatasetSelfTest.mq5',root/'mql5/Tests/Experts/StrategyFactory/UCE_I06_LongShortCounterfactualSelfTest.mq5']:
