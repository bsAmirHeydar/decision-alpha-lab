...
ROOT=find_repository_root(__file__);I=ROOT/'mql5/Include/AlphaLab/StrategyFactory/SAEDV4DataFoundation';E=ROOT/'mql5/Experts/AlphaLab/StrategyFactory/Diagnostics';files=sorted(I.glob('*.mqh'))+sorted(E.glob('EXP_SAED_V4_01_*.mq5'));forbidden=['OrderSend','CTrade','WebRequest','SocketCreate','PositionOpen','trade.Buy','trade.Sell'];errors=[]
for p in files:
