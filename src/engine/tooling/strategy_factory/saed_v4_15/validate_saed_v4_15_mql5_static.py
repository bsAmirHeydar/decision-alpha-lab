...
ROOT=find_repository_root(__file__);files=list((ROOT/'mql5/Include/DecisionAlphaLab/StrategyFactory/SAED/V4_15').glob('*.mqh'))+list((ROOT/'mql5/Experts/DecisionAlphaLab/StrategyFactory/SAED/V4_15').glob('*.mq5'));assert files
for p in files:
