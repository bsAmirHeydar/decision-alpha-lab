...
import hashlib,json
ROOT=find_repository_root(__file__);index=ROOT/'releases/history/saed/indexes/SAED_V4_15_FILE_INDEX.txt';ledger=ROOT/'releases/history/saed/hashes/SAED_V4_15_FILE_HASHES.sha256';manifest_path=ROOT/'releases/history/saed/manifests/SAED_V4_15_PATCH_MANIFEST.json'
...
assert set(expected)==set(paths)-{'releases/history/saed/hashes/SAED_V4_15_FILE_HASHES.sha256'}
...
s=json.loads((ROOT/'releases/history/strategy_factory/program/status/SAED_V4_15.json').read_text());assert s['claims']['multimodal_fusion_boundary_implemented'] and not s['claims']['production_authorization']
