...
schemas=list((ROOT/'schemas/legacy/strategy_factory/v3').glob('qualification_*.schema.json'))
...
for name in ('reference_environment.json','qualification_policy.json','reference_blocked_qualification_report.json','uce_i18_evidence_bundle.json','limitations.json','external_evidence_template.json','acceptance_matrix.json'):
 need('releases/history/strategy_factory/program/implementation/universal_context_exploitation_engine/v3_implementation/artifacts/uce_i18/'+name)
