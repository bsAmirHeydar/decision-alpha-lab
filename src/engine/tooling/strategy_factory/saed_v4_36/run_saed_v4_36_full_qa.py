...
ROOT=find_repository_root(__file__);TOOLS=Path(__file__).resolve().parent
commands=[
 [sys.executable,'-m','pytest','-q',str(ROOT/'tests/legacy/strategy_factory/v1/phase_saed_v4_36_research_memory_active_planner')],
