...
$targets = @(
  ...
  "mql5/Tests/Experts/StrategyFactory/UCE_I02_EXP0017ReferenceSelfTest.mq5",
  "mql5/Experts/StrategyFactory/UCE_I02_ContextPackageDiagnostic.mq5"
)
foreach ($relative in $targets) {
  $source = Join-Path $RepoRoot $relative; $log = "$source.compile.log"
...
Write-Host "UCE-I02 MetaEditor compile gate: PASS"
