...
ROOT=find_repository_root(__file__); paths=sorted((ROOT/"mql5/Include/DecisionAlphaLab/StrategyFactory/SAED/V4_28").glob("*.mqh"))+sorted((ROOT/"mql5/Experts/DecisionAlphaLab/StrategyFactory/SAED/V4_28").glob("*.mq5"))
