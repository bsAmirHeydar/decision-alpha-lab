...
def golden_inventory():
 return DataInventory('uce15.inventory.reference','1.0.0','uce15.reference_fixture',canonical_sha256({'rows':12}),DataMode.FIXTURE,12,('US100','US500','SYMBOL'),1000,12000,'known_time_ms','repo://examples/legacy/strategy_factory/uce_i15',12000,canonical_sha256({'schema':'uce15.reference'}),('reference fixture only','not market-edge evidence'))
