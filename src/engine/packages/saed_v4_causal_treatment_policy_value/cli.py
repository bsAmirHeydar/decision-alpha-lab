...
def main(argv=None):
    p=argparse.ArgumentParser(prog='saed-v4-18');p.add_argument('--artifact-root',default='releases/history/strategy_factory/artifacts/saed_v4_18');p.add_argument('--summary',action='store_true');a=p.parse_args(argv)
