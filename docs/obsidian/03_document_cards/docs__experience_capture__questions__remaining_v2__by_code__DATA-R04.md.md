---
title: "DATA-R04 — Audit Report and Chart Traceability"
type: document_card
generated_by: alpha_lab_obsidian_builder
generated_at: 2026-07-06
source_path: "docs/experience_capture/questions/remaining_v2/by_code/DATA-R04.md"
source_ext: ".md"
category: "experience_capture_docs"
source_size_bytes: "1197"
concepts:
  - "Execution"
  - "NDS Anatomy"
  - "Validation"
...
**Source:** [[docs/experience_capture/questions/remaining_v2/by_code/DATA-R04|docs/experience_capture/questions/remaining_v2/by_code/DATA-R04.md]]
...
Every model and decision must be explainable in NDS language. Do not repeat or overwrite the captured answers. Answered codes that must remain untouched: Which NDS objects must be drawn on chart? Which dataset rows must link to chart objects? Should every entry candidate have a screenshot export? What must a model report include before human review? How should rejected candidates be audited? How should branch comparisons be preserved? When answered, create a separate answer folder: Use an image only if it clarifies the structure. If an image is provided, store it under the answer folder and mark all relevant NDS objects.
