---
title: "TEST-R01 — Baseline, OOS, Ablation, and Negative Controls"
type: document_card
generated_by: alpha_lab_obsidian_builder
generated_at: 2026-07-06
source_path: "docs/experience_capture/questions/remaining_v2/by_code/TEST-R01.md"
source_ext: ".md"
...
**Source:** [[docs/experience_capture/questions/remaining_v2/by_code/TEST-R01|docs/experience_capture/questions/remaining_v2/by_code/TEST-R01.md]]
...
No trained policy should be accepted without anti-overfit evidence. Do not repeat or overwrite the captured answers. Answered codes that must remain untouched: What is the rule-based baseline for each entry family? What naive/random baselines must be beaten? How should out-of-sample splits be designed? Which ablations are mandatory? Which negative controls should fail? What makes a result fragile or overfit? When answered, create a separate answer folder: Use an image only if it clarifies the structure. If an image is provided, store it under the answer folder and mark all relevant NDS objects.
