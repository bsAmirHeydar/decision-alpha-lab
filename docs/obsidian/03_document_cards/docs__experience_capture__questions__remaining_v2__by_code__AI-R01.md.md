---
title: "AI-R01 — AI Model Role Registry"
type: document_card
generated_by: alpha_lab_obsidian_builder
generated_at: 2026-07-06
source_path: "docs/experience_capture/questions/remaining_v2/by_code/AI-R01.md"
source_ext: ".md"
category: "experience_capture_docs"
source_size_bytes: "1184"
concepts:
  - "Execution"
  - "NDS Anatomy"
---
...
**Source:** [[docs/experience_capture/questions/remaining_v2/by_code/AI-R01|docs/experience_capture/questions/remaining_v2/by_code/AI-R01.md]]
...
The AI layer needs role separation and authority limits. Do not repeat or overwrite the captured answers. Answered codes that must remain untouched: Which AI model should be built first? What is the role of ranker, veto, context power, ambiguity, anchor selector, width policy, and cancel/replace models? Which models are advisory only? Which models can veto? Which models can select an execution template? Which models must never send orders? When answered, create a separate answer folder: Use an image only if it clarifies the structure. If an image is provided, store it under the answer folder and mark all relevant NDS objects.
