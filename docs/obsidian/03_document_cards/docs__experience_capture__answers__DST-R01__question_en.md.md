...
source_path: "docs/experience_capture/answers/DST-R01/question_en.md"
source_ext: ".md"
category: "experience_capture_docs"
source_size_bytes: "1427"
concepts:
  - "Convexity"
  - "F-Counting"
  - "Hook"
...
**Source:** [[docs/experience_capture/answers/DST-R01/question_en|docs/experience_capture/answers/DST-R01/question_en.md]]
...
What is a Destination in NDS, how can it be formed, how should open one-and-two structures be treated, and how much of destination logic should remain trainable? Potential, optionality, and cost-to-potential quality cannot be evaluated without destination logic. Earlier records established that NDS prioritizes potential, open profit path, and convexity before win rate. DST-R01 defines the current understanding of destinations and marks what remains unknown and trainable. Please clarify: What exactly is a Destination in NDS? Can destinations be discovered from later F-counting? Can open one-and-two structures in the path become destinations? Can destination logic use counting inside a higher
