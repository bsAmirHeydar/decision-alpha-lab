---
title: "EXE-R03 — Spread, Thin Stop, and Effective Risk"
type: document_card
generated_by: alpha_lab_obsidian_builder
generated_at: 2026-07-06
source_path: "docs/experience_capture/questions/remaining_v2/by_code/EXE-R03.md"
source_ext: ".md"
category: "experience_capture_docs"
source_size_bytes: "1238"
concepts:
  - "Execution"
  - "NDS Anatomy"
---
...
**Source:** [[docs/experience_capture/questions/remaining_v2/by_code/EXE-R03|docs/experience_capture/questions/remaining_v2/by_code/EXE-R03.md]]
...
Very thin stops can be valuable, but spread can destroy the actual risk model. Do not repeat or overwrite the captured answers. Answered codes that must remain untouched: When is raw stop too close to spread? When should thin stops still be allowed? Should spread be hard veto, score penalty, or warning? Should spread policy differ by symbol or timeframe? How should effective risk after spread be calculated? How should this be simulated in backtest? When answered, create a separate answer folder: Use an image only if it clarifies the structure. If an image is provided, store it under the answer folder and mark all relevant NDS objects.
