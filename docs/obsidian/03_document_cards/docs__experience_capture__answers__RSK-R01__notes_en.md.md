---
title: "RSK-R01 — Notes and Open Questions"
type: document_card
generated_by: alpha_lab_obsidian_builder
generated_at: 2026-07-06
source_path: "docs/experience_capture/answers/RSK-R01/notes_en.md"
source_ext: ".md"
category: "experience_capture_docs"
source_size_bytes: "4302"
concepts:
  - "AI Agent Layer"
  - "Convexity"
  - "Execution"
...
**Source:** [[docs/experience_capture/answers/RSK-R01/notes_en|docs/experience_capture/answers/RSK-R01/notes_en.md]]
...
This answer should be treated as: Risk cannot be a flat number attached only at execution time. Recommended flow: This should happen before any ExecutionIntent is considered for validation. 1. What exact metrics define an expensive context? 2. What exact metrics define a clean context? 3. What exact metrics define an expensive zone? 4. What exact metrics define a clean zone? 5. What exact metrics define an expensive entry? 6. What exact metrics define a clean entry? 7. Should context risk dominate zone and entry risk? 8. Can a very clean entry compensate for an expensive context? 9. Can a very strong context compensate for an expensive entry? 10. Should risk scores be normalized per symbol/t
