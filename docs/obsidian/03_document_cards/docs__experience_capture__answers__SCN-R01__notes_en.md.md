---
title: "SCN-R01 — Notes and Open Questions"
type: document_card
generated_by: alpha_lab_obsidian_builder
generated_at: 2026-07-06
source_path: "docs/experience_capture/answers/SCN-R01/notes_en.md"
source_ext: ".md"
category: "experience_capture_docs"
source_size_bytes: "4677"
concepts:
  - "AI Agent Layer"
  - "Convexity"
  - "Execution"
...
**Source:** [[docs/experience_capture/answers/SCN-R01/notes_en|docs/experience_capture/answers/SCN-R01/notes_en.md]]
...
This answer should be treated as: The future system should not feed AI only a context score. The model should produce a structured packet: This packet should sit between canonical NDS state and execution candidate generation. 1. What exact structure defines an open one-and-two? 2. Is open one-and-two always a destination magnet, or only in some contexts? 3. How should timing uncertainty of open one-and-twos be represented? 4. What exact minimum X closure is required for reversal power? 5. Can Y closure alone ever create a tradable zone? 6. How should X-only, Y-only, and XY closure be weighted? 7. How should multiple closed sequences be normalized? 8. What exact rule promotes symmetry conflue
