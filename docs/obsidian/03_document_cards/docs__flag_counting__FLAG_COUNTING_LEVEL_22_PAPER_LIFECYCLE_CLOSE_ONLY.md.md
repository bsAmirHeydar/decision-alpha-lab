---
title: "Flag Counting Level 22 — Paper Lifecycle Close-Only"
type: document_card
generated_by: alpha_lab_obsidian_builder
generated_at: 2026-07-06
source_path: "docs/flag_counting/FLAG_COUNTING_LEVEL_22_PAPER_LIFECYCLE_CLOSE_ONLY.md"
source_ext: ".md"
category: "flag_counting_docs"
source_size_bytes: "3116"
concepts:
  - "Execution"
  - "F-Counting"
  - "Hook"
...
**Source:** [[docs/flag_counting/FLAG_COUNTING_LEVEL_22_PAPER_LIFECYCLE_CLOSE_ONLY|docs/flag_counting/FLAG_COUNTING_LEVEL_22_PAPER_LIFECYCLE_CLOSE_ONLY.md]]
...
Level 22 takes the Level 21 paper intent seed and reconstructs a close-only paper lifecycle. This is not execution. This is not a broker request. This is not a paper order sent to a broker. It is a CSV-only lifecycle reconstruction using closed-bar close prices. Level 22 does not modify: It remains: Level 22 deliberately ignores intrabar high/low. It uses close price only. For entry: For target: For stop: This is intentionally conservative and deterministic. The output row includes: Level 22 does not: Level 20 answers: Level 21 answers: Level 22 answers: The next layer should be: Level 23 should aggregate Level 22 lifecycle rows into performance-style metrics:
