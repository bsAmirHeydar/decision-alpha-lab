---
title: "ENT-R01 — Entry-Level Extreme Definition"
type: document_card
generated_by: alpha_lab_obsidian_builder
generated_at: 2026-07-06
source_path: "docs/experience_capture/answers/ENT-R01/question_en.md"
source_ext: ".md"
...
# ENT-R01 — Entry-Level Extreme Definition

**Source:** [[docs/experience_capture/answers/ENT-R01/question_en|docs/experience_capture/answers/ENT-R01/question_en.md]]
...
What exactly is an entry-level Extreme in NDS, and when does it authorize entry inside a zone? Earlier records separated the Hook Extreme from the entry-level Extreme. The Hook Extreme is the opposite extreme inside a Hook/CycleHook. The entry-level Extreme is the precise lower-scale entry condition used inside a zone for smaller stop and higher convexity. This distinction must be formalized. Please clarify: What is an entry-level Extreme? How is it different from a Hook Extreme? Is entry-level Extreme the near-death of the lower-scale CycleHook? Is it valid only inside a higher-timeframe zone? How closed should the lower-timeframe Hook/CycleHook be? Where should the stop be placed? Why does
