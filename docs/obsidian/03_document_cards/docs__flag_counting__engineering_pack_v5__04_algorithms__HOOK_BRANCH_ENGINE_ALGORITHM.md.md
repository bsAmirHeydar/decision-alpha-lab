---
title: "Hook Branch Engine Algorithm"
type: document_card
generated_by: alpha_lab_obsidian_builder
generated_at: 2026-07-06
source_path: "docs/flag_counting/engineering_pack_v5/04_algorithms/HOOK_BRANCH_ENGINE_ALGORITHM.md"
source_ext: ".md"
category: "flag_counting_docs"
source_size_bytes: "2674"
concepts:
  - "AI Agent Layer"
  - "F-Counting"
  - "Hook"
...
**Source:** [[docs/flag_counting/engineering_pack_v5/04_algorithms/HOOK_BRANCH_ENGINE_ALGORITHM|docs/flag_counting/engineering_pack_v5/04_algorithms/HOOK_BRANCH_ENGINE_ALGORITHM.md]]
...
Bullish: Bearish: Bullish branch rule: Bearish branch rule: After branch membership is built, reverse the branch chronologically and label: A branch has valid internal 1/2 when: Bullish: Bearish: For F1 before minimum 1/2 exists: Bullish: Bearish: After valid 1/2 exists, later 3/4 may be counted normally. If any branch length > 4: Do not emit a readable hook branch with more than four numbered nodes. For ND candidate: If input allows below-half ND, still emit but mark: Default should not accept below-half ND. Emit: Each emitted event must include:
