---
title: "Index Fragment — RSK-R02"
type: document_card
generated_by: alpha_lab_obsidian_builder
generated_at: 2026-07-06
source_path: "docs/experience_capture/index_fragments/RSK-R02_en.md"
source_ext: ".md"
category: "experience_capture_docs"
source_size_bytes: "1195"
concepts:
  - "Convexity"
  - "Execution"
  - "NDS Anatomy"
...
**Source:** [[docs/experience_capture/index_fragments/RSK-R02_en|docs/experience_capture/index_fragments/RSK-R02_en.md]]
...
Path: Summary: In NDS, risk is expressed as a percentage of account equity, adjusted by a setup-quality coefficient. The executable size must be calculated so that, after stop distance and commission, the true monetary cost equals the intended risk budget. The strategy seeks rewards above 10R, so cost must be judged against large and open reward potential. Optionality is not only an entry-level concept; it must be measured separately at context, zone, and entry levels, then combined into an aggregate optionality score. Convexity is therefore a multi-level cost-to-potential relationship, not just a small stop at the final entry. Main derived architecture requirements:
