---
title: "SCN-R04 — Layered Invalidation: Entry, Anchor, Zone, Scenario"
type: document_card
generated_by: alpha_lab_obsidian_builder
generated_at: 2026-07-06
source_path: "docs/experience_capture/questions/remaining_v2/by_code/SCN-R04.md"
source_ext: ".md"
category: "experience_capture_docs"
source_size_bytes: "1230"
concepts:
  - "Execution"
  - "NDS Anatomy"
  - "Structural Nodes"
...
**Source:** [[docs/experience_capture/questions/remaining_v2/by_code/SCN-R04|docs/experience_capture/questions/remaining_v2/by_code/SCN-R04.md]]
...
EXT-06 defines anchor death, but broader scenario death still needs separation. Do not repeat or overwrite the captured answers. Answered codes that must remain untouched: When does only the entry candidate die? When does only the Extreme anchor die? When does the zone die? When does the whole scenario die? If child Extreme dies but parent scenario remains alive, should the system search for a new entry? What exact invalidation states must be logged? When answered, create a separate answer folder: Use an image only if it clarifies the structure. If an image is provided, store it under the answer folder and mark all relevant NDS objects.
