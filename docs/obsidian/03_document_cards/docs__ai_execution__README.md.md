---
title: "AI Execution Docs"
type: document_card
generated_by: alpha_lab_obsidian_builder
generated_at: 2026-07-06
source_path: "docs/ai_execution/README.md"
source_ext: ".md"
...
**Source:** [[docs/ai_execution/README|docs/ai_execution/README.md]]
...
این پوشه برای اسناد مسیر هوش مصنوعی، بک‌تست، episode، label، algorithm layers و execution bridge است. تعریف رسمی تجربه امیر درباره ورود در اکستریم نزدیک نود L2 نخورده، 90% cycle proximity، ورود limit، stop پشت نود، spread-aware execution و labelهای لازم. نقشه لایه‌های الگوریتمی جداگانه برای Extreme Engine:
