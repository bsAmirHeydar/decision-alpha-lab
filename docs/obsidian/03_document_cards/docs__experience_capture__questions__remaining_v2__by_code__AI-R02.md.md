---
title: "AI-R02 — Human Review of Learned Rules"
type: document_card
generated_by: alpha_lab_obsidian_builder
generated_at: 2026-07-06
source_path: "docs/experience_capture/questions/remaining_v2/by_code/AI-R02.md"
source_ext: ".md"
...
**Source:** [[docs/experience_capture/questions/remaining_v2/by_code/AI-R02|docs/experience_capture/questions/remaining_v2/by_code/AI-R02.md]]
...
You want AI to tell you what it learned before tests and acceptance. Do not repeat or overwrite the captured answers. Answered codes that must remain untouched: What format should learned rules be reported in? What must AI explain before you review it? How do you approve, reject, or branch a learned rule? What tests run after approval? Can a rule remain watchlist-only? Where should human review notes be stored? When answered, create a separate answer folder: Use an image only if it clarifies the structure. If an image is provided, store it under the answer folder and mark all relevant NDS objects.
