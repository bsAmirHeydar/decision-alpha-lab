---
title: "SCN-R02 — Potential Zone Definition"
type: document_card
generated_by: alpha_lab_obsidian_builder
generated_at: 2026-07-06
source_path: "docs/experience_capture/answers/SCN-R02/question_en.md"
source_ext: ".md"
category: "experience_capture_docs"
source_size_bytes: "1059"
concepts:
  - "Convexity"
  - "Execution"
  - "NDS Anatomy"
...
**Source:** [[docs/experience_capture/answers/SCN-R02/question_en|docs/experience_capture/answers/SCN-R02/question_en.md]]
...
What turns a context or viewpoint into a Potential Zone / Trading Zone in NDS? Context identifies structural position. Zone identifies the region where that position becomes exploitable. Entry is then refined inside the zone on a lower scale. The system needs a formal model for context-to-zone promotion. Please clarify: What is a zone? What sources can create a zone? What is the difference between context and zone? Where is a reversal zone built? How does zone relate to lower-timeframe Extreme entry? How does symmetry create zone boundaries? How does destination/optionality affect zone value? Can multiple zones exist at the same time? What invalidates or expires a zone? What should the final
