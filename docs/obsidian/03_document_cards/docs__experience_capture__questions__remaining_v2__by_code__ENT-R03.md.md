---
title: "ENT-R03 — Higher-Timeframe F3 / Lower-Timeframe 3F Reversal"
type: document_card
generated_by: alpha_lab_obsidian_builder
generated_at: 2026-07-06
source_path: "docs/experience_capture/questions/remaining_v2/by_code/ENT-R03.md"
source_ext: ".md"
category: "experience_capture_docs"
source_size_bytes: "1205"
concepts:
  - "Execution"
  - "F-Counting"
  - "NDS Anatomy"
...
**Source:** [[docs/experience_capture/questions/remaining_v2/by_code/ENT-R03|docs/experience_capture/questions/remaining_v2/by_code/ENT-R03.md]]
...
This multi-timeframe setup has been mentioned, but not operationalized. Do not repeat or overwrite the captured answers. Answered codes that must remain untouched: What exactly qualifies as higher-timeframe F3? What lower-timeframe 3F must appear? When is the setup buy and when is it sell? How does parent context confirm or block it? Where are entry, stop, destination, and invalidation? What makes it dangerous or deceptive? When answered, create a separate answer folder: Use an image only if it clarifies the structure. If an image is provided, store it under the answer folder and mark all relevant NDS objects.
...
- [[docs/experience_capture/answers/EXT-11/notes_en|EXT-11 — Notes and Open Questions]] — `experience_capture_docs`
