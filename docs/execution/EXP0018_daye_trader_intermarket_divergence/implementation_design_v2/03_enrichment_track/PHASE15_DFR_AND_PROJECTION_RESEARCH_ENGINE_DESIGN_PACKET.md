  ---
  id: EXP0018-P15-DESIGN-PACKET-V2
  title: "EXP0018 P15 — موتور پژوهشی DFR و Projection"
  type: phase-design
  status: draft
  project: EXP0018
  version: 2.0.0
...
- p15
  ---
# P15 — موتور پژوهشی DFR و Projection
...
DFR، thirds و projection levels را صرفاً به‌عنوان feature/evidence قابل‌آزمون تولید کند.

## 3. ورودی‌های authoritative

- Q1 period
- approved DFR definition
- projection config

## 4. خروجی‌ها و قرارداد تحویل

- DFR high/low/equilibrium
- stdv projection levels
- touch events

## 5. فایل‌ها و ماژول‌های مالک

- `Optional/DAYE_DfrEngine.mqh`
- `Optional/DAYE_ProjectionLevels.mqh`
...
- Q1 thirds
- body/wick variants as separate experiments
- projection math
