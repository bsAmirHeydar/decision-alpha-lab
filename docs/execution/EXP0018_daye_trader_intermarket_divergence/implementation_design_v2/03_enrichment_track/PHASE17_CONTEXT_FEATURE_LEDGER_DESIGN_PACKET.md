  ---
  id: EXP0018-P17-DESIGN-PACKET-V2
  title: "EXP0018 P17 — دفتر Featureهای زمینه‌ای"
  type: phase-design
  status: draft
  project: EXP0018
  version: 2.0.0
...
AMDX/XAMD، 333، Golden Pocket، stacked opens، HTF arrays و session context را بدون filterکردن Core ثبت کند.

## 3. ورودی‌های authoritative

- core events
- optional context modules
- causal availability times

## 4. خروجی‌ها و قرارداد تحویل

- context feature rows
- feature version
- availability audit

## 5. فایل‌ها و ماژول‌های مالک

- `Optional/DAYE_ContextFeatures.mqh`
- `Optional/DAYE_ContextLedger.mqh`
...
- ledger-first.
- availability_time <= event confirmation time.
- no hidden ranking.
...
- no Core branch dependency

## 14. ریسک‌ها و hostile review

- future leakage
- context-as-rule drift
