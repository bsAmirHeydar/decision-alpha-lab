  ---
  id: EXP0018-P10-DESIGN-PACKET-V2
  title: "EXP0018 P10 — رندر Anchorهای TWO و TDO"
  type: phase-design
  status: draft
  project: EXP0018
  version: 2.0.0
...
TWO/TDO را با زمان دقیق مصوب، انتخاب open deterministic و عمر بصری مشخص رسم کند.
...
- `DAYE_AnchorTypes.mqh`
- `DAYE_TwoTdoResolver.mqh`
- `DAYE_AnchorRenderer.mqh`
...
- open fallback پنهان ممنوع.
- Monday/Tuesday ambiguity باید ADR داشته باشد.
- anchor is context, not signal.
...
- exact bar exists
- bar missing fallback reject/approved nearest policy
- holiday week
- DST week
- chart reattach
...
- TWO ADR approved
- TDO fixture pass
- anchor lifecycle documented

## 14. ریسک‌ها و hostile review

- wrong weekly day
- broker open mismatch
