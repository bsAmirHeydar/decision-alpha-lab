---
title: "ADR FP-005 — Execution از Detection جداست"
...
---
# ADR FP-005 — Execution از Detection جداست

## Decision

entry/quota/risk/target فقط confirmed context events را مصرف می‌کنند و reference/hunt را دوباره محاسبه نمی‌کنند.
...
این تصمیم testability و authority boundary را حفظ می‌کند.
