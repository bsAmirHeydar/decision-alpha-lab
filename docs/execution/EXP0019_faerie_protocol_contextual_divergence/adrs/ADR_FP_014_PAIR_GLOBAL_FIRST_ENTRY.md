---
title: "ADR FP-014 - One Pair-Global First Entry Per Session"
...
language: en
---
# ADR FP-014 - One Pair-Global First Entry Per Session

## Decision

Across both symbols and all relations, only the earliest-M1-hunt eligible setup may own a session quota.

## Context

This matches owner answers 11-A and 13-A.

## Consequences

Arbitration must be atomic and deterministic.
