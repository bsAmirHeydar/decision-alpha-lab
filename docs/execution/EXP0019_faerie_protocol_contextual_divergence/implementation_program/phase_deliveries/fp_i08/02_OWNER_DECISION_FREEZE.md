...
FP-DEC-007 through FP-DEC-010 are implemented exactly: second-symbol neutralization, tradeable WW, allow both when no active WW with complete data, and newest active confirmed WW wins.
