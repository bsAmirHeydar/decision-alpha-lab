...
Active-stack resolution is deterministic sorting over current evidence. Production integration should maintain indexes and avoid full-history rescans per tick.
