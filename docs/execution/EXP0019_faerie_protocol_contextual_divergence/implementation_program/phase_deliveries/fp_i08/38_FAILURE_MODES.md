...
Fail closed on weekly window mismatch, reference incompleteness, candidate lineage mismatch, host-close unavailability, checkpoint drift, and incomplete weekly data.
