---
title: "FP-I02 — Known Limitations and Non-Claims"
...
FP-I02 defines records and identity only. It does not prove session boundaries, data completeness, hunt detection, confirmation correctness, WW selection, quota arbitration, indicator visuals, or execution behavior.

## Normative invariants

1. **No edge claim.**
2. **No runtime performance claim beyond contract tests.**
3. **No MQL5 compile claim until local logs exist.**
4. **No live-authority claim.**
