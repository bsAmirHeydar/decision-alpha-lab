---
title: "FP-I02 — Quota Key, Record, and Open Consumption Policy"
...
language: en
---
# Quota Key, Record, and Open Consumption Policy

## Purpose

QuotaKey is context-epoch + trading day + canonical pair + A/L/N session. QuotaRecord represents AVAILABLE, RESERVED, CONSUMED, or RELEASED state while FP-DEC-012 remains open.

## Normative invariants

1. **Only A/L/N may own a quota key.**
2. **AVAILABLE has no owner lineage.**
3. **RESERVED/CONSUMED require a winner and first-hunt time.**
4. **CONSUMED is forbidden while policy is UNSET.**
5. **The earliest M1 hunt policy is semantic configuration.**
