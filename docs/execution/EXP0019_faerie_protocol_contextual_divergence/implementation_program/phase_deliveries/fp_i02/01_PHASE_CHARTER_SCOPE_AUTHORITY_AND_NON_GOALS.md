---
title: "FP-I02 — Phase Charter, Scope, Authority, and Non-Goals"
...
language: en
---
# Phase Charter, Scope, Authority, and Non-Goals

## Purpose

FP-I02 freezes the closed vocabulary and immutable public records that every later Faerie Protocol phase must consume. It is deliberately behavior-light: it defines what a window, reference, hunt, candidate, signal, weekly context, quota key, reason, configuration, and identity are before any market-history engine is allowed to produce them.

## Normative invariants

1. **Implement closed enums and immutable value records.**
2. **Separate semantic, projection, and operational configuration.**
3. **Implement canonical hashes and compact IDs.**
4. **Freeze relation, reason, state-machine, and contract registries.**
5. **Provide Python and MQL5 mirrors plus executable conformance.**

## Primary surfaces

- `No market-history access.`
- `No session calculation.`
- `No detection or confirmation algorithm.`
- `No chart-object creation.`
- `No broker, order, position, or network authority.`
