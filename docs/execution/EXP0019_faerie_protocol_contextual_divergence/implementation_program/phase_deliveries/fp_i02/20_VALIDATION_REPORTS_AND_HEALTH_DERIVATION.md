---
title: "FP-I02 — Validation Reports and Health Derivation"
...
language: en
---
# Validation Reports and Health Derivation

## Purpose

Validators return individual check findings and aggregate reports. HealthStatus derives READY, DEGRADED, or BLOCKED from registered reason severity rather than free-text inspection.

## Normative invariants

1. **Every failed check has a reason code.**
2. **READY uses FP_RC_READY.**
3. **ERROR/CRITICAL findings produce BLOCKED.**
4. **Health carries semantic and dependency hashes.**
