---
title: "FP-I02 — Operator Runbook and Local Acceptance"
...
The operator runs Python phase tests, conformance CLI, schema validation, boundary scan, MQL5 static checks, FP-I00/I01 regression, engineering policy, and local MetaEditor compile.

## Normative invariants

1. **Do not waive unknown reason codes.**
2. **Do not enable live profile with Q12 open.**
3. **Retain MetaEditor logs.**
4. **Inspect status and handoff hashes.**
5. **Stage only indexed files.**
