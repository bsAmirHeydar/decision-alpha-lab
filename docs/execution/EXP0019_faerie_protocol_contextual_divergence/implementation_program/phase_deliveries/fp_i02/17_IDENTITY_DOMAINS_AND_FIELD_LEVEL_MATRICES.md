---
title: "FP-I02 — Identity Domains and Field-Level Matrices"
...
language: en
---
# Identity Domains and Field-Level Matrices

## Purpose

The phase defines IDs for pair, context epoch, window, reference side, hunt, candidate, confirmation, signal, WW context, quota key, reason evidence, transition, health, and projection.

## Normative invariants

1. **Semantic IDs exclude mutable policy state.**
2. **Projection IDs include chart instance and projection hash.**
3. **Data revision is included where source facts can change.**
4. **Registry and dependency hashes enter context epoch.**

## Primary surfaces

- `Identity field tables`
