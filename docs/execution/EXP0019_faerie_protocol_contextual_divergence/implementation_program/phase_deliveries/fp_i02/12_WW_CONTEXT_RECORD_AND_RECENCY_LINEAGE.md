---
title: "FP-I02 — WW Context Record and Recency Lineage"
...
language: en
---
# WW Context Record and Recency Lineage

## Purpose

WWContextRecord carries weekly signal lineage and lifecycle state. FP-I08 will implement active-stack resolution; FP-I02 only freezes the record and legal transitions.

## Normative invariants

1. **WW signal identity is retained after neutralization.**
2. **NEUTRALIZED requires a later time and neutralizing hunt ID.**
3. **Older WW events remain auditable.**
4. **State transition cannot reopen a neutralized context.**

## Primary surfaces

- `Direction`
- `RAW/CONFIRMED/NEUTRALIZED/EXPIRED/INVALID_DATA`
- `Confirmation time`
- `Neutralization lineage`
- `Reason code`
