---
title: "FP-I02 — Semantic, Projection, and Operational Configuration"
...
language: en
---
# Semantic, Projection, and Operational Configuration

## Purpose

Configuration is split into three identity domains. Semantic fields change market interpretation and signal identity. Projection fields change chart representation only. Operational fields change scheduling or retention without changing semantic events.

## Normative invariants

1. **Every behavior-bearing input appears in SemanticConfiguration.**
2. **Style-only changes preserve semantic_config_hash and signal_id.**
3. **Projection changes produce a new projection_config_hash and chart-object identity.**
4. **Operational limits cannot alter which signal exists.**

## Primary surfaces

- `Resolved host timeframe is semantic.`
- `Line width and opacity are projection.`
- `Timer interval and object cap are operational.`
- `Non-canonical overrides require an explicit profile reason.`
