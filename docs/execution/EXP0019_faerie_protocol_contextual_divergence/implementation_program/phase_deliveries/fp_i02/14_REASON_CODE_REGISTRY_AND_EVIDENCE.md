---
title: "FP-I02 — Reason-Code Registry and Evidence"
...
language: en
---
# Reason-Code Registry and Evidence

## Purpose

The reason registry contains 35 exact codes: 15 strategy/visual reasons and 20 kernel/governance reasons. Free-text may supplement a code but may never replace it.

## Normative invariants

1. **All persisted failures and suppressions have a known code.**
2. **Unknown codes fail validation.**
3. **Severity and execution-blocking meaning are registry metadata.**
4. **Default visual treatment is future projection guidance, not signal identity.**
...
- `Data reasons`
- `Lifecycle reasons`
- `Configuration/identity/dependency/governance reasons`
