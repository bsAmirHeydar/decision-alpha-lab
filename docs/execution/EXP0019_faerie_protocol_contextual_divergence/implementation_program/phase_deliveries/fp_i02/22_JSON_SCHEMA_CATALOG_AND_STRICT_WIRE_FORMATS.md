---
title: "FP-I02 — JSON Schema Catalog and Strict Wire Formats"
...
language: en
---
# JSON Schema Catalog and Strict Wire Formats

## Purpose

Eighteen Draft 2020-12 schemas define strict public wire formats. Top-level unknown fields are rejected; enums, semver, SHA-256, numeric bounds, and constants are constrained.

## Normative invariants

1. **Schemas are closed.**
2. **$id is stable and version-scoped.**
3. **Golden records validate.**
4. **Unknown relation and properties fail.**
5. **References resolve locally.**
