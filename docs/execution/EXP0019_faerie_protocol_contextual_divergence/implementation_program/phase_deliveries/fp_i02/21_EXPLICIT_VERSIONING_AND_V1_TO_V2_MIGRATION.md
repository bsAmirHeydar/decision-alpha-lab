---
title: "FP-I02 — Explicit Versioning and v1-to-v2 Migration"
...
language: en
---
# Explicit Versioning and v1-to-v2 Migration

## Purpose

Schemas, registries, contracts, events, and manifests are exact-versioned. The supplied v1-to-v2 migration accepts only the declared legacy shape and emits migration lineage and hashes.

## Normative invariants

1. **No implicit defaults during migration.**
2. **Unknown source version fails.**
3. **Missing fields fail.**
4. **Q12 migrates to UNSET.**
5. **Missing calendar offsets remain unreplaced.**
