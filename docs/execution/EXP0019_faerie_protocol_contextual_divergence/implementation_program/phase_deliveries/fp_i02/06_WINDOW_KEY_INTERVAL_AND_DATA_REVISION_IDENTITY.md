---
title: "FP-I02 — Window Key, Interval, and Data-Revision Identity"
...
language: en
---
# Window Key, Interval, and Data-Revision Identity

## Purpose

WindowKey identifies A/L/N/W intervals using context, pair, kind, scope, trading-day/week ownership, half-open UTC interval, calendar offset, timezone, and data revision.

## Normative invariants

1. **Intervals are [start,end) and must be non-empty.**
2. **Prior-calendar scope requires a positive exact offset.**
3. **Non-prior scopes forbid calendar offsets.**
4. **Weekly windows require week_id.**
5. **Data revision changes window identity.**

## Primary surfaces

- `Same-day A/L/N windows`
- `Exact prior calendar N offsets`
- `Previous/current NY week`
- `UTC interval plus NY ownership`
- `Window ID`
