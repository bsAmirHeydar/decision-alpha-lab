---
title: "FP-I02 — FP-I01 Adapter Handoff and Dependency Snapshot"
...
language: en
---
# FP-I01 Adapter Handoff and Dependency Snapshot

## Purpose

FP-I02 binds the hash of the FP-I01 adapter registry into semantic configuration and context manifest dependency identity. Any adapter-registry change produces a new context epoch.

## Normative invariants

1. **FP-I01 remains read-only.**
2. **Adapter registry hash is required.**
3. **Missing/mismatched snapshot blocks health.**
4. **No FP-I02 contract imports source-context structs directly.**
