---
title: "FP-I02 — Confirmation Event and Confirmed Signal Contract"
...
language: en
---
# Confirmation Event and Confirmed Signal Contract

## Purpose

ConfirmationEvent records one host-candle outcome. ConfirmedSignal binds the economic setup to confirmation evidence. Eligibility, WW suppression, and quota suppression are policy child outcomes and do not mutate the signal ID.

## Normative invariants

1. **Confirmation candle interval is valid and closed.**
2. **Confirmed time cannot precede hunt.**
3. **signal_id includes semantic_config_hash.**
4. **Changing reason or eligibility does not change signal_id.**
5. **Changing context semantics does change signal_id.**
