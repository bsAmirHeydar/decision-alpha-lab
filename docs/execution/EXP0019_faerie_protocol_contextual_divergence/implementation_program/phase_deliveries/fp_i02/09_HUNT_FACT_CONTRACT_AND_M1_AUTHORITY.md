---
title: "FP-I02 — Hunt Fact Contract and M1 Authority"
...
language: en
---
# Hunt Fact Contract and M1 Authority

## Purpose

HuntFact is the immutable projection of a shared-core touch/hunt observation into the Faerie Protocol identity system. It binds relation, reference side, check window, pair, symbol, role, side, canonical M1 time, prices, data revision, and source fingerprint.

## Normative invariants

1. **Canonical hunt time must align to an M1 open.**
2. **Tick time is not identity-bearing.**
3. **Source fingerprint is required.**
4. **Observed and reference prices must be finite.**
5. **No role inference is performed by this type.**
