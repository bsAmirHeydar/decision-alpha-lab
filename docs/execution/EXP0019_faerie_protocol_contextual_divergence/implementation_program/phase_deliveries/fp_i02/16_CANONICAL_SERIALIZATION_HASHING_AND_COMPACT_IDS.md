---
title: "FP-I02 — Canonical Serialization, Hashing, and Compact IDs"
...
language: en
---
# Canonical Serialization, Hashing, and Compact IDs

## Purpose

Canonical JSON sorts mapping keys, normalizes enums/dataclasses, rejects unsupported types and non-finite numbers, and serializes floats with stable precision. Public IDs are uppercase prefixes plus the first 32 lowercase SHA-256 hex characters.

## Normative invariants

1. **Same semantic payload yields same digest.**
2. **Mapping order does not affect digest.**
3. **Negative zero normalizes to zero.**
4. **NaN and infinity are forbidden.**
5. **Identity conflicts are explicit errors.**
