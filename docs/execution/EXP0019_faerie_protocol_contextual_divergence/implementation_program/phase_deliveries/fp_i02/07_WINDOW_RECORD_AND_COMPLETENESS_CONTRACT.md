---
title: "FP-I02 — Window Record and Completeness Contract"
...
language: en
---
# Window Record and Completeness Contract

## Purpose

WindowRecord carries symbol-local highs, lows, bar counts, completion state, data state, and source revision hash. It never compares one symbol price to the other symbol reference.

## Normative invariants

1. **Exactly two symbol maps with identical keys.**
2. **High cannot be below low.**
3. **COMPLETE requires completed interval and positive bars for both symbols.**
4. **Non-finite prices are rejected.**
5. **Record hash includes coverage evidence.**
