---
title: "Immutable Confirmed Objects"
...
# Immutable Confirmed Objects

## Purpose

Confirmed signals, terminal invalidations, completed windows, hunts, and WW context cannot be rewritten under the same semantic identity.
