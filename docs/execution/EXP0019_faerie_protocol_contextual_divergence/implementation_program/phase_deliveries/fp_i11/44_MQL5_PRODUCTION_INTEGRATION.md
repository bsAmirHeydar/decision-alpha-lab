...
Documents the FP-I11 visual engine initialization, frame lifecycle, health projection, semantic fact ingestion API, and deinitialization integration in the main indicator.
