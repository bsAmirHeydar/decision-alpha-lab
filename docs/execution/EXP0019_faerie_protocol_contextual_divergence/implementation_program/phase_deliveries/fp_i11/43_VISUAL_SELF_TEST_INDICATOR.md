---
title: "Visual Self-Test Indicator"
...
# Visual Self-Test Indicator

## Purpose

Defines the dedicated chart test that renders every object family with deterministic fixtures and never runs in production mode.
