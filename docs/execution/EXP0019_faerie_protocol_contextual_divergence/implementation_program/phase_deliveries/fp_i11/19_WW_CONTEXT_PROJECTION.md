...
# WW Context Projection

## Purpose

Projects active and historical weekly context bands, including direction, hunter/protected lineage, lifecycle state, and check-week horizon.
