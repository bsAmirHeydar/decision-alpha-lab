...
Only mutable objects absent from the next desired projection are deleted. Immutable evidence is retained until an explicit retention/archival policy removes the entire phase namespace.
