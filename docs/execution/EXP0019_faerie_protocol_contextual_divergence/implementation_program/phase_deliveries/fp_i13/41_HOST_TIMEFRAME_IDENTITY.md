---
title: "Resolved Host Timeframe Identity"
...
language: en
---
# Resolved Host Timeframe Identity

Host timeframe is resolved during initialization and included in configuration identity. Current chart timeframe is not permitted to change confirmation semantics after initialization. A deliberate host-timeframe change creates a new configuration epoch and requires rebuild.
## Implementation linkage

The **41 Host Timeframe Identity** contract is implemented through the versioned `fp_i13_release` Python reference package, the MQL5 `I13` include boundary, the production indicator integration, and the FP-I13 release self-test. The implementation must consume accepted FP-I10–FP-I12 outputs rather than reconstructing context from chart objects.
