---
title: "Checkpoint Size and Retention"
...
language: en
---
# Checkpoint Size and Retention

Checkpoint size is measured before local persistence. Oversized checkpoints degrade health and may trigger rebuild-oriented retention. The event stream and upstream semantic ledger remain the source of truth.
## Implementation linkage

The **88 Checkpoint Size And Retention** contract is implemented through the versioned `fp_i13_release` Python reference package, the MQL5 `I13` include boundary, the production indicator integration, and the FP-I13 release self-test. The implementation must consume accepted FP-I10–FP-I12 outputs rather than reconstructing context from chart objects.
