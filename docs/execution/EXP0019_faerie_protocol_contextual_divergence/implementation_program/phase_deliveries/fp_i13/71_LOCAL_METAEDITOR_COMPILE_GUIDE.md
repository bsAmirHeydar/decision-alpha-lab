---
title: "Local MetaEditor Compile Guide"
...
language: en
---
# Local MetaEditor Compile Guide

Run `tools/exp0019/run_fp_i13_local_acceptance.ps1` with the MetaEditor executable and terminal data path. The script compiles the production indicator and FP-I13 self-test. Compilation errors keep the external gate pending or failed.

After compile, attach the self-test indicator and verify `FP-I13 ReleaseSelfTest PASS` in the Experts log. Attach the production indicator to at least two charts with different chart timeframes and verify no namespace collision or repeated historical alerts.
## Implementation linkage

The **71 Local Metaeditor Compile Guide** contract is implemented through the versioned `fp_i13_release` Python reference package, the MQL5 `I13` include boundary, the production indicator integration, and the FP-I13 release self-test. The implementation must consume accepted FP-I10–FP-I12 outputs rather than reconstructing context from chart objects.
