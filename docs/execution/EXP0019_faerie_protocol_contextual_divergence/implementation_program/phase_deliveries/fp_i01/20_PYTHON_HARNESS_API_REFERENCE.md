---
title: "FP-I01 — Python Harness API Reference"
...
language: en
---
# Python Harness API Reference

## Purpose

The Python package supplies canonicalization, models, adapters, registry, fixtures, hash guards, duplicate scan, reporting, validation, and CLI surfaces.
