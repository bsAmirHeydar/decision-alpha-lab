---
title: "FP-I01 — MQL5 Contract Mirror"
...
MQL5 mirrors the neutral contracts, dependency pins, adapters, registry, fingerprints, self-test, and diagnostic entry point without owning source semantics.

## MQL5 public surfaces

- `FP_I01_Enums.mqh`
- `FP_I01_Types.mqh`
- `FP_I01_Fingerprint.mqh`
- `FP_I01_DependencyPins.mqh`
- `FP_I01_CGAdapters.mqh`
- `FP_I01_DAYEAdapters.mqh`
- `FP_I01_Registry.mqh`
- `FP_I01_SelfTest.mqh`
- `FP_I01_All.mqh`

The mirror uses `const` source references and writes only to FP-owned target structs. Source fingerprints are re-evaluated by the self-test before and after adaptation.
