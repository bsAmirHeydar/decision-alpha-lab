---
title: "FP-I01 — Health, Reason Codes, and Fail-Closed Behavior"
...
language: en
---
# Health, Reason Codes, and Fail-Closed Behavior

## Purpose

READY, DEGRADED, and BLOCKED separate usable data from partial or unavailable data. Missing fields, hash mismatch, unknown adapters, and stale versions fail closed.
