...
This note defines the FP-I12 contract for **Preferences Checkpoint**. The operator layer consumes accepted FP-I10 machine state and FP-I11 visual identities. It may change visibility, layout, notification delivery, local export, and operator preferences. It may not recompute relation truth, change signal identity, modify eligibility, consume quota, or mutate the semantic ledger.
