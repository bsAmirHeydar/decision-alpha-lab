---
title: "FP-I15 — Synthetic order fields and identity"
...
language: en
---
# Synthetic order fields and identity

## Purpose

Synthetic order fields and identity. This note is normative for the FP-I15 source release and is implemented by `fp_i15_paper`, the MQL5 contract mirror under `I15`, the paper-only EA, the closed schemas, and the accepted test fixtures.
