---
title: "FP-I15 — Deterministic MQL5 geometry and fill self-test"
...
language: en
---
# Deterministic MQL5 geometry and fill self-test

## Purpose

Deterministic MQL5 geometry and fill self-test. This note is normative for the FP-I15 source release and is implemented by `fp_i15_paper`, the MQL5 contract mirror under `I15`, the paper-only EA, the closed schemas, and the accepted test fixtures.
