---
title: "FP-I15 — BUY SELL rejection partial fill and restart vectors"
...
language: en
---
# BUY SELL rejection partial fill and restart vectors

## Purpose

BUY SELL rejection partial fill and restart vectors. This note is normative for the FP-I15 source release and is implemented by `fp_i15_paper`, the MQL5 contract mirror under `I15`, the paper-only EA, the closed schemas, and the accepted test fixtures.
