---
title: "FP-I15 — Spread source, timestamp, and reproducibility"
...
language: en
---
# Spread source, timestamp, and reproducibility

## Purpose

Spread source, timestamp, and reproducibility. This note is normative for the FP-I15 source release and is implemented by `fp_i15_paper`, the MQL5 contract mirror under `I15`, the paper-only EA, the closed schemas, and the accepted test fixtures.
