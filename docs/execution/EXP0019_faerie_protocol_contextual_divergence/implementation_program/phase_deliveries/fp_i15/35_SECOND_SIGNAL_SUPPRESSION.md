---
title: "FP-I15 — No second paper reservation in pair-session"
...
language: en
---
# No second paper reservation in pair-session

## Purpose

No second paper reservation in pair-session. This note is normative for the FP-I15 source release and is implemented by `fp_i15_paper`, the MQL5 contract mirror under `I15`, the paper-only EA, the closed schemas, and the accepted test fixtures.
