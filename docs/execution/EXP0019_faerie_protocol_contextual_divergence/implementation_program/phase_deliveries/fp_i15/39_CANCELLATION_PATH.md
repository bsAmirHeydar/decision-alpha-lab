---
title: "FP-I15 — Accepted-then-cancelled behavior"
...
language: en
---
# Accepted-then-cancelled behavior

## Purpose

Accepted-then-cancelled behavior. This note is normative for the FP-I15 source release and is implemented by `fp_i15_paper`, the MQL5 contract mirror under `I15`, the paper-only EA, the closed schemas, and the accepted test fixtures.
