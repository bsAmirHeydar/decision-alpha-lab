---
title: "FP-I15 — First partial fill consumes fill profile"
...
language: en
---
# First partial fill consumes fill profile

## Purpose

First partial fill consumes fill profile. This note is normative for the FP-I15 source release and is implemented by `fp_i15_paper`, the MQL5 contract mirror under `I15`, the paper-only EA, the closed schemas, and the accepted test fixtures.
