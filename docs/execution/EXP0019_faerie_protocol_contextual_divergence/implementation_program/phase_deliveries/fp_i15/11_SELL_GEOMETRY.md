---
title: "FP-I15 — SELL stop plus exactly one spread"
...
language: en
---
# SELL stop plus exactly one spread

## Purpose

SELL stop plus exactly one spread. This note is normative for the FP-I15 source release and is implemented by `fp_i15_paper`, the MQL5 contract mirror under `I15`, the paper-only EA, the closed schemas, and the accepted test fixtures.
