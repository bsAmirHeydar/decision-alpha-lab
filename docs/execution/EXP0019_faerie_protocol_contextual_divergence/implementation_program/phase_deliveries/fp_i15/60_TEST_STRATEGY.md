---
title: "FP-I15 — Unit golden negative restart and injection matrix"
...
language: en
---
# Unit golden negative restart and injection matrix

## Purpose

Unit golden negative restart and injection matrix. This note is normative for the FP-I15 source release and is implemented by `fp_i15_paper`, the MQL5 contract mirror under `I15`, the paper-only EA, the closed schemas, and the accepted test fixtures.
