---
title: "FP-I15 — Atomic paper reservation by I09 winner"
...
language: en
---
# Atomic paper reservation by I09 winner

## Purpose

Atomic paper reservation by I09 winner. This note is normative for the FP-I15 source release and is implemented by `fp_i15_paper`, the MQL5 contract mirror under `I15`, the paper-only EA, the closed schemas, and the accepted test fixtures.
