---
title: "FP-I15 — Paper consume on first non-zero fill fixture"
...
language: en
---
# Paper consume on first non-zero fill fixture

## Purpose

Paper consume on first non-zero fill fixture. This note is normative for the FP-I15 source release and is implemented by `fp_i15_paper`, the MQL5 contract mirror under `I15`, the paper-only EA, the closed schemas, and the accepted test fixtures.
