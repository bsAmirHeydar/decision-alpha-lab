---
title: "FP-I15 — I14 consensus proof required before paper admission"
...
language: en
---
# I14 consensus proof required before paper admission

## Purpose

I14 consensus proof required before paper admission. This note is normative for the FP-I15 source release and is implemented by `fp_i15_paper`, the MQL5 contract mirror under `I15`, the paper-only EA, the closed schemas, and the accepted test fixtures.
