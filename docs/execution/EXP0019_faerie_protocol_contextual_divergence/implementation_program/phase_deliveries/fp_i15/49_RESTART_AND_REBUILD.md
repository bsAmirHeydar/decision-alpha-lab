---
title: "FP-I15 — Valid restore and invalid checkpoint rebuild"
...
language: en
---
# Valid restore and invalid checkpoint rebuild

## Purpose

Valid restore and invalid checkpoint rebuild. This note is normative for the FP-I15 source release and is implemented by `fp_i15_paper`, the MQL5 contract mirror under `I15`, the paper-only EA, the closed schemas, and the accepted test fixtures.
