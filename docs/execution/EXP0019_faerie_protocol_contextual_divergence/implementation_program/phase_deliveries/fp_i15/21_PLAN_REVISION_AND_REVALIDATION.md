---
title: "FP-I15 — Quote refresh and plan supersession"
...
language: en
---
# Quote refresh and plan supersession

## Purpose

Quote refresh and plan supersession. This note is normative for the FP-I15 source release and is implemented by `fp_i15_paper`, the MQL5 contract mirror under `I15`, the paper-only EA, the closed schemas, and the accepted test fixtures.
