---
title: "FP-I15 — Paper execution mission and explicit live non-goals"
...
language: en
---
# Paper execution mission and explicit live non-goals

## Purpose

Paper execution mission and explicit live non-goals. This note is normative for the FP-I15 source release and is implemented by `fp_i15_paper`, the MQL5 contract mirror under `I15`, the paper-only EA, the closed schemas, and the accepted test fixtures.
