---
title: "FP-I15 — Paper profile is not live owner policy"
...
language: en
---
# Paper profile is not live owner policy

## Purpose

Paper profile is not live owner policy. This note is normative for the FP-I15 source release and is implemented by `fp_i15_paper`, the MQL5 contract mirror under `I15`, the paper-only EA, the closed schemas, and the accepted test fixtures.
