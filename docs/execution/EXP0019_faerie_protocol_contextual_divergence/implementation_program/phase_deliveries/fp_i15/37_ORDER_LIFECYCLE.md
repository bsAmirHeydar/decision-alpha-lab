---
title: "FP-I15 — Created validated attempted accepted filled terminal states"
...
language: en
---
# Created validated attempted accepted filled terminal states

## Purpose

Created validated attempted accepted filled terminal states. This note is normative for the FP-I15 source release and is implemented by `fp_i15_paper`, the MQL5 contract mirror under `I15`, the paper-only EA, the closed schemas, and the accepted test fixtures.
