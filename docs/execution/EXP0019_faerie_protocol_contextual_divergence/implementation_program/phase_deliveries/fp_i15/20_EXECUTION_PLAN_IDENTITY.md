---
title: "FP-I15 — Behavior-bearing plan identity fields"
...
language: en
---
# Behavior-bearing plan identity fields

## Purpose

Behavior-bearing plan identity fields. This note is normative for the FP-I15 source release and is implemented by `fp_i15_paper`, the MQL5 contract mirror under `I15`, the paper-only EA, the closed schemas, and the accepted test fixtures.
