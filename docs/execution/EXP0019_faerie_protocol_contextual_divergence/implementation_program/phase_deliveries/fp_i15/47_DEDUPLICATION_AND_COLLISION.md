---
title: "FP-I15 — Idempotency and fail-closed ID collision"
...
language: en
---
# Idempotency and fail-closed ID collision

## Purpose

Idempotency and fail-closed ID collision. This note is normative for the FP-I15 source release and is implemented by `fp_i15_paper`, the MQL5 contract mirror under `I15`, the paper-only EA, the closed schemas, and the accepted test fixtures.
