---
title: "FP-I15 — Broker geometry fail-closed rules"
...
language: en
---
# Broker geometry fail-closed rules

## Purpose

Broker geometry fail-closed rules. This note is normative for the FP-I15 source release and is implemented by `fp_i15_paper`, the MQL5 contract mirror under `I15`, the paper-only EA, the closed schemas, and the accepted test fixtures.
