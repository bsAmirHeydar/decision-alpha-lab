---
title: "FP-I15 — Minimum volume rejection and maximum cap"
...
language: en
---
# Minimum volume rejection and maximum cap

## Purpose

Minimum volume rejection and maximum cap. This note is normative for the FP-I15 source release and is implemented by `fp_i15_paper`, the MQL5 contract mirror under `I15`, the paper-only EA, the closed schemas, and the accepted test fixtures.
