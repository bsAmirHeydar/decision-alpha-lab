---
title: "FP-I15 — Reprice stop and reduce size before attempt"
...
language: en
---
# Reprice stop and reduce size before attempt

## Purpose

Reprice stop and reduce size before attempt. This note is normative for the FP-I15 source release and is implemented by `fp_i15_paper`, the MQL5 contract mirror under `I15`, the paper-only EA, the closed schemas, and the accepted test fixtures.
