...
language: en
---
# Minute Contact Observation

## Purpose

Every scanned aligned minute produces LEFT_ONLY, RIGHT_ONLY, BOTH_SAME_M1, NONE, or DATA_BLOCKED.

## Boundary

The observation carries aligned-row identity and source revision hashes so replay can reproduce the classification.
