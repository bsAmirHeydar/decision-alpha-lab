...
FP-I06 has runtime authority NONE. It does not draw objects, send alerts, access a broker, calculate position size, submit orders, or call external networks.

## Boundary

Static guards inspect both Python and MQL5 for prohibited surfaces.
