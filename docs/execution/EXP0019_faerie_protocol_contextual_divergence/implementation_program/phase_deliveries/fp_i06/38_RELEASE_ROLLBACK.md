...
language: en
---
# Release, Patch, and Rollback

## Purpose

The patch owns only FP-I06 files. The file index is the sole Git staging source. Rollback removes indexed files and returns to accepted FP-I05.

## Boundary

Generated runtime evidence is retained for audit even when code is rolled back.
