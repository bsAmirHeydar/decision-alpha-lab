...
language: en
---
# Batch and Incremental Parity

## Purpose

Batch and incremental scans must consume the same ordered aligned-minute sequence and emit identical observations, HuntFact IDs, classifications, candidate IDs, and transitions.

## Boundary

The ScanCursor points to the first unprocessed M1 and is revision-bound.
