...
Operators validate FP-I05 handoff, exact hashes, relation registry, source revision, phase tests, vectors, MQL5 static checks, and MetaEditor logs.

## Boundary

A candidate is diagnostic evidence only until FP-I07 confirms it.
