...
Candidate identity includes relation instance, side plan, relation, direction, side, Hunter, Protected, first-hunt minute, hunt fact, check deadline, and source revision.

## Boundary

Visual fields, alerts, panel filters, and quota state do not belong to the raw candidate identity.
