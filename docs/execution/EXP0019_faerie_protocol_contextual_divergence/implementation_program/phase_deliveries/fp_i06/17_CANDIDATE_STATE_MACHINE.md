...
language: en
---
# Raw Candidate State Machine

## Purpose

The phase emits RAW_ACTIVE, CANCELLED_SECOND_TOUCH, INVALID_DATA, or CHECK_WINDOW_ENDED. CONFIRMED is intentionally not emitted in FP-I06.

## Boundary

Every state change is append-only through CandidateTransitionRecord.
