...
Critical failures include registry mismatch, store mismatch, selection lineage mismatch, consumed reference, duplicate aligned minute, symbol mismatch, same-M1 ambiguity, data gap, and checkpoint corruption.

## Boundary

The phase fails closed and preserves exact reason codes.
