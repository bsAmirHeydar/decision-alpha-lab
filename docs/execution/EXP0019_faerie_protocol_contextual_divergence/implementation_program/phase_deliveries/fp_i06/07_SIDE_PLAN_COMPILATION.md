...
language: en
---
# HIGH and LOW Side Plans

## Purpose

Each relation instance produces one HIGH side plan and one LOW side plan using the two symbol-local references from the source window.

## Boundary

The two prices are never merged, normalized into one level, or substituted across symbols.
