...
A one-sided LOW hunt creates a BULLISH raw candidate. A one-sided HIGH hunt creates a BEARISH raw candidate.

## Boundary

Direction is derived from side and is validated as an invariant in Python, schemas, MQL5, and tests.
