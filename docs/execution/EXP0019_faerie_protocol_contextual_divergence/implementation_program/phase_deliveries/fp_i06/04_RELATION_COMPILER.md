...
The compiler consumes one FP-I05 store snapshot, one calendar-day selection, one anchor trading date, and an exact registry hash.

## Boundary

It emits immutable relation instances and separate HIGH/LOW side plans. Compilation is pure and repeatable.
