...
language: en
---
# Same-M1 Symmetric Ambiguity

## Purpose

When both symbols contact their own corresponding side during the same M1, the engine emits SYMMETRIC_SAME_M1 and no raw candidate.

## Boundary

It is forbidden to use tick order, array order, symbol order, or registry order to invent a Hunter.
