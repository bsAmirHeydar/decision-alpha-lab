...
Checkpoint acceptance requires exact phase version, config hash, source revision, compiler report hash, and payload hash.

## Boundary

Mismatch causes deterministic rebuild; checkpoints are never migrated by inference.
