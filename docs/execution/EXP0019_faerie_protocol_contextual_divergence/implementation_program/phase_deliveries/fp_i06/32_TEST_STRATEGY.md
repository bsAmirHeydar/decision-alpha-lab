...
Tests cover registry, contracts, compilation, hunt facts, classification, lifecycle, identity, checkpoint, revision, performance, schemas, MQL5, and authority boundaries.

## Boundary

Every semantic branch has positive and negative fixtures. Synthetic fixtures prove implementation semantics, not market edge.
