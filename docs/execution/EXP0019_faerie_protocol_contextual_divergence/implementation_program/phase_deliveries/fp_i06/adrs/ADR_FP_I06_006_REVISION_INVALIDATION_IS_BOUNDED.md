...
language: en
---
# ADR — Revision Invalidation Is Bounded
...
Only relation plans overlapping a changed reference window, check window, or M1 minute are invalidated.

## Rationale

Full-history rescans are unnecessary and would harm performance and evidence locality.
