...
Golden vectors prove exact relation count, side-plan count, bearish candidate classification, same-M1 symmetry, and WW deferral.

## Boundary

Vector regeneration is allowed only after reviewed behavior changes and version update.
