...
The classifier stops at the first decisive semantic minute: one-sided contact, same-M1 symmetric contact, or data blocker.

## Boundary

No later minute may rewrite which minute was first. A changed source revision requires invalidation and deterministic rebuild.
