...
Every historical N calendar offset has its own relation instance and candidate identity. Several NA/NL/NN candidates may coexist in one session.

## Boundary

Calendar offset does not imply quality or priority. Pair-session arbitration is deferred to FP-I09.
