...
Seventy closed reason codes cover normal outcomes, compilation blockers, data blockers, identity failures, lifecycle transitions, revision, and checkpoint validation.

## Boundary

Free-text-only failures are forbidden. Operator text may accompany but cannot replace the code.
