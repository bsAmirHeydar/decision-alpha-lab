...
Repeated scans of identical source rows produce identical identities and must not create a second semantic candidate.

## Boundary

Persistent ledger-level deduplication is completed in FP-I09; I06 guarantees deterministic IDs.
