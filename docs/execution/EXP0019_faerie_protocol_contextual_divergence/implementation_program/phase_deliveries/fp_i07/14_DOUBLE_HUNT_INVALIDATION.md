---
title: "FP-I07 — Protected touch before close terminally cancels"
...
language: en
---
# Protected touch before close terminally cancels

## Purpose

Protected touch before close terminally cancels. This note is normative for FP-I07 and is implemented by the Python package `fp_i07_confirmation`, the MQL5 mirror under `I07`, the closed JSON schemas, and the phase tests.
