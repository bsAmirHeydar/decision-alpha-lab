---
title: "FP-I07 — Layered architecture from FP-I06 candidates to immutable signals"
...
language: en
---
# Layered architecture from FP-I06 candidates to immutable signals

## Purpose

Layered architecture from FP-I06 candidates to immutable signals. This note is normative for FP-I07 and is implemented by the Python package `fp_i07_confirmation`, the MQL5 mirror under `I07`, the closed JSON schemas, and the phase tests.
