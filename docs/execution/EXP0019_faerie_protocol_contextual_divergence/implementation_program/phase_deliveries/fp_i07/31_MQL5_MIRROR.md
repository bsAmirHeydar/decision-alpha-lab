---
title: "FP-I07 — Header composition and diagnostic entrypoints"
...
language: en
---
# Header composition and diagnostic entrypoints

## Purpose

Header composition and diagnostic entrypoints. This note is normative for FP-I07 and is implemented by the Python package `fp_i07_confirmation`, the MQL5 mirror under `I07`, the closed JSON schemas, and the phase tests.
