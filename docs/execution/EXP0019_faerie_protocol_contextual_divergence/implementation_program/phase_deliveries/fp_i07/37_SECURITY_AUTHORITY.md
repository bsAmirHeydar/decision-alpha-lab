---
title: "FP-I07 — No drawing, order, network, or broker authority"
...
language: en
---
# No drawing, order, network, or broker authority

## Purpose

No drawing, order, network, or broker authority. This note is normative for FP-I07 and is implemented by the Python package `fp_i07_confirmation`, the MQL5 mirror under `I07`, the closed JSON schemas, and the phase tests.
