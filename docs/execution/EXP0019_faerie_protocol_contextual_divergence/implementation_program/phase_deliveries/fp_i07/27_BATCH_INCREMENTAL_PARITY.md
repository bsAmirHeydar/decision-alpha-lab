---
title: "FP-I07 — Same target close and outcome across processing modes"
...
language: en
---
# Same target close and outcome across processing modes

## Purpose

Same target close and outcome across processing modes. This note is normative for FP-I07 and is implemented by the Python package `fp_i07_confirmation`, the MQL5 mirror under `I07`, the closed JSON schemas, and the phase tests.
