---
title: "FP-I07 — First eligible host bar containing or following candidate"
...
language: en
---
# First eligible host bar containing or following candidate

## Purpose

First eligible host bar containing or following candidate. This note is normative for FP-I07 and is implemented by the Python package `fp_i07_confirmation`, the MQL5 mirror under `I07`, the closed JSON schemas, and the phase tests.
