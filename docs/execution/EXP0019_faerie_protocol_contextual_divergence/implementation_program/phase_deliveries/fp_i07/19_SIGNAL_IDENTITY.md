---
title: "FP-I07 — Canonical identity fields and projection separation"
...
language: en
---
# Canonical identity fields and projection separation

## Purpose

Canonical identity fields and projection separation. This note is normative for FP-I07 and is implemented by the Python package `fp_i07_confirmation`, the MQL5 mirror under `I07`, the closed JSON schemas, and the phase tests.
