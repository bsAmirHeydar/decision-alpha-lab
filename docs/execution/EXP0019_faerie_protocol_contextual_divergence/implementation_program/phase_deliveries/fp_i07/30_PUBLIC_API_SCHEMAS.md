---
title: "FP-I07 — Python/MQL5 contracts and closed schemas"
...
language: en
---
# Python/MQL5 contracts and closed schemas

## Purpose

Python/MQL5 contracts and closed schemas. This note is normative for FP-I07 and is implemented by the Python package `fp_i07_confirmation`, the MQL5 mirror under `I07`, the closed JSON schemas, and the phase tests.
