---
title: "FP-I07 — Initialization-only resolution; PERIOD_CURRENT forbidden after init"
...
language: en
---
# Initialization-only resolution; PERIOD_CURRENT forbidden after init

## Purpose

Initialization-only resolution; PERIOD_CURRENT forbidden after init. This note is normative for FP-I07 and is implemented by the Python package `fp_i07_confirmation`, the MQL5 mirror under `I07`, the closed JSON schemas, and the phase tests.
