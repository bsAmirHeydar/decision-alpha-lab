---
title: "FP-I07 — Health, counters, IDs, revision, config, fixture evidence"
...
language: en
---
# Health, counters, IDs, revision, config, fixture evidence

## Purpose

Health, counters, IDs, revision, config, fixture evidence. This note is normative for FP-I07 and is implemented by the Python package `fp_i07_confirmation`, the MQL5 mirror under `I07`, the closed JSON schemas, and the phase tests.
