---
title: "FP-I00 — Code, File, and Artifact Catalog"
...
language: en
---
# Code, File, and Artifact Catalog

## Purpose

This catalog maps every public module, command, test, policy, and evidence artifact to its role and owner.

## Normative scope

- Document each Python module and PowerShell entry point.
- Document each generated JSON/CSV artifact.
- Document release metadata and Obsidian notes.

## Non-bypassable invariants

1. **Consumers use the CLI rather than importing internal filesystem assumptions.**
2. **Artifacts are machine-readable and stable.**
3. **The file index is the commit and rollback boundary.**
