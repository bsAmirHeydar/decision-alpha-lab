---
title: "FP-I00 — Handoff to FP-I01 Compatibility Harness"
...
language: en
---
# Handoff to FP-I01 Compatibility Harness

## Purpose

FP-I01 receives the exact dependency/test/ownership baseline and builds thin adapters plus differential compatibility tests.

## Normative scope

- Consume the generated dependency inventory without changing its hashes.
- Map each FP requirement to direct, adapter, pattern, or no reuse.
- Compile and execute previous-context regression fixtures before extracting any generic primitive.

## Non-bypassable invariants

1. **FP-I01 may add adapter contracts but may not alter FP-I00 evidence.**
2. **A dependency change triggers rebaseline review.**
3. **No indicator or EA product code is permitted until the context core phases reach their scheduled milestones.**
