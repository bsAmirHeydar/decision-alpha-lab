---
title: "FP-I00 — Previous-Context Compatibility Test Catalog"
...
language: en
---
# Previous-Context Compatibility Test Catalog

## Purpose

Twelve discoverable test entry points define the minimum regression surface before any shared-core integration.

## Normative scope

- Catalog EXP0017 time, reference, hunt, divergence, and visual-ledger diagnostics.
- Catalog EXP0018 time, data, hunt, confirmation, lifecycle, replay, and doctrine tests.
- Record whether MetaEditor compilation or Python execution is required.

## Non-bypassable invariants

1. **Discoverability is required in FP-I00; executable parity is expanded in FP-I01.**
2. **A missing test entry point blocks compatibility work.**
3. **The catalog records exact paths and operator commands.**
