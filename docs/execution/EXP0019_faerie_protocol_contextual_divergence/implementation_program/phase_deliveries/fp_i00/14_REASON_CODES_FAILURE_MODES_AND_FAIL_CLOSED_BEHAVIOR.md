---
title: "FP-I00 — Reason Codes, Failure Modes, and Fail-Closed Behavior"
...
language: en
---
# Reason Codes, Failure Modes, and Fail-Closed Behavior

## Purpose

Each governance failure maps to a stable code that operators and later phases can audit.

## Normative scope

- Detect missing required files, malformed source hashes, decision drift, relation drift, program drift, dependency absence, test absence, authority leakage, ownership errors, and manifest tampering.
- Separate errors from warnings and derive READY/DEGRADED/BLOCKED health.
- Preserve issue path and structured details.

## Non-bypassable invariants

1. **A missing dependency cannot be guessed.**
2. **A malformed manifest cannot be repaired by the consumer.**
3. **A forbidden runtime path blocks FP-I00 acceptance.**
