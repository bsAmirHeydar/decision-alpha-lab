---
title: "FP-I03 — Calendar Snapshot Aggregate"
...
language: en
---
# Calendar Snapshot Aggregate

## Purpose

CalendarSnapshot combines the resolved New York timestamp, trading day, segment, optional A/L/N session, week window, daily-gap bounds, health, reason code, configuration hash, and boundary-evidence hash.
