...
The suite contains unit, boundary, differential, contract, registry, schema, identity, broker-invariance, golden, negative, and authority tests. Cumulative FP and previous-context regressions are mandatory.
