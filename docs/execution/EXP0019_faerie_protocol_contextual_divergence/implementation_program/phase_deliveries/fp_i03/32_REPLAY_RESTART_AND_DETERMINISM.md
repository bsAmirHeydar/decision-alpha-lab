---
title: "FP-I03 — Replay, Restart, and Determinism"
...
language: en
---
# Replay, Restart, and Determinism

## Purpose

The kernel is stateless and pure for a fixed config and UTC instant. A restart requires no mutable checkpoint; all snapshots and window IDs are reconstructed from immutable rules.
