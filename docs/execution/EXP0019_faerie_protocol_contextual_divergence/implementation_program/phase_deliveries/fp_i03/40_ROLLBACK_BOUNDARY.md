---
title: "FP-I03 — Rollback Boundary"
...
Rollback removes only FP-I03-indexed files and restores the accepted FP-I02 state. Generated evidence is retained for audit; downstream artifacts using FP-I03 hashes become incompatible.
