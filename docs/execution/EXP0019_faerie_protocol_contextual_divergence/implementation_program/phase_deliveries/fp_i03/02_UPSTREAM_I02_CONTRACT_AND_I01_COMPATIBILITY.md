---
title: "FP-I03 — Upstream FP-I02 Contract and FP-I01 Compatibility"
...
language: en
---
# Upstream FP-I02 Contract and FP-I01 Compatibility

## Purpose

The phase consumes the frozen FP-I02 identity primitives and reuses the verified EXP0018 New York time core through a narrow MQL5 boundary. It must not rename FP-I02 enums, alter WindowKey identity fields, or mutate the shared Daye time implementation.
