---
title: "FP-I03 — Semantic Identities and Hashes"
...
language: en
---
# Semantic Identities and Hashes

## Purpose

NyTimestamp, LocalResolution, TradingDayWindow, SessionWindow, WeekWindow, BoundaryEvidence, and CalendarSnapshot receive deterministic SHA-256-derived identifiers. The same semantic input reproduces the same ID.
