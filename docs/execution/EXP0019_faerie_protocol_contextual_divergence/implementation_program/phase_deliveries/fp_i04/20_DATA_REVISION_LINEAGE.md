...
Every accepted dataset state has a parent-linked DataRevision describing INITIAL, APPEND, LATE_INSERT, VALUE_CORRECTION, DELETE, CONFLICT, or NO_CHANGE.

## Normative invariants

1. **Previous and current payload hashes are retained.**
2. **Affected range is half-open and minute aligned.**
3. **Changed symbols are unique and sorted.**
4. **Revision ID is content-addressed.**
