---
title: "Incremental Processing Model"
...
Incremental processing divides the same half-open range into non-overlapping chunks and advances a revision-bearing cursor.

## Normative invariants

1. **Chunk concatenation equals batch row sequence.**
2. **Chunk boundaries cannot duplicate minutes.**
3. **A cursor stores last emitted minute and source sequences.**
4. **Revision mismatch invalidates resume.**
