...
FP-I04 owns no broker orders, positions, chart objects, web requests, sockets, or file-based command channel.

## Normative invariants

1. **Market data is input only.**
2. **No hidden network dependency exists.**
3. **No indicator product is introduced.**
4. **Authority scanners are phase acceptance gates.**
