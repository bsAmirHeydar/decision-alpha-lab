...
The phase does not implement holiday/early-close calendars, tick-level sequencing, cross-broker reconciliation, persistent database storage, references, hunts, visuals, or execution.

## Normative invariants

1. **Holiday policy requires upstream calendar version.**
2. **Tick data cannot override M1 authority.**
3. **Persistence adapters must preserve public contracts.**
4. **FP-I05 owns aggregation and references.**
