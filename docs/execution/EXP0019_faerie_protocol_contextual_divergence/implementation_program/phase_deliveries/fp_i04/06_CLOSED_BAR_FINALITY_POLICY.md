---
title: "Closed-Bar Finality Policy"
...
language: en
---
# Closed-Bar Finality Policy

## Purpose

Provisional bars may exist at an acquisition edge but cannot enter the canonical synchronization result used by later references and hunts.

## Normative invariants

1. **Closed-only is the canonical profile.**
2. **A provisional bar is rejected with a closed reason code.**
3. **No later phase may silently reinterpret finality.**
4. **Live tick data can enrich telemetry but not rewrite historical M1 authority.**
