---
title: "ADR — UTC M1 Open Is the Sole Alignment Key"
status: accepted
date: 2026-07-13
phase: FP-I04
---
# UTC M1 Open Is the Sole Alignment Key

## Decision

Two bars align only when their canonical UTC minute-open timestamps are equal. Broker index, receipt order, formatted local time, and nearest-neighbor matching are rejected.
