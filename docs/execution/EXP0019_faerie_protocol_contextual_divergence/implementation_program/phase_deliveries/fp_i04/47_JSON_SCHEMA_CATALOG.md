...
Fifteen closed Draft 2020-12 schemas mirror all public contracts used for manifests, vectors, checkpoints, and cross-language validation.

## Normative invariants

1. **Top-level additionalProperties is false.**
2. **Hashes use lowercase SHA-256 patterns.**
3. **Enums are closed.**
4. **Schema IDs are versioned phase URLs.**
