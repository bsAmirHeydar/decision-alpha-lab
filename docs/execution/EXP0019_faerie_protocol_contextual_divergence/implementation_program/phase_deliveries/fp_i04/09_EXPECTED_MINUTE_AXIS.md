...
language: en
---
# Expected Minute Axis

## Purpose

The requested half-open UTC range is expanded into M1 opens. The canonical session-only profile emits only minutes whose FP-I03 segment is A, L, or N.

## Normative invariants

1. **Axis is strictly ascending and unique.**
2. **Daily gap and weekend are calendar exclusions, not missing bars.**
3. **An all-requested profile exists for diagnostics.**
4. **Axis policy is part of synchronizer identity.**
