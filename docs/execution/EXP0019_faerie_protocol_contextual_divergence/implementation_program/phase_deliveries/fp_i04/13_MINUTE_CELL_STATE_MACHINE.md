---
title: "Minute Cell State Machine"
...
language: en
---
# Minute Cell State Machine

## Purpose

For each symbol and expected minute, the cell is PRESENT, MISSING, OUT_OF_COVERAGE, CONFLICT, or REVISED.

## Normative invariants

1. **PRESENT and REVISED carry a bar.**
2. **Other states never carry a bar.**
3. **REVISED requires comparison against previous accepted data.**
4. **State and reason are persisted in row identity.**
