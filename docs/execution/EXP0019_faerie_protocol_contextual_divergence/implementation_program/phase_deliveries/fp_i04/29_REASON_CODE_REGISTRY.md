...
Thirty closed data reason codes cover validation, duplicate, cell, coverage, synchronization, revision, backfill, cursor, calendar, and symbol failures.

## Normative invariants

1. **Free-text-only failure is forbidden.**
2. **Reason registry version is recorded.**
3. **Unknown reason is a schema/contract failure.**
4. **UI may translate text but cannot rewrite codes.**
