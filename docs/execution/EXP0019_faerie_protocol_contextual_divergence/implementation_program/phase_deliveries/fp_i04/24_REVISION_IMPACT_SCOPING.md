...
language: en
---
# Revision Impact Scoping

## Purpose

RevisionImpact records affected minute IDs, dependent window IDs, unchanged prefix hash, and changed suffix hash.

## Normative invariants

1. **No global invalidation is allowed without explicit policy.**
2. **FP-I05 supplies actual dependent window IDs.**
3. **Impact lists are canonical and deduplicated.**
4. **Empty NO_CHANGE impact is valid.**
