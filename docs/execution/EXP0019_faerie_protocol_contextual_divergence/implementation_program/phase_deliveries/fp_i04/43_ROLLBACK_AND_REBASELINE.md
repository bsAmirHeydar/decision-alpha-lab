...
language: en
---
# Rollback and Rebaseline

## Purpose

Rollback removes only FP-I04-indexed implementation files and restores FP-I03 as the accepted boundary. Rebaseline is required for intentional semantic changes.

## Normative invariants

1. **Persisted evidence is retained.**
2. **Old checkpoints remain versioned but incompatible.**
3. **Rebaseline updates vectors, registries, docs, and hashes together.**
4. **Unrelated working-tree changes remain untouched.**
