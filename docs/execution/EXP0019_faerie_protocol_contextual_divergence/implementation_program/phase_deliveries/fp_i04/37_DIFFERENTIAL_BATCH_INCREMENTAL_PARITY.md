---
title: "Differential Batch/Incremental Parity"
...
language: en
---
# Differential Batch/Incremental Parity

## Purpose

The complete batch sequence is compared against concatenated incremental chunks across multiple boundaries.

## Normative invariants

1. **Open times match exactly.**
2. **Bar hashes match exactly.**
3. **No boundary duplicate exists.**
4. **Revision/cursor evidence explains differences in processing path.**
