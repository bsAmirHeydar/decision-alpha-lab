...
Golden fixtures include complete pair data, internal missing minute, duplicate conflict, and value correction with revision impact.

## Normative invariants

1. **Fixture inputs and expected hashes are versioned.**
2. **Golden changes require reviewed semantic change.**
3. **Synthetic fixtures prove contracts, not market edge.**
4. **Conformance report references fixture identities.**
