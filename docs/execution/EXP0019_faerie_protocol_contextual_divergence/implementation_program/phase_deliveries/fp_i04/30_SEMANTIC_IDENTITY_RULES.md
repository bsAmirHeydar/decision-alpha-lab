...
Semantic IDs cover pair metadata, calendar config, synchronization policy, bar semantics, expected range, aligned rows, gaps, conflicts, and revision lineage.

## Normative invariants

1. **Transport order does not affect IDs.**
2. **Price or source revision changes IDs.**
3. **Calendar policy changes IDs.**
4. **Visual styling never enters data identity.**
