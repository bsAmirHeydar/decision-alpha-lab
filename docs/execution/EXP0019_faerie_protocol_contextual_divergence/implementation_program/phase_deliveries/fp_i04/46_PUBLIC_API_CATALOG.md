...
The Python API exposes SymbolResolver, normalize_bars, synchronize, minute_axis, snapshot_from_result, coverage/gap utilities, revision classification/impact, cursor functions, backfill planning, and registries.

## Normative invariants

1. **Imports are explicit through fp_i04_data.**
2. **Public contracts are immutable dataclasses.**
3. **Exact version is 1.0.0.**
4. **Unknown behavior requires a new contract/version.**
