---
title: "Bounded Repair and Performance"
...
language: en
---
# Bounded Repair and Performance

## Purpose

Repair is limited by maximum_backfill_minutes and incremental cursors so live operation cannot rescan unbounded history on every tick.

## Normative invariants

1. **Semantic processing is never skipped for speed.**
2. **Only affected ranges are recomputed.**
3. **Counters expose input, deduplicated, emitted, gap, and revised minutes.**
4. **Performance degradation cannot fabricate completeness.**
