...
---
# A/L/N Session Aggregation

## Purpose

Specifies deterministic OHLC aggregation, earliest tie-breaking for equal highs/lows, active/completed states, and symbol-local preservation.
