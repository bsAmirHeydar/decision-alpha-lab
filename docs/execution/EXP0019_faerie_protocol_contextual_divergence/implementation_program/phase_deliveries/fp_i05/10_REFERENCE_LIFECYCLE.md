...
---
# Reference Lifecycle and Protected Consumption

## Purpose

Defines FRESH → HUNTER_SEEN as non-consuming and FRESH/HUNTER_SEEN → CONSUMED_BY_PROTECTED_TOUCH as the only consumption path.
