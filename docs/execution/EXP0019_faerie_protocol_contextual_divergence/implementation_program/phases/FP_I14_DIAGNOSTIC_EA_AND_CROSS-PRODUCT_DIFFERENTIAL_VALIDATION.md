...
language: en
---
# FP-I14 — Diagnostic EA and Cross-Product Differential Validation

## Mission

Build a non-trading EA that runs the exact engine, exports high-volume traces, and proves the indicator and EA produce identical semantic events and IDs.
...
- diagnostic EA entry point
- trace exporter
- indicator-vs-EA differential comparator
- stress/reconnect scenarios
- health dashboard

## Explicit non-goals

- No order APIs
- No separate detector
- No paper assumptions
