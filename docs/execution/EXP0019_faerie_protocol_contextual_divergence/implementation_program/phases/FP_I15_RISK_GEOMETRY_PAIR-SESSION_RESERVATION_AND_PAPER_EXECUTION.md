...
language: en
---
# FP-I15 — Risk Geometry, Pair-Session Reservation, and Paper Execution

## Mission

Add deterministic execution planning and synthetic execution only after indicator/diagnostic parity. Use one-spread SELL stop adjustment and explicit test quota-consumption profiles.
...
- setup-to-plan adapter
- stop/target geometry
- spread snapshot
- fixed-dollar risk sizing
- atomic reservation
- paper orders/fills/rejections
- reconciliation ledger

## Explicit non-goals

- No live broker adapter
- No permanent canonical FP-DEC-012 rule
- No alteration of raw signals
...
- [ ] The complete indicator release and diagnostic cross-product parity are accepted.
...
- [ ] maximum loss respects risk cap.
- [ ] SELL spread included in stop/risk.
- [ ] only earliest pair-session winner reserves.
- [ ] paper lifecycle is fully reason-coded.
