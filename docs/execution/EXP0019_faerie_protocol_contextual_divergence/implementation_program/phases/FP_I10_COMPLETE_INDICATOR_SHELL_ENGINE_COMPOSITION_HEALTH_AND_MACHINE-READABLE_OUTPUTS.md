---
title: "FP-I10 — Complete Indicator Shell, Engine Composition, Health, and Machine-Readable Outputs"
...
language: en
---
# FP-I10 — Complete Indicator Shell, Engine Composition, Health, and Machine-Readable Outputs

## Mission

Create the production indicator entry point and compose the shared FP engine without visual duplication or trade authority.
...
- indicator OnInit/OnCalculate/OnTimer/OnChartEvent/OnDeinit shell
- input validation
- symbol subscription
- engine lifecycle
- health state
- optional state buffers
...
- [ ] indicator initializes only with valid manifest/data policy.
- [ ] no order imports.
- [ ] two instances do not collide.
- [ ] buffer/state outputs match engine snapshot.
