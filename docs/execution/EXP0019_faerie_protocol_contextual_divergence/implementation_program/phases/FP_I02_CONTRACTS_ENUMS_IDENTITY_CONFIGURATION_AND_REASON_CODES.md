---
title: "FP-I02 — Contracts, Enums, Identity, Configuration, and Reason Codes"
...
language: en
---
# FP-I02 — Contracts, Enums, Identity, Configuration, and Reason Codes

## Mission

Implement the context’s closed type system before runtime behavior: windows, references, relations, hunts, candidates, signals, WW, quota, rendering, health, IDs, and configuration hashing.
...
- Enums and structs
- semantic versus projection configuration hashes
- relation registry
- reason-code registry
- signal/window/reference/object IDs
- manifest and version headers
...
- [ ] Canonical IDs repeat exactly.
- [ ] behavior-axis change alters semantic hash.
- [ ] style-only change preserves signal IDs.
- [ ] unknown enum/state rejected.
