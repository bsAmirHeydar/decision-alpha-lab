...
---
type: source_card
source_path: "lab/03_experiments/EXP0013_astro_feature_store/ASTRO_OSCILLATOR_COMPILE_FIX_AND_FRACTAL_PLAN.md"
source_ext: ".md"
source_size: 4014
empty: false
generated_at: 2026-07-06
concepts: ["AI Agent Layer", "Astro ML", "Execution / Risk", "MQL Native", "Path Smoothness", "UI / React", "Validation / Audit"]
entities: ["EXP0013"]
---

# Source Card — ASTRO_OSCILLATOR_COMPILE_FIX_AND_FRACTAL_PLAN.md
...
The first oscillator version used non-standard plot declarations: Some MQL5 builds reject this syntax with: The corrected indicator now uses standard MQL5 indicator properties: This is the supported MQL5 format and should compile normally. Current file: It plots the Level 1 raw axes: Default compact mode shows only: The current oscillator is intentionally simple. The next professional version should be fractal: The goal is not to predict direction directly. The goal is to understand the **quality of M1 movement**: Bodies: Purpose: Potential features: Interpretation for M1: Macro does not time entries. It gives the background environment. Bodies: Purpose: Potential features: Interpretation for M1: This layer is the main path-quality layer for breakout and continuation. Bodies: Purpose: Potential features: Interpretation for M1: This is the most important timing layer for one-minute path b
...
- [[docs/evidence/exp0013_astro_dashboard_layout_cleanup/fdcb3b9b6858_ASTRO_DASHBOARD_V4_LAYOUT_CLEANUP_GUIDE|ASTRO_DASHBOARD_V4_LAYOUT_CLEANUP_GUIDE.md]] — score `16`
