...
This document is retained as implementation history only. Do not use `FlagCountingVNextExperiment.mq5` for new work. The active implementation path is: The active source of truth is: Older vNext notes may help explain past design attempts, but they are not authoritative for current Phoenix patches.
