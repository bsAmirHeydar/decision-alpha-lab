...
concepts: ["Decision Node", "Execution / Risk", "Flag Counting", "Hook", "Validation / Audit"]
entities: []
---

# Source Card — README_IMPLEMENTATION_LADDER_V1.md
...
The Phoenix implementation ladder lives under: Use it together with the current canon: The experiment rule is: Current implementation order: A patch must declare the highest layer it touches and provide acceptance evidence for that layer.

## Concepts

[[docs/obsidian_deep/02_concepts/Decision_Node|Decision Node]], [[docs/obsidian_deep/02_concepts/Execution____Risk|Execution / Risk]], [[docs/obsidian_deep/02_concepts/Flag_Counting|Flag Counting]], [[docs/obsidian_deep/02_concepts/Hook|Hook]], [[docs/obsidian_deep/02_concepts/Validation____Audit|Validation / Audit]]
