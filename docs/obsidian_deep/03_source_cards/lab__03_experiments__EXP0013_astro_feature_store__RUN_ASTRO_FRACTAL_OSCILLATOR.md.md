...
---
type: source_card
source_path: "lab/03_experiments/EXP0013_astro_feature_store/RUN_ASTRO_FRACTAL_OSCILLATOR.md"
source_ext: ".md"
source_size: 1185
empty: false
...
# Source Card — RUN_ASTRO_FRACTAL_OSCILLATOR.md
...
Also compile the raw-axis version if needed: Check the Experts/Journal tab. The loader tries these locations: If the CSV is not loaded, the indicator still loads and draws a diagnostic zero line instead of disappearing silently. For most M1 observation: For compact roulette/jackpot read: For root-cause breakdown:
