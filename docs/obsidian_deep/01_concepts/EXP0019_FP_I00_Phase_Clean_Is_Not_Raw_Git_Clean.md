---
title: "EXP0019 FP I00 Phase Clean Is Not Raw Git Clean"
...
language: en
---
# EXP0019 FP I00 Phase Clean Is Not Raw Git Clean

## Definition

A patch-owned working tree can be raw-dirty but phase-clean. The harness separates owned changed paths from unrelated changes so governance does not confuse expected patch files with accidental edits.
