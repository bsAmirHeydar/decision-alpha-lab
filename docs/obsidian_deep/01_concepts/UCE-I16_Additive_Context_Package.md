---
title: "Additive Context Package"
tags: [atomic-concept, uce-i16]
status: canonical
doc_version: 1.0.0
---
# Additive Context Package

## Definition
Additive Context Package is a first-class governance and runtime concept in the UCE-I16 onboarding factory. It is represented by an explicit machine-readable field or artifact and cannot be inferred from comments or naming conventions.
