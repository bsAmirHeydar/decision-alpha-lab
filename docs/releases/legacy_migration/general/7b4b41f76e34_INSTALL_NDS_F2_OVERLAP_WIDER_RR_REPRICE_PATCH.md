...
```powershell
git add -- `
  "docs/releases/legacy_migration/general/7b4b41f76e34_INSTALL_NDS_F2_OVERLAP_WIDER_RR_REPRICE_PATCH.md" `
  "docs/evidence/nds_f2_overlap_wider_minimum_rr_entry_repricing_audit/82e0306d3778_NDS_F2_OVERLAP_WIDER_RR_REPRICE_AUDIT_REPORT.md" `
