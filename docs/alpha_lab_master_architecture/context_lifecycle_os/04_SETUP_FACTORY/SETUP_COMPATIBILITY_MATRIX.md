---
title: Setup Compatibility Matrix
...
This contract binds schema, registry, generator, Context and Treatment versions. It is part of ACL-04 and therefore operates only after an exact `ACL03_TO_ACL04` handoff has been validated.

## Ownership and authority boundary

Breaking behavior or required-field changes require a major version, impact analysis, historical-fixture replay and rollback.
...
exact semantic versions and declared supported ranges. Every material input carries an exact identity, semantic version and SHA-256 digest. Missing or ambiguous identities are blockers, not warnings.

## Produced artifacts

compatibility decision with migration or rejection reason. Structured JSON is authoritative. Obsidian notes are generated or reviewed projections and cannot mutate behavior.
