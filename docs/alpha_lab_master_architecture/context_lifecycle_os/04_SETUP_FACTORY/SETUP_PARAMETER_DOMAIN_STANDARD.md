---
title: Setup Parameter Domain Standard
status: accepted-reference
version: 1.0.0
updated: 2026-07-18
tags: [acl-os, acl-04, setup-factory]
---
# Setup Parameter Domain Standard

## Purpose

This contract freezes finite and reviewable parameter values before AI enumeration. It is part of ACL-04 and therefore operates only after an exact `ACL03_TO_ACL04` handoff has been validated.

## Ownership and authority boundary

Empty, infinite, undeclared, non-finite or dynamically expanded domains are rejected. Domain changes create a new authority revision.
...
named parameter domains inside Search Authority. Every material input carries an exact identity, semantic version and SHA-256 digest. Missing or ambiguous identities are blockers, not warnings.

## Produced artifacts

deterministic finite combinations and exposure accounting. Structured JSON is authoritative. Obsidian notes are generated or reviewed projections and cannot mutate behavior.
