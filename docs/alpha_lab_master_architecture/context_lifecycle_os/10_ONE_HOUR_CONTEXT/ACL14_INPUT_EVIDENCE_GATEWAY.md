---
title: Acl14 Input Evidence Gateway
status: accepted-reference
version: 1.0.0
updated: 2026-07-18
tags: [acl-os, acl-14, first-real-context-pilot]
---
# Acl14 Input Evidence Gateway

## Purpose

Verifies the complete ACL-13 package, receipt, manifest, handoff, event chain and provenance before any pilot contract is authored.
