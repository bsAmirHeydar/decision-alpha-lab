---
title: ACL-06 Resource Accounting
status: accepted-reference
version: 1.0.0
updated: 2026-07-18
tags: [acl-os, acl-06]
---
# ACL-06 Resource Accounting

## Purpose

Every successful task charges deterministic CPU, memory and output units against the frozen budget. Budget expansion during the run is forbidden.
