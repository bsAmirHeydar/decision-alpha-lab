---
title: ACL-06 Event and Provenance
status: accepted-reference
version: 1.0.0
updated: 2026-07-18
tags: [acl-os, acl-06]
---
# ACL-06 Event and Provenance

## Purpose

The run event ledger is hash chained and the provenance graph reaches the exact frozen Batch, DAG, result bundle and object index.
