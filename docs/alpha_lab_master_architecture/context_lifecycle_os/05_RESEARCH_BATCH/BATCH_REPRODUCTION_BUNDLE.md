---
title: Batch Reproduction Bundle
status: accepted-reference
version: 1.0.0
updated: 2026-07-18
tags: [acl-os, acl-05, research-batch]
---
# Batch Reproduction Bundle

## Purpose

Specifies the minimum evidence needed to reproduce and audit a Batch.

## Contract model

It includes upstream binding, frozen candidate/search sets, dataset bytes, labels, split, environment, budget, CAS index, events, provenance, manifests, receipts and handoff.

## Failure semantics

A notebook, report or result table alone is not a reproduction bundle.
...
[[BATCH_MANIFEST_STANDARD]], [[CACHE_IDEMPOTENCY_AND_REPLAY]], [[BATCH_SECURITY_AND_ISOLATION]]
