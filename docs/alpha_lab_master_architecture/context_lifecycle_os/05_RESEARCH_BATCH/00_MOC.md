---
title: ACL-05 Research Batch — Map of Content
status: accepted-reference
version: 1.0.0
updated: 2026-07-18
tags: [acl-os, acl-05, research-batch]
---
# ACL-05 Research Batch — Map of Content

## Purpose

Navigation and authority map for immutable research batches.

## Contract model

The machine artifacts, policies, implementation notes and atomic concepts are linked from one canonical entry point.

## Failure semantics

Fragmented navigation, stale links and competing definitions create hidden semantic forks.
...
[[ACL_05_IMMUTABLE_BATCH_AND_STORE]], [[IMMUTABLE_RESEARCH_BATCH]], [[CONTENT_ADDRESSED_ARTIFACT_STORE]], [[BATCH_FREEZE_PROTOCOL]]
