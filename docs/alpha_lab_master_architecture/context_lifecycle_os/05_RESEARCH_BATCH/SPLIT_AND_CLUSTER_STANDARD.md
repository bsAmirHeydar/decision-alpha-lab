---
title: Split and Cluster Standard
status: accepted-reference
version: 1.0.0
updated: 2026-07-18
tags: [acl-os, acl-05, research-batch]
---
# Split and Cluster Standard

## Purpose

Defines purged walk-forward partitions and cluster-aware evaluation boundaries.

## Contract model

Train, validation and test are temporally ordered; purge and embargo are positive; transformations fit on train only; cluster keys are explicit.

## Failure semantics

Random row splits, overlapping windows and all-data normalization are rejected.
...
[[DATASET_SNAPSHOT_AND_CUT]], [[BATCH_DAG_ORCHESTRATOR]], [[TASK_REGISTRY_AND_CONTRACT]]
