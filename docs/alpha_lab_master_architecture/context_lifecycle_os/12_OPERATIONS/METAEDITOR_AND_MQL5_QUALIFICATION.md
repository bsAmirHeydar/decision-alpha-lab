---
title: MetaEditor and MQL5 Qualification
status: proposed-reference
version: 1.0.0
updated: 2026-07-17
tags: [acl-os, context-lifecycle]
---
# MetaEditor and MQL5 Qualification

Builds compile matrices and differential replay evidence on actual Windows terminals.

## Responsibility boundary

This component owns a narrow part of promotion, runtime custody, fleet operation, surveillance and recovery. It communicates through versioned contracts and immutable references. It may not infer adjacent authority, reach into private implementation folders, or create an alternative identity, security or evidence system.
