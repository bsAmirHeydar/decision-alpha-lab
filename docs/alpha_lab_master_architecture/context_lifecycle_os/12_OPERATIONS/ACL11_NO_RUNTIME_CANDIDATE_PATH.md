---
title: Acl11 No Runtime Candidate Path
status: accepted-reference
version: 1.0.0
updated: 2026-07-18
tags: [acl-os, acl-11, runtime, custody]
---
# Acl11 No Runtime Candidate Path

Specifies the required behavior when upstream contains zero runtime candidates: no generation, no signing and no activation.
