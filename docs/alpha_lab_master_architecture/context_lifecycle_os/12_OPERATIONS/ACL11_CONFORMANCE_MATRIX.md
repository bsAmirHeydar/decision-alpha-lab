---
title: Acl11 Conformance Matrix
status: accepted-reference
version: 1.0.0
updated: 2026-07-18
tags: [acl-os, acl-11, runtime, custody]
---
# Acl11 Conformance Matrix

Defines test-vector and parity-case evidence. The reference matrix contains zero cases because there are no candidates.
