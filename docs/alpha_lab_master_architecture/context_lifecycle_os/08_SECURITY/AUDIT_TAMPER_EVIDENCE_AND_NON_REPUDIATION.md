---
title: Audit, Tamper Evidence and Non-Repudiation
status: proposed-reference
version: 1.0.0
updated: 2026-07-17
tags: [acl-os, context-lifecycle]
---
# Audit, Tamper Evidence and Non-Repudiation

Creates complete append-only records for privileged actions, decisions and artifact transitions.

## Responsibility boundary

This component owns a narrow part of defense-in-depth protection of code, data, models, intellectual property and capital. It communicates through versioned contracts and immutable references. It may not infer adjacent authority, reach into private implementation folders, or create an alternative identity, security or evidence system.
