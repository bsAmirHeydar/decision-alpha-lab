---
title: "Security-Restricted Precedence"
...
---
# Security-Restricted Precedence

Order, network, secret, subprocess and dynamic-code indicators force SECURITY_RESTRICTED unless a later reviewed policy proves a safer classification.
