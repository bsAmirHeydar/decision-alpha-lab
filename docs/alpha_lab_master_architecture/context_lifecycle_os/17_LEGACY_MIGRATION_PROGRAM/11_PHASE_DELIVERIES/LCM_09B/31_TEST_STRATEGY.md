...
Direct tests cover package contracts, evaluator ordering, known-time guards, adapter denial, Factory authority, parity, restart, schemas, static boundaries and full-package verification.
