...
- `registry/legacy_context_migration/lcm_09b/schemas/v1/`: closed machine contracts;
- `registry/legacy_context_migration/lcm_09b/policies/v1/`: versioned non-negotiable policy records;
- `registry/legacy_context_migration/setup_package_migrations/<migration_id>/`: immutable generated phase evidence.
