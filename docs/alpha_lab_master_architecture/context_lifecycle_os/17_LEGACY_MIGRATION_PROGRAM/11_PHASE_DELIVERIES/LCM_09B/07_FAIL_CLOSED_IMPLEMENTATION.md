---
title: "LCM-09B — Fail-Closed Implementation"
...
A package with mandatory UNKNOWN or an upstream implementation denial is non-executable and returns a first-class BLOCKED/no-trade decision.
