...
```text
python -m tools.strategy_factory.lcm.lcm_09b.cli build
python -m tools.strategy_factory.lcm.lcm_09b.cli verify-package
python -m tools.strategy_factory.lcm.lcm_09b.cli verify-installation
python -m tools.strategy_factory.lcm.lcm_09b.cli qa
python -m tools.strategy_factory.lcm.lcm_09b.cli validate-schemas
python -m tools.strategy_factory.lcm.lcm_09b.cli static-validate
```
