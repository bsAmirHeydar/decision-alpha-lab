...
The patch covers canonical reference package materialization, translation-only adapter declarations, research-only Factory exposure, parity disposition, blocker preservation, restart contracts and Treatment dependency seeding.
