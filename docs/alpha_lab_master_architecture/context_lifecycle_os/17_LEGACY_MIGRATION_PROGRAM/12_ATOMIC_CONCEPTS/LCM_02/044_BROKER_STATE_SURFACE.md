...
---
# Broker State Surface

## Definition

`BROKER_STATE_SURFACE` is a closed LCM-02 governance concept used to classify survey evidence without approving domain semantics.
