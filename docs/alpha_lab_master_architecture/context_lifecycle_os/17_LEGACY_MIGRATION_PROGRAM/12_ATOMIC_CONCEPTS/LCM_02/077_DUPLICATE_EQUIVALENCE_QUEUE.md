---
title: "Duplicate Equivalence Queue"
...
---
# Duplicate Equivalence Queue

## Definition

`DUPLICATE_EQUIVALENCE_QUEUE` is a closed LCM-02 governance concept used to classify survey evidence without approving domain semantics.
