...
---
# Lcm03 Forbidden Action

## Definition

`LCM03_FORBIDDEN_ACTION` is a closed LCM-02 governance concept used to classify survey evidence without approving domain semantics.
