...
---
# Lcm03 Allowed Action

## Definition

`LCM03_ALLOWED_ACTION` is a closed LCM-02 governance concept used to classify survey evidence without approving domain semantics.
