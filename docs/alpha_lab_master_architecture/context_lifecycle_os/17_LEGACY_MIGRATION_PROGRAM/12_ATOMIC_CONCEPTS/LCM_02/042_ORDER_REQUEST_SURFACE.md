...
---
# Order Request Surface

## Definition

`ORDER_REQUEST_SURFACE` is a closed LCM-02 governance concept used to classify survey evidence without approving domain semantics.
