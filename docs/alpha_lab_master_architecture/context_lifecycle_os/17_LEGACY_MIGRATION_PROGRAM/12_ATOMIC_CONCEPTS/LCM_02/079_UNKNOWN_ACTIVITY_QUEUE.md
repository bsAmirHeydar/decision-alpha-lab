...
---
# Unknown Activity Queue

## Definition

`UNKNOWN_ACTIVITY_QUEUE` is a closed LCM-02 governance concept used to classify survey evidence without approving domain semantics.
