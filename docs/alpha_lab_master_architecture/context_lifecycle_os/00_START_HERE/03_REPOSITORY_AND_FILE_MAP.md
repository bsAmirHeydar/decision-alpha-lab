...
- `docs/alpha_lab_master_architecture/context_lifecycle_os/`: architecture, ADRs, templates and runbooks.
- `registry/acl_os/`: public schemas, catalogs, policies and compatibility metadata.
