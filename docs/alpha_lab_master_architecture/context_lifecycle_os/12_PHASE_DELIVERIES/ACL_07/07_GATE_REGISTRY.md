---
title: ACL-07 — Gate Registry
status: accepted-reference
version: 1.0.0
updated: 2026-07-18
tags: [acl-os, acl-07, validation]
---
# ACL-07 — Gate Registry

## Purpose

This note specifies gate registry for the accepted ACL-07 reference implementation. It is written as an operational Obsidian artifact rather than a superficial code summary.
