---
title: ACL-01 — Canonical Path Templates
status: accepted-reference-implementation
version: 1.0.0
updated: 2026-07-17
tags: [acl-os, acl-01, repository, identity, lineage]
---
# ACL-01 — Canonical Path Templates

## Purpose

Produces deterministic paths for future artifacts while retaining explicit aliases for legacy locations.
