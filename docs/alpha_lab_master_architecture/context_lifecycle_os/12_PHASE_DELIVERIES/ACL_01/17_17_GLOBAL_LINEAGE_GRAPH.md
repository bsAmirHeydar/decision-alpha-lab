---
title: ACL-01 — Global Lineage Graph
status: accepted-reference-implementation
version: 1.0.0
updated: 2026-07-17
tags: [acl-os, acl-01, repository, identity, lineage]
---
# ACL-01 — Global Lineage Graph

## Purpose

Records derivation, generation, validation, promotion, migration, documentation and supersession edges.
