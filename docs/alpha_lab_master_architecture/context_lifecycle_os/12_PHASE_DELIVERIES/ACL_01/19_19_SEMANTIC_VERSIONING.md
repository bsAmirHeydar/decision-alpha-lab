---
title: ACL-01 — Semantic Versioning
status: accepted-reference-implementation
version: 1.0.0
updated: 2026-07-17
tags: [acl-os, acl-01, repository, identity, lineage]
---
# ACL-01 — Semantic Versioning

## Purpose

Defines compatible minor evolution, breaking major evolution and deterministic range resolution.
