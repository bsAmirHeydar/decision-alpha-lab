---
title: ACL-01 — Legacy Path Adoption
status: accepted-reference-implementation
version: 1.0.0
updated: 2026-07-17
tags: [acl-os, acl-01, repository, identity, lineage]
---
# ACL-01 — Legacy Path Adoption

## Purpose

Defines non-destructive registration and migration of existing SAED, UCEE and Strategy Factory artifacts.
