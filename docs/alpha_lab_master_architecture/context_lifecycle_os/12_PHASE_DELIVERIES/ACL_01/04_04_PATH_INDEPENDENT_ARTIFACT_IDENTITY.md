---
title: ACL-01 — Path-Independent Artifact Identity
status: accepted-reference-implementation
version: 1.0.0
updated: 2026-07-17
tags: [acl-os, acl-01, repository, identity, lineage]
---
# ACL-01 — Path-Independent Artifact Identity

## Purpose

Separates immutable logical identity from mutable storage location and display name.
