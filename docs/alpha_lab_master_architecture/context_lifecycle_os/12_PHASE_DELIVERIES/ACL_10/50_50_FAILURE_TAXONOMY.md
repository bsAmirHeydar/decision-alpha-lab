---
title: ACL-10 — 50 Failure Taxonomy
status: accepted-reference
version: 1.0.0
updated: 2026-07-18
tags: [acl-os, acl-10, promotion]
---
# ACL-10 — 50 Failure Taxonomy

This artifact records the ACL-10 engineering decision for **50 Failure Taxonomy**. It binds exact ACL-09 evidence to a closed promotion-state evaluation while preserving all authority denials.
