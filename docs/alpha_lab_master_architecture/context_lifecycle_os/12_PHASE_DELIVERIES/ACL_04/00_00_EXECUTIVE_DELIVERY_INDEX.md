---
title: ACL-04 — Executive Delivery Index
...
ACL-04 implements executive delivery index as part of the bounded Dual Setup Factory. The decision is accepted only at the `SETUP_DEFINITION_REFERENCE_ONLY` claim ceiling.
...
For this topic specifically, executive delivery index must remain reproducible, independently testable and reversible. No local success can broaden the phase authority ceiling.
