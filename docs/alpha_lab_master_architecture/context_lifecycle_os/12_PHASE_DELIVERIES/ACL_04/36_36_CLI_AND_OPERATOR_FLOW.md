---
title: ACL-04 — CLI and Operator Flow
...
ACL-04 implements cli and operator flow as part of the bounded Dual Setup Factory. The decision is accepted only at the `SETUP_DEFINITION_REFERENCE_ONLY` claim ceiling.
...
For this topic specifically, cli and operator flow must remain reproducible, independently testable and reversible. No local success can broaden the phase authority ceiling.
