---
title: ACL-04 — MQL5 Static Contracts
...
ACL-04 implements mql5 static contracts as part of the bounded Dual Setup Factory. The decision is accepted only at the `SETUP_DEFINITION_REFERENCE_ONLY` claim ceiling.
...
For this topic specifically, mql5 static contracts must remain reproducible, independently testable and reversible. No local success can broaden the phase authority ceiling.
