---
title: ACL-04 — Expiry, Abstention and Fallback
status: accepted-reference
version: 1.0.0
updated: 2026-07-18
tags: [acl-os, acl-04, phase-delivery]
---
# Expiry, Abstention and Fallback

## Decision

ACL-04 implements expiry, abstention and fallback as part of the bounded Dual Setup Factory. The decision is accepted only at the `SETUP_DEFINITION_REFERENCE_ONLY` claim ceiling.
...
For this topic specifically, expiry, abstention and fallback must remain reproducible, independently testable and reversible. No local success can broaden the phase authority ceiling.
