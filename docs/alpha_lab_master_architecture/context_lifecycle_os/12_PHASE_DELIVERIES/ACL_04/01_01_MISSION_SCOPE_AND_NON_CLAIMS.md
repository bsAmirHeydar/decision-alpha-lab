---
title: ACL-04 — Mission, Scope and Non-Claims
...
ACL-04 implements mission, scope and non-claims as part of the bounded Dual Setup Factory. The decision is accepted only at the `SETUP_DEFINITION_REFERENCE_ONLY` claim ceiling.
...
For this topic specifically, mission, scope and non-claims must remain reproducible, independently testable and reversible. No local success can broaden the phase authority ceiling.
