---
title: ACL-11 21 — Signed Generation Envelope
status: accepted-reference
version: 1.0.0
updated: 2026-07-18
tags: [acl-os, acl-11, phase-delivery]
---
# ACL-11 21 — Signed Generation Envelope

## Purpose

This delivery unit specifies signed generation envelope within the runtime parity and custody boundary. It is independently reviewable and links machine contracts, failure semantics and evidence obligations.
