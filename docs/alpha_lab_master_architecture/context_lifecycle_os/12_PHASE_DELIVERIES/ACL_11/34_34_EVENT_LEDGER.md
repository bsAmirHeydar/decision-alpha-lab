---
title: ACL-11 34 — Event Ledger
status: accepted-reference
version: 1.0.0
updated: 2026-07-18
tags: [acl-os, acl-11, phase-delivery]
---
# ACL-11 34 — Event Ledger

## Purpose

This delivery unit specifies event ledger within the runtime parity and custody boundary. It is independently reviewable and links machine contracts, failure semantics and evidence obligations.
