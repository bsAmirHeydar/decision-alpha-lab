---
title: ACL-11 12 — MQL5 Compile Evidence
status: accepted-reference
version: 1.0.0
updated: 2026-07-18
tags: [acl-os, acl-11, phase-delivery]
---
# ACL-11 12 — MQL5 Compile Evidence

## Purpose

This delivery unit specifies mql5 compile evidence within the runtime parity and custody boundary. It is independently reviewable and links machine contracts, failure semantics and evidence obligations.
