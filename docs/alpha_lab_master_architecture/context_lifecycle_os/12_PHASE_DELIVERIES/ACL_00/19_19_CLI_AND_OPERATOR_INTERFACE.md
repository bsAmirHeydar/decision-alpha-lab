---
title: ACL-00 — CLI and Operator Interface
status: accepted-reference-implementation
version: 1.0.0
updated: 2026-07-17
tags: [acl-os, acl-00, governance, security]
---
# ACL-00 — CLI and Operator Interface

## Purpose

Defines deterministic evaluation and ledger verification commands for local and CI use.
