---
title: ACL-00 — Security Negative Testing
status: accepted-reference-implementation
version: 1.0.0
updated: 2026-07-17
tags: [acl-os, acl-00, governance, security]
---
# ACL-00 — Security Negative Testing

## Purpose

Treats bypass attempts as first-class tests and never weakens a guard to make a test pass.
