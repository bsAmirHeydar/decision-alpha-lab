---
title: ACL-00 — Lifecycle Transition Graph
status: accepted-reference-implementation
version: 1.0.0
updated: 2026-07-17
tags: [acl-os, acl-00, governance, security]
---
# ACL-00 — Lifecycle Transition Graph

## Purpose

Registers legal state transitions, terminal-state behavior, suspension, reinstatement and retirement semantics.
