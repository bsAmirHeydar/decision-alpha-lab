---
title: ACL-00 — Allowed Next Actions
status: accepted-reference-implementation
version: 1.0.0
updated: 2026-07-17
tags: [acl-os, acl-00, governance, security]
---
# ACL-00 — Allowed Next Actions

## Purpose

Derives operator actions from current state and actor capabilities instead of exposing unrestricted commands.
