---
title: ACL-00 — Waiver Governance
status: accepted-reference-implementation
version: 1.0.0
updated: 2026-07-17
tags: [acl-os, acl-00, governance, security]
---
# ACL-00 — Waiver Governance

## Purpose

Allows only explicitly waivable failures, requires compensating controls and independent approvals, and protects nonwaivable controls.
