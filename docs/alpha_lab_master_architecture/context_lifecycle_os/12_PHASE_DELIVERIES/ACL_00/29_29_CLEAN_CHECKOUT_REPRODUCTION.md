---
title: ACL-00 — Clean Checkout Reproduction
status: accepted-reference-implementation
version: 1.0.0
updated: 2026-07-17
tags: [acl-os, acl-00, governance, security]
---
# ACL-00 — Clean Checkout Reproduction

## Purpose

Defines the independent installation and QA sequence proving no hidden dependency on the build workspace.
