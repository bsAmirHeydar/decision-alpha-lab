---
title: ACL-03 — Late Data and Correction Policy
...
This note defines the enforceable ACL-03 treatment of **late data and correction policy**. ACL-03 compiles an exact, semantically approved ACL-02 Context package into deterministic, closed-schema, non-trading intermediate representations and onboarding evidence. The compiler does not broaden Context doctrine, invent Treatment authority, train a model, establish statistical edge, generate unrestricted executable code, or authorize capital.
