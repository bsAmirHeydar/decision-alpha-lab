...
Defines the permanent laws governing Context-to-execution work and prevents any subsystem from widening its own authority.

## Responsibility boundary

This component owns a narrow part of governed authority, evidence classification and lifecycle state. It communicates through versioned contracts and immutable references. It may not infer adjacent authority, reach into private implementation folders, or create an alternative identity, security or evidence system.
