...
`ACL03_GENERATED_SCHEMA` is an atomic ACL-03 concept used by the Context Compiler and Onboarding Factory. It is defined narrowly so schemas, code, tests, policies, reason codes and operator documentation refer to the same behavior without semantic drift.
