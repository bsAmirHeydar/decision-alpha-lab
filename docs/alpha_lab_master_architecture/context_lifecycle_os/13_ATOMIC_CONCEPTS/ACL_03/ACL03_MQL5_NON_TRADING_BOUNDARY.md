---
title: ACL-03 Mql5 Non Trading Boundary
status: accepted-reference
version: 1.0.0
tags: [acl-os, acl-03, atomic-concept]
---
# Mql5 Non Trading Boundary

## Definition

`ACL03_MQL5_NON_TRADING_BOUNDARY` is an atomic ACL-03 concept used by the Context Compiler and Onboarding Factory. It is defined narrowly so schemas, code, tests, policies, reason codes and operator documentation refer to the same behavior without semantic drift.
