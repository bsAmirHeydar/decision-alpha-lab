---
title: ACL-03 External Data Qualification Required
status: accepted-reference
version: 1.0.0
tags: [acl-os, acl-03, atomic-concept]
---
# External Data Qualification Required

## Definition

`ACL03_EXTERNAL_DATA_QUALIFICATION_REQUIRED` is an atomic ACL-03 concept used by the Context Compiler and Onboarding Factory. It is defined narrowly so schemas, code, tests, policies, reason codes and operator documentation refer to the same behavior without semantic drift.
