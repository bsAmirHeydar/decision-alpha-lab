---
title: ACL-12 Atomic Concept — Rollback Generation
...
`ROLLBACK_GENERATION` is an atomic ACL-12 security concept. It has one bounded meaning, one authority boundary and one deterministic representation.
