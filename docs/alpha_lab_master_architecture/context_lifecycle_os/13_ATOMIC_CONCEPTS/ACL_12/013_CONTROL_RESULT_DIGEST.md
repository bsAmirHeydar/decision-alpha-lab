---
title: ACL-12 Atomic Concept — Control Result Digest
status: accepted-reference
version: 1.0.0
updated: 2026-07-18
tags: [acl-os, acl-12, atomic-concept]
---
# Control Result Digest

## Definition

`CONTROL_RESULT_DIGEST` is an atomic ACL-12 security concept. It has one bounded meaning, one authority boundary and one deterministic representation.
