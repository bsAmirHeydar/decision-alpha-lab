---
title: ACL-12 Atomic Concept — Live Order Denial
...
`LIVE_ORDER_DENIAL` is an atomic ACL-12 security concept. It has one bounded meaning, one authority boundary and one deterministic representation.
