---
title: ACL-12 Atomic Concept — Self Approval Denial
...
`SELF_APPROVAL_DENIAL` is an atomic ACL-12 security concept. It has one bounded meaning, one authority boundary and one deterministic representation.
