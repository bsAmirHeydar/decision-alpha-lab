---
title: ACL-12 Atomic Concept — Runner Attestation
...
`RUNNER_ATTESTATION` is an atomic ACL-12 security concept. It has one bounded meaning, one authority boundary and one deterministic representation.
