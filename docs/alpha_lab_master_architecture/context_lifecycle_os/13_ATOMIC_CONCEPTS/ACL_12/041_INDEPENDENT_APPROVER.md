---
title: ACL-12 Atomic Concept — Independent Approver
...
`INDEPENDENT_APPROVER` is an atomic ACL-12 security concept. It has one bounded meaning, one authority boundary and one deterministic representation.
