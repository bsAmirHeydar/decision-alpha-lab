---
title: ACL-12 Atomic Concept — Capital Owner
...
`CAPITAL_OWNER` is an atomic ACL-12 security concept. It has one bounded meaning, one authority boundary and one deterministic representation.
