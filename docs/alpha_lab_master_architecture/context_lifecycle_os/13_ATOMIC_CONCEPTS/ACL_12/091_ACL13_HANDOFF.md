---
title: ACL-12 Atomic Concept — Acl13 Handoff
...
`ACL13_HANDOFF` is an atomic ACL-12 security concept. It has one bounded meaning, one authority boundary and one deterministic representation.
