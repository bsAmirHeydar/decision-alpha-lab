---
title: ACL-12 Atomic Concept — Runtime Generation Denial
...
`RUNTIME_GENERATION_DENIAL` is an atomic ACL-12 security concept. It has one bounded meaning, one authority boundary and one deterministic representation.
