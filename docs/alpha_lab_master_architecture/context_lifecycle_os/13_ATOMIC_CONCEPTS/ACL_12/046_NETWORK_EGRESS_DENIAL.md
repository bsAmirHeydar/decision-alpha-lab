---
title: ACL-12 Atomic Concept — Network Egress Denial
...
`NETWORK_EGRESS_DENIAL` is an atomic ACL-12 security concept. It has one bounded meaning, one authority boundary and one deterministic representation.
