---
title: ACL-12 Atomic Concept — Threat Registry Digest
status: accepted-reference
version: 1.0.0
updated: 2026-07-18
tags: [acl-os, acl-12, atomic-concept]
---
# Threat Registry Digest

## Definition

`THREAT_REGISTRY_DIGEST` is an atomic ACL-12 security concept. It has one bounded meaning, one authority boundary and one deterministic representation.
