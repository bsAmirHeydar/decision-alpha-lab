---
title: ACL-12 Atomic Concept — Residual Unknown
...
`RESIDUAL_UNKNOWN` is an atomic ACL-12 security concept. It has one bounded meaning, one authority boundary and one deterministic representation.
