...
`ACL04_ATOM_LANE_POLICY` is the ACL-04 atomic concept for atom lane policy. It is intentionally narrow so schemas, code, policies, tests, reason codes and operator documentation use one meaning.
