---
title: ACL-04 Execution Authority None
...
`ACL04_EXECUTION_AUTHORITY_NONE` is the ACL-04 atomic concept for execution authority none. It is intentionally narrow so schemas, code, policies, tests, reason codes and operator documentation use one meaning.
