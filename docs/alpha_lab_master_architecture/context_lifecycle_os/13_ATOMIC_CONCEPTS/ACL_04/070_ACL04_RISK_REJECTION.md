...
`ACL04_RISK_REJECTION` is the ACL-04 atomic concept for risk rejection. It is intentionally narrow so schemas, code, policies, tests, reason codes and operator documentation use one meaning.
