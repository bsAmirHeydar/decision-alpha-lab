---
title: ACL-04 Symlink Rejection
...
`ACL04_SYMLINK_REJECTION` is the ACL-04 atomic concept for symlink rejection. It is intentionally narrow so schemas, code, policies, tests, reason codes and operator documentation use one meaning.
