---
title: ACL-04 Obsidian Projection
...
`ACL04_OBSIDIAN_PROJECTION` is the ACL-04 atomic concept for obsidian projection. It is intentionally narrow so schemas, code, policies, tests, reason codes and operator documentation use one meaning.
