---
title: ACL-04 Action Authority Rejection
status: accepted-reference
version: 1.0.0
updated: 2026-07-18
tags: [acl-os, acl-04, atomic-concept]
---
# Action Authority Rejection

## Definition

`ACL04_ACTION_AUTHORITY_REJECTION` is the ACL-04 atomic concept for action authority rejection. It is intentionally narrow so schemas, code, policies, tests, reason codes and operator documentation use one meaning.
