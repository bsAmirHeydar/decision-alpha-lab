...
`ACL04_SEARCH_AUTHORITY` is the ACL-04 atomic concept for search authority. It is intentionally narrow so schemas, code, policies, tests, reason codes and operator documentation use one meaning.
