...
`ACL04_FACTORY_RECEIPT` is the ACL-04 atomic concept for factory receipt. It is intentionally narrow so schemas, code, policies, tests, reason codes and operator documentation use one meaning.
