---
title: ACL-04 Unknown Atom Rejection
status: accepted-reference
version: 1.0.0
updated: 2026-07-18
tags: [acl-os, acl-04, atomic-concept]
---
# Unknown Atom Rejection

## Definition

`ACL04_UNKNOWN_ATOM_REJECTION` is the ACL-04 atomic concept for unknown atom rejection. It is intentionally narrow so schemas, code, policies, tests, reason codes and operator documentation use one meaning.
