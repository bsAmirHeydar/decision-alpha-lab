...
`ACL04_CANDIDATE_STATUS` is the ACL-04 atomic concept for candidate status. It is intentionally narrow so schemas, code, policies, tests, reason codes and operator documentation use one meaning.
