---
title: ACL-04 Baseline Always Long
...
`ACL04_BASELINE_ALWAYS_LONG` is the ACL-04 atomic concept for baseline always long. It is intentionally narrow so schemas, code, policies, tests, reason codes and operator documentation use one meaning.
