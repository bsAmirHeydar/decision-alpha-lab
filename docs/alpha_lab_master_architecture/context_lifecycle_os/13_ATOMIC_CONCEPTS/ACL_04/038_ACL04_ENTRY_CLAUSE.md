...
`ACL04_ENTRY_CLAUSE` is the ACL-04 atomic concept for entry clause. It is intentionally narrow so schemas, code, policies, tests, reason codes and operator documentation use one meaning.
