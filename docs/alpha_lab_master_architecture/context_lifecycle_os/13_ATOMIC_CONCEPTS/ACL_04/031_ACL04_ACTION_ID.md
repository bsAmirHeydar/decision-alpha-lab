...
`ACL04_ACTION_ID` is the ACL-04 atomic concept for action id. It is intentionally narrow so schemas, code, policies, tests, reason codes and operator documentation use one meaning.
