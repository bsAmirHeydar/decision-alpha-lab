---
title: ACL-04 Network Egress Prohibition
...
`ACL04_NETWORK_EGRESS_PROHIBITION` is the ACL-04 atomic concept for network egress prohibition. It is intentionally narrow so schemas, code, policies, tests, reason codes and operator documentation use one meaning.
