...
`ACL04_DUPLICATE_GROUP` is the ACL-04 atomic concept for duplicate group. It is intentionally narrow so schemas, code, policies, tests, reason codes and operator documentation use one meaning.
