...
`ACL04_CONTEXT_BINDING` is the ACL-04 atomic concept for context binding. It is intentionally narrow so schemas, code, policies, tests, reason codes and operator documentation use one meaning.
