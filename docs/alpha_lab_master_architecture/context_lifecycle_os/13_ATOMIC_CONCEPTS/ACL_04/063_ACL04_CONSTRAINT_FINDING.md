---
title: ACL-04 Constraint Finding
...
`ACL04_CONSTRAINT_FINDING` is the ACL-04 atomic concept for constraint finding. It is intentionally narrow so schemas, code, policies, tests, reason codes and operator documentation use one meaning.
