---
title: ACL-04 Invalid Candidate
...
`ACL04_INVALID_CANDIDATE` is the ACL-04 atomic concept for invalid candidate. It is intentionally narrow so schemas, code, policies, tests, reason codes and operator documentation use one meaning.
