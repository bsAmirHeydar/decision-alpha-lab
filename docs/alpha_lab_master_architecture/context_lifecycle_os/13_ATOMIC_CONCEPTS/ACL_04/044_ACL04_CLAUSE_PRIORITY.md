...
`ACL04_CLAUSE_PRIORITY` is the ACL-04 atomic concept for clause priority. It is intentionally narrow so schemas, code, policies, tests, reason codes and operator documentation use one meaning.
