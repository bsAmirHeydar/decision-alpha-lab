---
title: ACL-04 Live Order Prohibition
status: accepted-reference
version: 1.0.0
updated: 2026-07-18
tags: [acl-os, acl-04, atomic-concept]
---
# Live Order Prohibition

## Definition

`ACL04_LIVE_ORDER_PROHIBITION` is the ACL-04 atomic concept for live order prohibition. It is intentionally narrow so schemas, code, policies, tests, reason codes and operator documentation use one meaning.
