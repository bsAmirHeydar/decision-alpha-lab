...
`ACL04_ATOMIC_WRITE` is the ACL-04 atomic concept for atomic write. It is intentionally narrow so schemas, code, policies, tests, reason codes and operator documentation use one meaning.
