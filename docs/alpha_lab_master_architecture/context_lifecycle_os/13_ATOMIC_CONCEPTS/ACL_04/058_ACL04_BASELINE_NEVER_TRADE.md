---
title: ACL-04 Baseline Never Trade
status: accepted-reference
version: 1.0.0
updated: 2026-07-18
tags: [acl-os, acl-04, atomic-concept]
---
# Baseline Never Trade

## Definition

`ACL04_BASELINE_NEVER_TRADE` is the ACL-04 atomic concept for baseline never trade. It is intentionally narrow so schemas, code, policies, tests, reason codes and operator documentation use one meaning.
