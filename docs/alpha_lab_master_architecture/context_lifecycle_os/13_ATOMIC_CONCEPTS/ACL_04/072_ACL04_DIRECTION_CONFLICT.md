---
title: ACL-04 Direction Conflict
...
`ACL04_DIRECTION_CONFLICT` is the ACL-04 atomic concept for direction conflict. It is intentionally narrow so schemas, code, policies, tests, reason codes and operator documentation use one meaning.
