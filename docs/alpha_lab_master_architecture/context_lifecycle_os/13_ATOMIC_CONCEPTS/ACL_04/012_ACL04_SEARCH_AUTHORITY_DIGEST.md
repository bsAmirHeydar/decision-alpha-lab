---
title: ACL-04 Search Authority Digest
status: accepted-reference
version: 1.0.0
updated: 2026-07-18
tags: [acl-os, acl-04, atomic-concept]
---
# Search Authority Digest

## Definition

`ACL04_SEARCH_AUTHORITY_DIGEST` is the ACL-04 atomic concept for search authority digest. It is intentionally narrow so schemas, code, policies, tests, reason codes and operator documentation use one meaning.
