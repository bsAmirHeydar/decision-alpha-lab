...
`ACL04_ATOM_ARITY` is the ACL-04 atomic concept for atom arity. It is intentionally narrow so schemas, code, policies, tests, reason codes and operator documentation use one meaning.
