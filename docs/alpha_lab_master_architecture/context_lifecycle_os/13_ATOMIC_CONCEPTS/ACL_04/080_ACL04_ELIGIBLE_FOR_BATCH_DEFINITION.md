---
title: ACL-04 Eligible For Batch Definition
status: accepted-reference
version: 1.0.0
updated: 2026-07-18
tags: [acl-os, acl-04, atomic-concept]
---
# Eligible For Batch Definition

## Definition

`ACL04_ELIGIBLE_FOR_BATCH_DEFINITION` is the ACL-04 atomic concept for eligible for batch definition. It is intentionally narrow so schemas, code, policies, tests, reason codes and operator documentation use one meaning.
