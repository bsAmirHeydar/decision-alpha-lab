...
`ACL04_ALLOWED_LANE` is the ACL-04 atomic concept for allowed lane. It is intentionally narrow so schemas, code, policies, tests, reason codes and operator documentation use one meaning.
