...
`ACL04_SIZING_MODE` is the ACL-04 atomic concept for sizing mode. It is intentionally narrow so schemas, code, policies, tests, reason codes and operator documentation use one meaning.
