...
`ACL04_BEHAVIOR_PAYLOAD` is the ACL-04 atomic concept for behavior payload. It is intentionally narrow so schemas, code, policies, tests, reason codes and operator documentation use one meaning.
