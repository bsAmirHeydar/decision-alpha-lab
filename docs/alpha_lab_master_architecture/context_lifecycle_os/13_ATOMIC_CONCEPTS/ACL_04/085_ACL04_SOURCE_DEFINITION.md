---
title: ACL-04 Source Definition
...
`ACL04_SOURCE_DEFINITION` is the ACL-04 atomic concept for source definition. It is intentionally narrow so schemas, code, policies, tests, reason codes and operator documentation use one meaning.
