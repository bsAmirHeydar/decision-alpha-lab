---
title: ACL-04 Complete Enumeration
...
`ACL04_COMPLETE_ENUMERATION` is the ACL-04 atomic concept for complete enumeration. It is intentionally narrow so schemas, code, policies, tests, reason codes and operator documentation use one meaning.
