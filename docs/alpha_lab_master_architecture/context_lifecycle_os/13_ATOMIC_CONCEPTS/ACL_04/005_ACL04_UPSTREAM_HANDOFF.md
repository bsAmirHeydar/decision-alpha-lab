...
`ACL04_UPSTREAM_HANDOFF` is the ACL-04 atomic concept for upstream handoff. It is intentionally narrow so schemas, code, policies, tests, reason codes and operator documentation use one meaning.
