---
title: ACL-04 Unknown Field Rejection
...
`ACL04_UNKNOWN_FIELD_REJECTION` is the ACL-04 atomic concept for unknown field rejection. It is intentionally narrow so schemas, code, policies, tests, reason codes and operator documentation use one meaning.
