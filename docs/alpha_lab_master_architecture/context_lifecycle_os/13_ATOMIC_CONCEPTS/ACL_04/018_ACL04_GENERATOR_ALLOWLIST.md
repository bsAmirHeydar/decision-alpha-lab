---
title: ACL-04 Generator Allowlist
...
`ACL04_GENERATOR_ALLOWLIST` is the ACL-04 atomic concept for generator allowlist. It is intentionally narrow so schemas, code, policies, tests, reason codes and operator documentation use one meaning.
