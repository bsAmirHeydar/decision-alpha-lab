...
`ACL04_EXPRESSION_DEPTH` is the ACL-04 atomic concept for expression depth. It is intentionally narrow so schemas, code, policies, tests, reason codes and operator documentation use one meaning.
