...
`ACL04_ROLLBACK_PLAN` is the ACL-04 atomic concept for rollback plan. It is intentionally narrow so schemas, code, policies, tests, reason codes and operator documentation use one meaning.
