...
`ACL04_SETUP_POLICY_IR` is the ACL-04 atomic concept for setup policy ir. It is intentionally narrow so schemas, code, policies, tests, reason codes and operator documentation use one meaning.
