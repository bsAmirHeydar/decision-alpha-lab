...
`ACL04_OUTPUT_MANIFEST` is the ACL-04 atomic concept for output manifest. It is intentionally narrow so schemas, code, policies, tests, reason codes and operator documentation use one meaning.
