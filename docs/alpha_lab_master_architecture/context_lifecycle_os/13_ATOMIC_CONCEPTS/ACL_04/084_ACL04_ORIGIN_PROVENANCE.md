---
title: ACL-04 Origin Provenance
...
`ACL04_ORIGIN_PROVENANCE` is the ACL-04 atomic concept for origin provenance. It is intentionally narrow so schemas, code, policies, tests, reason codes and operator documentation use one meaning.
