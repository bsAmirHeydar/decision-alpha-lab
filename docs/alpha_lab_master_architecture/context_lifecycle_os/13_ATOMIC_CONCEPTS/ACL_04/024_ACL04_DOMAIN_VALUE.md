...
`ACL04_DOMAIN_VALUE` is the ACL-04 atomic concept for domain value. It is intentionally narrow so schemas, code, policies, tests, reason codes and operator documentation use one meaning.
