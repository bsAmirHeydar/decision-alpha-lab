---
title: ACL-14 Atomic Concept 103 — Hostile Review
...
`HOSTILE_REVIEW` is an atomic contract concept in ACL-14. It is represented explicitly in schemas, policies, reason codes, tests or immutable evidence artifacts.
