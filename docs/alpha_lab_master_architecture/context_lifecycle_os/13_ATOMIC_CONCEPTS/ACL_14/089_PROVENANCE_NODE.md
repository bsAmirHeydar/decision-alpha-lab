---
title: ACL-14 Atomic Concept 089 — Provenance Node
...
`PROVENANCE_NODE` is an atomic contract concept in ACL-14. It is represented explicitly in schemas, policies, reason codes, tests or immutable evidence artifacts.
