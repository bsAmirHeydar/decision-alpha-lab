---
title: ACL-14 Atomic Concept 112 — No Live Order
...
`NO_LIVE_ORDER` is an atomic contract concept in ACL-14. It is represented explicitly in schemas, policies, reason codes, tests or immutable evidence artifacts.
