---
title: ACL-14 Atomic Concept 111 — No Validation Claim
...
`NO_VALIDATION_CLAIM` is an atomic contract concept in ACL-14. It is represented explicitly in schemas, policies, reason codes, tests or immutable evidence artifacts.
