---
title: ACL-14 Atomic Concept 045 — Stop Condition
...
`STOP_CONDITION` is an atomic contract concept in ACL-14. It is represented explicitly in schemas, policies, reason codes, tests or immutable evidence artifacts.
