---
title: ACL-14 Atomic Concept 067 — Unknown Blocks Readiness
...
`UNKNOWN_BLOCKS_READINESS` is an atomic contract concept in ACL-14. It is represented explicitly in schemas, policies, reason codes, tests or immutable evidence artifacts.
