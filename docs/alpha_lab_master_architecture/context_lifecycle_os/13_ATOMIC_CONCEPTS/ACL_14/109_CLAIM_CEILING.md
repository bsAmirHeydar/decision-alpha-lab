---
title: ACL-14 Atomic Concept 109 — Claim Ceiling
...
`CLAIM_CEILING` is an atomic contract concept in ACL-14. It is represented explicitly in schemas, policies, reason codes, tests or immutable evidence artifacts.
