---
title: ACL-14 Atomic Concept 010 — Self Approval Denial
...
`SELF_APPROVAL_DENIAL` is an atomic contract concept in ACL-14. It is represented explicitly in schemas, policies, reason codes, tests or immutable evidence artifacts.
