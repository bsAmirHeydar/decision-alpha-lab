---
title: ACL-14 Atomic Concept 106 — Rollback Package
...
`ROLLBACK_PACKAGE` is an atomic contract concept in ACL-14. It is represented explicitly in schemas, policies, reason codes, tests or immutable evidence artifacts.
