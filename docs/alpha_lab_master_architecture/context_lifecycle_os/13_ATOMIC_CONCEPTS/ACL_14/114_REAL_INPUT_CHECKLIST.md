---
title: ACL-14 Atomic Concept 114 — Real Input Checklist
...
`REAL_INPUT_CHECKLIST` is an atomic contract concept in ACL-14. It is represented explicitly in schemas, policies, reason codes, tests or immutable evidence artifacts.
