---
title: ACL-14 Atomic Concept 021 — Label Availability Field
...
`LABEL_AVAILABILITY_FIELD` is an atomic contract concept in ACL-14. It is represented explicitly in schemas, policies, reason codes, tests or immutable evidence artifacts.
