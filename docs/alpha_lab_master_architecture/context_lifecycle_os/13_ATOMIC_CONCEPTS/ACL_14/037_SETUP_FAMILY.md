---
title: ACL-14 Atomic Concept 037 — Setup Family
...
`SETUP_FAMILY` is an atomic contract concept in ACL-14. It is represented explicitly in schemas, policies, reason codes, tests or immutable evidence artifacts.
