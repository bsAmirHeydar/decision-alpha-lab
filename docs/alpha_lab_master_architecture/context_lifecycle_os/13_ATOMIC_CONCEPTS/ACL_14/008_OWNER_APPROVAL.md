---
title: ACL-14 Atomic Concept 008 — Owner Approval
...
`OWNER_APPROVAL` is an atomic contract concept in ACL-14. It is represented explicitly in schemas, policies, reason codes, tests or immutable evidence artifacts.
