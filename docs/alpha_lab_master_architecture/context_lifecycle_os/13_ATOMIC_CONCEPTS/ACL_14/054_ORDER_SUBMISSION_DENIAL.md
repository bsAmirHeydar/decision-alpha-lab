---
title: ACL-14 Atomic Concept 054 — Order Submission Denial
...
`ORDER_SUBMISSION_DENIAL` is an atomic contract concept in ACL-14. It is represented explicitly in schemas, policies, reason codes, tests or immutable evidence artifacts.
