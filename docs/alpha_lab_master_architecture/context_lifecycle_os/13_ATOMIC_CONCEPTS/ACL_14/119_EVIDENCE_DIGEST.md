---
title: ACL-14 Atomic Concept 119 — Evidence Digest
...
`EVIDENCE_DIGEST` is an atomic contract concept in ACL-14. It is represented explicitly in schemas, policies, reason codes, tests or immutable evidence artifacts.
