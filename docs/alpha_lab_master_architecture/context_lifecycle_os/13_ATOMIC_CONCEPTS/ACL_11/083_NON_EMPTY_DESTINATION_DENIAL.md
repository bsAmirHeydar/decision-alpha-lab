---
title: ACL-11 Atomic — Non Empty Destination Denial
...
`Non Empty Destination Denial` is an atomic ACL-11 concept used in runtime parity assessment and non-executable custody. Its identity and semantics are explicit, versioned and independently testable.
