---
title: Transition Registry ID
status: accepted-reference
version: 1.0.0
updated: 2026-07-18
tags: [acl-os, acl-10, promotion]
---
# Transition Registry ID

**Definition.** Transition Registry ID is a bounded ACL-10 concept in deterministic promotion-state evaluation.
