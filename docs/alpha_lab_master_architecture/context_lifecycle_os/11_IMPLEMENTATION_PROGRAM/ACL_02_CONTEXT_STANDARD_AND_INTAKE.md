...
```powershell
python -m tools.strategy_factory.acl_os.acl_02.cli scaffold CTX_EXAMPLE
python -m tools.strategy_factory.acl_os.acl_02.cli questions CTX_EXAMPLE
python -m tools.strategy_factory.acl_os.acl_02.cli evaluate lab/11_strategy_factory/contexts/CTX_EXAMPLE --permit permit.json --output-dir reports/acl02
```
