---
id: AIEOS-EA5958FD9E
title: "Assumption Register Template"
type: template
status: active
domain: template
version: 1.0.0
...
> [!abstract] Purpose
> Track uncertainty as a managed engineering object.
...
```markdown
# Assumption Register — [Work Item]

| ID | Assumption | Impact if false | Evidence | Owner | Test/Resolution | Deadline/Trigger | Status |
|---|---|---|---|---|---|---|---|
