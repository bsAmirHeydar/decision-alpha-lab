...
> [!abstract] Purpose
> Assign domain truth, risk acceptance, and final authority to humans while delegating structured execution to AI.
...
Assign domain truth, risk acceptance, and final authority to humans while delegating structured execution to AI. The objective is not to maximize the amount of generated code. The objective is to reduce ambiguity, preserve domain truth, make changes reversible, and produce evidence that the implementation satisfies the approved intent.

### Core principles

- Treat **Human–AI Boundary** as an explicit engineering contract, not an informal preference.
- Keep what humans must decide and what AI may automate traceable to project intent, domain rules, and measurable evidence.
...
- AI may recommend but cannot silently approve domain changes or risk exceptions.

## 2. Required Procedure

1. Collect the minimum authoritative context required for what humans must decide and what AI may automate.
...
- A versioned record of what humans must decide and what AI may automate.
