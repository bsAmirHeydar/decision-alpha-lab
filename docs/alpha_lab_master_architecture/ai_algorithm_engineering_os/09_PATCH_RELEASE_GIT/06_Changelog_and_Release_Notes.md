...
> [!abstract] Purpose
> Communicate behavioral change, compatibility, migration, risk, and verification to users and maintainers.
...
Communicate behavioral change, compatibility, migration, risk, and verification to users and maintainers. The objective is not to maximize the amount of generated code. The objective is to reduce ambiguity, preserve domain truth, make changes reversible, and produce evidence that the implementation satisfies the approved intent.

### Core principles

- Treat **Changelog and Release Notes** as an explicit engineering contract, not an informal preference.
- Keep audience-specific release information traceable to project intent, domain rules, and measurable evidence.
...
- Describe user-visible behavior and operational action, not only file names.

## 2. Required Procedure

1. Collect the minimum authoritative context required for audience-specific release information.
...
- A versioned record of audience-specific release information.
