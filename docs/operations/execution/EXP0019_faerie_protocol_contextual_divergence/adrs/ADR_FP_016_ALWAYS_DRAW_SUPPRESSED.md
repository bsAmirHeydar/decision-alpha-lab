---
title: "ADR FP-016 - Suppressed Signals Remain Visible"
...
language: en
---
# ADR FP-016 - Suppressed Signals Remain Visible

## Decision

Always draw suppressed signals using a distinct style and explicit reason code.

## Context

This matches owner answer 15-B.

## Consequences

Visual filters may exist, but canonical default is visible audit evidence.
