...
Prove which existing time, market, reference, hunt, confirmation, identity, ledger, visual, economics, paper, and live modules can be reused without changing previous contexts.
...
- direct/adapter/pattern/no-reuse matrix
- exact dependency versions
- adapter interface stubs
- old-context regression suite

## Explicit non-goals

- No FP relation semantics
- No indicator code
- No behavior change to old contexts
...
- FP_CoreCompatibility.mqh
- FP adapter contract tests
...
- [ ] EXP0017 and EXP0018 golden behavior unchanged.
- [ ] all adapters have documented semantic delta.
- [ ] dependency mismatch fails initialization.
