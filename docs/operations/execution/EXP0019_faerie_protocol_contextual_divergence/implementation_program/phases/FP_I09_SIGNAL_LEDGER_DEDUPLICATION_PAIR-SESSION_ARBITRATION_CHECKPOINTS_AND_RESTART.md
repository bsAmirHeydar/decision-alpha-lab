---
title: "FP-I09 — Signal Ledger, Deduplication, Pair-Session Arbitration, Checkpoints, and Restart"
...
language: en
---
# FP-I09 — Signal Ledger, Deduplication, Pair-Session Arbitration, Checkpoints, and Restart

## Mission

Unify all semantic events in an append-only ledger, enforce identity/dedup, compute pair-global earliest-Hunt winner and quota eligibility, and restore deterministically after restart.
...
- append-only event/transition ledger
- indexes by signal/session/relation
- earliest-M1 arbitration
- reservation state without final live consumption
...
- No order send
- No permanent live quota rule
- No rendering source-of-truth
...
- FP_QuotaArbiter.mqh
- FP_Checkpoint.mqh
- restart/arbitration self-tests
...
- [ ] one pair-global winner per session.
- [ ] later signals retained as suppressed.
- [ ] restart yields same IDs/states.
- [ ] corrupt/incompatible checkpoint is rejected and rebuilt.
