---
title: "FP-I11 — Indicator Visual Projection: Sessions, References, Hunts, Signals, WW, and Suppression"
...
language: en
---
# FP-I11 — Indicator Visual Projection: Sessions, References, Hunts, Signals, WW, and Suppression

## Mission

Implement the complete event-driven chart projection from semantic snapshots and events.
...
- hunt and role markers
- candidate/confirmation/invalidation visuals
- WW history/current context
- suppression overlays
- responsive lane layout
- dirty-set object manager

## Explicit non-goals

- No semantic decisions in renderer
- No alerts/panel logic
- No orders
...
- visual inventory tests
- projection golden screenshots as supplemental evidence
...
- [ ] every ledger state has a documented visual.
- [ ] suppressed signals remain visible in audit mode.
- [ ] unchanged objects are not recreated.
- [ ] confirmed visuals remain immutable.
