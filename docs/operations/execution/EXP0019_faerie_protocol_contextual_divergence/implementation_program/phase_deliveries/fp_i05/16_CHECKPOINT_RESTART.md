...
---
# Checkpoint, Restart, and Deterministic Rebuild

## Purpose

Defines exact-version/config/revision/payload validation and rebuild behavior for stale or corrupt checkpoints.
