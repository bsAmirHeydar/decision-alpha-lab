...
---
# References Are Symbol-Local

## Decision

Each source window yields independent HIGH and LOW references for each symbol. Pair-level merging or borrowing is prohibited.
