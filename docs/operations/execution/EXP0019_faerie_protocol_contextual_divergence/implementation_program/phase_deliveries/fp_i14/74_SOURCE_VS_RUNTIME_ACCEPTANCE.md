---
title: "FP-I14 — Source Vs Runtime Acceptance"
...
---
# FP-I14 — Source Vs Runtime Acceptance
...
This note governs **Source Vs Runtime Acceptance**. Acceptance requires deterministic behavior across all three products and a reason-coded report for every negative branch. The operational owner must be able to reproduce the result from the trace and manifest alone, without inspecting mutable chart state.
