---
title: "Restart Failure Injection"
...
Tests mutate checkpoint version, fixture ID, configuration hash, instance ID, and payload hash. Every mutation must be rejected with a closed reason code. Valid checkpoints at early, middle, and late sequence boundaries must pass parity.
## Implementation linkage

The **33 Restart Failure Injection** contract is implemented through the versioned `fp_i13_release` Python reference package, the MQL5 `I13` include boundary, the production indicator integration, and the FP-I13 release self-test. The implementation must consume accepted FP-I10–FP-I12 outputs rather than reconstructing context from chart objects.
