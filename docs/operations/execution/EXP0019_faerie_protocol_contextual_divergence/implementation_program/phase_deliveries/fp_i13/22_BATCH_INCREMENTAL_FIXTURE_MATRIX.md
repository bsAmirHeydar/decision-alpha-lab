---
title: "Batch and Incremental Fixture Matrix"
...
language: en
---
# Batch and Incremental Fixture Matrix

Acceptance fixtures include all relation codes, bullish and bearish directions, WW direct setup, allowed and suppressed states, historical alerts, health transitions, export records, duplicates, invalid checkpoint paths, and object-budget pressure.

The minimum matrix uses multiple chunk sizes and at least one nondivisible chunk boundary.
## Implementation linkage

The **22 Batch Incremental Fixture Matrix** contract is implemented through the versioned `fp_i13_release` Python reference package, the MQL5 `I13` include boundary, the production indicator integration, and the FP-I13 release self-test. The implementation must consume accepted FP-I10–FP-I12 outputs rather than reconstructing context from chart objects.
