---
title: "Release Profile Selection Guide"
...
language: en
---
# Release Profile Selection Guide

Use Trading for normal discretionary operation, Audit for investigations and evidence export, Performance for low-resource terminals, and Safe Diagnostic when validating a new broker or symbol alias. Profile changes that alter history scope require projection rebuild but not semantic rule changes.
## Implementation linkage

The **69 Profile Selection Guide** contract is implemented through the versioned `fp_i13_release` Python reference package, the MQL5 `I13` include boundary, the production indicator integration, and the FP-I13 release self-test. The implementation must consume accepted FP-I10–FP-I12 outputs rather than reconstructing context from chart objects.
