---
title: "Multi-Chart and Multi-Instance Isolation"
...
language: en
---
# Multi-Chart and Multi-Instance Isolation

Every instance has a deterministic identity derived from chart ID, terminal path hash, pair, context epoch, and configuration hash. Display timeframe is deliberately excluded.

The instance identity derives object namespace, checkpoint key, export file key, alert state, panel preferences, and diagnostic scope. Four-chart tests require unique values for every instance-specific key while preserving equal semantic inventories.
## Implementation linkage

The **50 Multi Chart Isolation** contract is implemented through the versioned `fp_i13_release` Python reference package, the MQL5 `I13` include boundary, the production indicator integration, and the FP-I13 release self-test. The implementation must consume accepted FP-I10–FP-I12 outputs rather than reconstructing context from chart objects.
