---
title: "Parity Failure Diagnosis"
...
language: en
---
# Parity Failure Diagnosis

A failed comparator names every mismatched field. Operators first inspect event-chain mismatch, then last sequence, semantic payloads, visual semantics, alerts, and exports. Telemetry is used to locate a suspected accidental full scan but cannot override semantic failure.
## Implementation linkage

The **21 Parity Failure Diagnosis** contract is implemented through the versioned `fp_i13_release` Python reference package, the MQL5 `I13` include boundary, the production indicator integration, and the FP-I13 release self-test. The implementation must consume accepted FP-I10–FP-I12 outputs rather than reconstructing context from chart objects.
