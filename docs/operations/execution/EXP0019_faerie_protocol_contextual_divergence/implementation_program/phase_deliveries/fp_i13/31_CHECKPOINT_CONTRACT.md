---
title: "Replay Checkpoint Contract"
...
The checkpoint is a cache, not the authority. It is rejected on version, fixture, configuration, instance, or payload-hash mismatch. Rejection never produces partial restoration.

The rebuild path replays the accepted event stream from the beginning and produces reason-coded evidence.
## Implementation linkage

The **31 Checkpoint Contract** contract is implemented through the versioned `fp_i13_release` Python reference package, the MQL5 `I13` include boundary, the production indicator integration, and the FP-I13 release self-test. The implementation must consume accepted FP-I10–FP-I12 outputs rather than reconstructing context from chart objects.
