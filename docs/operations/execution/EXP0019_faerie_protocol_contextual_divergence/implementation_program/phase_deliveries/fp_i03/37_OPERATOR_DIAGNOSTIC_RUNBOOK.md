---
title: "FP-I03 — Operator Diagnostic Runbook"
...
Operators run Python tests, conformance, boundary checks, MQL static checks, cumulative regressions, engineering policy, and local MetaEditor compile. The diagnostic EA requires an explicit broker UTC offset input.
