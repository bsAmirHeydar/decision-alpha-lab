---
title: "FP-I03 — MQL5 Shared-Core Adapter"
...
language: en
---
# MQL5 Shared-Core Adapter

## Purpose

The MQL5 implementation wraps the accepted DAYE_Time conversion primitives and adds only Faerie-specific session/week policies, types, identities, diagnostics, and self-tests. The Daye source files remain unchanged.
