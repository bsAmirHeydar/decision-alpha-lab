---
title: "FP-I03 — MetaEditor Compile and Runtime Evidence"
...
language: en
---
# MetaEditor Compile and Runtime Evidence

## Purpose

Static MQL validation is not compilation. The Windows runbook compiles the self-test and diagnostic entry points and retains logs. A successful OnInit self-test is runtime evidence, not live trading authority.
