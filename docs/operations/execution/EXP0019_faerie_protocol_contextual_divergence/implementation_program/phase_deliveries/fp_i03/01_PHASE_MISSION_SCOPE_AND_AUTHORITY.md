---
title: "FP-I03 — Phase Mission, Scope, and Authority Boundary"
...
language: en
---
# Phase Mission, Scope, and Authority Boundary

## Purpose

FP-I03 establishes one exact temporal coordinate system for all later Faerie Protocol phases. It produces deterministic New York civil time, trading-day ownership, A/L/N session windows, daily gap state, and weekly interval identity. It does not read prices, detect hunts, render chart objects, or execute trades.
