---
title: "FP-I03 — Half-Open Boundary Ownership"
...
All intervals use start-inclusive/end-exclusive semantics. One millisecond before a boundary belongs to the previous state; the exact boundary belongs to the next state. This eliminates double ownership.
