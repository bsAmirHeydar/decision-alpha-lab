---
title: "FP-I03 — Broker-Time Invariance"
...
language: en
---
# Broker-Time Invariance

## Purpose

Two broker clocks representing the same UTC instant with different explicit offsets must produce the same NyTimestamp, CalendarSnapshot, trading-day ID, session ID, and week ID.
