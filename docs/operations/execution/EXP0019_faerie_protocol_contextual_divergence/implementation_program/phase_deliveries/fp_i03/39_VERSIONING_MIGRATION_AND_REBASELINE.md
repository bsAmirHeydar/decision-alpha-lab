---
title: "FP-I03 — Versioning, Migration, and Rebaseline"
...
language: en
---
# Versioning, Migration, and Rebaseline

## Purpose

Changing DST law, supported year range, session times, trading-day labeling, weekly boundary, ambiguity policy, or identity material requires a new version, golden vectors, registry hashes, migration statement, and downstream rebaseline.
