---
title: "FP-I03 — Performance and Incremental Usage"
...
language: en
---
# Performance and Incremental Usage

## Purpose

Time conversion and window construction are constant-time operations. Later phases should cache the current snapshot and recompute only when UTC time crosses a relevant boundary, without changing semantics.
