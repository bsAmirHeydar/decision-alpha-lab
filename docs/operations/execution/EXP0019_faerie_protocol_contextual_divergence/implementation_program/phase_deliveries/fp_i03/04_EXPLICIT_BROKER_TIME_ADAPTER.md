---
title: "FP-I03 — Explicit Broker-Time Adapter"
...
language: en
---
# Explicit Broker-Time Adapter

## Purpose

Broker timestamps are accepted only with an explicit UTC offset. Automatic inference from TimeCurrent, TimeTradeServer, or the present terminal environment is not replay-safe and is therefore excluded from the semantic kernel.
