---
title: "FP-I03 — Boundary Evidence Chain"
...
language: en
---
# Boundary Evidence Chain

## Purpose

Every constructed boundary records local civil value, selected UTC instant, resolved offset, local-resolution policy, and reason code. CalendarSnapshot hashes the complete evidence set so later phases can prove their windows use the accepted calendar.
