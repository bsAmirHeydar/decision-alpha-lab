---
title: "ADR — Broker Offset Is Explicit"
...
Broker time enters the kernel only with a caller-supplied UTC offset.

## Rationale

Automatic offset detection is current-environment dependent and cannot reproduce historical replays.
