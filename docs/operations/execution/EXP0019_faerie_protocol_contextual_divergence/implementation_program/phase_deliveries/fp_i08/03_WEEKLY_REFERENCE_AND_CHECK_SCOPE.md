...
language: en
---
# Weekly Reference and Check Scope

## Normative statement

The previous completed New York trading week is the reference W; the current New York trading week is the check W. Both are symbol-local and use FP-I05 windows.
