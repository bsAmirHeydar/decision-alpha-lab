...
Implements weekly WW compilation, confirmation reuse, neutralization, active-stack resolution, and directional gating. No indicator, quota, order, broker, position, chart-object, or network authority.
