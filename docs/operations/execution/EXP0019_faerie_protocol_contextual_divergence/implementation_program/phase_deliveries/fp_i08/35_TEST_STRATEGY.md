...
Tests cover policy rejection, identity, tie resolution, neutralization negatives, expiry, gate decisions, checkpoint parity, revision, schemas, MQL5 static boundary, and performance.
