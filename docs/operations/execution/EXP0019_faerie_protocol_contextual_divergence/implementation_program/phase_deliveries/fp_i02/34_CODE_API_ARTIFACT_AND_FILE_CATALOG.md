---
title: "FP-I02 — Code, API, Artifact, and File Catalog"
...
language: en
---
# Code, API, Artifact, and File Catalog

## Purpose

This catalog maps Python modules, MQL5 headers, schemas, artifacts, tools, tests, and documentation to their owner and downstream consumer.

## Normative invariants

1. **Every file appears in phase inventory.**
2. **Public APIs are exact-versioned.**
3. **Generated artifacts are reproducible.**
4. **No previous-phase file is silently replaced.**
