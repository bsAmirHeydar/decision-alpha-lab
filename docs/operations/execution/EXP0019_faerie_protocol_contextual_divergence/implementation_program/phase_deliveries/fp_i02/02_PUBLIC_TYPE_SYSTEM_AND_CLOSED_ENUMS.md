---
title: "FP-I02 — Public Type System and Closed Enums"
...
language: en
---
# Public Type System and Closed Enums

## Purpose

The type system eliminates free-text semantic drift. Window kinds, relation codes, direction, symbol roles, price sides, data states, lifecycle states, health states, profiles, policies, and authority levels are exact enums.

## Normative invariants

1. **Unknown enum values fail closed.**
2. **Enum numeric order in MQL5 is versioned and cannot be silently reordered.**
3. **Python enum values are the canonical wire strings.**
4. **Every public enum has a documented owner and downstream consumer.**

## Primary surfaces

- `WindowKind A/L/N/W`
- `RelationCode AL/AN/LN/NA/NL/NN/WW`
- `Candidate/Reference/WW/Quota states`
- `QuotaConsumptionPolicy with UNSET preserved`
- `ContextProfile and ExecutionAuthority`
