---
title: "FP-I02 — State-Machine Registry and Illegal Transitions"
...
language: en
---
# State-Machine Registry and Illegal Transitions

## Purpose

Candidate, reference-side, WW, and quota machines have closed transition maps. Terminal states cannot reopen. Quota consumption has an additional owner-decision guard.

## Normative invariants

1. **Candidate CONFIRMED/CANCELLED/EXPIRED/INVALID are terminal.**
2. **Hunter touch may advance FRESH to HUNTER_SEEN without consumption.**
3. **WW CONFIRMED may neutralize or expire.**
4. **Quota RESERVED may consume only under a frozen policy.**
