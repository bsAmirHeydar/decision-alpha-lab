---
title: "FP-I02 — Test Strategy: Golden, Negative, and Property Checks"
...
language: en
---
# Test Strategy: Golden, Negative, and Property Checks

## Purpose

The test suite exercises canonicalization, all registries, configuration identity, contracts, lifecycle transitions, migration, schemas, MQL5 static parity, authority boundaries, and conformance vectors.

## Normative invariants

1. **Each behavior axis has identity-change evidence.**
2. **Each immutable/policy-only field has identity-preservation evidence.**
3. **Unknown values and illegal transitions fail.**
4. **The golden suite repeats exactly.**
