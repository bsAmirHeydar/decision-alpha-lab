---
title: "FP-I02 — Divergence Candidate Contract"
...
language: en
---
# Divergence Candidate Contract

## Purpose

DivergenceCandidate represents one asymmetric first-sweep setup before confirmation. Its identity excludes mutable lifecycle state and reason code, but includes every behavior-bearing source axis.

## Normative invariants

1. **Hunter and protected symbols differ.**
2. **First hunt is M1 aligned.**
3. **Deadline follows hunt.**
4. **Resolved confirmation timeframe is positive and identity-bearing.**
5. **NA/NL/NN require positive calendar offset; other relations forbid it.**

## Primary surfaces

- `Relation/direction`
- `Role symbols`
- `Reference/check window IDs`
- `First-hunt time`
- `Strict deadline`
- `Data revision`
