---
title: "FP-I02 — Identity Ledger, Deduplication, and Conflicts"
...
language: en
---
# Identity Ledger, Deduplication, and Conflicts

## Purpose

IdentityLedger stores compact ID to payload hash. Re-registering the same payload returns DUPLICATE; reusing an ID for a different payload raises FP_RC_IDENTITY_CONFLICT.

## Normative invariants

1. **Deduplication is exact, not heuristic.**
2. **Conflicting payloads are never last-write-wins.**
3. **Snapshot hash is deterministic.**
4. **Later persistent ledger implementation must preserve this behavior.**
