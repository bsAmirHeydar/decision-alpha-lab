---
title: "FP-I02 — Performance, Memory, and Resource Budgets"
...
language: en
---
# Performance, Memory, and Resource Budgets

## Purpose

FP-I02 code is allocation-light and history-free. Canonical serialization is used for identity and evidence, not on every chart tick. Later phases may cache immutable hashes.

## Normative invariants

1. **No full-history loops.**
2. **No chart objects.**
3. **No network I/O.**
4. **Registry lookup is bounded.**
5. **Canonical payloads are immutable.**

## Primary surfaces

- `Startup hashing`
- `Registry memory`
- `Identity ledger growth`
- `MQL5 SHA helper`
- `Future caching rules`
