---
title: "FP-I02 — Authority, Security, and Forbidden Dependencies"
...
language: en
---
# Authority, Security, and Forbidden Dependencies

## Purpose

FP-I02 grants no runtime market authority. Static tests reject broker/order/position/network/chart-object imports and ensure no previous-context core is modified.

## Normative invariants

1. **No CTrade or OrderSend.**
2. **No WebRequest/socket.**
3. **No ObjectCreate.**
4. **No history-copy APIs.**
5. **No direct modification of EXP0017/EXP0018/Strategy Factory cores.**

## Primary surfaces

- `Python boundary scan`
- `MQL5 boundary scan`
- `Patch index ownership`
