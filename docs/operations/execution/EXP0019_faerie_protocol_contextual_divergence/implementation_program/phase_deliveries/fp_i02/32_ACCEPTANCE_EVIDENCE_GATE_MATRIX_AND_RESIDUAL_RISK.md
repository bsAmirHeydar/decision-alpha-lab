---
title: "FP-I02 — Acceptance Evidence, Gate Matrix, and Residual Risk"
...
language: en
---
# Acceptance Evidence, Gate Matrix, and Residual Risk

## Purpose

Acceptance requires deterministic IDs, semantic/projection separation, closed enums/reasons/relations, schema validation, lifecycle guards, compatibility regression, and honest MetaEditor status.

## Normative invariants

1. **Python/static pass does not equal MetaEditor compile.**
2. **Synthetic fixtures do not prove market edge.**
3. **Time/session semantics remain FP-I03 work.**
4. **Data coverage remains FP-I04 work.**
