---
title: "FP-I02 — Reference-Side Key and Lifecycle Record"
...
language: en
---
# Reference-Side Key and Lifecycle Record

## Purpose

A reference is side-specific and symbol-local. High and low receive separate IDs and lifecycle state. Hunter contact does not globally consume the side; protected contact may consume it in later phases.

## Normative invariants

1. **Reference identity includes window, symbol, side, price, and data revision.**
2. **High and low cannot share an ID.**
3. **HUNTER_SEEN requires hunter-event lineage.**
4. **CONSUMED requires protected-touch lineage.**
5. **Price is immutable within one revision.**

## Primary surfaces

- `ReferenceSideKey`
- `ReferenceSideRecord`
- `FRESH/HUNTER_SEEN/CONSUMED/EXPIRED/SUPERSEDED`
- `Event lineage`
- `Side-specific consumption`
