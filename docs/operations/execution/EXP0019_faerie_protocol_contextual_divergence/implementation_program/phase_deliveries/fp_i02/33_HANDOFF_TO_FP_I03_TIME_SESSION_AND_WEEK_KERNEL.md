---
title: "FP-I02 — Handoff to FP-I03 Time, Session, and Week Kernel"
...
language: en
---
# Handoff to FP-I03 Time, Session, and Week Kernel

## Purpose

FP-I03 may implement exact America/New_York conversion, DST, trading-day ownership, A/L/N intervals, and NY week keys only through the frozen FP-I02 types and identities.

## Normative invariants

1. **FP-I03 cannot rename enum values.**
2. **FP-I03 cannot alter identity field sets.**
3. **FP-I03 cannot infer quota consumption.**
4. **Every produced WindowKey must validate and hash deterministically.**
