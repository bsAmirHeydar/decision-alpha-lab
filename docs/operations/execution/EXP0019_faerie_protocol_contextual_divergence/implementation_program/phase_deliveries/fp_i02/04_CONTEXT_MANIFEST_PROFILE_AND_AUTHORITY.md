---
title: "FP-I02 — Context Manifest, Profile, and Authority"
...
language: en
---
# Context Manifest, Profile, and Authority

## Purpose

ContextManifestRecord binds exact config, dependency, registry, pair, decision-set, profile, and resolved timeframe identities into a context epoch. It is the root semantic identity for all downstream records.

## Normative invariants

1. **CANONICAL_RESEARCH has no execution authority.**
2. **CANONICAL_PAPER may create paper plans only in later phases.**
3. **CANONICAL_LIVE is impossible while FP-DEC-012 is open.**
4. **Created time is evidence but is excluded from context_epoch_id.**

## Primary surfaces

- `Manifest schema/version`
- `Decision set identity`
- `Semantic/projection/dependency hashes`
- `Open decision IDs`
