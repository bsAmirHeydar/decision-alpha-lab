...
Defines instance-scoped object IDs from semantic ID and object kind. Style, opacity, chart scale, and responsive lane placement do not alter semantic identity.
