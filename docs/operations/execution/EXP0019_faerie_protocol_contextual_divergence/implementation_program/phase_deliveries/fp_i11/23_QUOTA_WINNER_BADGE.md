...
Marks the pair-session first-entry reservation winner with a dedicated immutable badge. It does not imply permanent quota consumption while FP-DEC-012 remains open.
