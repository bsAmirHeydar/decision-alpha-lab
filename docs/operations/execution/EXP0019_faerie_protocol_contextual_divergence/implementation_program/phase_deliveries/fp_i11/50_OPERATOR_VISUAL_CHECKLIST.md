---
title: "Operator Visual Checklist"
...
Defines manual inspection of colors, layers, labels, lanes, session boundaries, suppression, WW, multi-chart isolation, resize behavior, and cleanup.
