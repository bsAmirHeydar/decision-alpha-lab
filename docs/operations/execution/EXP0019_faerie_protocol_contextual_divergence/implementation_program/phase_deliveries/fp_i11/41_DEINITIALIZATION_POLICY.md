...
# Deinitialization Policy

## Purpose

Default deinitialization removes mutable runtime objects while preserving immutable audit evidence; an explicit input may remove the entire instance namespace.
