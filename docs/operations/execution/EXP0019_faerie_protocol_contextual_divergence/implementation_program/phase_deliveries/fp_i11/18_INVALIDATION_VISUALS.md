...
# Invalidation Visuals

## Purpose

Projects terminal invalidation evidence without deleting the original semantic record. Double hunt, role change, data block, deadline miss, and replay-required remain distinguishable.
