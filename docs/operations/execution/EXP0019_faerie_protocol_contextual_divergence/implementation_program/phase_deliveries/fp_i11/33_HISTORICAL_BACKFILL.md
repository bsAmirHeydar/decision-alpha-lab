---
title: "Historical Visual Backfill"
...
# Historical Visual Backfill

## Purpose

Projects accepted historical facts within configured retention. Backfill is bounded and does not trigger semantic full-history recomputation.
