...
# WW Suppression Visual

## Purpose

Keeps directionally suppressed signals visible in Audit mode and, when enabled, Standard mode. Suppression is an eligibility overlay, not semantic deletion.
