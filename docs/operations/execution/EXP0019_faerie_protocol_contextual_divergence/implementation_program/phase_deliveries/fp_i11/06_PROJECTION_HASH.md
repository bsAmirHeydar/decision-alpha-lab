...
Defines the hash of anchor, style, text, visual state, semantic hash, and reason codes used by the dirty-set manager to detect exact no-op, update, or immutable conflict.
