...
Defines deterministic rendering order: week/session backgrounds, references, hunts, signals, suppression, badges, and health. Renderer order is stable across restart and chart refresh.
