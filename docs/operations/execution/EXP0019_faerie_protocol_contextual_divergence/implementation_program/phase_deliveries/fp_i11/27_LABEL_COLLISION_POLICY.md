...
Uses deterministic lanes rather than fixed price offsets. Stable identity prevents labels from jumping between refreshes unless chart geometry materially changes.
