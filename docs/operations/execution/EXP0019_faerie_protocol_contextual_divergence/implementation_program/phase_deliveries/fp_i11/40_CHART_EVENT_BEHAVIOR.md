...
# Chart Event Behavior

## Purpose

Chart resize and zoom can trigger layout-only updates. User object movement is disabled because chart objects are non-selectable and hidden from the object list by default.
