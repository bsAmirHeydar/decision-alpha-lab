---
title: "FP-I00 — Governance Harness Architecture and API"
...
language: en
---
# Governance Harness Architecture and API

## Purpose

The Python harness is split into canonicalization, models, Git capture, scanning, source verification, manifest assembly, validation, reporting, semantic diff, and CLI composition.

## Normative scope

- Keep modules pure and standard-library-only.
- Expose deterministic functions for tests and automation.
- Write closed JSON/CSV artifacts under the phase-owned artifact root.

## Non-bypassable invariants

1. **No validator performs market-data access.**
2. **No tool imports MQL5 trading libraries or broker APIs.**
3. **The CLI returns nonzero on any blocking issue.**
