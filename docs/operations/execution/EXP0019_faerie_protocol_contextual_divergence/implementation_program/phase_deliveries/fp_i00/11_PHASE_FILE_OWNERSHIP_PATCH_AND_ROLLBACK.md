---
title: "FP-I00 — Phase File Ownership, Patch Scope, and Rollback"
...
language: en
---
# Phase File Ownership, Patch Scope, and Rollback

## Purpose

FP-I00 owns only its governance code/evidence, phase-delivery documentation, atomic concepts, and root release metadata.

## Normative scope

- List ownership prefixes in policy and generated CSV.
- Stage only the phase file index.
- Rollback removes only indexed files and preserves unrelated evidence.

## Non-bypassable invariants

1. **Shared-core files are read-only inputs.**
2. **Previous FP documentation is referenced and may receive status/handoff metadata only when explicitly indexed.**
3. **Object or runtime files outside ownership are forbidden.**
