---
title: "FP-I00 — Rollback, Recovery, and Incident Response"
...
Rollback removes only FP-I00-indexed files and restores the accepted documentation/program baseline.

## Normative scope

- Preserve validation and incident logs when a gate fails.
- Revert generated phase evidence together with the code that produced it.
- Retain upstream documentation and source audits.

## Non-bypassable invariants

1. **Do not delete evidence used by a downstream decision.**
2. **A corrupted manifest is regenerated only from accepted contracts.**
3. **An accidental shared-core edit is reverted separately and treated as a compatibility incident.**
