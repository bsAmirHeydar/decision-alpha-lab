---
title: "ADR — Shared Cores Are Read-Only Inputs"
...
language: en
---
# Shared Cores Are Read-Only Inputs
...
FP-I00 inventories and hashes shared cores but does not modify them. Later generic extraction requires separate regression evidence and versioning.

## Context

Faerie Protocol is a context policy layer. Modifying generic cores during baseline freeze would mix governance and behavior.
