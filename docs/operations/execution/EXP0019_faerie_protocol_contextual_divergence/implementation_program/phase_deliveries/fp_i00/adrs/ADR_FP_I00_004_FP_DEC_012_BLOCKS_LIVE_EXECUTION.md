---
title: "ADR — FP-DEC-012 Blocks Live Execution"
...
language: en
---
# FP-DEC-012 Blocks Live Execution
...
Until the quota-consumption moment is owner-confirmed, live execution is disabled. Detection, drawing, audit, and non-live reservation architecture may proceed only under explicit boundaries.

## Context

Silently selecting PLAN_CREATED, ORDER_ATTEMPTED, ORDER_ACCEPTED, FILLED, or TWO_STAGE would change trade entitlement semantics.
