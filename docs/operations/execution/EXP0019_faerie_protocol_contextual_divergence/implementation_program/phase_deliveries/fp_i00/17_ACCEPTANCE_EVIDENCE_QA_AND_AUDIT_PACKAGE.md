---
title: "FP-I00 — Acceptance Evidence, QA, and Audit Package"
...
language: en
---
# Acceptance Evidence, QA, and Audit Package

## Purpose

The accepted package combines baseline manifest, inventories, validation report, tests, file hashes, patch manifest, QA report, and documentation.

## Normative scope

- Record test counts and policy checks.
- Record archive-vs-local Git evidence honestly.
- Record no MQL5 runtime code and no MetaEditor compile requirement for this phase.

## Non-bypassable invariants

1. **The QA report is derived from executed tests.**
2. **File hashes cover every patch-owned artifact except the hash file itself.**
3. **The audit package is sufficient for FP-I01 without reading implementation internals.**
