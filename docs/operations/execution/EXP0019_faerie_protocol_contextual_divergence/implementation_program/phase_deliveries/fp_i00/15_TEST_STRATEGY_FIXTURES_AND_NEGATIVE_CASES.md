---
title: "FP-I00 — Test Strategy, Fixtures, and Negative Cases"
...
language: en
---
# Test Strategy, Fixtures, and Negative Cases

## Purpose

The phase test suite proves deterministic identity, source verification, Git capture, inventory, positive validation, and injected failure behavior.

## Normative scope

- Test dictionary-order invariance and non-finite rejection.
- Test Git archive, clean, dirty, and phase-clean states.
- Inject missing dependencies, closed live gate, relation reorder, runtime-file creation, and manifest tampering.

## Non-bypassable invariants

1. **Tests remain fast and do not clone the full repository per negative case.**
2. **The golden repository gate executes at least 139 checks.**
3. **All negative fixtures assert the exact reason code.**
