---
title: "FP-I00 — Documentation and Normative Baseline Freeze"
...
language: en
---
# Documentation and Normative Baseline Freeze

## Purpose

The v2 context doctrine and v1 implementation program are frozen as the normative input to code.

## Normative scope

- Hash the complete EXP0019 documentation tree, including Markdown, JSON, CSV, and normalized INI evidence.
- Record the owner-decision, open-decision, relation-registry, and implementation-program files separately.
- Prevent later code from silently superseding a documented policy.

## Non-bypassable invariants

1. **Documentation identity is content-addressed.**
2. **Source prose, owner decisions, and architectural derivations keep their authority classifications.**
3. **A documentation change requires a reviewed rebaseline, not an incidental code patch.**
