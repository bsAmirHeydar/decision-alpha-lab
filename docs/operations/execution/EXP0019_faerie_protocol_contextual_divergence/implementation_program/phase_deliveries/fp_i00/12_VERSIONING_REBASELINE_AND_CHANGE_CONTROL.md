---
title: "FP-I00 — Versioning, Rebaseline, and Change Control"
...
language: en
---
# Versioning, Rebaseline, and Change Control

## Purpose

A rebaseline is an explicit governance event, not an automatic regeneration after any file change.

## Normative scope

- Classify changes as source, decision, doctrine, program, dependency, test, ownership, or tooling changes.
- Increment the appropriate contract version before regenerating accepted evidence.
- Use semantic manifest diff to disclose exact changed paths.

## Non-bypassable invariants

1. **A hash change without a documented reason is a blocker.**
2. **A new owner answer cannot overwrite v2 decisions in place.**
3. **Dependency drift is reviewed before FP adapters are updated.**
