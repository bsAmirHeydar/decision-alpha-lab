---
title: "FP-I00 — Relation and Program Registry Freeze"
...
language: en
---
# Relation and Program Registry Freeze

## Purpose

The relation registry and implementation phase registry are immutable coordination contracts.

## Normative scope

- Require the exact ordered relation set AL, AN, LN, NA, NL, NN, WW.
- Require `REFERENCE_THEN_CHECK` naming.
- Require the exact FP-I00 through FP-I16 phase sequence and preserve FP-DEC-012 as the live blocker.

## Non-bypassable invariants

1. **Relation ordering is deterministic registry evidence, not a hidden switch statement.**
2. **The program may add a new version but may not mutate v1 history.**
3. **WW remains both a relation and a directional policy input as documented.**
