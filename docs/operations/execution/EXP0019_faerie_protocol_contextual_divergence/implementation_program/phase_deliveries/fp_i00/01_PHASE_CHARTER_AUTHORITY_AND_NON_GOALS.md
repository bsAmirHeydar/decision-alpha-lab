---
title: "FP-I00 — Phase Charter, Authority, and Non-Goals"
...
language: en
---
# Phase Charter, Authority, and Non-Goals

## Purpose

FP-I00 establishes the immutable implementation baseline and the governance harness that all later Faerie Protocol phases must consume.

## Normative scope

- Freeze source, documentation, decisions, dependencies, test entry points, file ownership, and rollback scope.
- Provide executable validation without adding any market detector, indicator, EA, order, broker, or network authority.
- Make missing evidence a blocker rather than allowing later phases to infer behavior from code.

## Non-bypassable invariants

1. **The phase has zero runtime market authority.**
2. **The shared cores are inspected and hash-pinned but never modified.**
3. **The one unresolved owner decision remains explicit and live execution remains disabled.**
