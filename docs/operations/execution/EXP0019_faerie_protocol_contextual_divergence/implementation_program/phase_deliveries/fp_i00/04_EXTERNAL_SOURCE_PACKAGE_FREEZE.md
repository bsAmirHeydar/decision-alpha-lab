---
title: "FP-I00 — External Source Package Freeze"
...
language: en
---
# External Source Package Freeze

## Purpose

The original Word specification, legacy EA, and SET file are frozen by filename and SHA-256 without copying their contents into runtime modules.

## Normative scope

- Parse the three-row `SOURCE_HASHES.sha256` contract.
- Optionally verify an external source directory byte-for-byte.
- Report missing, mismatched, and extra files separately.

## Non-bypassable invariants

1. **Exactly three canonical source artifacts exist.**
2. **A hash mismatch is a hard blocker.**
3. **Extra source files are reported but do not replace any canonical source artifact.**
