---
title: "FP-I07 — Mission, boundaries, dependencies, and non-goals"
...
language: en
---
# Mission, boundaries, dependencies, and non-goals

## Purpose

Mission, boundaries, dependencies, and non-goals. This note is normative for FP-I07 and is implemented by the Python package `fp_i07_confirmation`, the MQL5 mirror under `I07`, the closed JSON schemas, and the phase tests.
