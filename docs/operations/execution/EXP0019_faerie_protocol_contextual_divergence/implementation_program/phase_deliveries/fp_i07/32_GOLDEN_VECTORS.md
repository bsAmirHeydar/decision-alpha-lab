---
title: "FP-I07 — Positive and negative deterministic cases"
...
language: en
---
# Positive and negative deterministic cases

## Purpose

Positive and negative deterministic cases. This note is normative for FP-I07 and is implemented by the Python package `fp_i07_confirmation`, the MQL5 mirror under `I07`, the closed JSON schemas, and the phase tests.
