---
title: "FP-I07 — Exact FP-I06 contracts consumed without reinterpretation"
...
language: en
---
# Exact FP-I06 contracts consumed without reinterpretation

## Purpose

Exact FP-I06 contracts consumed without reinterpretation. This note is normative for FP-I07 and is implemented by the Python package `fp_i07_confirmation`, the MQL5 mirror under `I07`, the closed JSON schemas, and the phase tests.
