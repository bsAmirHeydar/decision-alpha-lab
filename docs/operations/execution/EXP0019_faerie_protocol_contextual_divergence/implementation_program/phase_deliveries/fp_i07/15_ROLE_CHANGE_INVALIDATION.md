---
title: "FP-I07 — Protected-only state is not a reversed new signal"
...
language: en
---
# Protected-only state is not a reversed new signal

## Purpose

Protected-only state is not a reversed new signal. This note is normative for FP-I07 and is implemented by the Python package `fp_i07_confirmation`, the MQL5 mirror under `I07`, the closed JSON schemas, and the phase tests.
