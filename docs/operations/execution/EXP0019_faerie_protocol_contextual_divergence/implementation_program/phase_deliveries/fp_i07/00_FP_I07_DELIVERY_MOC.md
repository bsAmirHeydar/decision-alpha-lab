---
title: "FP-I07 — Delivery map and reading order"
...
language: en
---
# Delivery map and reading order

## Purpose

Delivery map and reading order. This note is normative for FP-I07 and is implemented by the Python package `fp_i07_confirmation`, the MQL5 mirror under `I07`, the closed JSON schemas, and the phase tests.
