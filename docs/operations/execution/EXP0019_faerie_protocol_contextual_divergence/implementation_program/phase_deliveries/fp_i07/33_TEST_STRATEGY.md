---
title: "FP-I07 — Unit, boundary, replay, restart, negative, regression tests"
...
language: en
---
# Unit, boundary, replay, restart, negative, regression tests

## Purpose

Unit, boundary, replay, restart, negative, regression tests. This note is normative for FP-I07 and is implemented by the Python package `fp_i07_confirmation`, the MQL5 mirror under `I07`, the closed JSON schemas, and the phase tests.
