---
title: "FP-I07 — Transient asymmetry that disappears is terminal no-signal"
...
language: en
---
# Transient asymmetry that disappears is terminal no-signal

## Purpose

Transient asymmetry that disappears is terminal no-signal. This note is normative for FP-I07 and is implemented by the Python package `fp_i07_confirmation`, the MQL5 mirror under `I07`, the closed JSON schemas, and the phase tests.
