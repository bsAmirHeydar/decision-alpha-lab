---
title: "FP-I07 — Confirmed-signal handoff for WW engine"
...
language: en
---
# Confirmed-signal handoff for WW engine

## Purpose

Confirmed-signal handoff for WW engine. This note is normative for FP-I07 and is implemented by the Python package `fp_i07_confirmation`, the MQL5 mirror under `I07`, the closed JSON schemas, and the phase tests.
