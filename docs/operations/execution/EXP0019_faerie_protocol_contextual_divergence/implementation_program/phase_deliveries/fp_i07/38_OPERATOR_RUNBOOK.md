---
title: "FP-I07 — Initialization, diagnostic, checkpoint, incident workflow"
...
language: en
---
# Initialization, diagnostic, checkpoint, incident workflow

## Purpose

Initialization, diagnostic, checkpoint, incident workflow. This note is normative for FP-I07 and is implemented by the Python package `fp_i07_confirmation`, the MQL5 mirror under `I07`, the closed JSON schemas, and the phase tests.
