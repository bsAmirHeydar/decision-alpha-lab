---
title: "FP-I07 — Host timeframe change starts a new config epoch"
...
language: en
---
# Host timeframe change starts a new config epoch

## Purpose

Host timeframe change starts a new config epoch. This note is normative for FP-I07 and is implemented by the Python package `fp_i07_confirmation`, the MQL5 mirror under `I07`, the closed JSON schemas, and the phase tests.
