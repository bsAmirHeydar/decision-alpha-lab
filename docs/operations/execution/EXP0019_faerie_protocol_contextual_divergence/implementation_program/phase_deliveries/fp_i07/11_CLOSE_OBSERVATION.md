---
title: "FP-I07 — Pair state at target close and causal as-of evidence"
...
language: en
---
# Pair state at target close and causal as-of evidence

## Purpose

Pair state at target close and causal as-of evidence. This note is normative for FP-I07 and is implemented by the Python package `fp_i07_confirmation`, the MQL5 mirror under `I07`, the closed JSON schemas, and the phase tests.
