---
title: "FP-I07 — Later data revisions never rewrite confirmed evidence"
...
language: en
---
# Later data revisions never rewrite confirmed evidence

## Purpose

Later data revisions never rewrite confirmed evidence. This note is normative for FP-I07 and is implemented by the Python package `fp_i07_confirmation`, the MQL5 mirror under `I07`, the closed JSON schemas, and the phase tests.
