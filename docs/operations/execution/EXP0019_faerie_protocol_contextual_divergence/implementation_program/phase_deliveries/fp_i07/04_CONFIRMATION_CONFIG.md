---
title: "FP-I07 — Resolved host timeframe and identity-bearing configuration"
...
language: en
---
# Resolved host timeframe and identity-bearing configuration

## Purpose

Resolved host timeframe and identity-bearing configuration. This note is normative for FP-I07 and is implemented by the Python package `fp_i07_confirmation`, the MQL5 mirror under `I07`, the closed JSON schemas, and the phase tests.
