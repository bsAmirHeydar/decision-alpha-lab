---
title: "FP-I07 — Pending to exactly one terminal state"
...
Pending to exactly one terminal state. This note is normative for FP-I07 and is implemented by the Python package `fp_i07_confirmation`, the MQL5 mirror under `I07`, the closed JSON schemas, and the phase tests.
