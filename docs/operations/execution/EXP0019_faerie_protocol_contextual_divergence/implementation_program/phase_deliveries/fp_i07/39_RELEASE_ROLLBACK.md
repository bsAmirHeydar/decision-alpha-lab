---
title: "FP-I07 — Patch-only rollback and evidence retention"
...
language: en
---
# Patch-only rollback and evidence retention

## Purpose

Patch-only rollback and evidence retention. This note is normative for FP-I07 and is implemented by the Python package `fp_i07_confirmation`, the MQL5 mirror under `I07`, the closed JSON schemas, and the phase tests.
