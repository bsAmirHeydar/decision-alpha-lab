---
title: "FP-I07 — Closed-bar clock and replay/live parity"
...
language: en
---
# Closed-bar clock and replay/live parity

## Purpose

Closed-bar clock and replay/live parity. This note is normative for FP-I07 and is implemented by the Python package `fp_i07_confirmation`, the MQL5 mirror under `I07`, the closed JSON schemas, and the phase tests.
