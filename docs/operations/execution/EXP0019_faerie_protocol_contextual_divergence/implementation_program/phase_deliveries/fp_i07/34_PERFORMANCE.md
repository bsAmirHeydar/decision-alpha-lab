---
title: "FP-I07 — O(1) candidate store and no full-history confirmation loop"
...
language: en
---
# O(1) candidate store and no full-history confirmation loop

## Purpose

O(1) candidate store and no full-history confirmation loop. This note is normative for FP-I07 and is implemented by the Python package `fp_i07_confirmation`, the MQL5 mirror under `I07`, the closed JSON schemas, and the phase tests.
