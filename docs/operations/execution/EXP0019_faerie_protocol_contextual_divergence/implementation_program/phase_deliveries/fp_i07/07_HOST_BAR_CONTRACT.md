---
title: "FP-I07 — Actual host geometry, causal availability, and M1 lineage"
...
language: en
---
# Actual host geometry, causal availability, and M1 lineage

## Purpose

Actual host geometry, causal availability, and M1 lineage. This note is normative for FP-I07 and is implemented by the Python package `fp_i07_confirmation`, the MQL5 mirror under `I07`, the closed JSON schemas, and the phase tests.
