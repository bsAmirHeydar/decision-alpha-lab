---
title: "FP-I07 — Outcome table for HUNTER_ONLY/BOTH/PROTECTED_ONLY/NONE/DATA"
...
language: en
---
# Outcome table for HUNTER_ONLY/BOTH/PROTECTED_ONLY/NONE/DATA

## Purpose

Outcome table for HUNTER_ONLY/BOTH/PROTECTED_ONLY/NONE/DATA. This note is normative for FP-I07 and is implemented by the Python package `fp_i07_confirmation`, the MQL5 mirror under `I07`, the closed JSON schemas, and the phase tests.
