---
title: "FP-I07 — Only pending candidates are invalidated by overlapping revisions"
...
language: en
---
# Only pending candidates are invalidated by overlapping revisions

## Purpose

Only pending candidates are invalidated by overlapping revisions. This note is normative for FP-I07 and is implemented by the Python package `fp_i07_confirmation`, the MQL5 mirror under `I07`, the closed JSON schemas, and the phase tests.
