---
title: "FP-I07 — Missed target close cannot be guessed from a later tick"
...
language: en
---
# Missed target close cannot be guessed from a later tick

## Purpose

Missed target close cannot be guessed from a later tick. This note is normative for FP-I07 and is implemented by the Python package `fp_i07_confirmation`, the MQL5 mirror under `I07`, the closed JSON schemas, and the phase tests.
