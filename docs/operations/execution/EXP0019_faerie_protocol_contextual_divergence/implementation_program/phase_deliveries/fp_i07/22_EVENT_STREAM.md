---
title: "FP-I07 — Append-only admission and terminal events"
...
language: en
---
# Append-only admission and terminal events

## Purpose

Append-only admission and terminal events. This note is normative for FP-I07 and is implemented by the Python package `fp_i07_confirmation`, the MQL5 mirror under `I07`, the closed JSON schemas, and the phase tests.
