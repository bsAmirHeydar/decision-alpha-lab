---
title: "FP-I07 — Fail-closed behavior catalogue"
...
language: en
---
# Fail-closed behavior catalogue

## Purpose

Fail-closed behavior catalogue. This note is normative for FP-I07 and is implemented by the Python package `fp_i07_confirmation`, the MQL5 mirror under `I07`, the closed JSON schemas, and the phase tests.
