---
title: "FP-I07 — Close must be strictly before owning session end"
...
language: en
---
# Close must be strictly before owning session end

## Purpose

Close must be strictly before owning session end. This note is normative for FP-I07 and is implemented by the Python package `fp_i07_confirmation`, the MQL5 mirror under `I07`, the closed JSON schemas, and the phase tests.
