---
title: "FP-I07 — Version/config/hash validation and deterministic restore"
...
language: en
---
# Version/config/hash validation and deterministic restore

## Purpose

Version/config/hash validation and deterministic restore. This note is normative for FP-I07 and is implemented by the Python package `fp_i07_confirmation`, the MQL5 mirror under `I07`, the closed JSON schemas, and the phase tests.
