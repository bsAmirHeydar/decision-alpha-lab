---
title: "FP-I07 — Only RAW_ACTIVE candidates admitted once"
...
language: en
---
# Only RAW_ACTIVE candidates admitted once

## Purpose

Only RAW_ACTIVE candidates admitted once. This note is normative for FP-I07 and is implemented by the Python package `fp_i07_confirmation`, the MQL5 mirror under `I07`, the closed JSON schemas, and the phase tests.
