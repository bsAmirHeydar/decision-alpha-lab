---
title: "FP-I07 — Candidate-level one result and signal-level stable identity"
...
language: en
---
# Candidate-level one result and signal-level stable identity

## Purpose

Candidate-level one result and signal-level stable identity. This note is normative for FP-I07 and is implemented by the Python package `fp_i07_confirmation`, the MQL5 mirror under `I07`, the closed JSON schemas, and the phase tests.
