---
title: "Price Grid and OHLC Validation"
...
language: en
---
# Price Grid and OHLC Validation

## Purpose

Prices must be finite, lie on the symbol tick grid, and satisfy high/low/open/close envelope constraints before any duplicate or alignment logic.

## Normative invariants

1. **Tick grid is symbol-local.**
2. **Invalid bars are rejected before coverage accounting.**
3. **Zero volume is suspect evidence, not necessarily invalid OHLC.**
4. **Validation failures never produce synthetic replacements.**
