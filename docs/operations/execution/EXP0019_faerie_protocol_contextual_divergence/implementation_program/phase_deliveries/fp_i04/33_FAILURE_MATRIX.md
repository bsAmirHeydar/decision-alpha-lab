...
The phase fails closed on unresolved symbols, invalid bars, calendar hash drift, duplicate conflicts, cursor revision mismatch, corrupted checkpoint, or unsupported schema.

## Normative invariants

1. **Invalid input is rejected before alignment.**
2. **Conflict blocks only its dependent result, not audit storage.**
3. **Missing history degrades with explicit reason.**
4. **No nearest-bar substitution is permitted.**
