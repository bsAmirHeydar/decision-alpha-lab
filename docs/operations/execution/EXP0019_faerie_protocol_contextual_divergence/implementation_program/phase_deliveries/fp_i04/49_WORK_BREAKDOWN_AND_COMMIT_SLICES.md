---
title: "Work Breakdown and Commit Slices"
...
language: en
---
# Work Breakdown and Commit Slices

## Purpose

The phase can be reviewed in slices: contracts, symbol/bar validation, duplicate normalization, axis/coverage, sync, revision/cursor/backfill, MQL5 mirror, tests, docs, and release evidence.

## Normative invariants

1. **Each slice has tests before integration.**
2. **Behavior changes update vectors.**
3. **One patch owns only FP-I04 files.**
4. **Handoff begins only after cumulative QA.**
