...
Acceptance requires UTC M1 alignment, explicit missing states, local revision invalidation, batch/incremental parity, closed schemas, MQL5 static parity, previous regressions, and zero runtime authority.

## Normative invariants

1. **Every gate has executable evidence.**
2. **MetaEditor is pending until actual Windows logs exist.**
3. **Warnings are treated as unresolved work.**
4. **Patch verification runs on a clean FP-I03 baseline.**
