---
title: "Symbol Pair and Alias Resolution"
...
language: en
---
# Symbol Pair and Alias Resolution

## Purpose

A versioned SymbolPairSpec maps broker aliases to exactly two canonical symbols while retaining tick size and digits for validation.

## Normative invariants

1. **Aliases are case-insensitive and collision-free.**
2. **Unknown aliases are blocked.**
3. **Pair order is stable: left and right are semantic roles, not display choices.**
4. **Changing symbol metadata changes pair identity.**
