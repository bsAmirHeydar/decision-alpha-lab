...
The diagnostic entry point exposes configuration and future data-sync telemetry without drawing or execution.

## Normative invariants

1. **Initialization rejects invalid parameters.**
2. **Authority is printed as NONE.**
3. **Future live acquisition must remain an adapter.**
4. **Diagnostic output includes pair and revision evidence.**
