...
Diagnostics report raw bars, accepted bars, identical duplicates, conflicts, expected/excluded minutes, present/missing/out-of-coverage/revised cells, gaps, revision kind, cursor, and backfill plan.

## Normative invariants

1. **Counters reconcile to inputs and axis.**
2. **No metric implies completeness without evidence.**
3. **Pair and revision IDs accompany every report.**
4. **Performance counters are operational, not semantic.**
