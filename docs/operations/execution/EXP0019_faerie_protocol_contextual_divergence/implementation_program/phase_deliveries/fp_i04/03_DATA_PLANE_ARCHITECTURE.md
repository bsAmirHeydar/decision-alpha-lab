...
The phase is split into symbol resolution, bar validation, duplicate normalization, expected-axis construction, coverage analysis, pair synchronization, revision lineage, cursoring, and backfill planning.

## Normative invariants

1. **Leaf modules are pure and deterministic.**
2. **The synchronizer composes upstream calendar and phase-local modules.**
3. **Transport metadata is separated from bar semantics.**
4. **No product entry point owns hidden data state.**
