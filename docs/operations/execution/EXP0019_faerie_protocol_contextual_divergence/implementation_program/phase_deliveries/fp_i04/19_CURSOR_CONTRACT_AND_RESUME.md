---
title: "Cursor Contract and Resume"
...
language: en
---
# Cursor Contract and Resume

## Purpose

IncrementalCursor binds pair ID, last minute, both source sequences, current revision ID, state, and cursor version.

## Normative invariants

1. **EMPTY is the only revision-free starting state.**
2. **ACTIVE cursor resumes only against its parent revision.**
3. **INVALIDATED cursor cannot resume.**
4. **Cursor identity is deterministic.**
