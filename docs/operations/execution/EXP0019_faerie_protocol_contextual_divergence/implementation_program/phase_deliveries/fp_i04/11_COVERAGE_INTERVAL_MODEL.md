...
language: en
---
# Coverage Interval Model

## Purpose

Each symbol receives a coverage interval with present count, expected count, excluded count, source revision hash, state, and reason.

## Normative invariants

1. **COMPLETE means every expected minute is present.**
2. **PARTIAL means some expected minutes are absent.**
3. **EMPTY means no expected minute is present.**
4. **CONFLICTED dominates present-count completeness.**
