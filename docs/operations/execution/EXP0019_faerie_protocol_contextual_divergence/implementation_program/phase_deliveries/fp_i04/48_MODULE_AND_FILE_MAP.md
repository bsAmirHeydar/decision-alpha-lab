...
The implementation is organized by canonical identity, contracts, symbol resolution, validation, normalization, coverage, synchronization, revision, cursor, backfill, conformance, registry, and CLI.

## Normative invariants

1. **No circular dependency into product layers.**
2. **I03 is an upstream dependency only.**
3. **I02 remains the shared identity kernel.**
4. **Release ownership excludes all previous phase directories.**
