...
Gap intervals are translated into FETCH_RANGE, FULL_REBUILD, BLOCK, or NONE requests under explicit size and conflict rules.

## Normative invariants

1. **Internal bounded gaps use FETCH_RANGE.**
2. **Oversized repair requests use FULL_REBUILD.**
3. **Conflicts use BLOCK.**
4. **Calendar exclusions never request history.**
