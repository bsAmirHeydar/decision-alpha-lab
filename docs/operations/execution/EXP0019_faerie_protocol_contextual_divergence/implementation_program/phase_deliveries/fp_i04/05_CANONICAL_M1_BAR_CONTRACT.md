---
title: "Canonical M1 Bar Contract"
...
language: en
---
# Canonical M1 Bar Contract

## Purpose

M1Bar stores UTC minute open, OHLC, volume, spread, finality, source revision, transport sequence, and receipt time. Its semantic hash excludes transport-only metadata.

## Normative invariants

1. **Open time is divisible by 60,000 ms.**
2. **OHLC envelope and finite-number rules are enforced.**
3. **Closed finality is required for canonical conclusions.**
4. **Source revision changes semantic identity.**
