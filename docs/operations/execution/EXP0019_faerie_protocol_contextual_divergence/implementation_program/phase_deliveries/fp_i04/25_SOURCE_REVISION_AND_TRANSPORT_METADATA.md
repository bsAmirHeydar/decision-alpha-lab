---
title: "Source Revision and Transport Metadata"
...
language: en
---
# Source Revision and Transport Metadata

## Purpose

Source revision is semantic because it identifies vendor/history version; source ID, sequence, and receipt time are transport evidence and do not alter price identity when semantics are equal.

## Normative invariants

1. **A transport retry is deduplicated.**
2. **A vendor correction changes bar identity.**
3. **Receipt timing cannot rewrite historical order.**
4. **Source sequence is used only for deterministic duplicate retention.**
