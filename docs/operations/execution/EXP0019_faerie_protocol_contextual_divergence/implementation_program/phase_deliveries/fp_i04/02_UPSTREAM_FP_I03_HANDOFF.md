...
language: en
---
# Upstream FP-I03 Handoff

## Purpose

The data plane consumes UTC-normalized minute opens and the exact New York calendar snapshot from FP-I03 without redefining DST, trading-day, A/L/N, daily-gap, or weekly boundaries.

## Normative invariants

1. **Calendar config hash is identity-bearing.**
2. **Session-only axes exclude daily gap and weekend explicitly.**
3. **Calendar drift blocks initialization.**
4. **Broker/server time never drives alignment.**
