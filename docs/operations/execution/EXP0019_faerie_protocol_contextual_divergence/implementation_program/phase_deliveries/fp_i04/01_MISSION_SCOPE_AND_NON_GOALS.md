---
title: "Mission, Scope, and Non-Goals"
...
FP-I04 establishes a deterministic two-symbol M1 data plane. It resolves symbols, validates closed bars, canonicalizes duplicate deliveries, aligns both symbols by UTC minute open, exposes coverage and gaps, versions revisions, and supports bounded incremental repair.

## Normative invariants

1. **No reference aggregation, relation semantics, drawing, alerts, or execution.**
2. **M1 closed bars are the only price authority.**
3. **Missing evidence is represented, never filled synthetically.**
4. **All downstream phases consume revision-bearing aligned rows.**
