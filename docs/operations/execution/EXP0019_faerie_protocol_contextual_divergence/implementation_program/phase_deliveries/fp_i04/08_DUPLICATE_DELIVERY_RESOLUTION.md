---
title: "Duplicate Delivery Resolution"
...
Multiple deliveries for one symbol-minute are grouped by canonical key. Identical semantic bars are deduplicated using deterministic transport ordering; conflicting semantic bars block that minute.

## Normative invariants

1. **Identical duplicates do not create extra bars.**
2. **Latest source sequence is retained only as transport evidence.**
3. **Conflicts do not select a winner.**
4. **Conflict hashes preserve all input bar hashes.**
