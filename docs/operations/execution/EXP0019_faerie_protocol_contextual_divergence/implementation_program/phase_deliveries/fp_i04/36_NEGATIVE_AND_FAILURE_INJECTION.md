---
title: "Negative and Failure Injection"
...
Negative tests inject provisional bars, off-grid prices, malformed OHLC, unknown aliases, conflicting duplicates, missing history, calendar hash mismatch, stale cursor, and oversized repair.

## Normative invariants

1. **Each failure has one closed reason code.**
2. **No failure is converted to a default bar.**
3. **Blocked data remains serializable for audit.**
4. **Unexpected exceptions fail the phase.**
