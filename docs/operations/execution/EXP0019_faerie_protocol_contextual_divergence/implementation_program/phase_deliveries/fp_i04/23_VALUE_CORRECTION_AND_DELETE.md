---
title: "Value Correction and Delete"
...
language: en
---
# Value Correction and Delete

## Purpose

A correction changes semantic bar content for an existing key; a delete removes a previously accepted key.

## Normative invariants

1. **Corrected cells are marked REVISED.**
2. **Delete reclassifies absence by current coverage bounds.**
3. **Both actions change dataset payload hash.**
4. **Previous artifacts remain retained for audit.**
