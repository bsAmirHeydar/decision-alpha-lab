...
Data incidents are classified as acquisition shortage, internal gap, vendor correction, duplicate conflict, calendar drift, or checkpoint mismatch.

## Normative invariants

1. **Capture source payload hashes first.**
2. **Do not manually edit canonical datasets.**
3. **Repair through a new revision.**
4. **Re-run dependent windows only after accepted repair.**
