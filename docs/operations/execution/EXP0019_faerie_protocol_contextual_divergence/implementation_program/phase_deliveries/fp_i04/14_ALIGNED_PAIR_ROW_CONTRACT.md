---
title: "Aligned Pair Row Contract"
...
language: en
---
# Aligned Pair Row Contract

## Purpose

AlignedMinute contains left and right cells for one UTC minute, plus the upstream calendar segment and snapshot hash.

## Normative invariants

1. **Both cells share the same open time.**
2. **Pair ID and left/right ordering are immutable.**
3. **Row identity includes both cell states and revision evidence.**
4. **A missing side is not dropped from the row.**
