...
Absence is classified as BEFORE_COVERAGE, SOURCE_MISSING inside known coverage, AFTER_COVERAGE, CALENDAR_EXCLUDED, or DUPLICATE_CONFLICT.

## Normative invariants

1. **History shortage differs from internal data loss.**
2. **Only internal/source gaps are normal range-backfill candidates.**
3. **Conflict is a blocking data-quality incident.**
4. **Adjacent gaps with equal reason are run-length encoded.**
