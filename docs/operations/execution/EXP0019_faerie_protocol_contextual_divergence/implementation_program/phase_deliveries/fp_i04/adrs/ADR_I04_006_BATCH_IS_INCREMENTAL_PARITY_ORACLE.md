---
title: "ADR — Batch Is the Incremental Parity Oracle"
status: accepted
date: 2026-07-13
phase: FP-I04
---
# Batch Is the Incremental Parity Oracle

## Decision

A clean batch rebuild defines the accepted semantic sequence. Incremental and resumed paths must reproduce that sequence for the same source revision and configuration.
