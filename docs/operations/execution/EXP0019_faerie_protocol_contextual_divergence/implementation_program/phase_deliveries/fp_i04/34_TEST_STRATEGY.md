...
Tests cover contracts, aliases, price validation, duplicate handling, calendar axes, coverage, synchronization, revisions, cursoring, backfill, batch/incremental parity, identities, schemas, and authority boundaries.

## Normative invariants

1. **Golden and negative paths are executable.**
2. **Input permutation tests prove order independence.**
3. **Late-data tests prove bounded invalidation.**
4. **Previous phase regressions remain green.**
