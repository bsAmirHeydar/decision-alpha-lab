---
title: "Restart and Rebuild Parity"
...
language: en
---
# Restart and Rebuild Parity

## Purpose

A clean rebuild from source bars must reproduce the same normalized bars, rows, gaps, revision semantics, and snapshot hash as an accepted checkpoint path.

## Normative invariants

1. **Checkpoint version mismatch triggers rebuild.**
2. **Resume does not skip unverified minutes.**
3. **Batch output remains the parity oracle.**
4. **Failure evidence survives restart.**
