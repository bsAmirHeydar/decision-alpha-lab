---
title: "Initial and Append Revisions"
...
language: en
---
# Initial and Append Revisions

## Purpose

INITIAL establishes the first dataset root. APPEND adds bars strictly after the previous maximum minute without rewriting earlier data.

## Normative invariants

1. **Append does not invalidate prior rows.**
2. **New suffix identities are deterministic.**
3. **Transport replay of identical bars is NO_CHANGE.**
4. **Append remains bounded by requested range.**
