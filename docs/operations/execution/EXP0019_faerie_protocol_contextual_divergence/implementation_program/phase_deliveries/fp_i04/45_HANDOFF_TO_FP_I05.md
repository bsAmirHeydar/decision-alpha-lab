---
title: "Handoff to FP-I05 Reference Engine"
...
language: en
---
# Handoff to FP-I05 Reference Engine

## Purpose

FP-I05 may consume aligned rows, symbol-local bars, coverage/gap states, data revision, calendar snapshots, cursor, and revision impact. It may not redefine synchronization semantics.

## Normative invariants

1. **Reference windows retain symbol-local levels.**
2. **Missing/revised cells affect only dependent windows.**
3. **Calendar-day offsets do not compress.**
4. **Source revision is retained in reference identity.**
