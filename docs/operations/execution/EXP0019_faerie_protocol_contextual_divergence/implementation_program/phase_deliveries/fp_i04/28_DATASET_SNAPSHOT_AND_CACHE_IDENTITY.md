---
title: "Dataset Snapshot and Cache Identity"
...
language: en
---
# Dataset Snapshot and Cache Identity

## Purpose

PairDatasetSnapshot binds range, exact row IDs, semantic hash, data revision, health, reasons, and creation time.

## Normative invariants

1. **Cache lookup requires exact revision and config hashes.**
2. **Projection settings are absent.**
3. **Snapshot rows are ordered and unique.**
4. **Stale checkpoints are ignored, not migrated silently.**
