---
title: "Health: READY, DEGRADED, and BLOCKED"
...
language: en
---
# Health: READY, DEGRADED, and BLOCKED

## Purpose

READY requires no expected gaps and no conflicts; DEGRADED preserves usable rows with explicit absence; BLOCKED indicates contradictory or invalid evidence.

## Normative invariants

1. **Health is derived, not manually set.**
2. **Later phases must enforce their own minimum health requirements.**
3. **DEGRADED cannot be relabeled COMPLETE by UI.**
4. **BLOCKED results remain auditable.**
