...
MQL5 mirrors symbol, bar, duplicate, coverage, cell, row, revision, cursor, backfill, result, diagnostics, and self-test structures.

## Normative invariants

1. **Mirror names are FP-I04 versioned.**
2. **No MQL5 chart object or trading function is present.**
3. **Static checks are not reported as actual compilation.**
4. **Python golden vectors remain semantic reference.**
