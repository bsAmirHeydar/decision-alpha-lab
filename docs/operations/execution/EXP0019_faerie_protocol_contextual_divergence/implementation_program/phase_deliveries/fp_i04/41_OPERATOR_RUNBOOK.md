...
Operators resolve aliases, verify calendar hash, import closed M1, run normalization, inspect conflicts and coverage, execute sync, review revision/backfill, and preserve evidence.

## Normative invariants

1. **Do not continue on conflict.**
2. **Do not mark out-of-coverage as internal missing.**
3. **Do not delete old revision artifacts.**
4. **Run clean rebuild parity before handoff.**
