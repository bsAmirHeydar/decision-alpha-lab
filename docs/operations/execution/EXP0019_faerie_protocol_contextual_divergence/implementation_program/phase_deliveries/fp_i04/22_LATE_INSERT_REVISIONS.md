...
language: en
---
# Late Insert Revisions

## Purpose

A late insert fills a previously absent historical minute at or before the previous maximum minute.

## Normative invariants

1. **Only the inserted minute and dependent downstream windows invalidate.**
2. **Unaffected prefix hash remains stable.**
3. **Late insert is not treated as ordinary append.**
4. **Backfill evidence links to the new revision.**
