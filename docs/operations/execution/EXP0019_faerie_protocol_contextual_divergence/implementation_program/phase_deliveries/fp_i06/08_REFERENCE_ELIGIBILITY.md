...
Only FRESH and HUNTER_SEEN references are reusable. CONSUMED_BY_PROTECTED_TOUCH, EXPIRED, and SUPERSEDED references make the side plan ineligible.

## Boundary

Hunter contact remains non-consuming. Eligibility is derived from accepted FP-I05 state rather than reinterpreted.
