...
FP-I07 may consume relation instances, side plans, HuntFacts, first-sweep classifications, raw candidates, candidate transitions, cursors, source revisions, and check-window deadlines.

## Boundary

FP-I07 may add host-candle confirmation and strict session deadline behavior but may not change M1 first-sweep identity, roles, direction, or same-M1 policy.
