...
language: en
---
# Check-Window End Semantics

## Purpose

The scan interval is half-open and inherited from FP-I03/FP-I05. A raw candidate may be terminalized as CHECK_WINDOW_ENDED when the check window closes without FP-I07 confirmation.

## Boundary

FP-I07 remains authoritative for strict host-candle confirmation deadlines.
