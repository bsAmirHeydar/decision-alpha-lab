...
language: en
---
# Prior-N Calendar-Offset Relations

## Purpose

NA, NL, and NN consume exact FP-I05 calendar offsets. Each selected offset creates a separate semantic instance.

## Boundary

Offsets never compress. A missing offset is skipped as evidence and does not promote an older date.
