...
language: en
---
# Public API and JSON Schemas

## Purpose

Fifteen public contracts have closed draft-2020-12 schemas. Unknown properties and open enums are rejected.

## Boundary

Schemas mirror semantic contracts; internal helper objects are not automatically public.
