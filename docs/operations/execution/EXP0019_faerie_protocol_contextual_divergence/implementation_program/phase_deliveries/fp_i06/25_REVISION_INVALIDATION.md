...
language: en
---
# Bounded Revision Invalidation

## Purpose

A revision invalidates plans whose reference window, check window, or scanned M1 interval overlaps the changed evidence.

## Boundary

Unrelated relation instances remain stable. Revision impact is explicit and content-addressed.
