...
The architecture separates registry, compiler, side-plan construction, minute observation, first-sweep classification, candidate reduction, checkpointing, and revision invalidation.

## Boundary

Each layer consumes immutable contracts and emits canonical evidence. Product entry points remain diagnostic only.
