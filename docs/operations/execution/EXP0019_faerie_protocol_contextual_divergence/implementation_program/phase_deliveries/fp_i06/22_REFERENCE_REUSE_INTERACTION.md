...
language: en
---
# Cross-Relation Reference Reuse

## Purpose

A source reference can support AL and later AN, or NA/NL/NN, while its FP-I05 state remains reusable.

## Boundary

Candidate creation and quota suppression do not consume a reference. Protected touch consumption remains an FP-I05 lifecycle fact.
