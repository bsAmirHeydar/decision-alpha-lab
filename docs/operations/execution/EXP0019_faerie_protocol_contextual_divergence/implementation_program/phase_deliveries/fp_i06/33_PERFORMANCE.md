...
language: en
---
# Performance and Incremental Work

## Purpose

The scan is linear in the supplied check-window M1 rows and never scans unrelated history. Compilation uses indexed FP-I05 windows and references.

## Boundary

Performance evidence records processed_row_count and benchmark duration; semantics may not be dropped to meet latency.
