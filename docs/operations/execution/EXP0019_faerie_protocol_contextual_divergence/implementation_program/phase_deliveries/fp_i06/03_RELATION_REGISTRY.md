...
The registry contains all seven context relation codes but marks only AL, AN, LN, NA, NL, and NN as supported in FP-I06. WW is visible as deferred evidence.

## Boundary

Exact mapping is AL A→L, AN A→N, LN L→N, NA N[d]→A, NL N[d]→L, NN N[d]→N, and WW W→W deferred to FP-I08.
