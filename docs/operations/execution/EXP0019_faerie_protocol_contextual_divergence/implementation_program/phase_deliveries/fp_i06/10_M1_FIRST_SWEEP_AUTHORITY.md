...
language: en
---
# M1-Only First-Sweep Authority

## Purpose

Canonical ordering uses UTC M1 open time only. Tick arrival order and host chart timeframe cannot decide Hunter and Protected roles.

## Boundary

Live ticks may later enrich metadata but cannot alter historical or semantic first-sweep order.
