...
language: en
---
# Same-Day Relation Compilation

## Purpose

AL, AN, and LN reference completed windows from the anchor trading day and bind them to L or N check windows from the same trading day.

## Boundary

A same-day instance always carries calendar_offset=0. Missing reference or check windows are explicit blockers.
