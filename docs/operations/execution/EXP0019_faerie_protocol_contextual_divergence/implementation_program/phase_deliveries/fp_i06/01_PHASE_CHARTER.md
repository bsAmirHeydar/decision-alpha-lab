...
FP-I06 transforms accepted FP-I05 windows and symbol-local references into deterministic non-weekly relation instances, M1 hunt facts, first-sweep classifications, and raw divergence candidates.

## Boundary

The phase owns relation compilation and raw candidate semantics but explicitly does not own host-timeframe confirmation, WW, quota, drawing, risk, or order submission.
