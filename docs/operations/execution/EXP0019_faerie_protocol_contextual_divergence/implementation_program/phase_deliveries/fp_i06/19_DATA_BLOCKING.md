...
A missing, out-of-coverage, or conflict cell blocks classification at that minute. If encountered after candidate creation and before downstream confirmation, the raw candidate becomes INVALID_DATA.

## Boundary

No synthetic bar, forward fill, or one-symbol inference is permitted.
