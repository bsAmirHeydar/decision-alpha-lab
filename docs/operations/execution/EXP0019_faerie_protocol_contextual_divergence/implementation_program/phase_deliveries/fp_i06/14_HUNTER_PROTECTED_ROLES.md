...
language: en
---
# Hunter and Protected Roles

## Purpose

For a one-sided contact, the touching symbol becomes Hunter and the non-touching symbol becomes Protected.

## Boundary

Roles are facts of the candidate and do not choose the eventual trade symbol. Execution policy remains downstream.
