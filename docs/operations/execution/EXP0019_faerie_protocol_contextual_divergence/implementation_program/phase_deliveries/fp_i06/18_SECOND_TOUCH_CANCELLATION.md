...
language: en
---
# Second Protected Touch Cancellation

## Purpose

After a raw candidate exists, a later M1 contact by the Protected symbol on the same reference side cancels the candidate.

## Boundary

Repeated Hunter contacts are evidence but do not cancel. The second touch must occur on a strictly later M1.
