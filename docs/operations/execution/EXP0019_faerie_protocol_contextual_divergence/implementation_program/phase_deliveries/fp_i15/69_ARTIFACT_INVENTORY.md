---
title: "FP-I15 — Schemas reports examples and hashes"
...
language: en
---
# Schemas reports examples and hashes

## Purpose

Schemas reports examples and hashes. This note is normative for the FP-I15 source release and is implemented by `fp_i15_paper`, the MQL5 contract mirror under `I15`, the paper-only EA, the closed schemas, and the accepted test fixtures.
