---
title: "FP-I15 — Outward stop and conservative target rounding"
...
language: en
---
# Outward stop and conservative target rounding

## Purpose

Outward stop and conservative target rounding. This note is normative for the FP-I15 source release and is implemented by `fp_i15_paper`, the MQL5 contract mirror under `I15`, the paper-only EA, the closed schemas, and the accepted test fixtures.
