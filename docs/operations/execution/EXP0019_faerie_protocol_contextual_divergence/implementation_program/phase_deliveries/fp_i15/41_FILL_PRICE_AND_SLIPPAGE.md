---
title: "FP-I15 — Fill price bounded by configured adverse slippage"
...
language: en
---
# Fill price bounded by configured adverse slippage

## Purpose

Fill price bounded by configured adverse slippage. This note is normative for the FP-I15 source release and is implemented by `fp_i15_paper`, the MQL5 contract mirror under `I15`, the paper-only EA, the closed schemas, and the accepted test fixtures.
