---
title: "FP-I15 — I09 winner-to-execution input adapter"
...
language: en
---
# I09 winner-to-execution input adapter

## Purpose

I09 winner-to-execution input adapter. This note is normative for the FP-I15 source release and is implemented by `fp_i15_paper`, the MQL5 contract mirror under `I15`, the paper-only EA, the closed schemas, and the accepted test fixtures.
