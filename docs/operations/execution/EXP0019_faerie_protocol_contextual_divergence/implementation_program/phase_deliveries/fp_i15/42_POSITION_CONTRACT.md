---
title: "FP-I15 — Synthetic open position evidence"
...
language: en
---
# Synthetic open position evidence

## Purpose

Synthetic open position evidence. This note is normative for the FP-I15 source release and is implemented by `fp_i15_paper`, the MQL5 contract mirror under `I15`, the paper-only EA, the closed schemas, and the accepted test fixtures.
