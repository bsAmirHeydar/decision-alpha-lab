---
title: "FP-I15 — Versioned target geometry and actual R evidence"
...
language: en
---
# Versioned target geometry and actual R evidence

## Purpose

Versioned target geometry and actual R evidence. This note is normative for the FP-I15 source release and is implemented by `fp_i15_paper`, the MQL5 contract mirror under `I15`, the paper-only EA, the closed schemas, and the accepted test fixtures.
