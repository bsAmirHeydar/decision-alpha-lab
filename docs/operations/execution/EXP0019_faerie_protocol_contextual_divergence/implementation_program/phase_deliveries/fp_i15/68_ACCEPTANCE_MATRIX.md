---
title: "FP-I15 — Source and local acceptance gate matrix"
...
language: en
---
# Source and local acceptance gate matrix

## Purpose

Source and local acceptance gate matrix. This note is normative for the FP-I15 source release and is implemented by `fp_i15_paper`, the MQL5 contract mirror under `I15`, the paper-only EA, the closed schemas, and the accepted test fixtures.
