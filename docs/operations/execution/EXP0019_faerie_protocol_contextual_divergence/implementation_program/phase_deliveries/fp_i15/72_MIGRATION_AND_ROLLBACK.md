---
title: "FP-I15 — Patch-scoped rollback and checkpoint compatibility"
...
language: en
---
# Patch-scoped rollback and checkpoint compatibility

## Purpose

Patch-scoped rollback and checkpoint compatibility. This note is normative for the FP-I15 source release and is implemented by `fp_i15_paper`, the MQL5 contract mirror under `I15`, the paper-only EA, the closed schemas, and the accepted test fixtures.
