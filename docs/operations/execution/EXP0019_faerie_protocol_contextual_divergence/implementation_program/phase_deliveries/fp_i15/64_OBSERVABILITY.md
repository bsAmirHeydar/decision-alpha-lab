---
title: "FP-I15 — Plan quota order and risk telemetry"
...
language: en
---
# Plan quota order and risk telemetry

## Purpose

Plan quota order and risk telemetry. This note is normative for the FP-I15 source release and is implemented by `fp_i15_paper`, the MQL5 contract mirror under `I15`, the paper-only EA, the closed schemas, and the accepted test fixtures.
