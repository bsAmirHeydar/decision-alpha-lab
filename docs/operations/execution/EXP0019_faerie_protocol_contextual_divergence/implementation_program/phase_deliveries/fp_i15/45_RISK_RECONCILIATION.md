---
title: "FP-I15 — Planned versus actual initial maximum loss"
...
language: en
---
# Planned versus actual initial maximum loss

## Purpose

Planned versus actual initial maximum loss. This note is normative for the FP-I15 source release and is implemented by `fp_i15_paper`, the MQL5 contract mirror under `I15`, the paper-only EA, the closed schemas, and the accepted test fixtures.
