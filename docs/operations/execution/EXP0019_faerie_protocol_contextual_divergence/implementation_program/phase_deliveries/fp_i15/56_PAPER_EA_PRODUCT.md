---
title: "FP-I15 — Production paper-only EA lifecycle"
...
language: en
---
# Production paper-only EA lifecycle

## Purpose

Production paper-only EA lifecycle. This note is normative for the FP-I15 source release and is implemented by `fp_i15_paper`, the MQL5 contract mirror under `I15`, the paper-only EA, the closed schemas, and the accepted test fixtures.
