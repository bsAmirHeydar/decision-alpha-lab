---
title: "FP-I15 — Fixed-dollar risk, R multiple, and slippage budget"
...
language: en
---
# Fixed-dollar risk, R multiple, and slippage budget

## Purpose

Fixed-dollar risk, R multiple, and slippage budget. This note is normative for the FP-I15 source release and is implemented by `fp_i15_paper`, the MQL5 contract mirror under `I15`, the paper-only EA, the closed schemas, and the accepted test fixtures.
