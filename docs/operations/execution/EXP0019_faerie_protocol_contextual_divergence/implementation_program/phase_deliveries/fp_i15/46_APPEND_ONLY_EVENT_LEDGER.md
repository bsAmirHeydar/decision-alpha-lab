---
title: "FP-I15 — Plan quota order fill and position event chain"
...
language: en
---
# Plan quota order fill and position event chain

## Purpose

Plan quota order fill and position event chain. This note is normative for the FP-I15 source release and is implemented by `fp_i15_paper`, the MQL5 contract mirror under `I15`, the paper-only EA, the closed schemas, and the accepted test fixtures.
