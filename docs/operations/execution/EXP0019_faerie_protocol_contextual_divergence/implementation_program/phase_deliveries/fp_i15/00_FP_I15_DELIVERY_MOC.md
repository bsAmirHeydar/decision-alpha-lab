---
title: "FP-I15 — Delivery map, authority boundary, and acceptance status"
...
language: en
---
# Delivery map, authority boundary, and acceptance status

## Purpose

Delivery map, authority boundary, and acceptance status. This note is normative for the FP-I15 source release and is implemented by `fp_i15_paper`, the MQL5 contract mirror under `I15`, the paper-only EA, the closed schemas, and the accepted test fixtures.
