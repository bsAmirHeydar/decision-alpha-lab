---
title: "FP-I15 — No live trading authority review"
...
language: en
---
# No live trading authority review

## Purpose

No live trading authority review. This note is normative for the FP-I15 source release and is implemented by `fp_i15_paper`, the MQL5 contract mirror under `I15`, the paper-only EA, the closed schemas, and the accepted test fixtures.
