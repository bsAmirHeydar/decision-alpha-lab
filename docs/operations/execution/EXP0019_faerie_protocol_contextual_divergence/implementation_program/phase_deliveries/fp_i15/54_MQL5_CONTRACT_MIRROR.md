---
title: "FP-I15 — Cross-language structures and enum parity"
...
language: en
---
# Cross-language structures and enum parity

## Purpose

Cross-language structures and enum parity. This note is normative for the FP-I15 source release and is implemented by `fp_i15_paper`, the MQL5 contract mirror under `I15`, the paper-only EA, the closed schemas, and the accepted test fixtures.
