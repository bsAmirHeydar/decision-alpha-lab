---
title: "FP-I15 — Bounded event ledger and O(1) quota lookup"
...
language: en
---
# Bounded event ledger and O(1) quota lookup

## Purpose

Bounded event ledger and O(1) quota lookup. This note is normative for the FP-I15 source release and is implemented by `fp_i15_paper`, the MQL5 contract mirror under `I15`, the paper-only EA, the closed schemas, and the accepted test fixtures.
