---
title: "FP-I15 — Adverse slippage budget before volume sizing"
...
language: en
---
# Adverse slippage budget before volume sizing

## Purpose

Adverse slippage budget before volume sizing. This note is normative for the FP-I15 source release and is implemented by `fp_i15_paper`, the MQL5 contract mirror under `I15`, the paper-only EA, the closed schemas, and the accepted test fixtures.
