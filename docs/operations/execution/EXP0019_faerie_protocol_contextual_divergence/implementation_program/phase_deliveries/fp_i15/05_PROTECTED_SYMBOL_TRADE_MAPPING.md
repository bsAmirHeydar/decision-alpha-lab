---
title: "FP-I15 — Protected symbol is always the trade symbol"
...
language: en
---
# Protected symbol is always the trade symbol

## Purpose

Protected symbol is always the trade symbol. This note is normative for the FP-I15 source release and is implemented by `fp_i15_paper`, the MQL5 contract mirror under `I15`, the paper-only EA, the closed schemas, and the accepted test fixtures.
