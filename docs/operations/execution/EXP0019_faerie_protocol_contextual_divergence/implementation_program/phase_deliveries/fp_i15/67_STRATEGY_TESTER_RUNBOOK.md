---
title: "FP-I15 — Paper self-test and log evidence"
...
language: en
---
# Paper self-test and log evidence

## Purpose

Paper self-test and log evidence. This note is normative for the FP-I15 source release and is implemented by `fp_i15_paper`, the MQL5 contract mirror under `I15`, the paper-only EA, the closed schemas, and the accepted test fixtures.
