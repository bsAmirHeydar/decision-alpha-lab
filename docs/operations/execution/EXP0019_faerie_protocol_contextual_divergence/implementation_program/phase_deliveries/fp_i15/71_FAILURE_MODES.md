---
title: "FP-I15 — Failure detection and fail-closed outcomes"
...
language: en
---
# Failure detection and fail-closed outcomes

## Purpose

Failure detection and fail-closed outcomes. This note is normative for the FP-I15 source release and is implemented by `fp_i15_paper`, the MQL5 contract mirror under `I15`, the paper-only EA, the closed schemas, and the accepted test fixtures.
