---
title: "Use atomic reservation and append-only transitions"
status: accepted
phase: FP-I15
---
# Use atomic reservation and append-only transitions

## Decision

Use atomic reservation and append-only transitions. The decision is encoded in the FP-I15 public contracts, golden fixtures, MQL5 mirror, and authority tests.
