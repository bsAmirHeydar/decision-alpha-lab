---
title: "FP-I15 — All synthetic quota-consumption profiles"
...
language: en
---
# All synthetic quota-consumption profiles

## Purpose

All synthetic quota-consumption profiles. This note is normative for the FP-I15 source release and is implemented by `fp_i15_paper`, the MQL5 contract mirror under `I15`, the paper-only EA, the closed schemas, and the accepted test fixtures.
