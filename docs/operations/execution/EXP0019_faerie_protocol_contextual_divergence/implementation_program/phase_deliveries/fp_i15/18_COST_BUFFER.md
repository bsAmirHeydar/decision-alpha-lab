---
title: "FP-I15 — Optional explicit per-lot cost in risk"
...
language: en
---
# Optional explicit per-lot cost in risk

## Purpose

Optional explicit per-lot cost in risk. This note is normative for the FP-I15 source release and is implemented by `fp_i15_paper`, the MQL5 contract mirror under `I15`, the paper-only EA, the closed schemas, and the accepted test fixtures.
