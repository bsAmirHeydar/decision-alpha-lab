---
title: "FP-I15 — Bid, ask, spread, timestamp, and revision evidence"
...
language: en
---
# Bid, ask, spread, timestamp, and revision evidence

## Purpose

Bid, ask, spread, timestamp, and revision evidence. This note is normative for the FP-I15 source release and is implemented by `fp_i15_paper`, the MQL5 contract mirror under `I15`, the paper-only EA, the closed schemas, and the accepted test fixtures.
