---
title: "FP-I15 — Paper stop outcome and PnL calculation"
...
language: en
---
# Paper stop outcome and PnL calculation

## Purpose

Paper stop outcome and PnL calculation. This note is normative for the FP-I15 source release and is implemented by `fp_i15_paper`, the MQL5 contract mirror under `I15`, the paper-only EA, the closed schemas, and the accepted test fixtures.
