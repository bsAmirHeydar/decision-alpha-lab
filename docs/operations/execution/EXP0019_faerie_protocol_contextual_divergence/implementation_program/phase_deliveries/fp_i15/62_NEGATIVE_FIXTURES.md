---
title: "FP-I15 — Invalid stop, missing quote, risk cap, duplicate quota"
...
language: en
---
# Invalid stop, missing quote, risk cap, duplicate quota

## Purpose

Invalid stop, missing quote, risk cap, duplicate quota. This note is normative for the FP-I15 source release and is implemented by `fp_i15_paper`, the MQL5 contract mirror under `I15`, the paper-only EA, the closed schemas, and the accepted test fixtures.
