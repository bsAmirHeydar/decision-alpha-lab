---
title: "FP-I15 — Tick, tick value, volume steps, and broker geometry"
...
language: en
---
# Tick, tick value, volume steps, and broker geometry

## Purpose

Tick, tick value, volume steps, and broker geometry. This note is normative for the FP-I15 source release and is implemented by `fp_i15_paper`, the MQL5 contract mirror under `I15`, the paper-only EA, the closed schemas, and the accepted test fixtures.
