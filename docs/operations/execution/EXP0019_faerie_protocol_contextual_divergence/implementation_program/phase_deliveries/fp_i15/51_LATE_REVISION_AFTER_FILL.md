---
title: "FP-I15 — Do not rewrite historical synthetic fills"
...
language: en
---
# Do not rewrite historical synthetic fills

## Purpose

Do not rewrite historical synthetic fills. This note is normative for the FP-I15 source release and is implemented by `fp_i15_paper`, the MQL5 contract mirror under `I15`, the paper-only EA, the closed schemas, and the accepted test fixtures.
