  ---
  id: EXP0018-P11-DESIGN-PACKET-V2
  title: "EXP0018 P11 — موتور بازپخش تاریخی و Backfill"
  type: phase-design
  status: draft
  project: EXP0018
  version: 2.0.0
...
- p11
  ---
# P11 — موتور بازپخش تاریخی و Backfill

## 1. وضعیت و Gate

- Track: **CORE**
- وضعیت فعلی: `not_started`
- Dependencies: `P08, P09, P10`
- Downstream blocked: `P12, P13`

## 2. هدف

همان موتور live را به‌صورت chronological روی تاریخ اجرا کند و نتیجه‌ای همسان با live تولید کند.

## 3. ورودی‌های authoritative

- historical synchronized bars
- all core engines
- lookback policy
...
- replay checkpoints
- live/backfill reconciliation

## 5. فایل‌ها و ماژول‌های مالک

- `DAYE_ReplayCursor.mqh`
- `DAYE_ReplayEngine.mqh`
- `DAYE_Reconciliation.mqh`
...
- no future bars.
- same event ordering as live.
- replay does not call alternate detector.
...
- missing bar day
- restart mid-history
- same event hashes live vs replay
...
- future leakage
- different live/backfill code paths
