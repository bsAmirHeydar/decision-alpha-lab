  ---
  id: EXP0018-P18-DESIGN-PACKET-V2
  title: "EXP0018 P18 — Adapter خبر و زمان رویداد"
  type: phase-design
  status: draft
  project: EXP0018
  version: 2.0.0
...
تقویم خبر را به‌صورت adapter قابل‌قطع و cache شده وارد context ledger کند.
...
- `Optional/DAYE_EventCalendarAdapter.mqh`
- `research/event_importer.py`
...
- offline Core works.
- external failure does not mutate signal.
- no hindsight actual-value leakage.
