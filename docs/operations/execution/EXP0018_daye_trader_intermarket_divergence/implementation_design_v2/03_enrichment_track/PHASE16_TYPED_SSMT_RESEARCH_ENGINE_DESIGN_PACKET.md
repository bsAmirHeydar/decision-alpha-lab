  ---
  id: EXP0018-P16-DESIGN-PACKET-V2
  title: "EXP0018 P16 — موتور پژوهشی انواع SSMT"
  type: phase-design
  status: draft
  project: EXP0018
  version: 2.0.0
...
Regular/Sequential/Hidden/Closure/Fill/Intermarket SMT را event typeهای مستقل کند.

## 3. ورودی‌های authoritative

- typed references
- multi-symbol data
- source-promoted definitions

## 4. خروجی‌ها و قرارداد تحویل

- typed SMT events
- variant-specific lifecycle
- comparison ledger

## 5. فایل‌ها و ماژول‌های مالک

- `Optional/DAYE_SsmtTypes.mqh`
- `Optional/DAYE_SsmtEngine.mqh`
...
- touch-hunt Core boolean با SSMTها ادغام نمی‌شود.
- هر variant confirmation مستقل دارد.
...
- concept collapse
- visual similarity misclassification
