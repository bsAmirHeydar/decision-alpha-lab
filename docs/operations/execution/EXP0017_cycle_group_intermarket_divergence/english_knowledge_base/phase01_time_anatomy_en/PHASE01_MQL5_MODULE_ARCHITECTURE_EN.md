# Phase01 Mql5 Module Architecture En

MQL5 module architecture for the standalone time anatomy layer: types, time conversion, display, and engine orchestration.
