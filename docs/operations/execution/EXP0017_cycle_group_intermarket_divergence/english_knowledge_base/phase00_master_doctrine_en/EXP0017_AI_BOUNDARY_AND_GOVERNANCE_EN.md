# Exp0017 Ai Boundary And Governance En

AI is an observer, analyst, ranker, comparer, and reporting assistant. It may learn the strategy architect language but cannot alter entries, exits, CGs, targets, stops, risk, boundaries, or execution rules in the current version.
