---
title: Release And Integrity Pipeline
status: implemented
version: 1.0.0
phase: V4-00
created: '2026-07-13'
...
# Release And Integrity Pipeline

> **Focus:** File index, SHA-256 ledger, archive build and clean extraction.
...
File index, SHA-256 ledger, archive build and clean extraction. This area is implemented as a closed, exact-version contract rather than an informal convention. Unknown fields are rejected, hashes are pinned and all decisions carry explicit reason codes.
