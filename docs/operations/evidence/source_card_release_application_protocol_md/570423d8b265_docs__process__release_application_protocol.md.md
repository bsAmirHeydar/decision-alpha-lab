...
[[docs/operations/evidence/release_application_protocol/9f8ab22f3dfb_release_application_protocol|docs/operations/evidence/release_application_protocol/9f8ab22f3dfb_release_application_protocol.md]]
...
[[docs/history/obsidian/deep/02_concepts/Execution____Risk|Execution / Risk]], [[docs/history/obsidian/deep/02_concepts/MQL_Native|MQL Native]]
...
- [[docs/operations/evidence/exp0002_mql_native_m0001_runtime/319a21879dae_report|report.md]] — score `10`
- [[docs/operations/evidence/val_m0001_mql_native/454e81f9f0b3_report|report.md]] — score `10`
- [[docs/operations/evidence/exp0000_sample/58c8a635ff91_report|report.md]] — score `8`
- [[docs/operations/evidence/exp0001_structural_highs_lows_importance/337872464ffa_report|report.md]] — score `8`
- [[docs/operations/evidence/val001/360462a17ab1_report|report.md]] — score `8`
- [[docs/operations/process/metatrader_compile_checklist|metatrader_compile_checklist.md]] — score `5`
- [[docs/operations/ai_execution/AI_NATIVE_EXECUTION_ROADMAP_FA|AI_NATIVE_EXECUTION_ROADMAP_FA.md]] — score `4`
