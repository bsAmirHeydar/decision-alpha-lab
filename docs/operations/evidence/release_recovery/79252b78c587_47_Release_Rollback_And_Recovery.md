...
The patch is additive except for bounded pyproject CLI/package registration and the current commit-message file. Release is content-addressed through file index and SHA-256 ledger. Rollback removes only indexed V4-05 paths and restores the prior pyproject and commit-message versions from source control. No migration of canonical truth is required.
...
- Previous: [[46_Observability_And_Exposure_Ledger]]
- Phase home: [[00_MOC_V4_05_Semantic_And_Temporal_Hypergraph]]
- Next: [[48_Acceptance_Criteria]]
