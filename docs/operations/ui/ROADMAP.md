...
- `docs/operations/ui/README.md`
- `docs/operations/ui/ARCHITECTURE.md`
- `docs/operations/ui/FOLDER_STRUCTURE.md`
- `docs/operations/ui/VISUAL_REPLAY_PROTOCOL.md`
- `docs/operations/ui/VISUALIZATION_API.md`
- `docs/operations/ui/ROADMAP.md`
- `apps/README.md`
- `apps/api/README.md`
- `apps/web/README.md`
