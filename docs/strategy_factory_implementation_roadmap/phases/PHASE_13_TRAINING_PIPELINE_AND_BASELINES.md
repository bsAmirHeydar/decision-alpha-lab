---
title: "Phase 13 — Training Pipeline and Baselines"
tags:
  - strategy-factory
...
# Phase 13 — Training Pipeline and Baselines

## Objective

Train transparent baselines and extensible ML models reproducibly.
...
- never/always trade baselines
- threshold models
- logistic/ridge
- tree plugin interface
- calibration
- ranking datasets
...
- [ ] Deterministic seeds
- [ ] OOS predictions only in evaluation
