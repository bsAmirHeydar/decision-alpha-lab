---
title: "DATA-R02 — Positive, Negative, Neutral, and Deceptive Examples"
type: document_card
generated_by: alpha_lab_obsidian_builder
generated_at: 2026-07-06
source_path: "docs/experience_capture/questions/remaining_v2/by_code/DATA-R02.md"
source_ext: ".md"
category: "experience_capture_docs"
source_size_bytes: "1158"
concepts:
  - "AI Agent Layer"
  - "Execution"
  - "NDS Anatomy"
...
**Source:** [[docs/experience_capture/questions/remaining_v2/by_code/DATA-R02|docs/experience_capture/questions/remaining_v2/by_code/DATA-R02.md]]
...
Veto/ranker models need labels deeper than win/loss. Do not repeat or overwrite the captured answers. Answered codes that must remain untouched: What is a positive example? What is a negative example? What is neutral or inconclusive? Can a losing trade be a good example? Can a winning trade be a bad example? Which labels must be known before entry and which only after outcome? When answered, create a separate answer folder: Use an image only if it clarifies the structure. If an image is provided, store it under the answer folder and mark all relevant NDS objects.
