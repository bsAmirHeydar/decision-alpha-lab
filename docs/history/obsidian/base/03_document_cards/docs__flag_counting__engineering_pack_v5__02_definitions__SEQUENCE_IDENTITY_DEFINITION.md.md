---
title: "Sequence Identity Definition"
type: document_card
generated_by: alpha_lab_obsidian_builder
generated_at: 2026-07-06
source_path: "docs/flag_counting/engineering_pack_v5/02_definitions/SEQUENCE_IDENTITY_DEFINITION.md"
source_ext: ".md"
...
**Source:** [[docs/flag_counting/engineering_pack_v5/02_definitions/SEQUENCE_IDENTITY_DEFINITION|docs/flag_counting/engineering_pack_v5/02_definitions/SEQUENCE_IDENTITY_DEFINITION.md]]
...
Earlier visual failures came from orphan lines and indistinguishable candidates. Every structure must be traceable. A drawn flag must answer: Recommended chain fields: Recommended F object fields: Recommended fields: Recommended fields: All different structures should be visible. A duplicate exists only when complete identity is the same. Compare: If any item differs, it is a distinct sequence. Near duplicates are not duplicates. Examples that must remain distinct: same price but different time; same time but different L identity; same body but different parent context; visually close but different waist; same origin/leg1 but different Leg2 extension; same geometry but different sequence rol
