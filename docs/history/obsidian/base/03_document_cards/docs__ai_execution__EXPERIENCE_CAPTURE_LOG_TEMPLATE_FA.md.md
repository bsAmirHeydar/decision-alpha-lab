---
title: "Experience Capture Log Template — قالب ثبت تجربه‌های امیر"
type: document_card
generated_by: alpha_lab_obsidian_builder
generated_at: 2026-07-06
source_path: "docs/ai_execution/EXPERIENCE_CAPTURE_LOG_TEMPLATE_FA.md"
source_ext: ".md"
category: "ai_execution_docs"
source_size_bytes: "1103"
concepts:
  - "AI Agent Layer"
  - "Convexity"
  - "Execution"
...
# Experience Capture Log Template — قالب ثبت تجربه‌های امیر

**Source:** [[docs/ai_execution/EXPERIENCE_CAPTURE_LOG_TEMPLATE_FA|docs/ai_execution/EXPERIENCE_CAPTURE_LOG_TEMPLATE_FA.md]]
...
این فایل قالب خام ثبت تجربه‌هاست. هر تجربه باید به یکی از این فرم‌ها تبدیل شود:
