# Document Card — CH12_no_filter_no_suppression_doctrine.md
...
این کارت برای اتصال سند `CH12_no_filter_no_suppression_doctrine.md` به گراف آبسیدین پروژه ساخته شده است.
