---
title: "SCN-R01 — Context Power Scoring"
type: document_card
generated_by: alpha_lab_obsidian_builder
generated_at: 2026-07-06
source_path: "docs/experience_capture/questions/remaining_v2/by_code/SCN-R01.md"
source_ext: ".md"
category: "experience_capture_docs"
source_size_bytes: "1255"
concepts:
  - "Execution"
  - "NDS Anatomy"
---
...
**Source:** [[docs/experience_capture/questions/remaining_v2/by_code/SCN-R01|docs/experience_capture/questions/remaining_v2/by_code/SCN-R01.md]]
...
You repeatedly mention that the system must understand which context has power. Do not repeat or overwrite the captured answers. Answered codes that must remain untouched: What makes one context stronger than another in NDS terms? How should parent, current, and child context be compared? When does parent context override a local entry? When can child/local structure weaken the parent view? What minimum reason vector is required before a context becomes tradable? Should context power be a score, class, or both? When answered, create a separate answer folder: Use an image only if it clarifies the structure. If an image is provided, store it under the answer folder and mark all relevant NDS ob
