---
title: "NDS-R01 — Canonical NDS Object Model"
type: document_card
generated_by: alpha_lab_obsidian_builder
generated_at: 2026-07-06
source_path: "docs/experience_capture/questions/remaining_v2/by_code/NDS-R01.md"
source_ext: ".md"
category: "experience_capture_docs"
source_size_bytes: "1455"
concepts:
  - "Convexity"
  - "Execution"
  - "Hook"
...
**Source:** [[docs/experience_capture/questions/remaining_v2/by_code/NDS-R01|docs/experience_capture/questions/remaining_v2/by_code/NDS-R01.md]]
...
The answered records define ontology boundaries, but the exact object model is still open. Do not repeat or overwrite the captured answers. Answered codes that must remain untouched: Define every core NDS object that must exist in v1: Hook, Rally, F-count, Node, Cycle, Scenario, Zone, Destination, Invalidation, Entry Family, and ExecutionIntent. For each object, specify required fields, optional fields, and forbidden fields. Separate deterministic anatomy objects from learnable policy objects. Define which objects can be nested across parent/current/child scales. Define which objects must be drawn on chart for audit. Define how every object should receive a stable ID. When answered, create a
