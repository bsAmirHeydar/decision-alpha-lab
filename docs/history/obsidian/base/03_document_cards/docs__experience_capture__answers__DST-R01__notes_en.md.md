---
title: "DST-R01 — Notes and Open Questions"
type: document_card
generated_by: alpha_lab_obsidian_builder
generated_at: 2026-07-06
source_path: "docs/experience_capture/answers/DST-R01/notes_en.md"
source_ext: ".md"
category: "experience_capture_docs"
source_size_bytes: "4640"
concepts:
  - "AI Agent Layer"
  - "Convexity"
  - "Execution"
...
**Source:** [[docs/experience_capture/answers/DST-R01/notes_en|docs/experience_capture/answers/DST-R01/notes_en.md]]
...
This answer should be treated as: The destination layer should not output one fixed final target only. Recommended flow: Destination candidates should feed DST-R02 exit policy, but should not force full exit by default. 1. What exact structure qualifies as an open one-and-two destination? 2. Is open one-and-two always a magnet candidate or only under higher Hook conditions? 3. How should timing uncertainty be represented? 4. How should later F-counting update existing destination candidates? 5. Can a destination candidate appear after entry and change exit policy? 6. How should destination confidence be calculated? 7. Should destination candidates be ordered, tree-based, or graph-based? 8. H
