...
source_path: "docs/experience_capture/answers/SCN-R01/question_en.md"
source_ext: ".md"
category: "experience_capture_docs"
source_size_bytes: "1161"
concepts:
  - "Convexity"
  - "Execution"
  - "Hook"
...
**Source:** [[docs/experience_capture/answers/SCN-R01/question_en|docs/experience_capture/answers/SCN-R01/question_en.md]]
...
What makes one context stronger than another in NDS? Context comes before zone and entry. Extreme is not enough by itself. Parent timeframe dominance, Hook type, X/Y closure, multiple sequences, symmetry, destination openness, and tradable constraints may all affect context quality. The system needs a formal model. Please clarify: Is higher timeframe always dominant? How do Hook Type A/B/C affect reversal power? How do X closure and Y closure affect reversal probability and zone precision? Does multiple sequence closure increase context power? How does symmetry confluence create a tradable zone or entry Extreme? When does context become a trade zone? How does destination openness affect opti
