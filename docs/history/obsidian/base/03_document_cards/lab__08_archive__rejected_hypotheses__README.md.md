...
source_path: "lab/08_archive/rejected_hypotheses/README.md"
source_ext: ".md"
category: "archive"
source_size_bytes: "0"
---
...
**Source:** [[lab/08_archive/rejected_hypotheses/README|lab/08_archive/rejected_hypotheses/README.md]]
...
این فایل متن کافی برای خلاصه خودکار ندارد یا عمداً به عنوان placeholder نگه داشته شده است.

## Related documents

- [[data/README|Readme]] — `data_docs`
...
- [[docs/experience_capture/questions/remaining_v2/README|Remaining Questions v2]] — `experience_capture_docs`
- [[docs/experience_capture/questions/remaining_v2/sections/01_core_schema/README|Core NDS Schema and Lifecycle]] — `experience_capture_docs`
