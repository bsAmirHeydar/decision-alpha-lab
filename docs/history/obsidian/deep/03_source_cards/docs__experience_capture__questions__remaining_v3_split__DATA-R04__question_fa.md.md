...
---
type: source_card
source_path: "docs/experience_capture/questions/remaining_v3_split/DATA-R04/question_fa.md"
source_ext: ".md"
source_size: 1286
empty: false
...
چرا مهم است: چون اگر win rate قبل از convexity اولویت ندارد، گزارش‌گیری و ارزیابی هم باید convexity-first باشد. باید pre-convexity و post-convexity metrics جدا شوند. برای پاسخ، حتماً این موارد را روشن کن: • Pre-convexity filters چه چیزهایی هستند؟ • Post-convexity win rate دقیقاً روی کدام subset محاسبه می‌شود؟ • R distribution چطور ثبت شود؟ • Tail contribution چطور سنجیده شود؟ • Missed opportunity چطور حساب شود؟ • Fill probability چقدر مهم است؟ • Stop buffer performance چطور سنجیده شود؟ • Zone family performance چطور گزارش شود؟ • Scenario family performance چطور گزارش شود؟ • Market/timeframe breakdown چطور باشد؟ عکس لازم: خیر. اگر گزارش یا equity/R distribution داری، اختیاری مفید است. خروجی مورد انتظار بعد از پاسخ: • convexity_first_evaluation_v1.csv • post_convexity_win_rate_model_v1.csv • tail_contribution_metrics_v1.csv • family_performance_report_v1.csv پاسخ شما:
...
- [[docs/experience_capture/questions/remaining_v2/by_code/DATA-R04|DATA-R04.md]] — score `12`
- [[lab/03_experiments/EXP0004_mql_native_m0004/report|report.md]] — score `12`
- [[docs/experience_capture/questions/remaining_v3_split/DATA-R04/question_en|question_en.md]] — score `11`
