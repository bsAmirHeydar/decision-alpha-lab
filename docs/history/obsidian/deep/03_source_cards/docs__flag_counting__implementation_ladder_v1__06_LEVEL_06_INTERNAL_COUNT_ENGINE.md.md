...
concepts: ["AI Agent Layer", "Convexity / Optionality", "Decision Node", "Flag Counting", "MQL Native", "UI / React", "Validation / Audit"]
entities: []
---

# Source Card — 06_LEVEL_06_INTERNAL_COUNT_ENGINE.md
...
- [[docs/flag_counting/FLAG_COUNTING_IMPLEMENTATION_CHECKLIST_V2|FLAG_COUNTING_IMPLEMENTATION_CHECKLIST_V2.md]] — score `14`
