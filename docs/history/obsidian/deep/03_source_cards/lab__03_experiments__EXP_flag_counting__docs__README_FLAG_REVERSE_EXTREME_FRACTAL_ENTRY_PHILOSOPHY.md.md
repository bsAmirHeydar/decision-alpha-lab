...
concepts: ["Convexity / Optionality", "Decision Node", "Execution / Risk", "Flag Counting", "Hook", "Market Anatomy", "Path Smoothness", "Rally", "UI / React", "Validation / Audit", "Zone / RTV"]
entities: []
---

# Source Card — README_FLAG_REVERSE_EXTREME_FRACTAL_ENTRY_PHILOSOPHY.md
...
> Status: philosophy and research-design document > Scope: Flag Project / market anatomy / optionality / Hook-Rally phases / X-axis and Y-axis execution design > Language: English > Purpose: preserve the founder's market experience as an engineering source for future Flag research, testing, and execution design. The Flag Project does not reject reverse trades. On the contrary, it treats the right reverse entry as one of the most powerful forms of optionality in trading. The key distinction is that the project does **not** mean naive reversal trading. A naive reversal says: The Flag philosophy says something more specific: The project favors extreme reverse entries not because the market must reverse, but because the **right extreme** can produce the best reward geometry: entry close to structural invalidation, smaller stop, larger R multiple, less confirmation lag, better convexity, bett
...
- [[docs/experience_capture/answers/EXT-02/answer_normalized_en|answer_normalized_en.md]] — score `18`
