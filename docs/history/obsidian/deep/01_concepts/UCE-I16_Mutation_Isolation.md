...
## Definition
Mutation Isolation is a first-class governance and runtime concept in the UCE-I16 onboarding factory. It is represented by an explicit machine-readable field or artifact and cannot be inferred from comments or naming conventions.
