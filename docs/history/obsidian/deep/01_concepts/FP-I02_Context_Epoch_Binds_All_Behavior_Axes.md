---
title: "FP-I02 Context Epoch Binds All Behavior Axes"
tags: [atomic-concept, exp0019, fp-i02]
status: canonical
---
# FP-I02 Context Epoch Binds All Behavior Axes

## Definition

Context epoch binds exact owner decisions, pair, resolved host timeframe, semantic config, dependency snapshot, relation/reason registries, authority, and open decisions.
