---
title: "Legacy Differential Parity"
tags: [atomic-concept, uce-i16]
status: canonical
doc_version: 1.0.0
---
# Legacy Differential Parity

## Definition
Legacy Differential Parity is a first-class governance and runtime concept in the UCE-I16 onboarding factory. It is represented by an explicit machine-readable field or artifact and cannot be inferred from comments or naming conventions.
