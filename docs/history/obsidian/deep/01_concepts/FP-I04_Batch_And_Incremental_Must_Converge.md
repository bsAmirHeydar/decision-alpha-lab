---
title: "FP-I04 Batch And Incremental Must Converge"
tags: [atomic-concept, exp0019, fp-i04]
status: canonical
---
# FP-I04 Batch And Incremental Must Converge

## Definition

For the same pair, range, source revision, and config, batch and chunked processing must produce the same aligned semantic row sequence.
