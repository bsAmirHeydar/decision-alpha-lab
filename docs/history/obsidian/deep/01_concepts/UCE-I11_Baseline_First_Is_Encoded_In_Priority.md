---
title: "UCE-I11 Baseline First Is Encoded In Priority"
tags: [atomic-concept, uce-i11, strategy-factory]
status: canonical
---
# UCE-I11 Baseline First Is Encoded In Priority

## Definition

Baseline-first is not a recommendation. Baseline trainer/trial nodes receive lower deterministic priorities than challengers so the accepted floor is scheduled first under finite budgets.
