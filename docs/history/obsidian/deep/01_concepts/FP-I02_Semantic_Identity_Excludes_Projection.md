---
title: "FP-I02 Semantic Identity Excludes Projection"
tags: [atomic-concept, exp0019, fp-i02]
status: canonical
---
# FP-I02 Semantic Identity Excludes Projection

## Definition

A confirmed signal is an economic semantic event. Color, opacity, line width, chart instance, and object role belong to projection identity and cannot alter signal_id.
