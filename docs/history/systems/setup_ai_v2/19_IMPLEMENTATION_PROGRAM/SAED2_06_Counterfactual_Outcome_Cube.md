---
title: SAED2-06 — Counterfactual Outcome Cube
status: canonical
version: 2.0.0
created: '2026-07-13'
updated: '2026-07-13'
...
Materialize all sibling treatment outcomes with censoring, ambiguity, path, costs, capacity, and failure records.
...
Outcome cube; partition manifest; simulator qualification.
...
A signed phase-status record enumerates delivered files, open blockers, local-Windows requirements, risks, and the exact handoff to SAED2-07 or operations.
