---
title: SAED2-14 — Uncertainty, Conformal and OOD
status: canonical
version: 2.0.0
created: '2026-07-13'
updated: '2026-07-13'
...
Implement uncertainty decomposition, ensembles, time-series conformal, risk controls, support index, and abstention.
...
Uncertainty bundles; coverage reports; support audits; fallback rules.
...
A signed phase-status record enumerates delivered files, open blockers, local-Windows requirements, risks, and the exact handoff to SAED2-15 or operations.
