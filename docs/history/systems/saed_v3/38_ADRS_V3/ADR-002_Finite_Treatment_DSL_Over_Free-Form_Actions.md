---
title: ADR-002 — Finite Treatment DSL Over Free-Form Actions
status: canonical
version: 3.0.0
created: '2026-07-13'
updated: '2026-07-13'
...
Models select only compiler-approved finite treatments plus Skip/Abstain.

## Rationale

Makes search measurable, runtime deterministic, and risk bounded.
...
- May miss useful actions until formally added and revalidated.
