---
title: ADR-017 — Content-Addressed Artifacts and Transparency Log
status: canonical
version: 3.0.0
created: '2026-07-13'
updated: '2026-07-13'
...
All material artifacts are immutable, signed, and linked through append-only transparency records.

## Rationale

Enables reproducibility, tamper detection, and impact analysis.
...
- Requires disciplined artifact lifecycle.
