---
title: SAED2-07 — Clustered Dataset and Fold Factory
status: canonical
version: 3.0.0
created: '2026-07-13'
updated: '2026-07-13'
...
Build occurrence-treatment rows, dependency graph, shared-event clusters, purged nested walk-forward roles, and locked test policy.
...
Dataset manifest; folds; purge ledger; effective sample report.
...
A signed phase-status record enumerates delivered files, open blockers, local-Windows requirements, risks, and the exact handoff to SAED2-08 or operations.
