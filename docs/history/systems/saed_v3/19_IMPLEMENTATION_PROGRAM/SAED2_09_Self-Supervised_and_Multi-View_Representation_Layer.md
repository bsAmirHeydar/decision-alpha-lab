---
title: SAED2-09 — Self-Supervised and Multi-View Representation Layer
status: canonical
version: 3.0.0
created: '2026-07-13'
updated: '2026-07-13'
...
Build masked/contrastive pretraining, view encoders, view dropout, probes, and role-safe embedding store.
...
Encoder checkpoints; representation cards; probe reports.
...
A signed phase-status record enumerates delivered files, open blockers, local-Windows requirements, risks, and the exact handoff to SAED2-10 or operations.
