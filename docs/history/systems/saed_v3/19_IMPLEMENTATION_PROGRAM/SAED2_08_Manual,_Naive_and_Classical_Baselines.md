---
title: SAED2-08 — Manual, Naive and Classical Baselines
status: canonical
version: 3.0.0
created: '2026-07-13'
updated: '2026-07-13'
...
Implement skip-all, manual, unconditional, time/session, context-only, linear, calibrated tree, survival, and ranking baselines.
...
Baseline registry; calibrated predictions; baseline attribution.
...
A signed phase-status record enumerates delivered files, open blockers, local-Windows requirements, risks, and the exact handoff to SAED2-09 or operations.
