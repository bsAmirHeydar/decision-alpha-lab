...
Requires known time to be no earlier than observed time and prevents monitoring from introducing look-ahead. This note is part of the permanent Strategy Factory operating model and applies to research, tester, paper, shadow, micro-live, and live-compatible execution modes.
