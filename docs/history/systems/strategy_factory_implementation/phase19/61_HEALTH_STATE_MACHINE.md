...
Defines HEALTHY, DEGRADED, CRITICAL, and SUSPEND_RECOMMENDED transitions. This note is part of the permanent Strategy Factory operating model and applies to research, tester, paper, shadow, micro-live, and live-compatible execution modes.
