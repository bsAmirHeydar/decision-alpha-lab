...
Separates market, server, local, observed, known, and processing clocks and records conversion assumptions. This note is part of the permanent Strategy Factory operating model and applies to research, tester, paper, shadow, micro-live, and live-compatible execution modes.
