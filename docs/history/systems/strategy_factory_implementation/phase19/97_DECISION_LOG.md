...
Records why monitoring is typed, bounded, deterministic, advisory, and MQL5-first. This note is part of the permanent Strategy Factory operating model and applies to research, tester, paper, shadow, micro-live, and live-compatible execution modes.
