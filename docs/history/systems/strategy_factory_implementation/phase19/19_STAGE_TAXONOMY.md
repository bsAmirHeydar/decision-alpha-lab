...
Defines market, anatomy, context, candidate, inference, decision, risk, execution, reconciliation, and governance stages. This note is part of the permanent Strategy Factory operating model and applies to research, tester, paper, shadow, micro-live, and live-compatible execution modes.
