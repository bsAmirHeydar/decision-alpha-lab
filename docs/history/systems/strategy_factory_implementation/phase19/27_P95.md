...
Uses P95 to expose persistent tail degradation relevant to decision timeliness. This note is part of the permanent Strategy Factory operating model and applies to research, tester, paper, shadow, micro-live, and live-compatible execution modes.
