...
Specifies INFO, WARNING, CRITICAL, and EMERGENCY semantics and prevents arbitrary escalation. This note is part of the permanent Strategy Factory operating model and applies to research, tester, paper, shadow, micro-live, and live-compatible execution modes.
