...
Derives stable event and payload hashes from canonical fields so replay and parity checks are exact. This note is part of the permanent Strategy Factory operating model and applies to research, tester, paper, shadow, micro-live, and live-compatible execution modes.
