...
Connects health and recommendations back to exact alerts, drift results, telemetry events, and live ledger records. This note is part of the permanent Strategy Factory operating model and applies to research, tester, paper, shadow, micro-live, and live-compatible execution modes.
