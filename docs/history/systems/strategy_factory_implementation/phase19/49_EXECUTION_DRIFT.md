...
Compares broker-path behavior against paper, shadow, and release baselines. This note is part of the permanent Strategy Factory operating model and applies to research, tester, paper, shadow, micro-live, and live-compatible execution modes.
