...
Keeps telemetry emission constant-time and excludes filesystem, networking, JSON parsing, and training from the decision path. This note is part of the permanent Strategy Factory operating model and applies to research, tester, paper, shadow, micro-live, and live-compatible execution modes.
