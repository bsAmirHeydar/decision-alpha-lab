...
Measures center movement relative to baseline standard deviation with zero-variance protection. This note is part of the permanent Strategy Factory operating model and applies to research, tester, paper, shadow, micro-live, and live-compatible execution modes.
