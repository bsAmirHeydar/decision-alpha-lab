...
Injects queue overflow, stale data, schema mismatch, model-integrity failure, and reconciliation mismatch. This note is part of the permanent Strategy Factory operating model and applies to research, tester, paper, shadow, micro-live, and live-compatible execution modes.
