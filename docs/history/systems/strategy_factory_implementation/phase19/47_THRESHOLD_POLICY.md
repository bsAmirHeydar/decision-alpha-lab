...
Separates warning and critical thresholds and requires exact policy identity in every result. This note is part of the permanent Strategy Factory operating model and applies to research, tester, paper, shadow, micro-live, and live-compatible execution modes.
