...
Transfers monitoring contracts into the Temporal Intermarket Divergence pilot without importing its semantics into the core. This note is part of the permanent Strategy Factory operating model and applies to research, tester, paper, shadow, micro-live, and live-compatible execution modes.
