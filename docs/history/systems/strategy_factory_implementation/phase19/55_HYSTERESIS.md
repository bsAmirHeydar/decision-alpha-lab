...
Requires repeated breaches and repeated recoveries to prevent flapping around thresholds. This note is part of the permanent Strategy Factory operating model and applies to research, tester, paper, shadow, micro-live, and live-compatible execution modes.
