...
Treats human-readable logs as a projection of typed telemetry, never as the canonical data contract. This note is part of the permanent Strategy Factory operating model and applies to research, tester, paper, shadow, micro-live, and live-compatible execution modes.
