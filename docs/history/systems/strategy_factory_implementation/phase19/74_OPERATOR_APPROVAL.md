...
Sets requires_operator_approval true and automatic_mutation_allowed false as non-negotiable invariants. This note is part of the permanent Strategy Factory operating model and applies to research, tester, paper, shadow, micro-live, and live-compatible execution modes.
