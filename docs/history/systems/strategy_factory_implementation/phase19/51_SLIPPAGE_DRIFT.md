...
Tracks mean and tail slippage in points and cash with directionally correct sign conventions. This note is part of the permanent Strategy Factory operating model and applies to research, tester, paper, shadow, micro-live, and live-compatible execution modes.
