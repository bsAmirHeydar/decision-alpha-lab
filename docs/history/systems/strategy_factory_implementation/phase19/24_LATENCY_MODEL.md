...
Defines stage boundaries and measures elapsed processing in microseconds without conflating market latency and compute latency. This note is part of the permanent Strategy Factory operating model and applies to research, tester, paper, shadow, micro-live, and live-compatible execution modes.
