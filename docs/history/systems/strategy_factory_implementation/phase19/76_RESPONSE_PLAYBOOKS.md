...
Defines diagnosis, containment, recovery, evidence preservation, and approval checkpoints for each trigger. This note is part of the permanent Strategy Factory operating model and applies to research, tester, paper, shadow, micro-live, and live-compatible execution modes.
