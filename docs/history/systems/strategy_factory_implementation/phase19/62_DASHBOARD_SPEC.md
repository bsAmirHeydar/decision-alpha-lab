...
Defines panels as versioned metric selections rather than hard-coded UI behavior. This note is part of the permanent Strategy Factory operating model and applies to research, tester, paper, shadow, micro-live, and live-compatible execution modes.
