...
Standardizes stage-qualified names for runtime, latency, drift, reconciliation, safety, and governance evidence. This note is part of the permanent Strategy Factory operating model and applies to research, tester, paper, shadow, micro-live, and live-compatible execution modes.
