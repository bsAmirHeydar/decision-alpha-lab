...
Defines conformance responsibilities and prevents Python from becoming live authority. This note is part of the permanent Strategy Factory operating model and applies to research, tester, paper, shadow, micro-live, and live-compatible execution modes.
