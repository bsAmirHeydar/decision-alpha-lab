...
Tracks fill and rejection rates while respecting order type, symbol, session, and broker regime. This note is part of the permanent Strategy Factory operating model and applies to research, tester, paper, shadow, micro-live, and live-compatible execution modes.
