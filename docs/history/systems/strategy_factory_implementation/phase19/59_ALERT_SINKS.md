...
Keeps the core sink local and deterministic; external messaging transports remain outside the MQL5 fast path. This note is part of the permanent Strategy Factory operating model and applies to research, tester, paper, shadow, micro-live, and live-compatible execution modes.
