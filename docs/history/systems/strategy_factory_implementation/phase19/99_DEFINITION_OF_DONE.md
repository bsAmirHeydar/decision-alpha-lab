...
Requires code, tests, schemas, fixtures, documentation, QA, rollback, and handoff with no hidden TODOs. This note is part of the permanent Strategy Factory operating model and applies to research, tester, paper, shadow, micro-live, and live-compatible execution modes.
