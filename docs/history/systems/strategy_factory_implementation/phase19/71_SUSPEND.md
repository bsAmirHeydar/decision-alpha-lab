...
Defines immediate containment evidence for reconciliation, integrity, or severe execution failures. This note is part of the permanent Strategy Factory operating model and applies to research, tester, paper, shadow, micro-live, and live-compatible execution modes.
