...
Measures intent submission through broker check, send acknowledgment, fill, and reconciliation. This note is part of the permanent Strategy Factory operating model and applies to research, tester, paper, shadow, micro-live, and live-compatible execution modes.
