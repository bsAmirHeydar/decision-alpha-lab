...
Defines sustained tick, burst, multi-symbol, and long-duration monitoring tests. This note is part of the permanent Strategy Factory operating model and applies to research, tester, paper, shadow, micro-live, and live-compatible execution modes.
