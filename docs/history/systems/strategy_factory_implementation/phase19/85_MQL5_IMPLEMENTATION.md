...
Documents typed structs, fixed arrays, bounded rings, histograms, evaluators, and coordinator integration. This note is part of the permanent Strategy Factory operating model and applies to research, tester, paper, shadow, micro-live, and live-compatible execution modes.
