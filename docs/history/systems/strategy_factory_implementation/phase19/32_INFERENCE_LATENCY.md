...
Measures preprocessing, tensor setup, ONNX runtime, calibration, and result validation separately. This note is part of the permanent Strategy Factory operating model and applies to research, tester, paper, shadow, micro-live, and live-compatible execution modes.
