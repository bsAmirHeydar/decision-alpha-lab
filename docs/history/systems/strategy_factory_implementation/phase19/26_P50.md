...
Uses median latency to represent normal path performance while avoiding false comfort from average-only reporting. This note is part of the permanent Strategy Factory operating model and applies to research, tester, paper, shadow, micro-live, and live-compatible execution modes.
