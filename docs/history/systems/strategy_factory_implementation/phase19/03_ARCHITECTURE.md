...
Describes direct typed fast-path instrumentation, bounded buffers, deterministic evaluators, and report assembly. This note is part of the permanent Strategy Factory operating model and applies to research, tester, paper, shadow, micro-live, and live-compatible execution modes.
