...
States that drift is evidence of changed inputs or outputs, not automatic evidence for retraining, suspension, or profitability loss. This note is part of the permanent Strategy Factory operating model and applies to research, tester, paper, shadow, micro-live, and live-compatible execution modes.
