...
Defines engineering policy, static compatibility, MetaEditor compilation, and local evidence capture. This note is part of the permanent Strategy Factory operating model and applies to research, tester, paper, shadow, micro-live, and live-compatible execution modes.
