...
Uses monotonic per-run sequence numbers and rejects replayed or reordered telemetry. This note is part of the permanent Strategy Factory operating model and applies to research, tester, paper, shadow, micro-live, and live-compatible execution modes.
