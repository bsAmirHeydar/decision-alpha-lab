...
Measures event-known time through candidate, inference, decision, and execution-intent availability. This note is part of the permanent Strategy Factory operating model and applies to research, tester, paper, shadow, micro-live, and live-compatible execution modes.
