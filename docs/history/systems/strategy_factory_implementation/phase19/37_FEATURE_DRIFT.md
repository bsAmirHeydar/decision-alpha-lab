...
Compares online feature distributions to exact training-era baselines with immutable bin definitions. This note is part of the permanent Strategy Factory operating model and applies to research, tester, paper, shadow, micro-live, and live-compatible execution modes.
