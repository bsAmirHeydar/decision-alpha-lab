...
Makes every alert and lifecycle recommendation traceable to the event, candidate, decision, or live transaction that caused it. This note is part of the permanent Strategy Factory operating model and applies to research, tester, paper, shadow, micro-live, and live-compatible execution modes.
