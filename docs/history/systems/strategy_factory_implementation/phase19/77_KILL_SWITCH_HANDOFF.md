...
Explains how a suspend recommendation is handed to the authorized Phase 18 operator procedure. This note is part of the permanent Strategy Factory operating model and applies to research, tester, paper, shadow, micro-live, and live-compatible execution modes.
