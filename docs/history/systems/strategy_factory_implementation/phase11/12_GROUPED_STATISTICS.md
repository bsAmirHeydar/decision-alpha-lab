---
title: "Grouped Statistics Engine"
phase: 11
status: canonical
tags: [strategy-factory, statistics, matched-nulls, phase11]
---
# Grouped Statistics Engine

## Scope

This document specifies **Grouped Statistics Engine** as a reusable central-engine capability. Strategy-specific interpretations are plugins or declared grouping/null specifications; they are not embedded in the statistics kernel.
