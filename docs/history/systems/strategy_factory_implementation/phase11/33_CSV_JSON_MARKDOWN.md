---
title: "CSV, JSON and Markdown Artifacts"
phase: 11
status: canonical
...
This document specifies **CSV, JSON and Markdown Artifacts** as a reusable central-engine capability. Strategy-specific interpretations are plugins or declared grouping/null specifications; they are not embedded in the statistics kernel.
