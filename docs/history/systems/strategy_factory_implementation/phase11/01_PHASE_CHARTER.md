---
title: "Phase Charter and Exit Gate"
phase: 11
status: canonical
tags: [strategy-factory, statistics, matched-nulls, phase11]
---
# Phase Charter and Exit Gate

## Scope

This document specifies **Phase Charter and Exit Gate** as a reusable central-engine capability. Strategy-specific interpretations are plugins or declared grouping/null specifications; they are not embedded in the statistics kernel.
