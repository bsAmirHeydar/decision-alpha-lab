---
title: "Role-Randomization Null"
phase: 11
status: canonical
tags: [strategy-factory, statistics, matched-nulls, phase11]
---
# Role-Randomization Null

## Scope

This document specifies **Role-Randomization Null** as a reusable central-engine capability. Strategy-specific interpretations are plugins or declared grouping/null specifications; they are not embedded in the statistics kernel.
