---
title: "Source Lineage and Reconciliation Gate"
phase: 11
status: canonical
tags: [strategy-factory, statistics, matched-nulls, phase11]
---
# Source Lineage and Reconciliation Gate

## Scope

This document specifies **Source Lineage and Reconciliation Gate** as a reusable central-engine capability. Strategy-specific interpretations are plugins or declared grouping/null specifications; they are not embedded in the statistics kernel.
