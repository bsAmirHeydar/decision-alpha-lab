---
title: "Streaming Moments and Bounded Memory"
phase: 11
status: canonical
tags: [strategy-factory, statistics, matched-nulls, phase11]
---
# Streaming Moments and Bounded Memory

## Scope

This document specifies **Streaming Moments and Bounded Memory** as a reusable central-engine capability. Strategy-specific interpretations are plugins or declared grouping/null specifications; they are not embedded in the statistics kernel.
