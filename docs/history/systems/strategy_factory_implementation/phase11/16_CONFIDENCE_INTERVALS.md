---
title: "Confidence Interval Catalog"
phase: 11
status: canonical
tags: [strategy-factory, statistics, matched-nulls, phase11]
---
# Confidence Interval Catalog

## Scope

This document specifies **Confidence Interval Catalog** as a reusable central-engine capability. Strategy-specific interpretations are plugins or declared grouping/null specifications; they are not embedded in the statistics kernel.
