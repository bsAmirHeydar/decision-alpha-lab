---
title: "Control Reuse and Independence"
phase: 11
status: canonical
tags: [strategy-factory, statistics, matched-nulls, phase11]
---
# Control Reuse and Independence

## Scope

This document specifies **Control Reuse and Independence** as a reusable central-engine capability. Strategy-specific interpretations are plugins or declared grouping/null specifications; they are not embedded in the statistics kernel.
