---
title: "Paired Null Comparison and Uplift"
phase: 11
status: canonical
tags: [strategy-factory, statistics, matched-nulls, phase11]
---
# Paired Null Comparison and Uplift

## Scope

This document specifies **Paired Null Comparison and Uplift** as a reusable central-engine capability. Strategy-specific interpretations are plugins or declared grouping/null specifications; they are not embedded in the statistics kernel.
