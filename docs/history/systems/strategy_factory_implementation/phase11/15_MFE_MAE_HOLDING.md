---
title: "MFE, MAE and Holding-Time Analysis"
phase: 11
status: canonical
tags: [strategy-factory, statistics, matched-nulls, phase11]
---
# MFE, MAE and Holding-Time Analysis

## Scope

This document specifies **MFE, MAE and Holding-Time Analysis** as a reusable central-engine capability. Strategy-specific interpretations are plugins or declared grouping/null specifications; they are not embedded in the statistics kernel.
