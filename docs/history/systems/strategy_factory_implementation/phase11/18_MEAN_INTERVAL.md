---
title: "Analytic Mean Interval"
phase: 11
status: canonical
tags: [strategy-factory, statistics, matched-nulls, phase11]
---
# Analytic Mean Interval

## Scope

This document specifies **Analytic Mean Interval** as a reusable central-engine capability. Strategy-specific interpretations are plugins or declared grouping/null specifications; they are not embedded in the statistics kernel.
