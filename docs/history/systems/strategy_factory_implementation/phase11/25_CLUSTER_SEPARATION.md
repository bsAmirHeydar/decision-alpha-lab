---
title: "Observed and Control Cluster Separation"
phase: 11
status: canonical
tags: [strategy-factory, statistics, matched-nulls, phase11]
---
# Observed and Control Cluster Separation

## Scope

This document specifies **Observed and Control Cluster Separation** as a reusable central-engine capability. Strategy-specific interpretations are plugins or declared grouping/null specifications; they are not embedded in the statistics kernel.
