---
title: "Local Compile and Test Runbook"
phase: 11
status: canonical
tags: [strategy-factory, statistics, matched-nulls, phase11]
---
# Local Compile and Test Runbook

## Scope

This document specifies **Local Compile and Test Runbook** as a reusable central-engine capability. Strategy-specific interpretations are plugins or declared grouping/null specifications; they are not embedded in the statistics kernel.
