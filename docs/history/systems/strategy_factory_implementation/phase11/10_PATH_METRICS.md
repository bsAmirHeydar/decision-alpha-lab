---
title: "Path Metrics, Drawdown and Runup"
phase: 11
status: canonical
tags: [strategy-factory, statistics, matched-nulls, phase11]
---
# Path Metrics, Drawdown and Runup

## Scope

This document specifies **Path Metrics, Drawdown and Runup** as a reusable central-engine capability. Strategy-specific interpretations are plugins or declared grouping/null specifications; they are not embedded in the statistics kernel.
