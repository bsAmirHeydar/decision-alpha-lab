...
Specify the next central-engine layer.

## Canonical decision

Phase 05 will compile plugins into immutable runtime generations and add append-only result sinks and artifact lineage.
