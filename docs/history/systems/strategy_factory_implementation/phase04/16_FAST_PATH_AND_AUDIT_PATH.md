---
title: "Fast Path and Audit Path"
phase: 04
status: canonical
---

# Fast Path and Audit Path

## Objective

Separate direct typed calls from append-only observability.

## Canonical decision

Event production uses direct bounded calls; audit envelopes never become the authority for decision ordering.
