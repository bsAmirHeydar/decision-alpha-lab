---
title: "Use Direct Typed Calls on the Fast Path"
status: accepted
phase: 04
---

# Use Direct Typed Calls on the Fast Path
...
The runtime calls plugin ports directly. The bounded event bus is audit infrastructure, not decision authority.
