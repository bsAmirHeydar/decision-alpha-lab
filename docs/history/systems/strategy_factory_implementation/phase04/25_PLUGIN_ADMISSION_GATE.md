...
Define the evidence needed before any anatomy joins the registry.

## Canonical decision

Compile, self-test, requirements, fixtures, known-time proof, duplicate handling and authority scans are mandatory.
