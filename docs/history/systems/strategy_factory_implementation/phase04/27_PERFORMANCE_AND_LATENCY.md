---
title: "Performance and Latency Budget"
phase: 04
status: canonical
---
...
Bound plugin callbacks and queue work.

## Canonical decision

Tick callbacks must be incremental; history rebuild is explicit; per-cycle event draining is capped.
