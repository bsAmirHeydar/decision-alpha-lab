...
Build the central static plugin kernel before integrating any legacy anatomy.

## Canonical decision

A plugin is admitted only when identity, version, capabilities, resource needs, lifecycle, queue behavior, known-time semantics and tests are explicit.
