---
title: "Plugin Base API Reference"
phase: 04
status: canonical
---

# Plugin Base API Reference

## Objective

Document lifecycle, requirement declaration, emission, duplicate handling and telemetry methods.

## Canonical decision

Derived plugins implement only market callbacks and anatomy-specific state transitions.
