...
Turn approved event examples into permanent regression evidence.

## Canonical decision

A fixture freezes input sequence, expected event IDs, known times, cluster IDs and queue outcomes.
