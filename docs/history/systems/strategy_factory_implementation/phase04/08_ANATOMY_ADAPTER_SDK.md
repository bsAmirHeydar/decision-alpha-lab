...
Provide the smallest reusable base required to turn an anatomy into canonical events.

## Canonical decision

The SDK supplies descriptor, lifecycle, requirements, queue, duplicate protection, telemetry and fail-closed semantics.
