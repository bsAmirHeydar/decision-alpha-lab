---
title: "Idempotency and Event Clustering"
phase: 04
status: canonical
---

# Idempotency and Event Clustering

## Objective

Ensure a repeated market fact does not produce repeated exposure.

## Canonical decision

Stable event ID, recent-ID ledger, parent links and market_event_cluster_id are first-class requirements.
