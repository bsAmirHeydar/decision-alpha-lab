...
Separate code version, plugin version, provider version and configuration hash.

## Canonical decision

Behavioral changes require version movement and differential replay evidence.
