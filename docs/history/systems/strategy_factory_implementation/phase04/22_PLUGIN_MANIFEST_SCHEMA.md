...
Provide a machine-readable contract for tooling and future compilation.

## Canonical decision

Manifests validate metadata but are compiled before startup; the live fast path does not parse them.
