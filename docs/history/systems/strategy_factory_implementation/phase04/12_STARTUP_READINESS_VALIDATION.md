---
title: "Startup Readiness Validation"
phase: 04
status: canonical
---
...
Validate all required market resources before the plugin can run.

## Canonical decision

Required failures block startup; optional failures degrade health and remain observable.
