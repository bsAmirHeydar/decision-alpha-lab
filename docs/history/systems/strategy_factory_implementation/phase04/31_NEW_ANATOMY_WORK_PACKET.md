---
title: "New Anatomy Work Packet"
phase: 04
status: canonical
---

# New Anatomy Work Packet

## Objective

Reduce onboarding to a bounded list of strategy-specific tasks.

## Canonical decision

Doctrine, adapter, requirements, event mapping, fixtures and exact registration are the only expected custom work.
