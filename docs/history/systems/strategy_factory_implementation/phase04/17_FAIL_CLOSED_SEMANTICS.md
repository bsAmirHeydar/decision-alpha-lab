...
Define how invalid contracts, stale data, queue overflow and duplicates are handled.

## Canonical decision

Required uncertainty blocks event production rather than manufacturing a default market interpretation.
