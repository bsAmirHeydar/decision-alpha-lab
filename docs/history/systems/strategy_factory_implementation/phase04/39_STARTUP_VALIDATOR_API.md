---
title: "Startup Validator API Reference"
phase: 04
status: canonical
---

# Startup Validator API Reference

## Objective

Document required and optional requirement probes.

## Canonical decision

Validation reads only shared service ports and never hides a missing dependency.
