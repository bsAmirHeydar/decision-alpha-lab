---
title: "Plugin Evidence Binding"
phase: 05
status: canonical
tags: [strategy-factory, mql5-first, runtime-generation, result-sink]
---

# Plugin Evidence Binding

## Purpose

Descriptor hash, requirement hash and plugin configuration hash permanently bound to the generation.
