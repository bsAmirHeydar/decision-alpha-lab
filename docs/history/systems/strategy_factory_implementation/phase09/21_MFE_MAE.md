...
Maximum favorable and adverse excursion are measured from actual simulated fill using initial risk as denominator. They are path diagnostics, not executable profit, and remain separate from realized gross and net R.
