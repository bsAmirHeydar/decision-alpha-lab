---
title: "Bid, Ask and Side-Aware Prices"
phase: 09
status: canonical
---
# Bid, Ask and Side-Aware Prices

Long entries pay ask and long exits receive bid; short entries receive bid and short exits pay ask when quotes are available. Bar-only observations rely on explicit spread and cost assumptions rather than hidden midpoint fills.
