...
Compact fixed-width numeric pass summaries are sent with FrameAdd and collected with FrameNext. Large event datasets are not transmitted for every pass.
