---
title: "Tester Mode Is External"
phase: 10
status: canonical
tags: [strategy-factory, mql5, tester-research, phase10]
---
# Tester Mode Is External

The EA records expected fidelity but MetaTrader tester modeling mode is configured externally. The run manifest and operator checklist prevent hidden mismatch.
