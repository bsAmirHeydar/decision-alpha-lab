---
title: "Unique Event and Cluster Counts"
phase: 10
status: canonical
tags: [strategy-factory, mql5, tester-research, phase10]
---
# Unique Event and Cluster Counts

Rows are not assumed independent. Event and market-cluster identities are first-class gates for sample sufficiency and future anti-overfit logic.
