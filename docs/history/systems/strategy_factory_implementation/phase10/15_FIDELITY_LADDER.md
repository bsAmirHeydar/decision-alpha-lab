...
Fast structural smoke tests precede bar validation, every-tick validation and final real-tick validation. Promotion requires surviving the required rung.
