# Requote, timeout and price-change handling

## Purpose

This note specifies **requote, timeout and price-change handling** for the MQL5-first Strategy Factory live boundary.
