# Success, transient, policy, market, account and request classes

## Purpose

This note specifies **success, transient, policy, market, account and request classes** for the MQL5-first Strategy Factory live boundary.
