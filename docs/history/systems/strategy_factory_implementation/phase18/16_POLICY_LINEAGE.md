# Decision, risk, allocation and execution policy hashes

## Purpose

This note specifies **decision, risk, allocation and execution policy hashes** for the MQL5-first Strategy Factory live boundary.
