# Request, order, deal and position reconciliation

## Purpose

This note specifies **request, order, deal and position reconciliation** for the MQL5-first Strategy Factory live boundary.
