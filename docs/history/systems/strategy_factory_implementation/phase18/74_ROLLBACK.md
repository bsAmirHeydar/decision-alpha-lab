# Revoke authorization and return to paper

## Purpose

This note specifies **revoke authorization and return to paper** for the MQL5-first Strategy Factory live boundary.
