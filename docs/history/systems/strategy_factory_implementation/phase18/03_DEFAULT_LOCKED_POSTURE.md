# Disabled mode and engaged startup kill switch

## Purpose

This note specifies **disabled mode and engaged startup kill switch** for the MQL5-first Strategy Factory live boundary.
