# Intent to preflight, check, send and transaction observation

## Purpose

This note specifies **intent to preflight, check, send and transaction observation** for the MQL5-first Strategy Factory live boundary.
