# Least authority and bounded blast radius

## Purpose

This note specifies **least authority and bounded blast radius** for the MQL5-first Strategy Factory live boundary.
