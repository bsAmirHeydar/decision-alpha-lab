# The single-file broker mutation boundary

## Purpose

This note specifies **the single-file broker mutation boundary** for the MQL5-first Strategy Factory live boundary.
