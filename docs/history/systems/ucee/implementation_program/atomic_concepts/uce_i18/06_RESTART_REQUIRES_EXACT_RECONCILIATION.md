---
title: "UCE-I18 — Restart requires exact reconciliation"
...
---
# Restart requires exact reconciliation

## Normative decision

A restarted runtime may emit no action until persisted generation, reservation ledger, positions and pending intent state reconcile exactly.
