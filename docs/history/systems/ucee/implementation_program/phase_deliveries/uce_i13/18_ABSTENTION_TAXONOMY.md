...
Treat abstention as a first-class decision for low score, conflict, capacity, unsupported output, and policy uncertainty.
...
- This chapter owns **Abstention Taxonomy** and treats its behavior-bearing fields as versioned identity.
- The primary operational objective is: Treat abstention as a first-class decision for low score, conflict, capacity, unsupported output, and policy uncertainty.
