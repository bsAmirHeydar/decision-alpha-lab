---
title: "Model Identity, Validity, and Staleness"
tags: [strategy-factory, universal-context-engine, uce-i13, policy-graph]
status: implemented_static_and_python_validated
doc_version: 1.0.0
last_updated: 2026-07-13
---
# Model Identity, Validity, and Staleness

## Decision summary

Bind output to the promoted model, occurrence, feature hash, known time, validity horizon, and required views.
...
- This chapter owns **Model Identity, Validity, and Staleness** and treats its behavior-bearing fields as versioned identity.
- The primary operational objective is: Bind output to the promoted model, occurrence, feature hash, known time, validity horizon, and required views.
