---
title: "Python and MQL5 Contract Parity"
tags: [strategy-factory, universal-context-engine, uce-i13, policy-graph]
status: implemented_static_and_python_validated
doc_version: 1.0.0
last_updated: 2026-07-13
---
# Python and MQL5 Contract Parity

## Decision summary

Mirror decision states, authority ordering, fallback semantics, and node catalog without claiming MetaEditor compilation.
...
- This chapter owns **Python and MQL5 Contract Parity** and treats its behavior-bearing fields as versioned identity.
- The primary operational objective is: Mirror decision states, authority ordering, fallback semantics, and node catalog without claiming MetaEditor compilation.
