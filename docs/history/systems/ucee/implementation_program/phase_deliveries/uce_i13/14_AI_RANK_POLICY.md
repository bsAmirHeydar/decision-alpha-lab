...
Attach deterministic ranking evidence to existing opportunities without turning rank into hidden eligibility.
...
- This chapter owns **AI Rank Policy** and treats its behavior-bearing fields as versioned identity.
- The primary operational objective is: Attach deterministic ranking evidence to existing opportunities without turning rank into hidden eligibility.
