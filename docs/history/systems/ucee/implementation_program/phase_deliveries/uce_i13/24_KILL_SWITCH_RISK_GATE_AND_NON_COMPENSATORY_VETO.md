---
title: "Kill Switch, Risk Gate, and Non-Compensatory Veto"
tags: [strategy-factory, universal-context-engine, uce-i13, policy-graph]
status: implemented_static_and_python_validated
doc_version: 1.0.0
last_updated: 2026-07-13
---
# Kill Switch, Risk Gate, and Non-Compensatory Veto

## Decision summary

Ensure high model confidence can never compensate for kill, risk, or hard manual veto.
...
- This chapter owns **Kill Switch, Risk Gate, and Non-Compensatory Veto** and treats its behavior-bearing fields as versioned identity.
- The primary operational objective is: Ensure high model confidence can never compensate for kill, risk, or hard manual veto.
