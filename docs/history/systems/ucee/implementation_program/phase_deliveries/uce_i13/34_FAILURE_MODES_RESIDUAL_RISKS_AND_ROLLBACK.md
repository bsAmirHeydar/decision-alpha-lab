---
title: "Failure Modes, Residual Risks, and Rollback"
...
State what the phase proves, what remains synthetic, and how to revert to the pinned manual graph.
...
- This chapter owns **Failure Modes, Residual Risks, and Rollback** and treats its behavior-bearing fields as versioned identity.
- The primary operational objective is: State what the phase proves, what remains synthetic, and how to revert to the pinned manual graph.
