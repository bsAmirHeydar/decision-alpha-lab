...
Publish closed schemas, canonical serialization, version handling, golden examples, and fail-closed migration.
...
- This chapter owns **Public Schemas, API, and Migration** and treats its behavior-bearing fields as versioned identity.
- The primary operational objective is: Publish closed schemas, canonical serialization, version handling, golden examples, and fail-closed migration.
