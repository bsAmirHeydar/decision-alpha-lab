...
Allow a valid promoted model to abstain from an eligible manual opportunity without creating a new occurrence.
...
- This chapter owns **AI Filter Policy** and treats its behavior-bearing fields as versioned identity.
- The primary operational objective is: Allow a valid promoted model to abstain from an eligible manual opportunity without creating a new occurrence.
