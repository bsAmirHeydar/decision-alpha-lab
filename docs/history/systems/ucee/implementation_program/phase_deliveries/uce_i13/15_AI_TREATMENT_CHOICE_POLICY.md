---
title: "AI Treatment Choice Policy"
tags: [strategy-factory, universal-context-engine, uce-i13, policy-graph]
status: implemented_static_and_python_validated
doc_version: 1.0.0
last_updated: 2026-07-13
---
# AI Treatment Choice Policy

## Decision summary

Choose only among treatments declared by manual support, occurrence support, graph support, and signed promotion evidence.
...
- This chapter owns **AI Treatment Choice Policy** and treats its behavior-bearing fields as versioned identity.
- The primary operational objective is: Choose only among treatments declared by manual support, occurrence support, graph support, and signed promotion evidence.
