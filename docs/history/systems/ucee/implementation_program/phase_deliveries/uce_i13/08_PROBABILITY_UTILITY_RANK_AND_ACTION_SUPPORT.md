---
title: "Probability, Utility, Rank, and Action Support"
tags: [strategy-factory, universal-context-engine, uce-i13, policy-graph]
status: implemented_static_and_python_validated
doc_version: 1.0.0
last_updated: 2026-07-13
---
# Probability, Utility, Rank, and Action Support

## Decision summary

Separate model evidence from authority and prevent distributions from creating actions outside signed support.
...
- This chapter owns **Probability, Utility, Rank, and Action Support** and treats its behavior-bearing fields as versioned identity.
- The primary operational objective is: Separate model evidence from authority and prevent distributions from creating actions outside signed support.
