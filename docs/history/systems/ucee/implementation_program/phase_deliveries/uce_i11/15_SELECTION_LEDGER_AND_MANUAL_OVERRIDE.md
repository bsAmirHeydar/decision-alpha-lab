---
title: "UCE-I11 — Selection Ledger and Manual Override"
...
---
# Selection Ledger and Manual Override

## Purpose

Every attempted, skipped, invalid, pruned, failed, timed-out, selected, rejected, thresholded, calibrated, ensembled, cached, resumed, cancelled, and overridden decision is hash-chained.

## Scope

- Append entries in sequence order.
- Hash previous_entry_hash into the next entry.
- Require reason_code and actor.
- Require report models to have selected/ensembled entries.

## Normative invariants

1. **Ledger entries are never edited in place.**
2. **Manual override cannot erase the pre-override decision.**
3. **Metrics and artifact hashes are part of entry identity.**
4. **Chain verification is mandatory before delivery.**
...
immutable upstream evidence
        │
        ▼
validated selection ledger and manual override
        │
