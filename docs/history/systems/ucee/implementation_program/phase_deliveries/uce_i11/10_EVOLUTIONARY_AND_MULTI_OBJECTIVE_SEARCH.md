---
title: "UCE-I11 — Evolutionary and Multi-Objective Search"
...
---
# Evolutionary and Multi-Objective Search

## Purpose

The evolutionary reference selects deterministic elites, performs seeded crossover/mutation, suppresses duplicates, and keeps constraints explicit. Pareto selection removes dominated feasible observations.

## Scope

- Rank elites using declared weighted objective score.
- Use local seeded mutation only.
- Require all objective values before dominance comparison.
- Keep infeasible points outside the Pareto front but inside evidence.

## Normative invariants

1. **Elite fraction is validated.**
2. **Observed points are not reissued silently.**
3. **Pareto ties are ordered by trial_id.**
4. **Multi-objective selection does not replace I12 multiplicity correction.**
...
immutable upstream evidence
        │
        ▼
validated evolutionary and multi-objective search
        │
