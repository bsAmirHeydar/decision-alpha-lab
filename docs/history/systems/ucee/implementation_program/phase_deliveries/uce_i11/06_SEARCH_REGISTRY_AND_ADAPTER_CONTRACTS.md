---
title: "UCE-I11 — Search Registry and Adapter Contracts"
...
---
# Search Registry and Adapter Contracts

## Purpose

The exact-version registry contains native baseline, grid, random, Halton, TPE reference, successive halving, Hyperband, evolutionary, Pareto, and an optional Optuna adapter boundary.

## Scope

- Resolve adapters by exact key.
- Freeze the registry before compilation.
- Declare determinism, constraints, multi-objective, pruning, and dependency capabilities.
- Treat optional adapters as separate evidence obligations.

## Normative invariants

1. **Native adapters cannot declare optional dependencies.**
2. **Registry mutation after freeze is forbidden.**
3. **Adapter version is part of search-plan identity.**
4. **An unregistered search kind fails closed.**
...
immutable upstream evidence
        │
        ▼
validated search registry and adapter contracts
        │
