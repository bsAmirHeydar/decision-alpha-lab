---
title: "UCE-I11 — TPE and Bayesian Adapter Boundary"
...
---
# TPE and Bayesian Adapter Boundary

## Purpose

The native TPE reference uses warm-up quasi-random proposals, a deterministic good/bad partition, smoothed categorical ratios, and seeded local numeric sampling.

## Scope

- Require objective metrics for adaptive observations.
- Respect hard objective constraints before ranking.
- Use exact observation order and completed_sequence evidence.
- Pin dependency, sampler, storage, and worker count for Optuna.

## Normative invariants

1. **The native TPE is a contract floor, not a claim of optimizer superiority.**
2. **Missing objective metrics are hard errors.**
3. **Adaptive proposals cannot see final-test observations.**
4. **External optimizer state must be content-addressed.**
...
immutable upstream evidence
        │
        ▼
validated tpe and bayesian adapter boundary
        │
