---
title: "UCE-I11 — Experiment Declaration and Identity"
...
---
# Experiment Declaration and Identity

## Purpose

ExperimentDeclaration is the sole compiler input. Dataset, split, transform, target, economics, known-time, candidate, fold, seed, search, budget, scheduler, and compiler identities are immutable.

## Scope

- Define all axes before compilation.
- Use canonical JSON and lowercase SHA-256.
- Reject duplicate folds, seeds, candidates, and parameter names.
- Reject hidden-test role requests at construction time.

## Normative invariants

1. **Changing one behavior axis changes trial_id.**
2. **Changing scheduler/compiler version changes trial identity.**
3. **No environment clock or filesystem enumeration enters compilation.**
4. **Non-finite numeric values are forbidden.**
...
immutable upstream evidence
        │
        ▼
validated experiment declaration and identity
        │
