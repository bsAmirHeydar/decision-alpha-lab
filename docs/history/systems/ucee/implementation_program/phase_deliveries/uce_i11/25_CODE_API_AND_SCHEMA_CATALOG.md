---
title: "UCE-I11 — Code, API, and Schema Catalog"
...
---
# Code, API, and Schema Catalog

## Purpose

The delivery exposes a Python package, 24 public JSON schemas, golden examples, conformance vectors, MQL5 mirrors, validation tools, tests, and phase evidence.

## Scope

- Use strategy_factory_experiments_v3 public imports.
- Use ExperimentDagCompiler for pure compilation.
- Use DeterministicScheduler with BudgetManager.
- Use ContentAddressedCache and audit_reproducibility for evidence.

## Normative invariants

1. **Schemas are draft 2020-12 and closed at public top level.**
2. **Enums are closed.**
3. **Exact versions are required.**
...
immutable upstream evidence
        │
        ▼
validated code, api, and schema catalog
        │
