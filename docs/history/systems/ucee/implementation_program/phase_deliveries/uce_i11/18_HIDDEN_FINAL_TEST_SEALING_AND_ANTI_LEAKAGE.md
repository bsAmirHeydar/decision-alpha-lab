---
title: "UCE-I11 — Hidden Final-Test Sealing and Anti-Leakage"
...
---
# Hidden Final-Test Sealing and Anti-Leakage

## Purpose

The protected final-test role is rejected from ExperimentDeclaration.requested_roles and is absent from search, scheduler, budget, cache, and isolation primitives.

## Scope

- Use train/validation roles only during I11.
- Hash known-time policy and split plan into every trial.
- Do not expose final-test metrics to adaptive search.
- Defer final unsealing to a frozen downstream gate.

## Normative invariants

1. **Role exclusion is executable, not a convention.**
2. **Search modules contain no hardcoded protected role.**
3. **Dataset manifest remains immutable.**
4. **Future observations cannot alter a past trial identity.**
...
immutable upstream evidence
        │
        ▼
validated hidden final-test sealing and anti-leakage
        │
