---
title: "UCE-I18 — MQL5 Host and Diagnostic Compile"
tags: [strategy-factory, uce-i18, production-qualification, release]
status: implemented_reference_external_evidence_pending
doc_version: 1.0.0
last_updated: 2026-07-15
---
# MQL5 Host and Diagnostic Compile

## Decision

Compiles every production host, include consumer, self-test and diagnostic expert; no single umbrella compile substitutes for target coverage.
