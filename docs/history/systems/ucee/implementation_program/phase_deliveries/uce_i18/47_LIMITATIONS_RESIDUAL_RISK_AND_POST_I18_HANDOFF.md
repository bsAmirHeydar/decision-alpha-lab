---
title: "UCE-I18 — Limitations Residual Risk and Post-I18 Handoff"
tags: [strategy-factory, uce-i18, production-qualification, release]
status: implemented_reference_external_evidence_pending
doc_version: 1.0.0
last_updated: 2026-07-15
---
# Limitations Residual Risk and Post-I18 Handoff

## Decision

States that repository evidence is synthetic/static and keeps activation blocked until Windows, terminal, broker and prospective evidence exist.


## Current hard blockers

- no MetaEditor/Windows compile log is embedded in this repository;
- no terminal-generated Python/MQL5 parity evidence is embedded;
- no real broker symbol/account fingerprint is embedded;
- no long soak, chaos, disconnect/restart or broker reconciliation run is embedded;
- no prospectively frozen paper/shadow period is embedded;
- no human-approved micro-live run is embedded.

Accordingly, `activation_allowed` remains `false`. The reference package may generate a synthetic qualified path only to test orchestration; that path is explicitly marked synthetic and must never be used as release evidence.
