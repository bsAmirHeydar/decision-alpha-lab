---
title: "UCE-I19 — Reservation Open Risk and Capital Accounting"
tags: [strategy-factory, uce-i19, production-operations, deployment]
status: implemented_reference_external_evidence_pending
doc_version: 1.0.0
last_updated: 2026-07-15
---
# Reservation Open Risk and Capital Accounting

## Decision

Requires risk reservation before selection and exact reconciliation across reservations, intents, orders, fills, positions, and cash.

## Scope and non-goals

Unreserved exposure is a critical incident and immediately removes new-order authority. The control is evaluated only against artifacts available at the decision cut. It does not fill missing fields, infer broker semantics, reinterpret a market setup, or convert a monitoring recommendation into execution authority.
...
- [[16_RISK_ENVELOPE_AND_NON_COMPENSATORY_CAPS|Previous control]]
- [[18_SYMBOL_CONTEXT_CONCENTRATION_AND_DEPENDENCE|Next control]]
