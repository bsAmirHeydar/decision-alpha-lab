---
title: "UCE-I19 — Post-Trade Broker Statement Reconciliation"
tags: [strategy-factory, uce-i19, production-operations, deployment]
status: implemented_reference_external_evidence_pending
doc_version: 1.0.0
last_updated: 2026-07-15
---
# Post-Trade Broker Statement Reconciliation

## Decision

Reconciles fills, commissions, swaps, cash, positions, and broker statements against the internal ledger.

## Scope and non-goals

Economic differences are recorded explicitly and cannot be hidden inside aggregate PnL. The control is evaluated only against artifacts available at the decision cut. It does not fill missing fields, infer broker semantics, reinterpret a market setup, or convert a monitoring recommendation into execution authority.
...
- [[28_END_OF_DAY_CONTROL_AND_HANDOFF|Previous control]]
- [[30_PROSPECTIVE_STAGE_WINDOWS|Next control]]
