---
title: "UCE-I19 — Risk Envelope and Non-Compensatory Caps"
tags: [strategy-factory, uce-i19, production-operations, deployment]
status: implemented_reference_external_evidence_pending
doc_version: 1.0.0
last_updated: 2026-07-15
---
# Risk Envelope and Non-Compensatory Caps

## Decision

Defines total, open, per-order, daily-loss, weekly-loss, position-count, order-rate, symbol, and context caps.

## Scope and non-goals

No model score, expected utility, diversification benefit, or human preference may compensate for a breached hard cap. The control is evaluated only against artifacts available at the decision cut. It does not fill missing fields, infer broker semantics, reinterpret a market setup, or convert a monitoring recommendation into execution authority.
...
- [[15_BROKER_CONNECTIVITY_SESSION_AND_SYMBOL_CONTROLS|Previous control]]
- [[17_RESERVATION_OPEN_RISK_AND_CAPITAL_ACCOUNTING|Next control]]
