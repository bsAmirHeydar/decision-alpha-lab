---
title: "UCE-I19 — Exact Broker Reconciliation"
tags: [strategy-factory, uce-i19, production-operations, deployment]
status: implemented_reference_external_evidence_pending
doc_version: 1.0.0
last_updated: 2026-07-15
---
# Exact Broker Reconciliation

## Decision

Compares expected and observed reservation, order, position, and ledger identities without tolerance for orphan or unreserved exposure.

## Scope and non-goals

Cash rounding may use an approved numerical tolerance; identity and count mismatches remain exact failures. The control is evaluated only against artifacts available at the decision cut. It does not fill missing fields, infer broker semantics, reinterpret a market setup, or convert a monitoring recommendation into execution authority.
...
- [[20_ORDER_RATE_IDEMPOTENCY_DUPLICATE_AND_STALE_GUARDS|Previous control]]
- [[22_RESTART_RECOVERY_AND_REPLAY_BOUNDARY|Next control]]
