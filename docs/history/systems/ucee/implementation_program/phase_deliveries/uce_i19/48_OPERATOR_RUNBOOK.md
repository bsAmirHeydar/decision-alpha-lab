---
title: "UCE-I19 — Operator Runbook"
...
Provides pre-start, per-cycle, incident, EOD, rollback, ramp, change, and retirement procedures.

## Scope and non-goals

Every command must preserve root-relative artifacts, explicit scope, exact hashes, and fail-closed return codes. The control is evaluated only against artifacts available at the decision cut. It does not fill missing fields, infer broker semantics, reinterpret a market setup, or convert a monitoring recommendation into execution authority.
...
- [[47_SCHEMA_CODE_MQL5_TEST_AND_TOOL_CATALOG|Previous control]]
- [[49_NEGATIVE_FAILURE_AND_CHAOS_TEST_MATRIX|Next control]]
