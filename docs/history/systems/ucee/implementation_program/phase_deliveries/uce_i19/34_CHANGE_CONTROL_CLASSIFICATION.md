---
title: "UCE-I19 — Change Control Classification"
...
Classifies documentation-only, non-authority operational, emergency risk-reduction, qualification-invalidating, and forbidden hot changes.

## Scope and non-goals

Unknown fields fail into requalification or denial rather than a permissive default. The control is evaluated only against artifacts available at the decision cut. It does not fill missing fields, infer broker semantics, reinterpret a market setup, or convert a monitoring recommendation into execution authority.
...
- [[33_HUMAN_APPROVAL_AND_NO_AUTOMATIC_ESCALATION|Previous control]]
- [[35_INVALIDATING_CHANGES_AND_REQUALIFICATION|Next control]]
