---
title: "UCE-I19 — Derisk Safe Halt and Emergency Flattening"
tags: [strategy-factory, uce-i19, production-operations, deployment]
status: implemented_reference_external_evidence_pending
doc_version: 1.0.0
last_updated: 2026-07-15
---
# Derisk Safe Halt and Emergency Flattening

## Decision

Separates no-new-risk derisk, safe halt, controlled position reduction, and emergency flattening.

## Scope and non-goals

The reference layer only decides and records required control state; broker-side flattening remains in the locked execution adapter. The control is evaluated only against artifacts available at the decision cut. It does not fill missing fields, infer broker semantics, reinterpret a market setup, or convert a monitoring recommendation into execution authority.
...
- [[23_KILL_SWITCH_ENGAGE_RELEASE_AND_AUDIT|Previous control]]
- [[25_INCIDENT_LIFECYCLE_AND_STATE_TRANSITIONS|Next control]]
