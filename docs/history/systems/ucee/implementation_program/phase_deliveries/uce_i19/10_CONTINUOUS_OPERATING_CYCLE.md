---
title: "UCE-I19 — Continuous Operating Cycle"
...
Evaluates plan, lease, telemetry, health, reconciliation, incidents, and risk headroom before every possible action cycle.

## Scope and non-goals

A prior passing cycle cannot authorize a later cycle; authority is recomputed from current known-time evidence. The control is evaluated only against artifacts available at the decision cut. It does not fill missing fields, infer broker semantics, reinterpret a market setup, or convert a monitoring recommendation into execution authority.
...
- [[09_STARTUP_PREFLIGHT_AND_ZERO_STATE|Previous control]]
- [[11_TELEMETRY_KNOWN_TIME_AND_FRESHNESS|Next control]]
