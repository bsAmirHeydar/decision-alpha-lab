---
title: "UCE-I19 — Authority Boundary and Separation of Duties"
tags: [strategy-factory, uce-i19, production-operations, deployment]
status: implemented_reference_external_evidence_pending
doc_version: 1.0.0
last_updated: 2026-07-15
---
# Authority Boundary and Separation of Duties

## Decision

Separates research truth, qualification authority, operating control, broker execution, human approval, incident command, and audit review.

## Scope and non-goals

The reference Python and MQL5 surfaces are evaluators and diagnostics only; they do not connect to a broker or send orders. The control is evaluated only against artifacts available at the decision cut. It does not fill missing fields, infer broker semantics, reinterpret a market setup, or convert a monitoring recommendation into execution authority.
...
- [[03_PRODUCTION_OPERATIONS_STATE_MACHINE|Previous control]]
- [[05_DEPLOYMENT_IDENTITY_AND_CANONICAL_BINDING|Next control]]
