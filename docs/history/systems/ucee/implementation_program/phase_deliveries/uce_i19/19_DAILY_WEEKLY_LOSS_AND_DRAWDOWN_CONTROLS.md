---
title: "UCE-I19 — Daily Weekly Loss and Drawdown Controls"
...
Evaluates realized and marked loss against immutable daily and weekly operating limits.

## Scope and non-goals

Loss controls are measured from broker-reconciled capital state and cannot be reset by process restart, timezone ambiguity, or manual file deletion. The control is evaluated only against artifacts available at the decision cut. It does not fill missing fields, infer broker semantics, reinterpret a market setup, or convert a monitoring recommendation into execution authority.
...
- [[18_SYMBOL_CONTEXT_CONCENTRATION_AND_DEPENDENCE|Previous control]]
- [[20_ORDER_RATE_IDEMPOTENCY_DUPLICATE_AND_STALE_GUARDS|Next control]]
