---
title: "UCE-I19 — Broker Connectivity Session and Symbol Controls"
tags: [strategy-factory, uce-i19, production-operations, deployment]
status: implemented_reference_external_evidence_pending
doc_version: 1.0.0
last_updated: 2026-07-15
---
# Broker Connectivity Session and Symbol Controls

## Decision

Controls broker connectivity, trade-session availability, symbol selection, specification freshness, and terminal state.

## Scope and non-goals

Connection alone is insufficient; symbol specification, account mode, terminal identity, and history synchronization must match qualification. The control is evaluated only against artifacts available at the decision cut. It does not fill missing fields, infer broker semantics, reinterpret a market setup, or convert a monitoring recommendation into execution authority.
...
- [[14_GENERATION_MODEL_POLICY_AND_ARTIFACT_INTEGRITY|Previous control]]
- [[16_RISK_ENVELOPE_AND_NON_COMPENSATORY_CAPS|Next control]]
