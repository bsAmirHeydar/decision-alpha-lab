---
title: "UCE-I19 — Incident Lifecycle and State Transitions"
...
Defines open, contained, resolved, and closed incident states with monotonic timestamps and evidence.

## Scope and non-goals

Incidents are never deleted, backdated, self-closed, or converted to warnings to regain authority. The control is evaluated only against artifacts available at the decision cut. It does not fill missing fields, infer broker semantics, reinterpret a market setup, or convert a monitoring recommendation into execution authority.
...
- [[24_DERISK_SAFE_HALT_AND_EMERGENCY_FLATTENING|Previous control]]
- [[26_INCIDENT_SEVERITY_ESCALATION_AND_COMMAND|Next control]]
