...
---
# Parity Vector Families

## Decision summary

Define golden, edge, random, missing, extreme, OOD, and batch evidence families.
...
- The chapter owner is `15_GOLDEN_EDGE_RANDOM_MISSING_EXTREME_OOD_VECTORS`; downstream consumers must cite its artifact identities rather than reconstruct behavior from prose.
- The operational objective is: Define golden, edge, random, missing, extreme, OOD, and batch evidence families.
