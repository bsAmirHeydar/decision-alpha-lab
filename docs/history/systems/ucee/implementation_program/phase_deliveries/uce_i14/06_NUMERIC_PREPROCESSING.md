...
Specify imputation, clipping, z-score, min-max, finite-value checks, and deterministic precision.
...
- The chapter owner is `06_NUMERIC_PREPROCESSING`; downstream consumers must cite its artifact identities rather than reconstruct behavior from prose.
- The operational objective is: Specify imputation, clipping, z-score, min-max, finite-value checks, and deterministic precision.
