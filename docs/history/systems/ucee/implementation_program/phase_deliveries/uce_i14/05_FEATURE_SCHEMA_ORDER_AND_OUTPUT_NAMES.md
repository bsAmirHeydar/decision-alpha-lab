---
title: "Feature Schema, Order, and Output Names"
...
---
# Feature Schema, Order, and Output Names

## Decision summary

Freeze input names, preprocessing expansion, model input names, and output labels as exact ordered identities.
...
- The chapter owner is `05_FEATURE_SCHEMA_ORDER_AND_OUTPUT_NAMES`; downstream consumers must cite its artifact identities rather than reconstruct behavior from prose.
- The operational objective is: Freeze input names, preprocessing expansion, model input names, and output labels as exact ordered identities.
