---
title: "UCE-I14 Delivery Map of Content"
...
---
# UCE-I14 Delivery Map of Content

## Decision summary

Navigate the immutable runtime compilation delivery and its evidence graph.
...
- The chapter owner is `00_UCE_I14_DELIVERY_MOC`; downstream consumers must cite its artifact identities rather than reconstruct behavior from prose.
- The operational objective is: Navigate the immutable runtime compilation delivery and its evidence graph.
