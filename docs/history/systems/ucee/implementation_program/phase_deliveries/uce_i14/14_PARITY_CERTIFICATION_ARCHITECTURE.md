---
title: "Parity Certification Architecture"
...
---
# Parity Certification Architecture

## Decision summary

Compare source, exported representation, and MQL5 mirror under one vector universe.
...
- The chapter owner is `14_PARITY_CERTIFICATION_ARCHITECTURE`; downstream consumers must cite its artifact identities rather than reconstruct behavior from prose.
- The operational objective is: Compare source, exported representation, and MQL5 mirror under one vector universe.
