---
title: "Float32 and Cross-Language Arithmetic"
...
---
# Float32 and Cross-Language Arithmetic

## Decision summary

Define operation order and float32 casts required for Python/MQL5 parity.
...
- The chapter owner is `08_FLOAT32_AND_CROSS_LANGUAGE_ARITHMETIC`; downstream consumers must cite its artifact identities rather than reconstruct behavior from prose.
- The operational objective is: Define operation order and float32 casts required for Python/MQL5 parity.
