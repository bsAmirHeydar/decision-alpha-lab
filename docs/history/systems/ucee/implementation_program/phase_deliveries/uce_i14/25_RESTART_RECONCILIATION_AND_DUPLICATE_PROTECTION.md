---
title: "Restart Reconciliation and Duplicate Protection"
...
---
# Restart Reconciliation and Duplicate Protection

## Decision summary

Restore journal state and active generation without duplicate decisions or mixed artifacts.
...
- The chapter owner is `25_RESTART_RECONCILIATION_AND_DUPLICATE_PROTECTION`; downstream consumers must cite its artifact identities rather than reconstruct behavior from prose.
- The operational objective is: Restore journal state and active generation without duplicate decisions or mixed artifacts.
