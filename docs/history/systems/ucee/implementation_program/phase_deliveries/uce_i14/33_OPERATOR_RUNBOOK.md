...
Build, export, certify, warm, activate, observe, quarantine, and roll back a generation.
...
- The chapter owner is `33_OPERATOR_RUNBOOK`; downstream consumers must cite its artifact identities rather than reconstruct behavior from prose.
- The operational objective is: Build, export, certify, warm, activate, observe, quarantine, and roll back a generation.
