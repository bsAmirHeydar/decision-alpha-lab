---
title: "Public Schemas, API, and Migration"
...
---
# Public Schemas, API, and Migration

## Decision summary

Publish closed schemas, explicit version migration, and rejection of unsupported manifests.
...
- The chapter owner is `31_PUBLIC_SCHEMAS_API_AND_MIGRATION`; downstream consumers must cite its artifact identities rather than reconstruct behavior from prose.
- The operational objective is: Publish closed schemas, explicit version migration, and rejection of unsupported manifests.
