---
title: "Atomic Activation, Retirement, and Rollback"
...
---
# Atomic Activation, Retirement, and Rollback

## Decision summary

Switch one complete generation at a time and preserve an exact rollback target.
...
- The chapter owner is `24_ATOMIC_ACTIVATION_RETIREMENT_AND_ROLLBACK`; downstream consumers must cite its artifact identities rather than reconstruct behavior from prose.
- The operational objective is: Switch one complete generation at a time and preserve an exact rollback target.
