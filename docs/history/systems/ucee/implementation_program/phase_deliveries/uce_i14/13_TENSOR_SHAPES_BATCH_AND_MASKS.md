---
title: "Tensor Shapes, Batch, and Masks"
...
---
# Tensor Shapes, Batch, and Masks

## Decision summary

Freeze shape semantics and reject silent broadcasting, truncation, padding, or mask reinterpretation.
...
- The chapter owner is `13_TENSOR_SHAPES_BATCH_AND_MASKS`; downstream consumers must cite its artifact identities rather than reconstruct behavior from prose.
- The operational objective is: Freeze shape semantics and reject silent broadcasting, truncation, padding, or mask reinterpretation.
