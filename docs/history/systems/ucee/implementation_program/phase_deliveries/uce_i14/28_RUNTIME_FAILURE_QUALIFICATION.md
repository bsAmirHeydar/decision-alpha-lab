---
title: "Runtime Failure Qualification"
...
---
# Runtime Failure Qualification

## Decision summary

Exercise corrupt artifact, stale context, symbol failure, inference failure, restart, parity, signature, and kill switch.
...
- The chapter owner is `28_RUNTIME_FAILURE_QUALIFICATION`; downstream consumers must cite its artifact identities rather than reconstruct behavior from prose.
- The operational objective is: Exercise corrupt artifact, stale context, symbol failure, inference failure, restart, parity, signature, and kill switch.
