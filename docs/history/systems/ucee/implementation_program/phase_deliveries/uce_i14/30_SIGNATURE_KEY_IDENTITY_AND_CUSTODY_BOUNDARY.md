---
title: "Signature Identity and Key-Custody Boundary"
...
---
# Signature Identity and Key-Custody Boundary

## Decision summary

Provide deterministic verification while explicitly leaving production key custody downstream.
...
- The chapter owner is `30_SIGNATURE_KEY_IDENTITY_AND_CUSTODY_BOUNDARY`; downstream consumers must cite its artifact identities rather than reconstruct behavior from prose.
- The operational objective is: Provide deterministic verification while explicitly leaving production key custody downstream.
