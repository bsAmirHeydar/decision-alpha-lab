---
title: "ONNX Capability and Fail-Closed Behavior"
...
---
# ONNX Capability and Fail-Closed Behavior

## Decision summary

Probe ONNX dependencies explicitly and forbid unqualified conversion or unverifiable parity claims.
...
- The chapter owner is `11_ONNX_CAPABILITY_AND_FAIL_CLOSED_BEHAVIOR`; downstream consumers must cite its artifact identities rather than reconstruct behavior from prose.
- The operational objective is: Probe ONNX dependencies explicitly and forbid unqualified conversion or unverifiable parity claims.
