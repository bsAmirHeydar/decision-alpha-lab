---
title: "Categorical, Boolean, and Missingness Semantics"
...
---
# Categorical, Boolean, and Missingness Semantics

## Decision summary

Close categorical vocabularies, boolean encoding, unknown values, and missing-value policy.
...
- The chapter owner is `07_CATEGORICAL_BOOLEAN_MISSINGNESS`; downstream consumers must cite its artifact identities rather than reconstruct behavior from prose.
- The operational objective is: Close categorical vocabularies, boolean encoding, unknown values, and missing-value policy.
