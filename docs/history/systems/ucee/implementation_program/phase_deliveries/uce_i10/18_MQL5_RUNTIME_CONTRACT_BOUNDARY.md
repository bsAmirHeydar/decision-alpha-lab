---
title: "MQL5 Runtime Contract Boundary"
tags: [strategy-factory, universal-context-engine, uce-i10, deep-views]
status: implemented
doc_version: 1.1.0
last_updated: 2026-07-13
---
# MQL5 Runtime Contract Boundary

## Purpose

Mirror identity and qualification contracts in MQL5 while preserving a strict no-execution-authority boundary.
...
1. **MQL5 files define enums, descriptors, view artifacts, qualification, dependency, and transfer records.**
2. **The catalog declares 17 algorithms and 10 native implementations.**
3. **Diagnostics and self-tests inspect contracts only.**
4. **OrderSend, OrderCheck, CTrade, position opening, broker networking, and model training are prohibited.**

## Contract and implementation surface

- `UCEI10_All.mqh`
- `catalog and frozen registry`
- `diagnostic expert`
- `contract self-test`
- `causality safety self-test`
...
|---|---|
| `embedding trading authority in a diagnostic` | Reject or abstain; retain code and evidence; do not silently repair. |
| `claiming Python/MQL5 parity without compiled logs` | Reject or abstain; retain code and evidence; do not silently repair. |
| `different enum semantics between languages` | Reject or abstain; retain code and evidence; do not silently repair. |
| `silently defaulting missing qualification evidence` | Reject or abstain; retain code and evidence; do not silently repair. |
