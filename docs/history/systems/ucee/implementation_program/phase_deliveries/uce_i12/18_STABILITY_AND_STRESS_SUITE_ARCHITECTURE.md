---
title: "Stability and Stress Suite Architecture"
tags:
  - strategy-factory
...
---
# Stability and Stress Suite Architecture

## Decision summary

- Stress results report metric retention, not only absolute stressed output.
- Each stress has a minimum retention gate and explicit mechanics.
- The suite cannot omit a failed stress from the aggregate report.
