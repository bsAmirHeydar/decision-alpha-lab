---
title: "Cost, Spread, Slippage, Latency, and Fill Stress"
tags:
  - strategy-factory
...
---
# Cost, Spread, Slippage, Latency, and Fill Stress

## Decision summary

- Costs are applied to executable long/short sides using incremental stress above the base economics contract.
- Latency stress consumes adverse movement per millisecond.
- Fill stress is seeded and preserves dropped opportunities as zero execution value.
