---
title: "Deflated Performance and True Trial Count"
tags:
  - strategy-factory
...
---
# Deflated Performance and True Trial Count

## Decision summary

- The benchmark increases with the complete number of searched choices.
- Skewness, excess kurtosis, sample count, and trial dispersion remain explicit inputs.
- Reporting a deflated probability from selected trials only is forbidden.
