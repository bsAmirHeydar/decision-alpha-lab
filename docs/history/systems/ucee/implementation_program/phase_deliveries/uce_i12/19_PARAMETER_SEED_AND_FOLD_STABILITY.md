---
title: "Parameter-Neighborhood, Seed, and Fold Stability"
tags:
  - strategy-factory
...
---
# Parameter-Neighborhood, Seed, and Fold Stability

## Decision summary

- Promotion requires a plateau, not a single sharp optimum.
- Seed and fold distributions remain visible; best-seed reporting is forbidden.
- Worst-neighbor retention is used as a conservative stability summary.
