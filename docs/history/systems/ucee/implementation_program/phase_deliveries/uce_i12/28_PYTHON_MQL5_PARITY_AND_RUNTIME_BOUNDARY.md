---
title: "Python/MQL5 Parity and Runtime Boundary"
tags:
  - strategy-factory
...
---
# Python/MQL5 Parity and Runtime Boundary

## Decision summary

- Python owns full statistical computation; MQL5 mirrors contracts, registry, scorecard, and veto logic.
- Static checks are not represented as MetaEditor compilation.
- No MQL5 file in this phase can create or modify a market position.
