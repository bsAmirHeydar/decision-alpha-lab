---
title: "Acceptance Evidence, Gate Matrix, and Handoff to I13"
tags:
  - strategy-factory
...
---
# Acceptance Evidence, Gate Matrix, and Handoff to I13

## Decision summary

- I13 receives only signed reject/challenge/promote evidence and may not infer missing statistics.
- Promotion does not grant trading authority; it only admits a model/policy artifact to the next design phase.
- The first I13 golden test preserves manual-only output exactly while AI remains bounded.
...
- `strategy_factory_promotion_v3/gate.py`
