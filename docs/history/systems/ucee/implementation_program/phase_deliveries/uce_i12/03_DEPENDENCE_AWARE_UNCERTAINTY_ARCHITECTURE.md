---
title: "Dependence-Aware Uncertainty Architecture"
tags:
  - strategy-factory
...
---
# Dependence-Aware Uncertainty Architecture

## Decision summary

- Overlapping trades and repeated context observations are not treated as IID rows.
- The uncertainty engine supports moving-block, cluster, and paired block bootstrap.
- Every stochastic procedure carries a deterministic seed and identity-bearing block policy.
