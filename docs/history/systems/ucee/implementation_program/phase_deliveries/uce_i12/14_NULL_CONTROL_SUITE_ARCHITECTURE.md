---
title: "Null and Negative-Control Suite Architecture"
tags:
  - strategy-factory
...
---
# Null and Negative-Control Suite Architecture

## Decision summary

- Nulls target timing, context, direction, labels, trigger logic, treatment selection, and human baselines.
- A null is paired to the same opportunity universe whenever possible.
- Manual baseline is mandatory rather than an optional narrative benchmark.
...
- `strategy_factory_promotion_v3/nulls.py`
