---
title: "Subgroup and Sequential Confidence Reporting"
tags:
  - strategy-factory
...
---
# Subgroup and Sequential Confidence Reporting

## Decision summary

- Regime, session, symbol, direction, and treatment uncertainty remain separately visible.
- Sequential looks use explicit alpha spending; repeated peeking is not free.
- Sparse subgroups remain missing evidence rather than silently pooled.
