---
title: "Calibration: Brier Score, Log Loss, Reliability, and ECE"
tags:
  - strategy-factory
...
---
# Calibration: Brier Score, Log Loss, Reliability, and ECE

## Decision summary

- Only out-of-fold or locked confirmatory probabilities may enter calibration.
- Brier and log loss measure proper scoring; ECE exposes bucket miscalibration.
- Reliability bins retain empty bins explicitly.
...
- `strategy_factory_promotion_v3/calibration.py`
