---
title: "Trade Drop, Best-Trade Removal, Tail, Capacity, and Revision Stress"
tags:
  - strategy-factory
...
---
# Trade Drop, Best-Trade Removal, Tail, Capacity, and Revision Stress

## Decision summary

- Best-trade removal reveals concentration in a small number of outcomes.
- Trade-drop and capacity stresses model opportunity loss and market impact constraints.
- Tail and source-revision tests remain first-class evidence.
...
- `strategy_factory_promotion_v3/stress.py`
