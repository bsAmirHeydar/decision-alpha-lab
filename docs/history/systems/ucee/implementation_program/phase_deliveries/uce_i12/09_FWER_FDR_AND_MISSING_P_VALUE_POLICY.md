---
title: "FWER, FDR, and Missing-P-Value Policy"
tags:
  - strategy-factory
...
---
# FWER, FDR, and Missing-P-Value Policy

## Decision summary

- Bonferroni, Holm, Benjamini-Hochberg, and Benjamini-Yekutieli are deterministic native corrections.
- Missing p-values are padded as p=1 when complete-universe accounting is enabled.
- Adjusted p-values preserve original trial identity and input order.
...
- `strategy_factory_promotion_v3/multiplicity.py`
