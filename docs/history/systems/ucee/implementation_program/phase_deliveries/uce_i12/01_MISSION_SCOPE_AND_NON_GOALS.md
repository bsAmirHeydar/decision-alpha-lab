---
title: "Mission, Scope, Authority Boundary, and Non-Goals"
tags:
  - strategy-factory
...
---
# Mission, Scope, Authority Boundary, and Non-Goals

## Decision summary

- Offline statistical governance only; no broker, order, position, network, or live execution authority.
- The phase evaluates evidence; it does not manufacture economic edge.
- Protected final-test observations remain outside discovery and threshold tuning.
...
- `strategy_factory_promotion_v3/uncertainty.py`
