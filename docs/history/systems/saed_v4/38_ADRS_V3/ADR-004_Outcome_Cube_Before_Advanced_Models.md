---
title: ADR-004 — Outcome Cube Before Advanced Models
status: canonical
version: 4.0.0
created: '2026-07-13'
updated: '2026-07-13'
...
Build executable counterfactual outcomes for treatment siblings before complex policy learning.

## Rationale

Reduces selection bias and supports fair treatment comparison.
...
- Replay is expensive and requires broker/path assumptions.
