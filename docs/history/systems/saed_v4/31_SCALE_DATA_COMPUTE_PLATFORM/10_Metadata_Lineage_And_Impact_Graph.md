---
title: Metadata Lineage and Impact Graph
status: canonical
version: 4.0.0
created: '2026-07-13'
updated: '2026-07-13'
...
Trace every claim from raw data through code, environment, features, models, policies, runtime, portfolio, and incidents.
...
- Content hashes as nodes.
- Typed derivation and compatibility edges.
- Impact analysis before artifact retirement or schema change.
...
- Dashboard result cannot be reproduced.
- Schema change breaks hidden consumers.
- Manual files outside lineage.
