---
title: Environment Reproducibility and SBOM
status: canonical
version: 4.0.0
created: '2026-07-13'
updated: '2026-07-13'
...
Reconstruct software, hardware, compiler, dependency, container, and model supply chain for every result and runtime generation.
...
- Record accelerator/runtime/compiler versions.
- Scan vulnerabilities and licenses.
...
- Latest package changes model.
- Unsafe model serialization.
- Untrusted wheel or checkpoint.
