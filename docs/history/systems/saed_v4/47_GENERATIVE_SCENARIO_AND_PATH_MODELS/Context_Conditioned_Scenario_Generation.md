---
title: Context Conditioned Scenario Generation
status: canonical
version: 4.0.0
created: '2026-07-13'
updated: '2026-07-13'
...
tags:
  - saed-v4
  - 47_generative_scenario_and_path_models
  - institutional-v4
---

# Mandate

Generate conditional path distributions for stress, coverage analysis and missing-regime falsification without treating synthetic profitability as evidence of alpha.

**This specification:** **Context Conditioned Scenario Generation**.
...
- diffusion challengers
- flow matching
- stochastic flow matching
- neural SDEs
- conditional path generators
- scenario importance sampling
...
- no promotion from synthetic gains
- real-to-synthetic discriminator audit
- tail coverage tests
- scenario diversity tests
- simulator exploitability challenge
