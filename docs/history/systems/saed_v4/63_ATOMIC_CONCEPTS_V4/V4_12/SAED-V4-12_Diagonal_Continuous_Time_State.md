---
title: SAED V4-12 — Diagonal Continuous Time State
...
# SAED V4-12 — Diagonal Continuous Time State

## Definition

The diagonal SSM uses explicit positive decay rates and elapsed-time discretization.
