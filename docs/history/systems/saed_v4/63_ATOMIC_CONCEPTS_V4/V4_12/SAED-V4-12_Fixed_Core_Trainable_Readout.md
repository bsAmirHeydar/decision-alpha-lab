---
title: SAED V4-12 — Fixed Core Trainable Readout
...
# SAED V4-12 — Fixed Core Trainable Readout

## Definition

Core parameters remain fixed; only the self-supervised readout is fitted.
