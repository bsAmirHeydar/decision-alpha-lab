---
title: SAED V4-12 — Frozen Encoder Hash Binding
...
# SAED V4-12 — Frozen Encoder Hash Binding

## Definition

The exact V4-11 encoder checkpoint hash is a non-mutable model input dependency.
