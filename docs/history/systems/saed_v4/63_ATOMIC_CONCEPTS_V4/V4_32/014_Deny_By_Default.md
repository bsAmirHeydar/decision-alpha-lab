---
title: "V4-32 Atomic — Deny By Default"
phase: V4-32
...
**Deny By Default** is a closed V4-32 research-governance primitive with deterministic identity, explicit known-time semantics, content-addressed evidence, and fail-closed behavior.
