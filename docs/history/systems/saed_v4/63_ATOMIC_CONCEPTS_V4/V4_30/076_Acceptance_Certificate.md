---
title: Atomic Concept — Acceptance Certificate
...
**Acceptance Certificate** is an atomic V4-30 control concept. It has one canonical meaning, a deterministic identity boundary, an explicit evidence producer and a fail-closed consumer.
