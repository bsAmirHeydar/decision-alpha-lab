---
title: "V4-37 Atomic Concept 005 — Implicit Cost"
...
---
# SAED V4-37 Atomic Concept — Implicit Cost

## Definition

**Implicit Cost** is an atomic portfolio or execution-economics concept. It has one deterministic responsibility and a closed evidence shape so that economics can be audited independently from signal discovery, treatment selection and live execution.
