---
title: "V4-37 Atomic Concept 118 — Model Risk Review"
...
---
# SAED V4-37 Atomic Concept — Model Risk Review

## Definition

**Model Risk Review** is an atomic portfolio or execution-economics concept. It has one deterministic responsibility and a closed evidence shape so that economics can be audited independently from signal discovery, treatment selection and live execution.
