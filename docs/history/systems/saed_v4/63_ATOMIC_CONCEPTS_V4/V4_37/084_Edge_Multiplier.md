---
title: "V4-37 Atomic Concept 084 — Edge Multiplier"
...
---
# SAED V4-37 Atomic Concept — Edge Multiplier

## Definition

**Edge Multiplier** is an atomic portfolio or execution-economics concept. It has one deterministic responsibility and a closed evidence shape so that economics can be audited independently from signal discovery, treatment selection and live execution.
