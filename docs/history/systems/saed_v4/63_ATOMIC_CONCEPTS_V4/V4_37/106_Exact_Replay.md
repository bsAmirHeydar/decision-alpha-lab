---
title: "V4-37 Atomic Concept 106 — Exact Replay"
...
---
# SAED V4-37 Atomic Concept — Exact Replay

## Definition

**Exact Replay** is an atomic portfolio or execution-economics concept. It has one deterministic responsibility and a closed evidence shape so that economics can be audited independently from signal discovery, treatment selection and live execution.
