---
title: "V4-37 Atomic Concept 069 — Constrained Greedy Allocation"
...
---
# SAED V4-37 Atomic Concept — Constrained Greedy Allocation

## Definition

**Constrained Greedy Allocation** is an atomic portfolio or execution-economics concept. It has one deterministic responsibility and a closed evidence shape so that economics can be audited independently from signal discovery, treatment selection and live execution.
