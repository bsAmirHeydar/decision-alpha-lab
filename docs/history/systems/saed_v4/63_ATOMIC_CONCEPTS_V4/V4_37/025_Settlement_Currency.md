---
title: "V4-37 Atomic Concept 025 — Settlement Currency"
...
---
# SAED V4-37 Atomic Concept — Settlement Currency

## Definition

**Settlement Currency** is an atomic portfolio or execution-economics concept. It has one deterministic responsibility and a closed evidence shape so that economics can be audited independently from signal discovery, treatment selection and live execution.
