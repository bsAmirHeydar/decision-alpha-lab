---
title: "V4-37 Atomic Concept 020 — Contract Multiplier"
...
---
# SAED V4-37 Atomic Concept — Contract Multiplier

## Definition

**Contract Multiplier** is an atomic portfolio or execution-economics concept. It has one deterministic responsibility and a closed evidence shape so that economics can be audited independently from signal discovery, treatment selection and live execution.
