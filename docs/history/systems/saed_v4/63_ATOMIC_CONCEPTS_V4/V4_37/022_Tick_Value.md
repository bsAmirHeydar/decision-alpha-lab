---
title: "V4-37 Atomic Concept 022 — Tick Value"
...
---
# SAED V4-37 Atomic Concept — Tick Value

## Definition

**Tick Value** is an atomic portfolio or execution-economics concept. It has one deterministic responsibility and a closed evidence shape so that economics can be audited independently from signal discovery, treatment selection and live execution.
