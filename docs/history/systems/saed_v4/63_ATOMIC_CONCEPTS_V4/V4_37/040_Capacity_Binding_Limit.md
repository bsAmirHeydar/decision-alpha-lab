---
title: "V4-37 Atomic Concept 040 — Capacity Binding Limit"
...
---
# SAED V4-37 Atomic Concept — Capacity Binding Limit

## Definition

**Capacity Binding Limit** is an atomic portfolio or execution-economics concept. It has one deterministic responsibility and a closed evidence shape so that economics can be audited independently from signal discovery, treatment selection and live execution.
