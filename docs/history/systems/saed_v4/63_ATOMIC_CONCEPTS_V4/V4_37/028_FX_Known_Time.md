---
title: "V4-37 Atomic Concept 028 — FX Known-Time"
...
---
# SAED V4-37 Atomic Concept — FX Known-Time

## Definition

**FX Known-Time** is an atomic portfolio or execution-economics concept. It has one deterministic responsibility and a closed evidence shape so that economics can be audited independently from signal discovery, treatment selection and live execution.
