---
title: "V4-37 Atomic Concept 035 — Session Capacity"
...
---
# SAED V4-37 Atomic Concept — Session Capacity

## Definition

**Session Capacity** is an atomic portfolio or execution-economics concept. It has one deterministic responsibility and a closed evidence shape so that economics can be audited independently from signal discovery, treatment selection and live execution.
