---
title: "V4-37 Atomic Concept 100 — Known-Time Cutoff"
...
---
# SAED V4-37 Atomic Concept — Known-Time Cutoff

## Definition

**Known-Time Cutoff** is an atomic portfolio or execution-economics concept. It has one deterministic responsibility and a closed evidence shape so that economics can be audited independently from signal discovery, treatment selection and live execution.
