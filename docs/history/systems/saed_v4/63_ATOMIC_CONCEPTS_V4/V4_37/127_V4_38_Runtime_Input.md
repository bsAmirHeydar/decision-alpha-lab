---
title: "V4-37 Atomic Concept 127 — V4-38 Runtime Input"
...
---
# SAED V4-37 Atomic Concept — V4-38 Runtime Input

## Definition

**V4-38 Runtime Input** is an atomic portfolio or execution-economics concept. It has one deterministic responsibility and a closed evidence shape so that economics can be audited independently from signal discovery, treatment selection and live execution.
