...
# Package Lineage Root

## Definition

The deterministic aggregate commitment over all parent and child semantic identities.

## Why it exists

It supports integrity and replay checks without granting release authority.
