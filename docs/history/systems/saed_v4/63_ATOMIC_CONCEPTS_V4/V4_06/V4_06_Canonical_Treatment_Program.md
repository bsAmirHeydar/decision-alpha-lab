---
title: Canonical Treatment Program
status: implemented
version: 1.0.0
phase: V4-06
created: '2026-07-15'
...
# Canonical Treatment Program

## Definition

The deterministic semantic representation produced only after successful validation.

## Why it exists

Ordering noise is removed while all identity-affecting meaning is retained.
