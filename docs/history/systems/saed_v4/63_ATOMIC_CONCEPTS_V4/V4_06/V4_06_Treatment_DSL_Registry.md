...
# Treatment DSL Registry

## Definition

The content-addressed finite catalog of all allowed Treatment primitives.

## Why it exists

It is a governance artifact, not a plugin marketplace or dynamic code registry.
