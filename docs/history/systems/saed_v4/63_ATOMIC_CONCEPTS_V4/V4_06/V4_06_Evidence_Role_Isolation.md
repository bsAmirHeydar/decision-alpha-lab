...
The invariant that one package and its programs use one governed evidence role.

## Why it exists

It blocks development, final, prospective and external evidence contamination.
