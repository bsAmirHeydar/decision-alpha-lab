...
# Censoring Is Not Loss

## Purpose

Censoring records incomplete observation and preserves risk-set information; it is never a negative class or zero-return label. This note is normative for the deterministic synthetic-reference implementation and must be read together with the machine-readable contracts, frozen upstream evidence, source package, negative fixtures, QA report, claim ledger and authority boundary.
