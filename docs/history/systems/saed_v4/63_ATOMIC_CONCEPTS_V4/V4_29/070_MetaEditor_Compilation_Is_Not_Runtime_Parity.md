---
title: MetaEditor Compilation Is Not Runtime Parity
...
# MetaEditor Compilation Is Not Runtime Parity

## Atomic rule

**MetaEditor Compilation Is Not Runtime Parity.** The rule is evaluated as a closed binary invariant in [[V4_29_Hidden_Evaluation_Air_Gap]]. It is never inferred from a nearby field and it never grants authority beyond the research-control reference.
