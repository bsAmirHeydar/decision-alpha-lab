...
Action Lattice DAG is an atomic SAED V4-07 concept used by the deterministic bounded constraint solver and action lattice. Its meaning is fixed by [[00_MOC_V4_07_Constraint_Solver_And_Action_Lattice]] and cannot be widened by an adapter, model, runtime or operator convenience.
