---
title: Bitemporal Truth Is Two Clocks
status: implemented
version: 1.0.0
phase: V4-01
created: '2026-07-13'
...
# Bitemporal Truth Is Two Clocks

> **Parent phase:** [[00_MOC_V4_01_Sovereign_Data_And_Artifact_Foundation]]

## Definition

An observation is not historically usable merely because its event happened; it is usable only after its known time. Event time and known time are separate contractual fields.
