---
title: SAED V4-11 — Frozen Encoder Handoff
...
# Frozen Encoder Handoff

## Definition

The V4-12 contract granting read-only use of exact tokenizer and encoder hashes without decision authority.
