...
---
# SAED V4-18 — Python API

## Purpose

Package modules and reference service. This note is part of the closed implementation dossier for deterministic synthetic treatment-effect and policy-value research.
