...
---
# SAED V4-18 — IPW Value

## Purpose

Inverse-propensity policy value and weight risk. This note is part of the closed implementation dossier for deterministic synthetic treatment-effect and policy-value research.
