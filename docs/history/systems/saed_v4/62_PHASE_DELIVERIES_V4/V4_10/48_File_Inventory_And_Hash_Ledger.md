---
title: SAED V4-10 — File Inventory and Hash Ledger
...
# SAED V4-10 — File Inventory and Hash Ledger

## Purpose

Every patch file is root-relative, inventoried and SHA-256 hashed. Installation stages only the explicit V4-10 file index.
