---
title: SAED V4-10 — Baseline Registry Immutability
...
# SAED V4-10 — Baseline Registry Immutability

## Purpose

Registry identity is content-addressed. Any change to source, rule, node, fallback or upstream hashes creates a new registry rather than rewriting the prior baseline.
