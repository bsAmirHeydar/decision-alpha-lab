---
title: SAED V4-10 — Rule Priority and Determinism
...
# SAED V4-10 — Rule Priority and Determinism

## Purpose

Rules are compiled in descending priority with stable rule-id tie semantics; duplicate priorities are rejected to remove ambiguous human intent.
