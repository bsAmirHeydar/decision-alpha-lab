---
title: SAED V4-10 — Time and Identity Split Policy
...
# SAED V4-10 — Time and Identity Split Policy

## Purpose

Before V4-11 training, corpus shards must be partitioned by identity and time. No future suffix, duplicate context identity or descendant leakage may cross a split boundary.
