---
title: SAED V4-10 — Outcome Leakage Firewall
...
# SAED V4-10 — Outcome Leakage Firewall

## Purpose

Outcome, net return, path extrema, fills, labels, protected-final, prospective, shadow and live tokens are forbidden in manual predicates and V4-11 pretraining inputs.
