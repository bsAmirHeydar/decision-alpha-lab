---
title: SAED V4-10 — Predicate Algebra
...
# SAED V4-10 — Predicate Algebra

## Purpose

Supported operators are deliberately small: equality, inequality, ordered comparisons, membership, existence and missingness. Missing-data behavior is explicit per predicate.
