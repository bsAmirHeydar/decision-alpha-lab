---
title: SAED V4-10 — Rollback and Reversibility
...
# SAED V4-10 — Rollback and Reversibility

## Purpose

The additive patch can be reverted as one commit. Upstream V4-04 through V4-09 artifacts are not modified, and downstream V4-11 must reference exact V4-10 hashes.
