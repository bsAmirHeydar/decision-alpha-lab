---
title: SAED V4-10 — Model Risk Controls
...
# SAED V4-10 — Model Risk Controls

## Purpose

The benchmark floor prevents later AI claims from relying on complex-model novelty alone. Challengers must beat simple baselines under predeclared evidence roles and uncertainty.
