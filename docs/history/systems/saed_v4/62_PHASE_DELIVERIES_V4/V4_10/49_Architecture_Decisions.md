---
title: SAED V4-10 — Architecture Decisions
...
# SAED V4-10 — Architecture Decisions

## Purpose

Key decisions are manual-before-measurement, abstain mandatory, no outcome-derived predicates, no ranking semantics and outcome exclusion from V4-11 self-supervised inputs.
