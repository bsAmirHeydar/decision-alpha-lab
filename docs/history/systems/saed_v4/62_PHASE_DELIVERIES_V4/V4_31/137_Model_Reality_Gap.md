...
This note specifies **Model Reality Gap** as a closed component of SAED_V4_31. It exists to make the formal-verification and safety-case evidence deterministic, reviewable, replayable and incapable of acquiring trading authority. The component is interpreted only inside the finite synthetic reference scope declared by the phase certificate.
...
- Previous: [[136_Specification_Error_Limitation]]
- Next: [[138_External_Solver_Boundary]]
