---
title: SAED V4-22 — Adversarial Stress Search
...
# SAED V4-22 — Adversarial Stress Search

## Purpose

This note specifies **Adversarial Stress Search** inside the closed V4-22 Generative Path Stress Lab. The capability exists to create deterministic, watermarked and auditable synthetic market paths that can falsify robustness claims. It does not create positive alpha evidence and it does not authorize a treatment, risk allocation, runtime generation or order.
