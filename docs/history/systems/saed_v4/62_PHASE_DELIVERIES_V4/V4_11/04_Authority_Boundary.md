---
title: SAED V4-11 — Authority Boundary
...
# SAED V4-11 — Authority Boundary

## Decision

Defines reference-synthetic training as the maximum authority and denies all decision, runtime and order authority. This control is implemented for the deterministic synthetic-reference path and is subordinate to the V4-10 evidence boundary and UCEE authority model.
...
- [[03_Entry_Gates|Previous control]]
- [[05_V4_10_Handoff_Intake|Next control]]
