---
title: SAED V4-11 — Temporal Contrast Objective
...
# SAED V4-11 — Temporal Contrast Objective

## Decision

Pulls temporally related Contexts together and uses dependency-safe negatives from other roots. This control is implemented for the deterministic synthetic-reference path and is subordinate to the V4-10 evidence boundary and UCEE authority model.
...
- [[18_Next_Event_Objective|Previous control]]
- [[20_Cross_View_Alignment|Next control]]
