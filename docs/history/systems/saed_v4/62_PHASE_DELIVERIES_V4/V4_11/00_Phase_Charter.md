---
title: SAED V4-11 — Phase Charter
...
# SAED V4-11 — Phase Charter

## Decision

Freezes the mission, evidence scope, authority ceiling and deliverable set for the first learned representation phase. This control is implemented for the deterministic synthetic-reference path and is subordinate to the V4-10 evidence boundary and UCEE authority model.
...
- [[01_Executive_Architecture|Next control]]
