---
title: SAED V4-11 — File Inventory and Hash Ledger
...
# SAED V4-11 — File Inventory and Hash Ledger

## Decision

Defines installation scope, per-file hashes, artifact inventory and patch manifest integrity. This control is implemented for the deterministic synthetic-reference path and is subordinate to the V4-10 evidence boundary and UCEE authority model.
...
- [[59_Test_Evidence|Previous control]]
- [[61_Architecture_Decisions|Next control]]
