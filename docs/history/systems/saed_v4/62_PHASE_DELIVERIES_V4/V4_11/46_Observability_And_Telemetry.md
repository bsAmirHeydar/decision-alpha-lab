---
title: SAED V4-11 — Observability and Telemetry
...
# SAED V4-11 — Observability and Telemetry

## Decision

Reports corpus, split, vocabulary, exposure, collapse, contamination, registry and external-evidence status. This control is implemented for the deterministic synthetic-reference path and is subordinate to the V4-10 evidence boundary and UCEE authority model.
...
- [[45_Semantic_Diff|Previous control]]
- [[47_Incident_Response|Next control]]
