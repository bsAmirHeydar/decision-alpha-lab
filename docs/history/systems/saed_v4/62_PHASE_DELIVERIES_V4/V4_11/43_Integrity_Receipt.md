---
title: SAED V4-11 — Integrity Receipt
...
# SAED V4-11 — Integrity Receipt

## Decision

Builds a Merkle-rooted receipt over all decision-relevant pretraining artifacts. This control is implemented for the deterministic synthetic-reference path and is subordinate to the V4-10 evidence boundary and UCEE authority model.
...
- [[42_Rejection_And_Quarantine|Previous control]]
- [[44_Independent_Replay|Next control]]
