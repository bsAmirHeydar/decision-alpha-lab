---
title: SAED V4-11 — Semantic Diff
...
# SAED V4-11 — Semantic Diff

## Decision

Compares checkpoint semantics while ignoring self-identifying hash fields and reports any decision-relevant drift. This control is implemented for the deterministic synthetic-reference path and is subordinate to the V4-10 evidence boundary and UCEE authority model.
...
- [[44_Independent_Replay|Previous control]]
- [[46_Observability_And_Telemetry|Next control]]
