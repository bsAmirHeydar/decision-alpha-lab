---
title: SAED V4-11 — V4-10 Handoff Intake
...
# SAED V4-11 — V4-10 Handoff Intake

## Decision

Validates the exact upstream handoff, baseline registry reference and pretraining corpus manifest before any token is admitted. This control is implemented for the deterministic synthetic-reference path and is subordinate to the V4-10 evidence boundary and UCEE authority model.
...
- [[04_Authority_Boundary|Previous control]]
- [[06_Corpus_Membership_Contract|Next control]]
