---
title: SAED V4-11 — Security and Supply Chain
...
# SAED V4-11 — Security and Supply Chain

## Decision

Prohibits opaque checkpoint deserialization, network dependency, undeclared packages and credential access. This control is implemented for the deterministic synthetic-reference path and is subordinate to the V4-10 evidence boundary and UCEE authority model.
...
- [[47_Incident_Response|Previous control]]
- [[49_Model_Risk_Controls|Next control]]
