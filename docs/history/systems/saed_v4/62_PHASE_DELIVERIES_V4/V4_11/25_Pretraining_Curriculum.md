---
title: SAED V4-11 — Pretraining Curriculum
...
# SAED V4-11 — Pretraining Curriculum

## Decision

Stages local semantics, cross-view and graph structure, then temporal Context learning under frozen objective identities. This control is implemented for the deterministic synthetic-reference path and is subordinate to the V4-10 evidence boundary and UCEE authority model.
...
- [[24_Dependency_Safe_Negatives|Previous control]]
- [[26_Deterministic_Trainer|Next control]]
