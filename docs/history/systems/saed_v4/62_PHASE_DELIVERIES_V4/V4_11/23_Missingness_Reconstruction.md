---
title: SAED V4-11 — Missingness Reconstruction
...
# SAED V4-11 — Missingness Reconstruction

## Decision

Makes missing and present view states explicit objectives so absence cannot be silently treated as zero. This control is implemented for the deterministic synthetic-reference path and is subordinate to the V4-10 evidence boundary and UCEE authority model.
...
- [[22_Context_Transition_Objective|Previous control]]
- [[24_Dependency_Safe_Negatives|Next control]]
