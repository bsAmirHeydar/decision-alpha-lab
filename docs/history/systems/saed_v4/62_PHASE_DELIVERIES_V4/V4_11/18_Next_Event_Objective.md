---
title: SAED V4-11 — Next-Event Objective
...
# SAED V4-11 — Next-Event Objective

## Decision

Learns temporal continuity from later samples inside the same training root without crossing split boundaries. This control is implemented for the deterministic synthetic-reference path and is subordinate to the V4-10 evidence boundary and UCEE authority model.
...
- [[17_Masked_Span_Objective|Previous control]]
- [[19_Temporal_Contrast_Objective|Next control]]
