...
# SAED V4-11 — Entry Gates

## Decision

Requires immutable V4-10 hashes, approved synthetic corpus membership, closed split policy, objective denylist, compute budget and canaries. This control is implemented for the deterministic synthetic-reference path and is subordinate to the V4-10 evidence boundary and UCEE authority model.
...
- [[02_Scope_And_Non_Goals|Previous control]]
- [[04_Authority_Boundary|Next control]]
