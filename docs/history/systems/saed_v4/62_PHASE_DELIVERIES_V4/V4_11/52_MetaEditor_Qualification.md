---
title: SAED V4-11 — MetaEditor Qualification
...
# SAED V4-11 — MetaEditor Qualification

## Decision

Distinguishes local static validation from actual Windows MetaEditor compilation evidence. This control is implemented for the deterministic synthetic-reference path and is subordinate to the V4-10 evidence boundary and UCEE authority model.
...
- [[51_MQL5_Static_Mirror|Previous control]]
- [[53_Performance_Budget|Next control]]
