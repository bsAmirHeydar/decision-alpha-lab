---
title: SAED V4-11 — Random and Frozen Controls
...
# SAED V4-11 — Random and Frozen Controls

## Decision

Preserves random and initial frozen encoders so representation results cannot be interpreted without simple baselines. This control is implemented for the deterministic synthetic-reference path and is subordinate to the V4-10 evidence boundary and UCEE authority model.
...
- [[39_Leave_Domain_Out_Transfer|Previous control]]
- [[41_Checkpoint_Registry|Next control]]
