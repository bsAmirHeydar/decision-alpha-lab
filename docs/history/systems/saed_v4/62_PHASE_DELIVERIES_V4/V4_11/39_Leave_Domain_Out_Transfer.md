---
title: SAED V4-11 — Leave-Domain-Out Transfer
...
# SAED V4-11 — Leave-Domain-Out Transfer

## Decision

Specifies domain isolation and transfer measurement for future real-corpus evidence without changing current synthetic status. This control is implemented for the deterministic synthetic-reference path and is subordinate to the V4-10 evidence boundary and UCEE authority model.
...
- [[38_Few_Shot_And_Sample_Efficiency|Previous control]]
- [[40_Random_And_Frozen_Controls|Next control]]
