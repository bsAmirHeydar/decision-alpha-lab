---
title: SAED V4-11 — Optimizer and Numerics
...
# SAED V4-11 — Optimizer and Numerics

## Decision

Defines bounded sigmoid updates, finite-number requirements, stable rounding and no opaque accelerator kernels in the reference path. This control is implemented for the deterministic synthetic-reference path and is subordinate to the V4-10 evidence boundary and UCEE authority model.
...
- [[26_Deterministic_Trainer|Previous control]]
- [[28_Compute_Budget|Next control]]
