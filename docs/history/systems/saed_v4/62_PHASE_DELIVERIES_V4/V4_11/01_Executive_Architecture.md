---
title: SAED V4-11 — Executive Architecture
...
# SAED V4-11 — Executive Architecture

## Decision

Defines the end-to-end flow from the V4-10 corpus boundary through tokenization, self-supervised training, evaluation, registration and V4-12 handoff. This control is implemented for the deterministic synthetic-reference path and is subordinate to the V4-10 evidence boundary and UCEE authority model.
...
- [[00_Phase_Charter|Previous control]]
- [[02_Scope_And_Non_Goals|Next control]]
