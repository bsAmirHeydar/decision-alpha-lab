---
title: SAED V4-11 — Augmentation Policy
...
# SAED V4-11 — Augmentation Policy

## Decision

Defines deterministic span masking and view-preserving perturbations that do not create future information or erase provenance. This control is implemented for the deterministic synthetic-reference path and is subordinate to the V4-10 evidence boundary and UCEE authority model.
...
- [[15_Descriptor_Vocabulary_Boundary|Previous control]]
- [[17_Masked_Span_Objective|Next control]]
