...
# SAED V4-11 — Linear Probe

## Decision

Evaluates simple nearest-centroid transfer on non-outcome structural labels without granting predictive authority. This control is implemented for the deterministic synthetic-reference path and is subordinate to the V4-10 evidence boundary and UCEE authority model.
...
- [[36_Representation_Collapse|Previous control]]
- [[38_Few_Shot_And_Sample_Efficiency|Next control]]
