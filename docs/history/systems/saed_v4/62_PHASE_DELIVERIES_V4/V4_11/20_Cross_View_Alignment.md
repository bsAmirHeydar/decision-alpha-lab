---
title: SAED V4-11 — Cross-View Alignment
...
# SAED V4-11 — Cross-View Alignment

## Decision

Aligns representations of distinct views from the same Context while preserving view identity and masks. This control is implemented for the deterministic synthetic-reference path and is subordinate to the V4-10 evidence boundary and UCEE authority model.
...
- [[19_Temporal_Contrast_Objective|Previous control]]
- [[21_Graph_Relation_Reconstruction|Next control]]
