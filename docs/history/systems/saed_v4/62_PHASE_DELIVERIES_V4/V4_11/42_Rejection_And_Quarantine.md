---
title: SAED V4-11 — Rejection and Quarantine
...
# SAED V4-11 — Rejection and Quarantine

## Decision

Records failed candidates immutably and blocks partial or contaminated checkpoints from downstream use. This control is implemented for the deterministic synthetic-reference path and is subordinate to the V4-10 evidence boundary and UCEE authority model.
...
- [[41_Checkpoint_Registry|Previous control]]
- [[43_Integrity_Receipt|Next control]]
