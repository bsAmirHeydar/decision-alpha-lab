---
title: SAED V4-11 — Model Risk Controls
...
# SAED V4-11 — Model Risk Controls

## Decision

Requires simple controls, no outcome labels, no automatic superiority claim, explicit limitations and reversible registration. This control is implemented for the deterministic synthetic-reference path and is subordinate to the V4-10 evidence boundary and UCEE authority model.
...
- [[48_Security_And_Supply_Chain|Previous control]]
- [[50_UCEE_Compatibility|Next control]]
