---
title: SAED V4-11 — V4-12 Handoff
...
# SAED V4-11 — V4-12 Handoff

## Decision

Freezes tokenizer, checkpoint, registry, corpus, split, training and dossier hashes for sequence-model challengers. This control is implemented for the deterministic synthetic-reference path and is subordinate to the V4-10 evidence boundary and UCEE authority model.
...
- [[55_Limitations_And_Residual_Risk|Previous control]]
- [[57_Review_Guide|Next control]]
