---
title: SAED V4-11 — Known-Time Semantics
...
# SAED V4-11 — Known-Time Semantics

## Decision

Requires every sample and token to be available at its declared decision-time boundary and rejects known-time regressions. This control is implemented for the deterministic synthetic-reference path and is subordinate to the V4-10 evidence boundary and UCEE authority model.
...
- [[07_Evidence_Role_Firewall|Previous control]]
- [[09_Identity_And_Time_Splits|Next control]]
