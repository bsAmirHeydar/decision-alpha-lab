---
title: SAED V4-11 — Hypergraph Tokenization
...
# SAED V4-11 — Hypergraph Tokenization

## Decision

Projects semantic-temporal relation kinds into role-safe structural tokens while retaining source graph lineage. This control is implemented for the deterministic synthetic-reference path and is subordinate to the V4-10 evidence boundary and UCEE authority model.
...
- [[13_View_Mask_Semantics|Previous control]]
- [[15_Descriptor_Vocabulary_Boundary|Next control]]
