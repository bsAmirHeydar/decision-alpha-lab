---
title: SAED V4-11 — Checkpoint Registry
...
# SAED V4-11 — Checkpoint Registry

## Decision

Admits exactly identified reference checkpoints only after contamination, membership, collapse and integrity gates pass. This control is implemented for the deterministic synthetic-reference path and is subordinate to the V4-10 evidence boundary and UCEE authority model.
...
- [[40_Random_And_Frozen_Controls|Previous control]]
- [[42_Rejection_And_Quarantine|Next control]]
