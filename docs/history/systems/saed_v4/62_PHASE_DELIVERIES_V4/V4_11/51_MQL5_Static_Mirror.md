---
title: SAED V4-11 — MQL5 Static Mirror
...
# SAED V4-11 — MQL5 Static Mirror

## Decision

Mirrors version, authority, checkpoint and telemetry contracts for static compatibility without implementing training or orders. This control is implemented for the deterministic synthetic-reference path and is subordinate to the V4-10 evidence boundary and UCEE authority model.
...
- [[50_UCEE_Compatibility|Previous control]]
- [[52_MetaEditor_Qualification|Next control]]
