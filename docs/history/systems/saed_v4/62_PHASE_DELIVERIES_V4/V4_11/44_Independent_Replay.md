---
title: SAED V4-11 — Independent Replay
...
# SAED V4-11 — Independent Replay

## Decision

Rebuilds the bundle in a separate invocation and requires identical token, receipt and checkpoint hashes. This control is implemented for the deterministic synthetic-reference path and is subordinate to the V4-10 evidence boundary and UCEE authority model.
...
- [[43_Integrity_Receipt|Previous control]]
- [[45_Semantic_Diff|Next control]]
