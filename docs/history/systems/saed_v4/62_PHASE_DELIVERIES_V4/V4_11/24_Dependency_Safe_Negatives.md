---
title: SAED V4-11 — Dependency-Safe Negatives
...
# SAED V4-11 — Dependency-Safe Negatives

## Decision

Excludes positives, same-root descendants and unavailable future records from temporal negative selection. This control is implemented for the deterministic synthetic-reference path and is subordinate to the V4-10 evidence boundary and UCEE authority model.
...
- [[23_Missingness_Reconstruction|Previous control]]
- [[25_Pretraining_Curriculum|Next control]]
