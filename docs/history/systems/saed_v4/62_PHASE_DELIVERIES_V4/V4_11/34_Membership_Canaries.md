---
title: SAED V4-11 — Membership Canaries
...
# SAED V4-11 — Membership Canaries

## Decision

Uses explicit canary tokens that must remain absent from admitted corpus streams and checkpoint vocabulary. This control is implemented for the deterministic synthetic-reference path and is subordinate to the V4-10 evidence boundary and UCEE authority model.
...
- [[33_Contamination_Audit|Previous control]]
- [[35_Temporal_Shuffle_Test|Next control]]
