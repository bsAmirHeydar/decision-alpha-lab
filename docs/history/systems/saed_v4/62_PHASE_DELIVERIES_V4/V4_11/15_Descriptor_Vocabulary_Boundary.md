---
title: SAED V4-11 — Descriptor Vocabulary Boundary
...
# SAED V4-11 — Descriptor Vocabulary Boundary

## Decision

Allows action-lattice descriptors only as non-preference vocabulary and forbids rankings, outcomes and policy value. This control is implemented for the deterministic synthetic-reference path and is subordinate to the V4-10 evidence boundary and UCEE authority model.
...
- [[14_Hypergraph_Tokenization|Previous control]]
- [[16_Augmentation_Policy|Next control]]
