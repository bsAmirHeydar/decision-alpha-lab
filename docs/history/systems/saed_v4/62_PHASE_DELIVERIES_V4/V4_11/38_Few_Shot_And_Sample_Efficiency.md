---
title: SAED V4-11 — Few-Shot and Sample Efficiency
...
# SAED V4-11 — Few-Shot and Sample Efficiency

## Decision

Defines downstream diagnostic requirements while deferring economic or protected-label few-shot claims. This control is implemented for the deterministic synthetic-reference path and is subordinate to the V4-10 evidence boundary and UCEE authority model.
...
- [[37_Linear_Probe|Previous control]]
- [[39_Leave_Domain_Out_Transfer|Next control]]
