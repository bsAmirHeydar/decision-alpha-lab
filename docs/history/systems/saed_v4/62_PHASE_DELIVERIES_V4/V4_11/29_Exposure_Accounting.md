---
title: SAED V4-11 — Exposure Accounting
...
# SAED V4-11 — Exposure Accounting

## Decision

Records every training pair by stage, epoch, record, objective, hashed tokens, negatives and weight. This control is implemented for the deterministic synthetic-reference path and is subordinate to the V4-10 evidence boundary and UCEE authority model.
...
- [[28_Compute_Budget|Previous control]]
- [[30_Checkpoint_Format|Next control]]
