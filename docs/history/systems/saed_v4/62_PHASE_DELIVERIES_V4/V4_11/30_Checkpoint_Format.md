---
title: SAED V4-11 — Checkpoint Format
...
# SAED V4-11 — Checkpoint Format

## Decision

Uses canonical JSON embedding tables rather than pickle or opaque binary state so review and hashing remain deterministic. This control is implemented for the deterministic synthetic-reference path and is subordinate to the V4-10 evidence boundary and UCEE authority model.
...
- [[29_Exposure_Accounting|Previous control]]
- [[31_Checkpoint_Provenance|Next control]]
