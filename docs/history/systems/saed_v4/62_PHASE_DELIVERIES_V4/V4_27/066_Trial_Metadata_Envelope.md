---
title: V4-27 Delivery 066 — Trial Metadata Envelope
...
# Trial Metadata Envelope

## Normative statement

**Trial Metadata Envelope** is a mandatory control in the V4-27 complete-search and exposure-accounting boundary. The control is evaluated over frozen V4-26 lineage, exact actor identities, exact data roles, immutable experiment manifests, terminal trial histories and append-only exposure events. Unknown, missing, stale, contradictory or non-replayable states resolve fail-closed.
...
- [[065_Cost_Unit_Accounting]]
- [[067_Trial_Known_Time]]
