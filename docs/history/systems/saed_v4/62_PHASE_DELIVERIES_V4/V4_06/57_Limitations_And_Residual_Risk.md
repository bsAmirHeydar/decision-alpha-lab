...
Record what the reference language does not guarantee.

## Contract

The registry is deliberately small; semantic labels rely on upstream governance; capability profiles are diagnostic; static analysis cannot prove market suitability; canonical equality is not behavioral equality; and lexical prohibitions require continued review for synonyms.
...
Residual risk is managed by exact versioning, review, negative fixtures, downstream solver gates and no direct execution authority. The implementation returns an explicit rejected or quarantined artifact where applicable. It never substitutes the nearest primitive, widens a range, drops an unknown field, merges Evidence Roles, reuses a stale hash or falls back to an executable default.
...
- Previous: [[56_Evidence_And_Claim_Ledger]]
- Phase home: [[00_MOC_V4_06_Treatment_DSL]]
- Next: [[58_V4_07_Action_Lattice_Handoff]]
