...
Bind an externally approved V4-05 Treatment descriptor to one compatible canonical program.

## Contract

Binding checks descriptor identity, graph membership, Evidence Role, known-as-of, source graph identity and semantic labels. It records exact program and descriptor hashes without changing either artifact.
...
Reject unknown descriptors, mismatched hashes, role/time conflicts and missing required semantic agreement. The implementation returns an explicit rejected or quarantined artifact where applicable. It never substitutes the nearest primitive, widens a range, drops an unknown field, merges Evidence Roles, reuses a stale hash or falls back to an executable default.
...
- Previous: [[29_Known_Time_And_Evidence_Roles]]
- Phase home: [[00_MOC_V4_06_Treatment_DSL]]
- Next: [[31_Semantic_Label_Reconciliation]]
