---
title: Cost And Economics Boundary
status: implemented
version: 1.0.0
phase: V4-06
created: '2026-07-15'
...
# Cost And Economics Boundary

## Purpose

Allow finite feasibility guards while keeping full economics and risk outside V4-06.

## Contract

The reference cost primitive declares a maximum spread in points. It can constrain feasibility in V4-07 but does not estimate fill probability, transaction-cost distribution, expected value, capital usage or realized PnL.
...
Reject cost fields that imply optimization, realized outcomes, volume, leverage or account equity. The implementation returns an explicit rejected or quarantined artifact where applicable. It never substitutes the nearest primitive, widens a range, drops an unknown field, merges Evidence Roles, reuses a stale hash or falls back to an executable default.
...
- Previous: [[16_Time_Primitives]]
- Phase home: [[00_MOC_V4_06_Treatment_DSL]]
- Next: [[18_Capability_Profiles]]
