---
title: Feature Reference Grammar
status: implemented
version: 1.0.0
phase: V4-06
created: '2026-07-15'
...
# Feature Reference Grammar

## Purpose

Limit Context access to explicit allowlisted feature references visible at known time.

## Contract

Feature references use a qualified form such as feature:structure_view:breakout_state or primitive parameter unit feature_ref. They are declarations bound to upstream Context representation and cannot trigger remote reads or implicit joins.
...
Reject future, outcome, label, realized and forward-return tokens as well as unqualified or unavailable references. The implementation returns an explicit rejected or quarantined artifact where applicable. It never substitutes the nearest primitive, widens a range, drops an unknown field, merges Evidence Roles, reuses a stale hash or falls back to an executable default.
...
- Previous: [[27_Constraint_Declaration_Grammar]]
- Phase home: [[00_MOC_V4_06_Treatment_DSL]]
- Next: [[29_Known_Time_And_Evidence_Roles]]
