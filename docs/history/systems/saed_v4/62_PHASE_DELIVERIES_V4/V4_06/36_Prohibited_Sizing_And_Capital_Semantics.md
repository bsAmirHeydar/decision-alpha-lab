---
title: Prohibited Sizing And Capital Semantics
status: implemented
version: 1.0.0
phase: V4-06
created: '2026-07-15'
...
# Prohibited Sizing And Capital Semantics

## Purpose

Enforce a hard lexical and semantic boundary against risk and portfolio authority.

## Contract

Identifiers and parameters containing lot, volume, leverage, capital, allocation, position_size, risk_cash or equity_fraction are prohibited. Quantity fraction is allowed only as post-entry management proportion and never as original capital sizing.
...
Reject hidden synonyms when discovered during review and version the policy when the prohibited vocabulary changes. The implementation returns an explicit rejected or quarantined artifact where applicable. It never substitutes the nearest primitive, widens a range, drops an unknown field, merges Evidence Roles, reuses a stale hash or falls back to an executable default.
...
- Previous: [[35_Budgets_And_Explosion_Controls]]
- Phase home: [[00_MOC_V4_06_Treatment_DSL]]
- Next: [[37_Fail_Closed_Skip_Abstain_Fallback]]
