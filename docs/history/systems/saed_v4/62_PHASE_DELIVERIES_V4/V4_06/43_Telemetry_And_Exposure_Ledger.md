---
title: Telemetry And Exposure Ledger
status: implemented
version: 1.0.0
phase: V4-06
created: '2026-07-15'
...
# Telemetry And Exposure Ledger

## Purpose

Record validation coverage, primitive exposure and package composition without leaking outcomes.

## Contract

Telemetry counts accepted/rejected programs, component kinds, exact primitive usage, path dependence, constraints, states, transitions and bindings. The exposure ledger supports governance and untested-surface review.
...
Do not include realized PnL, labels, future outcomes or model-selection evidence in V4-06 telemetry. The implementation returns an explicit rejected or quarantined artifact where applicable. It never substitutes the nearest primitive, widens a range, drops an unknown field, merges Evidence Roles, reuses a stale hash or falls back to an executable default.
...
- Previous: [[42_Deterministic_Partitioning]]
- Phase home: [[00_MOC_V4_06_Treatment_DSL]]
- Next: [[44_Service_And_CLI]]
