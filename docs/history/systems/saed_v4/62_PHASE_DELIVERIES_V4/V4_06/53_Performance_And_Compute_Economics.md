---
title: Performance And Compute Economics
status: implemented
version: 1.0.0
phase: V4-06
created: '2026-07-15'
...
# Performance And Compute Economics

## Purpose

Keep V4-06 deterministic validation bounded and inexpensive relative to later search phases.

## Contract

Complexity is linear or near-linear in program components, constraints, states and transitions under strict budgets. No training, optimization or remote service is invoked. Deterministic partitioning allows parallel validation without semantic divergence.
...
Any proposal for unbounded enumeration belongs to V4-07 and requires separate compute governance. The implementation returns an explicit rejected or quarantined artifact where applicable. It never substitutes the nearest primitive, widens a range, drops an unknown field, merges Evidence Roles, reuses a stale hash or falls back to an executable default.
...
- Previous: [[52_Operational_Runbook]]
- Phase home: [[00_MOC_V4_06_Treatment_DSL]]
- Next: [[54_Release_Rollback_And_Recovery]]
