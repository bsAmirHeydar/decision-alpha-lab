...
Assign deterministic identities and hashes to canonical component instances.

## Contract

A component identity binds slot, exact primitive key, primitive definition identity/hash and normalized parameter payload. This enables fine-grained semantic diffing and tamper localization without granting execution authority.
...
Reject duplicate component identities or a component whose definition hash does not match the registry. The implementation returns an explicit rejected or quarantined artifact where applicable. It never substitutes the nearest primitive, widens a range, drops an unknown field, merges Evidence Roles, reuses a stale hash or falls back to an executable default.
...
- Previous: [[24_Program_Identity]]
- Phase home: [[00_MOC_V4_06_Treatment_DSL]]
- Next: [[26_Static_Type_Checking]]
