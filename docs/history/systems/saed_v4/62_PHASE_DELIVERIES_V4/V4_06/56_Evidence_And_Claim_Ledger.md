---
title: Evidence And Claim Ledger
status: implemented
version: 1.0.0
phase: V4-06
created: '2026-07-15'
...
Separate implemented and tested claims from pending external evidence.

## Contract

Accepted claims concern finite declaration, exact versioning, deterministic canonicalization, validation, binding, integrity and diagnostic mirrors. Pending claims include external reproduction, MetaEditor compilation, terminal parity, solver correctness in V4-07, model value, real alpha and production authorization.
...
Every report must preserve this distinction and must not promote static evidence to actual runtime evidence. The implementation returns an explicit rejected or quarantined artifact where applicable. It never substitutes the nearest primitive, widens a range, drops an unknown field, merges Evidence Roles, reuses a stale hash or falls back to an executable default.
...
- Previous: [[55_Acceptance_Criteria]]
- Phase home: [[00_MOC_V4_06_Treatment_DSL]]
- Next: [[57_Limitations_And_Residual_Risk]]
