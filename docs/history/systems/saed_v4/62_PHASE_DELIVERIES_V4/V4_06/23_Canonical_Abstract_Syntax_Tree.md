---
title: Canonical Abstract Syntax Tree
status: implemented
version: 1.0.0
phase: V4-06
created: '2026-07-15'
...
Transform accepted source declarations into deterministic, order-insensitive semantic objects.

## Contract

Canonicalization sorts components, parameters, labels, constraints, states, transitions, sides and limitations according to stable rules. Operational metadata and input ordering do not influence semantic identity.
...
Reject canonicalization when source validation has unresolved errors; never repair invalid source silently. The implementation returns an explicit rejected or quarantined artifact where applicable. It never substitutes the nearest primitive, widens a range, drops an unknown field, merges Evidence Roles, reuses a stale hash or falls back to an executable default.
...
- Previous: [[22_Closed_Program_Grammar]]
- Phase home: [[00_MOC_V4_06_Treatment_DSL]]
- Next: [[24_Program_Identity]]
