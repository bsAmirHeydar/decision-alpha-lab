---
title: Test Strategy And Mutation Coverage
status: implemented
version: 1.0.0
phase: V4-06
created: '2026-07-15'
...
# Test Strategy And Mutation Coverage

## Purpose

Test semantics, determinism, boundaries and delivery rather than line execution alone.

## Contract

The suite covers registry policy, primitive coverage, closed parsing, static negatives, descriptor binding, handoff integrity, deterministic replay, tamper detection, diff, partitioning, telemetry, schemas, conformance, exposure, MQL5 safety, source boundaries, status and CLI packaging.
...
Release is blocked by any failed test, invalid schema, broken Obsidian link or forbidden source/MQL5 token. The implementation returns an explicit rejected or quarantined artifact where applicable. It never substitutes the nearest primitive, widens a range, drops an unknown field, merges Evidence Roles, reuses a stale hash or falls back to an executable default.
...
- Previous: [[48_Golden_Negative_And_Conformance_Fixtures]]
- Phase home: [[00_MOC_V4_06_Treatment_DSL]]
- Next: [[50_Security_And_Threat_Model]]
