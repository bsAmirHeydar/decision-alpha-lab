---
title: State Machine Declaration
status: implemented
version: 1.0.0
phase: V4-06
created: '2026-07-15'
...
Represent path lifecycle as a finite directed acyclic declaration.

## Contract

States are typed initial, active or terminal. Transitions have unique names, explicit from/to states, optional guard constraints and optional terminal actions. The source example declares armed, entered, managed and closed.
...
- Previous: [[31_Semantic_Label_Reconciliation]]
- Phase home: [[00_MOC_V4_06_Treatment_DSL]]
- Next: [[33_Cycle_Rejection_And_Reachability]]
