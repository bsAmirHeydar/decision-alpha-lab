---
title: V4-30 Custodian Sender Role
...
# Custodian Sender Role

## Purpose

This note defines the **Custodian Sender Role** boundary inside SAED V4-30 independent and multi-lab replication. The implementation is deterministic, additive, closed-contract, synthetic-reference-only, and subordinate to the existing UCEE authority model.
