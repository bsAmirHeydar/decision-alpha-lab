---
title: V4-30 Pre Assignment Ordering
...
# Pre Assignment Ordering

## Purpose

This note defines the **Pre Assignment Ordering** boundary inside SAED V4-30 independent and multi-lab replication. The implementation is deterministic, additive, closed-contract, synthetic-reference-only, and subordinate to the existing UCEE authority model.
