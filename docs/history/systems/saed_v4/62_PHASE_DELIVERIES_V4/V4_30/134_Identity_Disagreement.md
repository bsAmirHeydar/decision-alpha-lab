---
title: V4-30 Identity Disagreement
...
This note defines the **Identity Disagreement** boundary inside SAED V4-30 independent and multi-lab replication. The implementation is deterministic, additive, closed-contract, synthetic-reference-only, and subordinate to the existing UCEE authority model.
