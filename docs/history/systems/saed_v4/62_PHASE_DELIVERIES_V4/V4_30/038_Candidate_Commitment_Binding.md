---
title: V4-30 Candidate Commitment Binding
...
# Candidate Commitment Binding

## Purpose

This note defines the **Candidate Commitment Binding** boundary inside SAED V4-30 independent and multi-lab replication. The implementation is deterministic, additive, closed-contract, synthetic-reference-only, and subordinate to the existing UCEE authority model.
