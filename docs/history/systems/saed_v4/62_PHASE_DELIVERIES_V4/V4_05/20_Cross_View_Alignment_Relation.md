---
title: Cross-View Alignment Relation
status: implemented
version: 1.0.0
phase: V4-05
created: '2026-07-15'
...
# Cross-View Alignment Relation

## Purpose

A required cross-View alignment hyperedge binds the Context and all View nodes proven compatible by V4-04. It captures shared twin, boundary, and Evidence Role alignment. An incompatible package never reaches this construction step.
...
- Previous: [[19_Temporal_Cohort_Relation]]
- Phase home: [[00_MOC_V4_05_Semantic_And_Temporal_Hypergraph]]
- Next: [[21_Semantic_Family_Relation]]
