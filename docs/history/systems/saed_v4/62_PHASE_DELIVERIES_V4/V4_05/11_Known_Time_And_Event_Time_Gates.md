---
title: Known-Time And Event-Time Gates
status: implemented
version: 1.0.0
phase: V4-05
created: '2026-07-15'
...
# Known-Time And Event-Time Gates

## Purpose

The builder accepts no future suffix. A node with event_time later than event_as_of, a node with known_time later than known_as_of, or an edge interval that crosses either boundary is rejected. Irrelevant operational request IDs do not enter identity. Replay uses the same exact boundaries and hashes.
...
- Previous: [[10_Bitemporal_Graph_Semantics]]
- Phase home: [[00_MOC_V4_05_Semantic_And_Temporal_Hypergraph]]
- Next: [[12_Evidence_Role_Isolation]]
