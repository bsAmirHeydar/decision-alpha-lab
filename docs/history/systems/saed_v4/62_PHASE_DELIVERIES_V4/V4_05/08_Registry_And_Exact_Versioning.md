---
title: Registry And Exact Versioning
status: implemented
version: 1.0.0
phase: V4-05
created: '2026-07-15'
...
# Registry And Exact Versioning

## Purpose

The semantic registry is immutable, exact-versioned, content-addressed, and authority-bounded. Registry hash changes are semantic changes and therefore produce a different graph identity even when the source package is unchanged. Rule order and relation declaration order are non-semantic; canonical sorting prevents operational ordering from changing the output.
...
- Previous: [[07_Relation_Type_Contracts]]
- Phase home: [[00_MOC_V4_05_Semantic_And_Temporal_Hypergraph]]
- Next: [[09_Allowlisted_Semantic_Rules]]
