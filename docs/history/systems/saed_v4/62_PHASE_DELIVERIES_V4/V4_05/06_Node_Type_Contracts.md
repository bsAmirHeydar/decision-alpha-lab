...
Every node has deterministic identity, kind, semantic key, event time, known time, Evidence Role, quality, missing and mask state, source hashes, closed attributes, and a node hash. Node identity is derived from semantic source-bound fields, never an operational request identifier or randomness. Node kinds are closed; unknown kinds fail contract validation.
...
- Previous: [[05_Semantic_Ontology]]
- Phase home: [[00_MOC_V4_05_Semantic_And_Temporal_Hypergraph]]
- Next: [[07_Relation_Type_Contracts]]
