---
title: Semantic Family Relation
status: implemented
version: 1.0.0
phase: V4-05
created: '2026-07-15'
...
# Semantic Family Relation

## Purpose

Semantic family edges encode only institutionally allowlisted groupings such as visible price/execution state or time/session state. They are derived representation, not canonical ontology truth, causal explanation, or learned association. Required semantic rules contribute directly to graph support.
...
- Previous: [[20_Cross_View_Alignment_Relation]]
- Phase home: [[00_MOC_V4_05_Semantic_And_Temporal_Hypergraph]]
- Next: [[22_Context_Ancestry_Relation]]
