---
title: Source Provenance Relation
status: implemented
version: 1.0.0
phase: V4-05
created: '2026-07-15'
...
A feature with supporting source artifacts receives a provenance hyperedge linking the feature node to content-addressed source-artifact nodes. This allows lineage reconstruction without copying or mutating the underlying source truth. Missing features have no invented provenance.
...
- Previous: [[17_View_Composition_Relation]]
- Phase home: [[00_MOC_V4_05_Semantic_And_Temporal_Hypergraph]]
- Next: [[19_Temporal_Cohort_Relation]]
