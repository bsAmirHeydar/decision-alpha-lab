---
title: View Composition Relation
status: implemented
version: 1.0.0
phase: V4-05
created: '2026-07-15'
...
# View Composition Relation

## Purpose

Each exact-version View receives one composition hyperedge connecting its View node to all represented feature nodes. Missing features may remain explicit masked nodes according to policy. The relation records representation membership; it does not claim causal dependence among features.
...
- Previous: [[16_Context_Composition_Relation]]
- Phase home: [[00_MOC_V4_05_Semantic_And_Temporal_Hypergraph]]
- Next: [[18_Source_Provenance_Relation]]
