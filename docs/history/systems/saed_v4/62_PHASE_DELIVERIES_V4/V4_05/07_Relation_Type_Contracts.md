...
Every relation definition fixes its type, allowed node kinds, minimum and maximum arity, whether it is required, repeated-kind policy, and institutional description. Edge instances must use only registered relations and valid incidence. Unknown relations remain unknown; the system does not coerce them into a generic relation.
...
- Previous: [[06_Node_Type_Contracts]]
- Phase home: [[00_MOC_V4_05_Semantic_And_Temporal_Hypergraph]]
- Next: [[08_Registry_And_Exact_Versioning]]
