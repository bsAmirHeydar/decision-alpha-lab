---
title: Temporal Cohort Relation
status: implemented
version: 1.0.0
phase: V4-05
created: '2026-07-15'
...
# Temporal Cohort Relation

## Purpose

Features sharing an exact visible event time may be grouped with a temporal-anchor node. Cohorts are deterministic and boundary-safe. They do not forward-fill, interpolate, or imply simultaneous market causality beyond the represented timestamp.
...
- Previous: [[18_Source_Provenance_Relation]]
- Phase home: [[00_MOC_V4_05_Semantic_And_Temporal_Hypergraph]]
- Next: [[20_Cross_View_Alignment_Relation]]
