---
title: Caching, Idempotency, And Rebuild
status: implemented
version: 1.0.0
phase: V4-05
created: '2026-07-15'
...
# Caching, Idempotency, And Rebuild

## Purpose

Graph construction is side-effect free and idempotent. Cache keys must include source package hash, registry hash, policy hash, graph version, and temporal boundaries. Cache hits must still verify graph and integrity hashes. A stale or partial cache entry is quarantined.
...
- Previous: [[33_Deterministic_Partitioning]]
