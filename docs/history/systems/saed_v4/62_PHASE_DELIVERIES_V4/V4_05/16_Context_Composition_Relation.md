---
title: Context Composition Relation
status: implemented
version: 1.0.0
phase: V4-05
created: '2026-07-15'
...
# Context Composition Relation

## Purpose

The Context composition hyperedge binds the Context node to the exact View nodes contained in the source package. It is required and preserves package membership as a single multi-member relation rather than a set of ungoverned pairwise links.
...
- Previous: [[15_Incidence_And_Arity]]
- Phase home: [[00_MOC_V4_05_Semantic_And_Temporal_Hypergraph]]
- Next: [[17_View_Composition_Relation]]
