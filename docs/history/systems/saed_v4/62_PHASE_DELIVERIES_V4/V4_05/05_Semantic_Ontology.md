...
The ontology is finite and registry-backed. Nodes represent Context, View, Feature, source artifact, temporal anchor, external Context reference, and approved Treatment descriptor. Hyperedges represent Context composition, View composition, provenance, temporal cohort, cross-View alignment, explicit semantic family, Context ancestry, and read-only Treatment descriptor binding. No relation is inferred merely because two values correlate.
...
- Previous: [[04_V4_04_Input_Package_Contract]]
- Phase home: [[00_MOC_V4_05_Semantic_And_Temporal_Hypergraph]]
- Next: [[06_Node_Type_Contracts]]
