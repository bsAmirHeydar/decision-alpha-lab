---
title: Golden Examples And Conformance Vectors
status: implemented
version: 1.0.0
phase: V4-05
created: '2026-07-15'
...
# Golden Examples And Conformance Vectors

## Purpose

The evidence bundle includes the institutional registry and policy, a golden graph, integrity and replay receipts, incidence projection, partition manifest, telemetry, bounded query and result, V4-06 handoff, six negative mutation fixtures, and a versioned conformance vector set.
