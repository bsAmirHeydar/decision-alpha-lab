---
title: Structural And Semantic Validation
status: implemented
version: 1.0.0
phase: V4-05
created: '2026-07-15'
...
Validation checks unique identities, no dangling incidence, no duplicate members, closed relation kinds, valid node kinds, legal arity, bitemporal boundaries, Evidence Role consistency, node and edge hashes, graph budgets, and consistency between graph status and support. Any failure is fail-closed.
...
- Previous: [[26_Deterministic_Builder_Pipeline]]
- Phase home: [[00_MOC_V4_05_Semantic_And_Temporal_Hypergraph]]
- Next: [[28_Integrity_Receipt]]
