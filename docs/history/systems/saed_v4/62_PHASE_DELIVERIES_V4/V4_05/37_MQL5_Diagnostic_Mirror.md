...
The MQL5 layer mirrors enums, authority, headers, node and edge contracts, boundary checks, relation arity, incidence semantics, and static diagnostics. It is diagnostic-only and contains no trading functions. Static source validation is not MetaEditor compile evidence; actual Windows compile logs remain external evidence.
...
- Previous: [[36_Python_Reference_Implementation]]
- Phase home: [[00_MOC_V4_05_Semantic_And_Temporal_Hypergraph]]
- Next: [[38_Closed_Schema_Catalog]]
