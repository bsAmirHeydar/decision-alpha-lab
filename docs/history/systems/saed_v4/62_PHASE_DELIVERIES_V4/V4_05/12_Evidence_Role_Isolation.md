...
A graph belongs to one Evidence Role inherited from the source package. Every node and edge must carry the same role. Development, calibration, selection-validation, locked-final, prospective, shadow, micro-live, live, synthetic-stress, and external roles are not silently mixed. Cross-role contamination is a quarantine-class integrity failure.
...
- Previous: [[11_Known_Time_And_Event_Time_Gates]]
- Phase home: [[00_MOC_V4_05_Semantic_And_Temporal_Hypergraph]]
- Next: [[13_Deterministic_Node_Identity]]
