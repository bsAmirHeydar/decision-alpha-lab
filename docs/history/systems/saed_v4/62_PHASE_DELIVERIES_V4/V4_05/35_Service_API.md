...
The in-process service exposes build, integrity, verify, replay, diff, projection, query, partition, and telemetry operations. It intentionally exposes no training, optimization, Treatment generation, Treatment selection, portfolio, runtime, broker, or order endpoint.
...
- Previous: [[34_Caching_Idempotency_And_Rebuild]]
- Phase home: [[00_MOC_V4_05_Semantic_And_Temporal_Hypergraph]]
- Next: [[36_Python_Reference_Implementation]]
