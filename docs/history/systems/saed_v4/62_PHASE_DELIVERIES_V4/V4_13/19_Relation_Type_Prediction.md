---
title: SAED V4-13 — Relation Type Prediction
...
---
# SAED V4-13 — Relation Type Prediction

Relation centroids test whether embeddings retain upstream semantic distinctions.
