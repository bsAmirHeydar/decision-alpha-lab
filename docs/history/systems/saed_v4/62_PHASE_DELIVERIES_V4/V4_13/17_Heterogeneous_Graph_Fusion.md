---
title: SAED V4-13 — Heterogeneous Graph Fusion
...
---
# SAED V4-13 — Heterogeneous Graph Fusion

The fusion challenger combines self, relation, hyperedge and sequence-state channels.
