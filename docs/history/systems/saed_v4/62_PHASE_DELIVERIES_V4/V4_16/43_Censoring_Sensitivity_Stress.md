---
title: Censoring Sensitivity Stress
status: canonical
version: 1.0.0
phase: SAED_V4_16
created: '2026-07-16'
...
# Censoring Sensitivity Stress

## Purpose

Reference scoring under lower, nominal and higher censoring factors. This note is normative for the deterministic synthetic-reference implementation and must be read together with the machine-readable contracts, frozen upstream evidence, source package, negative fixtures, QA report, claim ledger and authority boundary.
