---
title: Feature Known-Time Freeze
status: canonical
version: 1.0.0
phase: SAED_V4_16
created: '2026-07-16'
...
# Feature Known-Time Freeze

## Purpose

Only frozen V4-15 features known at context time may enter any hazard or distribution estimate. This note is normative for the deterministic synthetic-reference implementation and must be read together with the machine-readable contracts, frozen upstream evidence, source package, negative fixtures, QA report, claim ledger and authority boundary.
