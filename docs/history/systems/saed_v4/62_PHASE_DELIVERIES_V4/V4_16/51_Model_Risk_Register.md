...
Censoring assumptions, tail scarcity, calibration instability, feature shift and synthetic-to-real transport remain open risks. This note is normative for the deterministic synthetic-reference implementation and must be read together with the machine-readable contracts, frozen upstream evidence, source package, negative fixtures, QA report, claim ledger and authority boundary.
