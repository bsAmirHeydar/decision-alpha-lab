---
title: Quantile Crossing Control
status: canonical
version: 1.0.0
phase: SAED_V4_16
created: '2026-07-16'
...
# Quantile Crossing Control

## Purpose

Raw crossing is detected, projected outputs are monotone, and unsupported outputs fail closed. This note is normative for the deterministic synthetic-reference implementation and must be read together with the machine-readable contracts, frozen upstream evidence, source package, negative fixtures, QA report, claim ledger and authority boundary.
