---
title: IPCW Reference Implementation
status: canonical
version: 1.0.0
phase: SAED_V4_16
created: '2026-07-16'
...
# IPCW Reference Implementation

## Purpose

Kaplan-Meier censor-survival estimation, weight clipping, positivity checks and exposure accounting. This note is normative for the deterministic synthetic-reference implementation and must be read together with the machine-readable contracts, frozen upstream evidence, source package, negative fixtures, QA report, claim ledger and authority boundary.
