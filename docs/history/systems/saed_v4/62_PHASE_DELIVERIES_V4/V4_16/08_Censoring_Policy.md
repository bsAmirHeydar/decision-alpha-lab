...
Right and interval censoring rules, administrative horizon, assumptions, failure semantics and immutable versioning. This note is normative for the deterministic synthetic-reference implementation and must be read together with the machine-readable contracts, frozen upstream evidence, source package, negative fixtures, QA report, claim ledger and authority boundary.
