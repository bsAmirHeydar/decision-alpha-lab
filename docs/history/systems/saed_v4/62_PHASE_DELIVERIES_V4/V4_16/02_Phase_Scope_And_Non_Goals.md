...
The exact additive capability delivered here and the economic, causal, promotion, runtime and execution claims explicitly excluded. This note is normative for the deterministic synthetic-reference implementation and must be read together with the machine-readable contracts, frozen upstream evidence, source package, negative fixtures, QA report, claim ledger and authority boundary.
