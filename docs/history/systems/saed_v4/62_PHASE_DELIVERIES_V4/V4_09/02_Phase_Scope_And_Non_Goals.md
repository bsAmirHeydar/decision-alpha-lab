...
Freeze what V4-09 may model and explicitly prohibit treatment preference, broker routing, shadow substitution, and production authorization. The implementation is subordinate to immutable Context truth, the V4-08 Executable Path Outcome Cube, protected evidence roles, UCEE promotion, hard risk, portfolio governance, runtime compilation, and I18 production qualification.
