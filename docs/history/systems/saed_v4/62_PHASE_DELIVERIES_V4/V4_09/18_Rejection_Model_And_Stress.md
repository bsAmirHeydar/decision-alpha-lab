---
title: Rejection Model and Stress
...
# Rejection Model and Stress

## Institutional intent

Use deterministic hash-derived stress draws solely for reproducible scenarios, never as calibrated broker probabilities. The implementation is subordinate to immutable Context truth, the V4-08 Executable Path Outcome Cube, protected evidence roles, UCEE promotion, hard risk, portfolio governance, runtime compilation, and I18 production qualification.
