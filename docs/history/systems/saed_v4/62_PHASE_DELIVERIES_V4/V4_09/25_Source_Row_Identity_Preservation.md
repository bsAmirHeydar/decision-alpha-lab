---
title: Source Row Identity Preservation
...
Bind every projection to source row ID, row hash, node ID, and node hash. The implementation is subordinate to immutable Context truth, the V4-08 Executable Path Outcome Cube, protected evidence roles, UCEE promotion, hard risk, portfolio governance, runtime compilation, and I18 production qualification.
