---
title: Key Share Commitment Registry
...
# Key Share Commitment Registry

## Purpose

Stores only commitments in the repository and never stores reconstructable key material. This module is interpreted only inside the [[V4_29_Hidden_Evaluation_Air_Gap]] authority ceiling and cannot independently authorize model promotion, runtime compilation, capital allocation, order submission or production use.
