...
# One Shot Token Identity

## Purpose

Binds token identity to candidate, dataset, protocol, issuer, issue time and expiry. This module is interpreted only inside the [[V4_29_Hidden_Evaluation_Air_Gap]] authority ceiling and cannot independently authorize model promotion, runtime compilation, capital allocation, order submission or production use.
