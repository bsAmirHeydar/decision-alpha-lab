---
title: Sealed Evaluator Determinism
...
# Sealed Evaluator Determinism

## Purpose

Requires equal committed inputs to yield equal aggregate result and hashes. This module is interpreted only inside the [[V4_29_Hidden_Evaluation_Air_Gap]] authority ceiling and cannot independently authorize model promotion, runtime compilation, capital allocation, order submission or production use.
