---
title: MetaEditor Compilation Pending
...
# MetaEditor Compilation Pending

## Purpose

Classifies MQL5 evidence as static until local Windows compilation is attached. This module is interpreted only inside the [[V4_29_Hidden_Evaluation_Air_Gap]] authority ceiling and cannot independently authorize model promotion, runtime compilation, capital allocation, order submission or production use.
