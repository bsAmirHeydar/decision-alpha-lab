---
title: Disclosure Field Denylist
...
# Disclosure Field Denylist

## Purpose

Denies row IDs, labels, predictions, probabilities, raw scores, feature vectors, key shares and plaintext. This module is interpreted only inside the [[V4_29_Hidden_Evaluation_Air_Gap]] authority ceiling and cannot independently authorize model promotion, runtime compilation, capital allocation, order submission or production use.
