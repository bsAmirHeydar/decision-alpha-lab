---
title: Disclosure Field Allowlist
...
Allows only evaluation identity, candidate identity, dataset commitment, protocol identity, decision, aggregate metrics, baseline comparison and release hash. This module is interpreted only inside the [[V4_29_Hidden_Evaluation_Air_Gap]] authority ceiling and cannot independently authorize model promotion, runtime compilation, capital allocation, order submission or production use.
