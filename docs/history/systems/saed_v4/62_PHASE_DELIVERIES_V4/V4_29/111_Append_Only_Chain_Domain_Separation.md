---
title: Append Only Chain Domain Separation
...
# Append Only Chain Domain Separation

## Purpose

Uses distinct chain domains for query, token, custody and transport records. This module is interpreted only inside the [[V4_29_Hidden_Evaluation_Air_Gap]] authority ceiling and cannot independently authorize model promotion, runtime compilation, capital allocation, order submission or production use.
