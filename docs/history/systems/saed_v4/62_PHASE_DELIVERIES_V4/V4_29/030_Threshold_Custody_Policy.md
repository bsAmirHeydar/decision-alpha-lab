---
title: Threshold Custody Policy
...
Requires a two-of-three reference quorum and rejects single-actor custody. This module is interpreted only inside the [[V4_29_Hidden_Evaluation_Air_Gap]] authority ceiling and cannot independently authorize model promotion, runtime compilation, capital allocation, order submission or production use.
