---
title: Evaluator Export Restriction
...
# Evaluator Export Restriction

## Purpose

Allows evaluator plaintext use only inside the sealed zone and prohibits plaintext egress. This module is interpreted only inside the [[V4_29_Hidden_Evaluation_Air_Gap]] authority ceiling and cannot independently authorize model promotion, runtime compilation, capital allocation, order submission or production use.
