---
title: "V4-25 048 — Dataset Minimum Task Count"
...
# Dataset Minimum Task Count

## Control objective

The meta-dataset is a chronological collection of task windows. Each task separates support information available for adaptation from query outcomes reserved for retrospective evaluation. Context, cluster, regime, role, and time identities are content-addressed and schema closed.

The objective of **Dataset Minimum Task Count** is to make this boundary explicit, machine-checkable, and reproducible. The control is evaluated before any downstream artifact can be accepted. Unknown fields, missing identities, non-finite values, future-known inputs, protected-evidence access, or authority escalation invalidate the artifact rather than being silently coerced.
...
- Previous: [[047_Dataset_Content_Addressing]]
- Phase map: [[00_MOC_V4_25_Continual_Meta_And_Transfer]]
- Next: [[049_Dataset_Context_Diversity]]
