---
title: "V4-25 045 — OOD P Value Intake"
...
The objective of **OOD P Value Intake** is to make this boundary explicit, machine-checkable, and reproducible. The control is evaluated before any downstream artifact can be accepted. Unknown fields, missing identities, non-finite values, future-known inputs, protected-evidence access, or authority escalation invalidate the artifact rather than being silently coerced.
...
- Previous: [[044_Support_Score_Intake]]
- Phase map: [[00_MOC_V4_25_Continual_Meta_And_Transfer]]
- Next: [[046_Conformal_Lower_Bound_Intake]]
