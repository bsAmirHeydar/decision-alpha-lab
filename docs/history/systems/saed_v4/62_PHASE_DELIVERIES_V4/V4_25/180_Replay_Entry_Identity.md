---
title: "V4-25 180 — Replay Entry Identity"
...
The objective of **Replay Entry Identity** is to make this boundary explicit, machine-checkable, and reproducible. The control is evaluated before any downstream artifact can be accepted. Unknown fields, missing identities, non-finite values, future-known inputs, protected-evidence access, or authority escalation invalidate the artifact rather than being silently coerced.
...
- Previous: [[179_Diversity_Completion_Rule]]
- Phase map: [[00_MOC_V4_25_Continual_Meta_And_Transfer]]
- Next: [[V4_25_TO_V4_26_HANDOFF]]
