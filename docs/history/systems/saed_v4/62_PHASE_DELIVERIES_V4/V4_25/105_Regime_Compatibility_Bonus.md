---
title: "V4-25 105 — Regime Compatibility Bonus"
...
The objective of **Regime Compatibility Bonus** is to make this boundary explicit, machine-checkable, and reproducible. The control is evaluated before any downstream artifact can be accepted. Unknown fields, missing identities, non-finite values, future-known inputs, protected-evidence access, or authority escalation invalidate the artifact rather than being silently coerced.
...
- Previous: [[104_Maximum_Meta_Distance_Gate]]
- Phase map: [[00_MOC_V4_25_Continual_Meta_And_Transfer]]
- Next: [[106_Context_Compatibility_Bonus]]
