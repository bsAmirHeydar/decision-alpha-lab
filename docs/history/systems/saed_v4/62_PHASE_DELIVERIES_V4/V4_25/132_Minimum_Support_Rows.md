---
title: "V4-25 132 — Minimum Support Rows"
...
The objective of **Minimum Support Rows** is to make this boundary explicit, machine-checkable, and reproducible. The control is evaluated before any downstream artifact can be accepted. Unknown fields, missing identities, non-finite values, future-known inputs, protected-evidence access, or authority escalation invalidate the artifact rather than being silently coerced.
...
- Previous: [[131_Ridge_Penalty]]
- Phase map: [[00_MOC_V4_25_Continual_Meta_And_Transfer]]
- Next: [[133_Maximum_Parameter_Delta]]
