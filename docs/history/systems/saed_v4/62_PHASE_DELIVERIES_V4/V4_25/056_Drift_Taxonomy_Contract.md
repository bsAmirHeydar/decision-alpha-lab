---
title: "V4-25 056 — Drift Taxonomy Contract"
...
The objective of **Drift Taxonomy Contract** is to make this boundary explicit, machine-checkable, and reproducible. The control is evaluated before any downstream artifact can be accepted. Unknown fields, missing identities, non-finite values, future-known inputs, protected-evidence access, or authority escalation invalidate the artifact rather than being silently coerced.
...
- Previous: [[055_Task_Ledger_Completeness]]
- Phase map: [[00_MOC_V4_25_Continual_Meta_And_Transfer]]
- Next: [[057_Stationary_Drift_Class]]
