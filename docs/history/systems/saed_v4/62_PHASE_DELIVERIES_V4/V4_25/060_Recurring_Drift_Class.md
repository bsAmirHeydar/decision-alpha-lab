---
title: "V4-25 060 — Recurring Drift Class"
...
The objective of **Recurring Drift Class** is to make this boundary explicit, machine-checkable, and reproducible. The control is evaluated before any downstream artifact can be accepted. Unknown fields, missing identities, non-finite values, future-known inputs, protected-evidence access, or authority escalation invalidate the artifact rather than being silently coerced.
...
- Previous: [[059_Sudden_Drift_Class]]
- Phase map: [[00_MOC_V4_25_Continual_Meta_And_Transfer]]
- Next: [[061_Novel_Drift_Class]]
