---
title: "V4-25 079 — Drift Taxonomy Versioning"
...
The objective of **Drift Taxonomy Versioning** is to make this boundary explicit, machine-checkable, and reproducible. The control is evaluated before any downstream artifact can be accepted. Unknown fields, missing identities, non-finite values, future-known inputs, protected-evidence access, or authority escalation invalidate the artifact rather than being silently coerced.
...
- Previous: [[078_Drift_Misclassification_Risk]]
- Phase map: [[00_MOC_V4_25_Continual_Meta_And_Transfer]]
- Next: [[080_Drift_Report_Certificate_Input]]
