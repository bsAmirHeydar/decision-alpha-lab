---
title: "V4-25 106 — Context Compatibility Bonus"
...
The objective of **Context Compatibility Bonus** is to make this boundary explicit, machine-checkable, and reproducible. The control is evaluated before any downstream artifact can be accepted. Unknown fields, missing identities, non-finite values, future-known inputs, protected-evidence access, or authority escalation invalidate the artifact rather than being silently coerced.
...
- Previous: [[105_Regime_Compatibility_Bonus]]
- Phase map: [[00_MOC_V4_25_Continual_Meta_And_Transfer]]
- Next: [[107_Transfer_Weight_Equation]]
