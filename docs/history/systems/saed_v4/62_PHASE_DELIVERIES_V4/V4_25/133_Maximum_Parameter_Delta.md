---
title: "V4-25 133 — Maximum Parameter Delta"
...
The objective of **Maximum Parameter Delta** is to make this boundary explicit, machine-checkable, and reproducible. The control is evaluated before any downstream artifact can be accepted. Unknown fields, missing identities, non-finite values, future-known inputs, protected-evidence access, or authority escalation invalidate the artifact rather than being silently coerced.
...
- Previous: [[132_Minimum_Support_Rows]]
- Phase map: [[00_MOC_V4_25_Continual_Meta_And_Transfer]]
- Next: [[134_Baseline_Parameter_Preservation]]
