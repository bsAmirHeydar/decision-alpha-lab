---
title: "V4-25 074 — Drift Class Count Ledger"
...
The objective of **Drift Class Count Ledger** is to make this boundary explicit, machine-checkable, and reproducible. The control is evaluated before any downstream artifact can be accepted. Unknown fields, missing identities, non-finite values, future-known inputs, protected-evidence access, or authority escalation invalidate the artifact rather than being silently coerced.
...
- Previous: [[073_Minimum_Segment_Support]]
- Phase map: [[00_MOC_V4_25_Continual_Meta_And_Transfer]]
- Next: [[075_Drift_Mutation_Tests]]
