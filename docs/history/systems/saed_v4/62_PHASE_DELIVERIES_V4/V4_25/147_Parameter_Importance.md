---
title: "V4-25 147 — Parameter Importance"
...
The objective of **Parameter Importance** is to make this boundary explicit, machine-checkable, and reproducible. The control is evaluated before any downstream artifact can be accepted. Unknown fields, missing identities, non-finite values, future-known inputs, protected-evidence access, or authority escalation invalidate the artifact rather than being silently coerced.
...
- Previous: [[146_Support_Fisher_Diagonal_Approximation]]
- Phase map: [[00_MOC_V4_25_Continual_Meta_And_Transfer]]
- Next: [[148_Quadratic_Anchor_Penalty]]
