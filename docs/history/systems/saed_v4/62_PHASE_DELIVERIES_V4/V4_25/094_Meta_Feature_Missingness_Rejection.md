---
title: "V4-25 094 — Meta Feature Missingness Rejection"
...
# Meta Feature Missingness Rejection

## Control objective

Meta-features summarize only information legally available at the task decision boundary: frozen context features, support quality, support outcomes, OOD evidence, conformal lower bounds, and support size. Query outcomes never enter source selection or adaptation.

The objective of **Meta Feature Missingness Rejection** is to make this boundary explicit, machine-checkable, and reproducible. The control is evaluated before any downstream artifact can be accepted. Unknown fields, missing identities, non-finite values, future-known inputs, protected-evidence access, or authority escalation invalidate the artifact rather than being silently coerced.
...
- Previous: [[093_Meta_Feature_Dimension_Freeze]]
- Phase map: [[00_MOC_V4_25_Continual_Meta_And_Transfer]]
- Next: [[095_Meta_Feature_Replay]]
