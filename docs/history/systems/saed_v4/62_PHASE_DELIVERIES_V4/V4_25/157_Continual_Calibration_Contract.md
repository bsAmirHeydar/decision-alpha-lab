---
title: "V4-25 157 — Continual Calibration Contract"
...
# Continual Calibration Contract
...
The objective of **Continual Calibration Contract** is to make this boundary explicit, machine-checkable, and reproducible. The control is evaluated before any downstream artifact can be accepted. Unknown fields, missing identities, non-finite values, future-known inputs, protected-evidence access, or authority escalation invalidate the artifact rather than being silently coerced.
...
- Previous: [[156_Regularization_Limitations]]
- Phase map: [[00_MOC_V4_25_Continual_Meta_And_Transfer]]
- Next: [[158_Past_Only_Calibration]]
