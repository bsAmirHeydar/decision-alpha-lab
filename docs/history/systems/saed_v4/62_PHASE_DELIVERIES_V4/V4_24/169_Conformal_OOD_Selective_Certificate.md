---
title: SAED V4-24 — Conformal OOD Selective Certificate
...
---
# SAED V4-24 — Conformal OOD Selective Certificate

## Purpose
**Conformal OOD Selective Certificate** is a normative element of the V4-24 Conformal OOD and Selective Control phase. It makes distribution-shift detection and drift containment explicit, versioned, content-addressed and independently reproducible above the immutable V4-23 offline-policy research handoff. It does not create a production decision right or alter UCEE authority.
...
## Traceability
Parent phase: [[V4_23_Offline_Policy_Research]]. Current map: [[00_MOC_V4_24_Conformal_OOD_And_Selective_Control]]. Next concept: [[Certificate_Gate_Matrix]]. Next phase: [[V4_25_Continual_Meta_And_Transfer]]. Sequence: 169/180.
