---
title: "V4-21 — Wasserstein L1 Reference Ball"
...
---
# V4-21 — Wasserstein L1 Reference Ball

## Purpose
This note specifies **Wasserstein L1 Reference Ball** as a closed-contract component of the V4-21 robust-optimization and regret-analysis reference implementation. The component is deterministic, content-addressed, independently reproducible, and bounded by explicit compute and evidence budgets.
...
## Relationship
[[27_Scenario_Convex_Hull|Previous: Scenario Convex Hull]] · [[29_KL_Ball_Reference_Boundary|Next: KL Ball Reference Boundary]]
