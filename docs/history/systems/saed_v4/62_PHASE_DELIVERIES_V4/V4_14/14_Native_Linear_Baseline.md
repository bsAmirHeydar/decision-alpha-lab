...
The simple baseline that must remain visible and available as a fallback. This note is normative for the V4-14 reference implementation and must be read together with the machine-readable contracts, artifacts, tests, and authority boundary.
