...
Hash-bound candidate, source sequence, feature, evaluation, calibration, domain, intake, and supply-chain evidence. This note is normative for the V4-14 reference implementation and must be read together with the machine-readable contracts, artifacts, tests, and authority boundary.
