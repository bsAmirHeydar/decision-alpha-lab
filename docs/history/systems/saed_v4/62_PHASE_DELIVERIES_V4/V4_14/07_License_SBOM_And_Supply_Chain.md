---
title: License, SBOM, and Supply Chain
status: canonical
version: 1.0.0
phase: SAED_V4_14
created: '2026-07-16'
...
# License, SBOM, and Supply Chain

## Purpose

License admissibility, dependency inventory, vulnerability review, network denial, and quarantine logic. This note is normative for the V4-14 reference implementation and must be read together with the machine-readable contracts, artifacts, tests, and authority boundary.
