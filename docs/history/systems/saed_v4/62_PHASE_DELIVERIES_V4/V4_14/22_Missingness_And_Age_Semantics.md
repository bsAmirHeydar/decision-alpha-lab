---
title: Missingness and Age Semantics
status: canonical
version: 1.0.0
phase: SAED_V4_14
created: '2026-07-16'
...
# Missingness and Age Semantics

## Purpose

Explicit masks, staleness age, reject/carry/mask policies, and support accounting. This note is normative for the V4-14 reference implementation and must be read together with the machine-readable contracts, artifacts, tests, and authority boundary.
