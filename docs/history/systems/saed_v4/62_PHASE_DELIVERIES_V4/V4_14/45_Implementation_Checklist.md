...
A complete engineering checklist from source modules through schemas, fixtures, QA, MQL5 mirrors, and delivery hashes. This note is normative for the V4-14 reference implementation and must be read together with the machine-readable contracts, artifacts, tests, and authority boundary.
