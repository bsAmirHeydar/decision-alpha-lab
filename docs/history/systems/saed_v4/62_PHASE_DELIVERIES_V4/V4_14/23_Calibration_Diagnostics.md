...
Reference interval coverage, median error, monotonicity, and the limits of synthetic calibration evidence. This note is normative for the V4-14 reference implementation and must be read together with the machine-readable contracts, artifacts, tests, and authority boundary.
