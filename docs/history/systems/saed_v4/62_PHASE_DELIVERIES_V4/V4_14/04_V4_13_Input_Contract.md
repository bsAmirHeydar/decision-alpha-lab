---
title: V4-13 Frozen Input Contract
status: canonical
version: 1.0.0
phase: SAED_V4_14
created: '2026-07-16'
...
# V4-13 Frozen Input Contract

## Purpose

Hash binding to the graph checkpoint registry, champion embedding, compiled graph, tournament, and immutable handoff. This note is normative for the V4-14 reference implementation and must be read together with the machine-readable contracts, artifacts, tests, and authority boundary.
