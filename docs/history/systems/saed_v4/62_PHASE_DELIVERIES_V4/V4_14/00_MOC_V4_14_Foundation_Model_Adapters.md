---
title: V4-14 Foundation Model Adapters — Map of Content
status: canonical
version: 1.0.0
phase: SAED_V4_14
created: '2026-07-16'
...
# V4-14 Foundation Model Adapters — Map of Content

## Purpose

The institutional map for bounded foundation-model intake, adaptation, diagnostics, evidence, and handoff. This note is normative for the V4-14 reference implementation and must be read together with the machine-readable contracts, artifacts, tests, and authority boundary.
