...
What synthetic reference emulation cannot establish about real external checkpoints or market utility. This note is normative for the V4-14 reference implementation and must be read together with the machine-readable contracts, artifacts, tests, and authority boundary.
