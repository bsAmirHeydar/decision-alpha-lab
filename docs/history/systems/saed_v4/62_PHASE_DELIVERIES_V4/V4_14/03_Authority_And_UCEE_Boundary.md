...
Executable separation between research feature generation and UCEE truth, promotion, risk, runtime, and execution authority. This note is normative for the V4-14 reference implementation and must be read together with the machine-readable contracts, artifacts, tests, and authority boundary.
