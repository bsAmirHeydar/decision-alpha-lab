---
title: Compute and Exposure Budget
status: canonical
version: 1.0.0
phase: SAED_V4_14
created: '2026-07-16'
...
# Compute and Exposure Budget

## Purpose

Candidate count, calls, tokens, trainable parameters, exposures, failures, retries, and immutable accounting. This note is normative for the V4-14 reference implementation and must be read together with the machine-readable contracts, artifacts, tests, and authority boundary.
