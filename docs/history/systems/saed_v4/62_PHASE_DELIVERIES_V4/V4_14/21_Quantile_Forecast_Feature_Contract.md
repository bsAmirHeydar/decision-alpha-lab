---
title: Quantile Forecast Feature Contract
status: canonical
version: 1.0.0
phase: SAED_V4_14
created: '2026-07-16'
...
# Quantile Forecast Feature Contract

## Purpose

Monotone quantiles, uncertainty scale, calibration metadata, and feature-only authority. This note is normative for the V4-14 reference implementation and must be read together with the machine-readable contracts, artifacts, tests, and authority boundary.
