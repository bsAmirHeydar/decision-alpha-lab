...
Outcome-free latent reconstruction, temporal consistency, graph alignment, calibration, robustness, and complexity. This note is normative for the V4-14 reference implementation and must be read together with the machine-readable contracts, artifacts, tests, and authority boundary.
