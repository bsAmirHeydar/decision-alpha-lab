...
Advanced families cannot erase the native baseline from scorecards, registries, or fallback paths. This note is normative for the V4-14 reference implementation and must be read together with the machine-readable contracts, artifacts, tests, and authority boundary.
