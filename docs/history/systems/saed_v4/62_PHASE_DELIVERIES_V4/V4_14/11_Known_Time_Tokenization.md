...
# Known-Time Tokenization

## Purpose

Deterministic ordering, causal normalization, missingness masks, age fields, and cutoff-bounded token compilation. This note is normative for the V4-14 reference implementation and must be read together with the machine-readable contracts, artifacts, tests, and authority boundary.
