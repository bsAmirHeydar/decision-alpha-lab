...
Required counts, hashes, support flags, uncertainty, fallback resolution, and forbidden-operation events. This note is normative for the V4-14 reference implementation and must be read together with the machine-readable contracts, artifacts, tests, and authority boundary.
