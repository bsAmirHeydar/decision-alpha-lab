---
title: MOMENT-Style Reference Adapter
status: canonical
version: 1.0.0
phase: SAED_V4_14
created: '2026-07-16'
...
# MOMENT-Style Reference Adapter

## Purpose

A local masked-representation emulation for self-supervised feature comparison. This note is normative for the V4-14 reference implementation and must be read together with the machine-readable contracts, artifacts, tests, and authority boundary.
