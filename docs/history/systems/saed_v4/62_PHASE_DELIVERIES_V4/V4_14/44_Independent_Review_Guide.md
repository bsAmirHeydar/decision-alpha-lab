...
A reviewer sequence for contracts, provenance, code, tests, artifacts, claims, and handoff authority. This note is normative for the V4-14 reference implementation and must be read together with the machine-readable contracts, artifacts, tests, and authority boundary.
