...
Unsupported challengers resolve to the native baseline; unsupported baseline resolves to abstain. This note is normative for the V4-14 reference implementation and must be read together with the machine-readable contracts, artifacts, tests, and authority boundary.
