---
title: Twin Seed Handoff Contract
status: implemented
version: 1.0.0
phase: V4-01
created: '2026-07-13'
...
Defines the only admissible input package for the V4-02 Context Digital Twin Kernel.
...
The Twin Seed package contains a canonical Context Specification artifact ID, immutable snapshot IDs, exact schema versions, lineage root, known-as-of boundary, constitution hash and limitations. It contains no learned latent state and is not itself a Digital Twin. V4-02 must deterministically derive the same initial Cell from the same seed package.
