...
Prevents protected evidence from flowing back into train, tune or adaptive selection.
...
Role isolation is enforced at access time and derivation time. Development can train and tune. Calibration can calibrate. Selection validation can select. Locked-final and later roles are report, replay and promotion evidence only. Synthetic stress and external static evidence may challenge or reject, but cannot create positive promotion evidence.
