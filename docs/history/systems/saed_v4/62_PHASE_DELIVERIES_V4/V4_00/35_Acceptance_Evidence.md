...
> **Focus:** What constitutes phase completion and how evidence is classified.
...
What constitutes phase completion and how evidence is classified. This area is implemented as a closed, exact-version contract rather than an informal convention. Unknown fields are rejected, hashes are pinned and all decisions carry explicit reason codes.
