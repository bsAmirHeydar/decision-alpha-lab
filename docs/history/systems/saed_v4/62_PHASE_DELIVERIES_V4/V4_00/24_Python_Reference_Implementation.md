...
> **Focus:** Module map, purity boundaries and API examples.
...
Module map, purity boundaries and API examples. This area is implemented as a closed, exact-version contract rather than an informal convention. Unknown fields are rejected, hashes are pinned and all decisions carry explicit reason codes.
