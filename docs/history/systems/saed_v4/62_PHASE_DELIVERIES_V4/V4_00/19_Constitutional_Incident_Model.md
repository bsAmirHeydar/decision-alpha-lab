---
title: Constitutional Incident Model
status: implemented
version: 1.0.0
phase: V4-00
created: '2026-07-13'
...
# Constitutional Incident Model

> **Focus:** Incident categories, mandatory responses and evidence retention.
...
Incident categories, mandatory responses and evidence retention. This area is implemented as a closed, exact-version contract rather than an informal convention. Unknown fields are rejected, hashes are pinned and all decisions carry explicit reason codes.
