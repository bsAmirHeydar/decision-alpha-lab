...
> **Focus:** Protected data roles, permitted operations and synthetic evidence limits.
...
Protected data roles, permitted operations and synthetic evidence limits. This area is implemented as a closed, exact-version contract rather than an informal convention. Unknown fields are rejected, hashes are pinned and all decisions carry explicit reason codes.
