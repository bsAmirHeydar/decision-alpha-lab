---
title: Constitutional Kernel Architecture
status: implemented
version: 1.0.0
phase: V4-00
created: '2026-07-13'
...
> **Focus:** Pure deterministic control plane, decision flow and fail-closed composition.
...
Pure deterministic control plane, decision flow and fail-closed composition. This area is implemented as a closed, exact-version contract rather than an informal convention. Unknown fields are rejected, hashes are pinned and all decisions carry explicit reason codes.
