...
> **Focus:** Frozen entry gates for Context Digital Twin Kernel.
...
Frozen entry gates for Context Digital Twin Kernel. This area is implemented as a closed, exact-version contract rather than an informal convention. Unknown fields are rejected, hashes are pinned and all decisions carry explicit reason codes.
