...
> **Focus:** Prospective-only constitutional changes with exact lineage and independent approvals.
...
Prospective-only constitutional changes with exact lineage and independent approvals. This area is implemented as a closed, exact-version contract rather than an informal convention. Unknown fields are rejected, hashes are pinned and all decisions carry explicit reason codes.
