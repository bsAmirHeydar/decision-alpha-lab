---
title: Hidden Evaluation Query Budget
status: implemented
version: 1.0.0
phase: V4-00
created: '2026-07-13'
...
# Hidden Evaluation Query Budget

> **Focus:** Submission accounting, exhaustion behavior and adaptive overfit controls.
...
Submission accounting, exhaustion behavior and adaptive overfit controls. This area is implemented as a closed, exact-version contract rather than an informal convention. Unknown fields are rejected, hashes are pinned and all decisions carry explicit reason codes.
