---
title: Signature And Key-Management Boundary
status: implemented
version: 1.0.0
phase: V4-00
created: '2026-07-13'
...
# Signature And Key-Management Boundary

> **Focus:** Reference HMAC adapter and production asymmetric-signature requirements.
...
Reference HMAC adapter and production asymmetric-signature requirements. This area is implemented as a closed, exact-version contract rather than an informal convention. Unknown fields are rejected, hashes are pinned and all decisions carry explicit reason codes.
