...
> **Focus:** Allowed tools, forbidden actions and no self-approval.
...
Allowed tools, forbidden actions and no self-approval. This area is implemented as a closed, exact-version contract rather than an informal convention. Unknown fields are rejected, hashes are pinned and all decisions carry explicit reason codes.
