...
> **Focus:** Tampering, privilege escalation, evidence poisoning and replay attacks.
...
Tampering, privilege escalation, evidence poisoning and replay attacks. This area is implemented as a closed, exact-version contract rather than an informal convention. Unknown fields are rejected, hashes are pinned and all decisions carry explicit reason codes.
