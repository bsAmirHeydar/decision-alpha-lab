---
title: Authority Matrix And Denial By Default
status: implemented
version: 1.0.0
phase: V4-00
created: '2026-07-13'
...
# Authority Matrix And Denial By Default

> **Focus:** Explicit grants, hard denies and specialized service authority.
...
Explicit grants, hard denies and specialized service authority. This area is implemented as a closed, exact-version contract rather than an informal convention. Unknown fields are rejected, hashes are pinned and all decisions carry explicit reason codes.
