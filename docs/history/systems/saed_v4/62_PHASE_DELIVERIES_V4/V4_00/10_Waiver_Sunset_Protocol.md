...
# Waiver Sunset Protocol

> **Focus:** Time-bounded exceptions, compensating controls and non-waivable rules.
...
Time-bounded exceptions, compensating controls and non-waivable rules. This area is implemented as a closed, exact-version contract rather than an informal convention. Unknown fields are rejected, hashes are pinned and all decisions carry explicit reason codes.
