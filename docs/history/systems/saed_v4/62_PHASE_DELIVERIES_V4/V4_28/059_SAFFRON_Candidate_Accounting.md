---
title: SAFFRON Candidate Accounting
...
# SAFFRON Candidate Accounting

This note is part of the accepted V4-28 online-FDR reference. It specifies the **saffron candidate accounting** contract as a closed, deterministic, known-time research control. The implementation consumes only the immutable V4-27 completeness evidence and cannot access hidden evaluation data.
