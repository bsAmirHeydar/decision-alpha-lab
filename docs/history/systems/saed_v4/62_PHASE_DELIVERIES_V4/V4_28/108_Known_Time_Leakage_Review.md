---
title: Known Time Leakage Review
...
This note is part of the accepted V4-28 online-FDR reference. It specifies the **known time leakage review** contract as a closed, deterministic, known-time research control. The implementation consumes only the immutable V4-27 completeness evidence and cannot access hidden evaluation data.
