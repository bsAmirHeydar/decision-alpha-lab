---
title: Authority Mutation Tests
...
# Authority Mutation Tests

This note is part of the accepted V4-28 online-FDR reference. It specifies the **authority mutation tests** contract as a closed, deterministic, known-time research control. The implementation consumes only the immutable V4-27 completeness evidence and cannot access hidden evaluation data.
