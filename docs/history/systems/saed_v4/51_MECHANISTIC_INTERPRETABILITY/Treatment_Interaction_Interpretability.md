---
title: Treatment Interaction Interpretability
status: canonical
version: 4.0.0
created: '2026-07-13'
updated: '2026-07-13'
...
tags:
  - saed-v4
  - 51_mechanistic_interpretability
  - institutional-v4
---

# Mandate

Understand which internal features, circuits, views and treatment interactions drive a decision, and detect reliance on shortcuts, leakage or unstable spurious mechanisms.

**This specification:** **Treatment Interaction Interpretability**.
...
- causal tracing
- activation patching challengers
...
- interpretability is not proof
- sanity checks
- randomization tests
- faithfulness challenge
