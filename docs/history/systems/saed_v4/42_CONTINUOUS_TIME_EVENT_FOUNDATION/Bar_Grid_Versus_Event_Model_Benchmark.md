---
title: Bar Grid Versus Event Model Benchmark
status: canonical
version: 4.0.0
created: '2026-07-13'
updated: '2026-07-13'
...
tags:
  - saed-v4
  - 42_continuous_time_event_foundation
  - institutional-v4
---

# Mandate

Learn irregular, asynchronous and multi-scale market event dynamics in continuous time rather than forcing all information into a single bar grid.

**This specification:** **Bar Grid Versus Event Model Benchmark**.
...
- neural ODE/SDE challengers
- marked point processes
- survival transformers
...
- strict known-time ordering
- clock-source identity
- no interpolated future information
- grid baseline comparison
- event dropout stress
