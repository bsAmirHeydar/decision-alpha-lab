---
title: View Specific Support And Calibration
status: canonical
version: 4.0.0
created: '2026-07-13'
updated: '2026-07-13'
...
tags:
  - saed-v4
  - 43_multimodal_market_intelligence
  - institutional-v4
---

# Mandate

Fuse price, structure, time, intermarket, liquidity, execution and approved textual metadata through independently auditable view encoders and support-aware fusion.

**This specification:** **View Specific Support And Calibration**.
...
- numeric sequences
- graphs
- categorical context facts
- approved event text embeddings
- execution state
- portfolio state
...
- no unrestricted internet at inference
- source allowlist
- view ablation
- text-removal parity
