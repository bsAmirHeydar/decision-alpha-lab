...
Marginal Portfolio Risk is an identity-relevant rule in the UCE-I17 portfolio layer. It must be represented in schemas, code, fixtures, tests, telemetry and runtime evidence rather than being left as an undocumented convention.
