---
title: "UCE-I18 — Compile log is an artifact"
...
---
# Compile log is an artifact

## Normative decision

Compiler build, source hash, output hash, exit code, errors, warnings and the complete log hash participate in qualification identity.
