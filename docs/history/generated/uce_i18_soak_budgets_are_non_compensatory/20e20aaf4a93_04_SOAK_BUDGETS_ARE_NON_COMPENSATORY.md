---
title: "UCE-I18 — Soak budgets are non-compensatory"
...
---
# Soak budgets are non-compensatory

## Normative decision

A latency, memory, duplicate-action, stale-action or reconciliation failure cannot be offset by more runtime duration.
