...
## Purpose
چون بعد از ساختن Limit Entry، هنوز معلوم نیست سفارش تا چه زمانی زنده است، چه زمانی باید کنسل شود، چه زمانی missed حساب شود، و چه زمانی با یک Entry-Level Extreme جدید جایگزین شود. این بخش جلوی اجرای کور و سفارش‌های مرده را می‌گیرد.
...
## Image Requirement
اختیاری. اگر نمونه‌ای از limit missed یا replace روی چارت داری، عکس کمک می‌کند.
