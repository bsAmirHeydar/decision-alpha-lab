# Reference release, auth and failure vectors

## Purpose

This note specifies **reference release, auth and failure vectors** for the MQL5-first Strategy Factory live boundary.
