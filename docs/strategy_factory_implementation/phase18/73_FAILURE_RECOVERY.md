# Recovery after rejection or circuit open

## Purpose

This note specifies **recovery after rejection or circuit open** for the MQL5-first Strategy Factory live boundary.
