# Why live elevation is separate from intent authority

## Purpose

This note specifies **why live elevation is separate from intent authority** for the MQL5-first Strategy Factory live boundary.
