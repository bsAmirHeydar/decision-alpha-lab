...
Treats missing and invalid rates as first-class health signals rather than silently imputing them online. This note is part of the permanent Strategy Factory operating model and applies to research, tester, paper, shadow, micro-live, and live-compatible execution modes.
