...
Separates terminal compute delay from OrderCheck, OrderSend, acknowledgment, and fill latency. This note is part of the permanent Strategy Factory operating model and applies to research, tester, paper, shadow, micro-live, and live-compatible execution modes.
