...
Implements a fixed-capacity ring with explicit drop accounting rather than unbounded allocation. This note is part of the permanent Strategy Factory operating model and applies to research, tester, paper, shadow, micro-live, and live-compatible execution modes.
