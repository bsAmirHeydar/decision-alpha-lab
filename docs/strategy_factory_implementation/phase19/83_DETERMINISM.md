...
Requires identical inputs and policies to produce identical IDs, severities, and recommendations. This note is part of the permanent Strategy Factory operating model and applies to research, tester, paper, shadow, micro-live, and live-compatible execution modes.
