...
Packages health, latency, drift, alerts, recommendation, lineage, and canonical hash into an immutable report. This note is part of the permanent Strategy Factory operating model and applies to research, tester, paper, shadow, micro-live, and live-compatible execution modes.
