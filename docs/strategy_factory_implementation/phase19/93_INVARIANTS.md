...
Collects causality, boundedness, exact lineage, fail-closed schemas, and operator approval guarantees. This note is part of the permanent Strategy Factory operating model and applies to research, tester, paper, shadow, micro-live, and live-compatible execution modes.
