...
Requires representative, leakage-safe, sufficiently large baseline windows and explicit retirement rules. This note is part of the permanent Strategy Factory operating model and applies to research, tester, paper, shadow, micro-live, and live-compatible execution modes.
