...
Links model-integrity or champion degradation evidence to an operator-approved Phase 14 rollback plan. This note is part of the permanent Strategy Factory operating model and applies to research, tester, paper, shadow, micro-live, and live-compatible execution modes.
