...
Defines exact metric name, version, kind, unit, stage, bounds, description, and stable schema identity. This note is part of the permanent Strategy Factory operating model and applies to research, tester, paper, shadow, micro-live, and live-compatible execution modes.
