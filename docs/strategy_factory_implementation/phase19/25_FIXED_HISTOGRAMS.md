...
Uses startup-defined buckets to avoid dynamic allocation and make MQL5 and Python percentile evidence comparable. This note is part of the permanent Strategy Factory operating model and applies to research, tester, paper, shadow, micro-live, and live-compatible execution modes.
