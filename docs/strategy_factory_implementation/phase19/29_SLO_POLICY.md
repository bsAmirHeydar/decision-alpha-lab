...
Versions stage-specific P50, P95, P99 limits and minimum sample requirements. This note is part of the permanent Strategy Factory operating model and applies to research, tester, paper, shadow, micro-live, and live-compatible execution modes.
