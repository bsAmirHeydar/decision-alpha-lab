...
Lists pre-run, runtime, incident, recovery, and post-run verification steps. This note is part of the permanent Strategy Factory operating model and applies to research, tester, paper, shadow, micro-live, and live-compatible execution modes.
