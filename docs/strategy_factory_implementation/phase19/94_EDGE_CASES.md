...
Documents sparse windows, zero variance, empty histograms, clock rollback, duplicate events, and overflow. This note is part of the permanent Strategy Factory operating model and applies to research, tester, paper, shadow, micro-live, and live-compatible execution modes.
