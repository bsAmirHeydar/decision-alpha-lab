...
Suppresses duplicate notifications while preserving the canonical active-alert state. This note is part of the permanent Strategy Factory operating model and applies to research, tester, paper, shadow, micro-live, and live-compatible execution modes.
