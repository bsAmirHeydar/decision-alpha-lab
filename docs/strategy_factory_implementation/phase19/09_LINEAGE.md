# Run Generation Strategy Model Lineage
...
Carries run, generation, strategy, model, correlation, and causation identities through every observation. This note is part of the permanent Strategy Factory operating model and applies to research, tester, paper, shadow, micro-live, and live-compatible execution modes.
