...
Sizes buffers and windows against worst-case tick bursts, multi-symbol fan-out, and report intervals. This note is part of the permanent Strategy Factory operating model and applies to research, tester, paper, shadow, micro-live, and live-compatible execution modes.
