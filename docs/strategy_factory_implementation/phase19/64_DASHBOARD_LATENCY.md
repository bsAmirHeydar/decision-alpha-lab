...
Shows sample counts, bucket occupancy, P50, P95, P99, overflow, and SLO status per stage. This note is part of the permanent Strategy Factory operating model and applies to research, tester, paper, shadow, micro-live, and live-compatible execution modes.
