...
Tracks output-score and calibrated-probability distributions without assuming that drift proves loss of edge. This note is part of the permanent Strategy Factory operating model and applies to research, tester, paper, shadow, micro-live, and live-compatible execution modes.
