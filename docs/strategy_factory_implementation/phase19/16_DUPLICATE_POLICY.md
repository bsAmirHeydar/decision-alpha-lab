...
Rejects duplicate event IDs and records duplicate counts as an operational quality signal. This note is part of the permanent Strategy Factory operating model and applies to research, tester, paper, shadow, micro-live, and live-compatible execution modes.
