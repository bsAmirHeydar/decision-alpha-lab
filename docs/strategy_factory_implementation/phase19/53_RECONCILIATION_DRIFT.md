...
Escalates missing transactions and unresolved order, deal, or position mismatches. This note is part of the permanent Strategy Factory operating model and applies to research, tester, paper, shadow, micro-live, and live-compatible execution modes.
