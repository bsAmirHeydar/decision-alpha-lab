...
Provides stable and shifted distributions, latency sequences, alert transitions, and failure injections. This note is part of the permanent Strategy Factory operating model and applies to research, tester, paper, shadow, micro-live, and live-compatible execution modes.
