...
Shows baseline identity, window identity, PSI, JS divergence, z shift, missingness, severity, and sample sufficiency. This note is part of the permanent Strategy Factory operating model and applies to research, tester, paper, shadow, micro-live, and live-compatible execution modes.
