...
Prevents accidental comparison of points, cash, ratios, milliseconds, microseconds, and counts. This note is part of the permanent Strategy Factory operating model and applies to research, tester, paper, shadow, micro-live, and live-compatible execution modes.
