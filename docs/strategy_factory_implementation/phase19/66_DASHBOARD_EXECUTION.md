...
Shows order, fill, reject, mismatch, slippage, latency, and reconciliation evidence. This note is part of the permanent Strategy Factory operating model and applies to research, tester, paper, shadow, micro-live, and live-compatible execution modes.
