...
Versions thresholds, comparison direction, consecutive breach and recovery counts, cooldown, and reminder intervals. This note is part of the permanent Strategy Factory operating model and applies to research, tester, paper, shadow, micro-live, and live-compatible execution modes.
