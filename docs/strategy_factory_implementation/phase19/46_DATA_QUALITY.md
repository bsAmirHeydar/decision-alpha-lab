...
Detects stale quotes, gaps, non-finite values, schema mismatches, and time-order violations. This note is part of the permanent Strategy Factory operating model and applies to research, tester, paper, shadow, micro-live, and live-compatible execution modes.
