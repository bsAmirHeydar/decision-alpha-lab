...
Adds symmetric bounded distribution comparison as an independent drift diagnostic. This note is part of the permanent Strategy Factory operating model and applies to research, tester, paper, shadow, micro-live, and live-compatible execution modes.
