...
Freezes bin edges from the baseline and forbids online rebucketing that would hide distribution movement. This note is part of the permanent Strategy Factory operating model and applies to research, tester, paper, shadow, micro-live, and live-compatible execution modes.
