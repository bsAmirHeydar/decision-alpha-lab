...
Uses P99 to detect rare stalls, terminal load spikes, and broker-path outliers. This note is part of the permanent Strategy Factory operating model and applies to research, tester, paper, shadow, micro-live, and live-compatible execution modes.
