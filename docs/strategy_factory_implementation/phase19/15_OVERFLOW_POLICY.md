...
Documents drop-oldest versus reject-new behavior and the health degradation that follows any loss of evidence. This note is part of the permanent Strategy Factory operating model and applies to research, tester, paper, shadow, micro-live, and live-compatible execution modes.
