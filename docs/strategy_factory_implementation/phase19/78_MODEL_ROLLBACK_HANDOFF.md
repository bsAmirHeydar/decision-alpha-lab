...
Explains how a rollback recommendation is evaluated against immutable model registry evidence. This note is part of the permanent Strategy Factory operating model and applies to research, tester, paper, shadow, micro-live, and live-compatible execution modes.
