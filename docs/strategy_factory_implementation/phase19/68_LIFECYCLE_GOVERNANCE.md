...
Turns evidence into advisory actions while preserving Phase 14 registry and Phase 18 safety authority boundaries. This note is part of the permanent Strategy Factory operating model and applies to research, tester, paper, shadow, micro-live, and live-compatible execution modes.
