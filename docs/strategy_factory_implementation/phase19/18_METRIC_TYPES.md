...
Distinguishes counters, gauges, histograms, and state metrics and defines legal aggregation for each. This note is part of the permanent Strategy Factory operating model and applies to research, tester, paper, shadow, micro-live, and live-compatible execution modes.
