...
Binds every drift result to a model, feature schema, preprocessing version, training window, and bin specification. This note is part of the permanent Strategy Factory operating model and applies to research, tester, paper, shadow, micro-live, and live-compatible execution modes.
