...
Separates monitoring authority from broker authority, model promotion authority, and strategy semantics. This note is part of the permanent Strategy Factory operating model and applies to research, tester, paper, shadow, micro-live, and live-compatible execution modes.
