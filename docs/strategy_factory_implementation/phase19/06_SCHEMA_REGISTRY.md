...
Requires startup-known schemas and rejects unknown or version-mismatched telemetry fail-closed. This note is part of the permanent Strategy Factory operating model and applies to research, tester, paper, shadow, micro-live, and live-compatible execution modes.
