...
Defines when reduced activity may be appropriate but prohibits Phase 19 from applying it automatically. This note is part of the permanent Strategy Factory operating model and applies to research, tester, paper, shadow, micro-live, and live-compatible execution modes.
