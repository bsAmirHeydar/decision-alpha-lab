...
Forbids direct model swaps, broker actions, kill-switch changes, and registry writes from monitoring code. This note is part of the permanent Strategy Factory operating model and applies to research, tester, paper, shadow, micro-live, and live-compatible execution modes.
