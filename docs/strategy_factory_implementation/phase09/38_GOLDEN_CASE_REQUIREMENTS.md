---
title: "Golden Case Requirements"
phase: 09
status: canonical
---
# Golden Case Requirements

Every real bug becomes a replay fixture containing candidate, observations, expected path, expected outcome and doctrine. Golden cases must be fidelity-specific and immutable.
