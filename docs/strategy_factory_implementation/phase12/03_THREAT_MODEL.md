---
title: "Overfit Threat Model"
phase: 12
status: canonical
tags: [strategy-factory, anti-overfit, validation, phase12]
---
# Overfit Threat Model

## Purpose

Catalogues temporal leakage, selection bias, multiple trials, correlated samples, parameter islands, best-trade dependence and cost fragility.
