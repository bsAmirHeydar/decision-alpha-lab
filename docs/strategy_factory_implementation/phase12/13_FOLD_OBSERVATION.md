---
title: "Fold Observation Contract"
phase: 12
status: canonical
tags: [strategy-factory, anti-overfit, validation, phase12]
---
# Fold Observation Contract

## Purpose

Carries immutable event, cluster, outcome, trial and parameter identities with causal known and resolved timestamps.
