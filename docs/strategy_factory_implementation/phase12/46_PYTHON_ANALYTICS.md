---
title: "Python Analytics Responsibilities"
phase: 12
status: canonical
...
Performs higher-order corrections, PBO, reality checks, surface diagnostics and report assembly from canonical exports.
