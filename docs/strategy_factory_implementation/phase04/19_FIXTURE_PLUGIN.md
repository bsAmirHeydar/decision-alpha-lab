---
title: "Fixture Pulse Anatomy"
phase: 04
status: canonical
---

# Fixture Pulse Anatomy

## Objective

Prove the framework with a synthetic deterministic anatomy before legacy migration.

## Canonical decision

The fixture uses only shared services and emits reproducible events suitable for self-test and replay.
