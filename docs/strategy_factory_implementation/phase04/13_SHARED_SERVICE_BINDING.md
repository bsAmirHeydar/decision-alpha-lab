...
Bind plugins only to shared clock, market-data and symbol-spec ports.

## Canonical decision

No direct CopyRates, SymbolInfo or broker-time logic is permitted inside anatomy plugins.
