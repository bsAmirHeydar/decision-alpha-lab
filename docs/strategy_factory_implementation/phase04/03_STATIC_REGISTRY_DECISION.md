---
title: "Static Registry Decision"
phase: 04
status: canonical
---

# Static Registry Decision

## Objective

Remove runtime file discovery and dynamic loading from the MQL5 fast path.

## Canonical decision

Factories are registered in source, selected by exact ID and version, validated at startup and frozen for the runtime generation.
