---
title: "Multi-Symbol and Multi-Timeframe Declaration"
phase: 04
status: canonical
---

# Multi-Symbol and Multi-Timeframe Declaration

## Objective

Make synchronized dependencies explicit before execution.

## Canonical decision

Each series has timeframe, lookback, staleness, skew and synchronization-group metadata.
