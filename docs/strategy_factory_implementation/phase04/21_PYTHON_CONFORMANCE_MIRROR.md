...
# Python Conformance Mirror

## Objective

Mirror plugin metadata and startup rules for CI and offline research.

## Canonical decision

Python cannot become the live plugin registry or reinterpret anatomy semantics.
