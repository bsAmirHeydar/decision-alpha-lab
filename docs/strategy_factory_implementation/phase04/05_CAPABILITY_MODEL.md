...
Represent runtime abilities as explicit capability bits rather than inferred behavior.

## Canonical decision

A plugin cannot claim fast-path or replay safety without determinism and matching tests.
