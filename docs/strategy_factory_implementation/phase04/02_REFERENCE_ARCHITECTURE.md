...
Define the full MQL5-first path from shared market services into a bounded anatomy plugin and canonical event queue.

## Canonical decision

The host composes ports; plugins own anatomy; the runtime owns sequencing; Python mirrors and audits.
