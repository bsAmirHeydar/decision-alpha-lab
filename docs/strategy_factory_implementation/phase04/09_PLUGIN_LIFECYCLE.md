...
Standardize Created, Bound, Initialized, Running, Stopped and Failed transitions.

## Canonical decision

No event emission is valid before successful binding, requirement validation and initialization.
