---
title: "Runtime Integration Sequence"
phase: 04
status: canonical
---
...
Registry build, exact selection, factory creation, binding, requirements, initialization, start, drain, stop and destroy occur in a fixed order.
