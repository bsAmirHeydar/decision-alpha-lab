...
Bind the plugin’s behavior to a deterministic configuration identity.

## Canonical decision

A configuration schema hash participates in descriptor identity and later runtime-generation hashing.
