...
Generate a compliant plugin shell without generating anatomy logic.

## Canonical decision

Scaffolding accelerates structure but cannot invent doctrine or known-time semantics.
