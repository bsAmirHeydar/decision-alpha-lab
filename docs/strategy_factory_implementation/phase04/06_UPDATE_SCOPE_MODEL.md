...
Declare whether a plugin consumes ticks, closed bars, timers, rebuilds or replay.

## Canonical decision

The host dispatches only declared callbacks; undeclared work is an architecture violation.
