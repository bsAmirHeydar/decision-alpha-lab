...
Require identical ordered inputs to produce identical canonical events.

## Canonical decision

Replay-safe plugins must have no wall-clock, random, file, network or mutable global dependency.
