---
title: "Event Queue API Reference"
phase: 04
status: canonical
---

# Event Queue API Reference

## Objective

Document push, pop, duplicate detection, overflow and reset behavior.

## Canonical decision

Queue policy is part of the plugin contract and run evidence.
