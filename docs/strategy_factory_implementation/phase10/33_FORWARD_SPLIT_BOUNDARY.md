---
title: "Forward Split Boundary"
phase: 10
status: canonical
tags: [strategy-factory, mql5, tester-research, phase10]
---
# Forward Split Boundary

Tester forward mode may be used as a supplementary split, but canonical purged walk-forward is implemented in later phases.
