---
title: "Input Parameter Identity"
phase: 10
status: canonical
tags: [strategy-factory, mql5, tester-research, phase10]
---
# Input Parameter Identity

Optimization inputs are canonicalized and hashed. A pass without an exact parameter hash is not reproducible and cannot be promoted.
