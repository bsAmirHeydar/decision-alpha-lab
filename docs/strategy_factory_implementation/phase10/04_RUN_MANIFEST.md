...
Every run freezes strategy version, generation, plugin set, candidate matrix, simulation policy, cost registry, tester data source, date range, fidelity and objective configuration.
