---
title: "Objective Failure Semantics"
phase: 10
status: canonical
...
Rejected passes receive a deterministic worst score and an explicit reason. Missing data is never converted into an attractive score.
