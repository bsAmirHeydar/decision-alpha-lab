---
title: "Research Metrics Accumulator"
phase: 10
status: canonical
tags: [strategy-factory, mql5, tester-research, phase10]
---
# Research Metrics Accumulator

Online bounded accumulation of fill rate, expectancy, dispersion, profit factor, drawdown, MFE, MAE, holding time, tail dependency and unique event counts.
