...
The canonical map for the Strategy Tester research harness, custom optimization objective, frame transport, selected-pass reruns, fidelity escalation, differential validation and reproducible research artifacts.
