---
title: "Tester Caching and Reuse"
phase: 10
status: canonical
tags: [strategy-factory, mql5, tester-research, phase10]
---
# Tester Caching and Reuse

Reuse is permitted only when code, data, manifest and input hashes match exactly. Stale tester cache is never treated as new evidence.
