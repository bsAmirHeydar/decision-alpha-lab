---
title: "Manifest Hashing and Reproducibility"
phase: 05
status: canonical
tags: [strategy-factory, mql5-first, runtime-generation, result-sink]
---

# Manifest Hashing and Reproducibility

## Purpose

Explains deterministic canonicalization and why every result must point to a materialized manifest.
