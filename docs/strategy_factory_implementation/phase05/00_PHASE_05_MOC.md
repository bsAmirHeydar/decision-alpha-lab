---
title: "Phase 05 — Runtime Generations and Result Sinks"
phase: 05
status: canonical
...
Central map for the immutable generation, run-manifest, result-envelope, artifact-lineage, activation and rollback layer.
