---
title: "Within-Day Time-Shift Null"
phase: 11
status: canonical
tags: [strategy-factory, statistics, matched-nulls, phase11]
---
# Within-Day Time-Shift Null

## Scope

This document specifies **Within-Day Time-Shift Null** as a reusable central-engine capability. Strategy-specific interpretations are plugins or declared grouping/null specifications; they are not embedded in the statistics kernel.
