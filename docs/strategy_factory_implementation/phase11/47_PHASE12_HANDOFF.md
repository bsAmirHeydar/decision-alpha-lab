---
title: "Phase 12 Handoff — Anti-Overfit Engine"
phase: 11
status: canonical
tags: [strategy-factory, statistics, matched-nulls, phase11]
---
# Phase 12 Handoff — Anti-Overfit Engine

## Handoff contract

Phase 12 receives:

- immutable statistical samples;
- versioned metric and group registries;
- cluster-aware confidence primitives;
- matched-null assignments and comparisons;
- deterministic report manifests and artifact indexes;
- an explicit trial ledger boundary from Phase 10 optimization discovery.

Phase 12 must add purged and embargoed folds, nested selection, multiple-testing correction, parameter-surface stability, White-style reality checks, deflated Sharpe-style diagnostics, probability of backtest overfitting, best-trade removal, cost and delay stress, and formal promotion rejection reasons.
