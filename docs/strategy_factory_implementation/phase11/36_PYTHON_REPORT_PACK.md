---
title: "Python Research and Reporting Pack"
phase: 11
status: canonical
tags: [strategy-factory, statistics, matched-nulls, phase11]
---
# Python Research and Reporting Pack

## Scope

This document specifies **Python Research and Reporting Pack** as a reusable central-engine capability. Strategy-specific interpretations are plugins or declared grouping/null specifications; they are not embedded in the statistics kernel.
