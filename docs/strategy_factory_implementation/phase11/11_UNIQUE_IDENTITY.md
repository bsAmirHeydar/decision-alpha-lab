---
title: "Event and Cluster Identity Semantics"
phase: 11
status: canonical
tags: [strategy-factory, statistics, matched-nulls, phase11]
---
# Event and Cluster Identity Semantics

## Scope

This document specifies **Event and Cluster Identity Semantics** as a reusable central-engine capability. Strategy-specific interpretations are plugins or declared grouping/null specifications; they are not embedded in the statistics kernel.
