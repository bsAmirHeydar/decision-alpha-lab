---
title: "Conditional Group Schema"
phase: 11
status: canonical
tags: [strategy-factory, statistics, matched-nulls, phase11]
---
# Conditional Group Schema

## Scope

This document specifies **Conditional Group Schema** as a reusable central-engine capability. Strategy-specific interpretations are plugins or declared grouping/null specifications; they are not embedded in the statistics kernel.
