---
title: "Match-Rate Quality Gate"
phase: 11
status: canonical
tags: [strategy-factory, statistics, matched-nulls, phase11]
---
# Match-Rate Quality Gate

## Scope

This document specifies **Match-Rate Quality Gate** as a reusable central-engine capability. Strategy-specific interpretations are plugins or declared grouping/null specifications; they are not embedded in the statistics kernel.
