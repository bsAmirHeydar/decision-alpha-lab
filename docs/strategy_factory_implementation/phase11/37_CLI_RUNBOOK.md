---
title: "Statistics CLI Runbook"
phase: 11
status: canonical
tags: [strategy-factory, statistics, matched-nulls, phase11]
---
# Statistics CLI Runbook

## Scope

This document specifies **Statistics CLI Runbook** as a reusable central-engine capability. Strategy-specific interpretations are plugins or declared grouping/null specifications; they are not embedded in the statistics kernel.
