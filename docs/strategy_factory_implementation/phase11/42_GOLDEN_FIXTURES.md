---
title: "Golden Statistical Fixtures"
phase: 11
status: canonical
tags: [strategy-factory, statistics, matched-nulls, phase11]
---
# Golden Statistical Fixtures

## Scope

This document specifies **Golden Statistical Fixtures** as a reusable central-engine capability. Strategy-specific interpretations are plugins or declared grouping/null specifications; they are not embedded in the statistics kernel.
