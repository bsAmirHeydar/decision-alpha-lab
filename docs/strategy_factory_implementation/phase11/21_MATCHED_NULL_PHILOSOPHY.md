---
title: "Matched Null Philosophy"
phase: 11
status: canonical
tags: [strategy-factory, statistics, matched-nulls, phase11]
---
# Matched Null Philosophy

## Scope

This document specifies **Matched Null Philosophy** as a reusable central-engine capability. Strategy-specific interpretations are plugins or declared grouping/null specifications; they are not embedded in the statistics kernel.
