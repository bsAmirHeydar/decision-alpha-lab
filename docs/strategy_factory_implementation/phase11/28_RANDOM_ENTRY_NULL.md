---
title: "Session-Matched Random-Entry Null"
phase: 11
status: canonical
tags: [strategy-factory, statistics, matched-nulls, phase11]
---
# Session-Matched Random-Entry Null

## Scope

This document specifies **Session-Matched Random-Entry Null** as a reusable central-engine capability. Strategy-specific interpretations are plugins or declared grouping/null specifications; they are not embedded in the statistics kernel.
