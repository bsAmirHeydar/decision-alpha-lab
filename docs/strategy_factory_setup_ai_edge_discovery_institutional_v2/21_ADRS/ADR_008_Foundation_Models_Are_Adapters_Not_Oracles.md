---
title: ADR 008 — Foundation Models Are Adapters, Not Oracles
status: canonical
version: 2.0.0
created: '2026-07-13'
updated: '2026-07-13'
...
SAED V2 deliberately evaluates frontier AI while preserving UCEE truth, evidence, risk and runtime authority. Without an architectural decision, research convenience can become de facto production authority.

# Decision

Foundation models may supply frozen embeddings, forecasts or bounded challenger heads, but they do not define context truth, economic utility, support, promotion or live decisions. Every intake requires provenance, security, fair baseline, contamination, calibration, export and fallback evidence.
