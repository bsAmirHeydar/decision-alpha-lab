---
title: SAED2-20 — Anti-Overfit Adversarial Qualification
status: canonical
version: 2.0.0
created: '2026-07-13'
updated: '2026-07-13'
...
Run nested selection, multiplicity, PBO/CSCV, DSR, Reality Check/SPA, nulls, stability, profile attacks, and transport.
...
Anti-overfit dossier; model-risk scorecard; failure map.
...
A signed phase-status record enumerates delivered files, open blockers, local-Windows requirements, risks, and the exact handoff to SAED2-21 or operations.
