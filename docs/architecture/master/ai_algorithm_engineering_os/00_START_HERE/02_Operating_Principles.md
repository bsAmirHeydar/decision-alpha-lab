...
> [!abstract] Purpose
> Define the governing principles of specification-first AI-assisted engineering.
...
Define the governing principles of specification-first AI-assisted engineering. The objective is not to maximize the amount of generated code. The objective is to reduce ambiguity, preserve domain truth, make changes reversible, and produce evidence that the implementation satisfies the approved intent.

### Core principles

- Treat **Operating Principles** as an explicit engineering contract, not an informal preference.
- Keep the behavior of humans, AI agents, code, and evidence traceable to project intent, domain rules, and measurable evidence.
...
- Domain definitions outrank model priors.
- Evidence outranks fluent explanation.
- Small reversible patches outrank broad rewrites.
- State integrity outranks visual plausibility.
- Knowledge capture is part of Done.

## 2. Required Procedure

1. Collect the minimum authoritative context required for the behavior of humans, AI agents, code, and evidence.
...
- A versioned record of the behavior of humans, AI agents, code, and evidence.
