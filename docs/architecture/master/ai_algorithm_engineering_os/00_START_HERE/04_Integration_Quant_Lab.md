...
docs/history/aieos_legacy/
tools/engineering/
```

The root `AGENTS.md` is the fast enforcement contract. `docs/standards/engineering` contains concise canonical project standards. The full modular vault contains detailed workflows, templates, prompts, examples, and governance.
