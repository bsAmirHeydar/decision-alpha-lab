---
id: AIEOS-80FD0DD048
title: "Timeframe and Symbol Changes"
type: guide
status: active
domain: mql5
version: 1.0.0
...
tags:
  ...
  - guide
---
# Timeframe and Symbol Changes

> [!abstract] Purpose
> Reconstruct or migrate state safely when chart context changes.
...
Reconstruct or migrate state safely when chart context changes. The objective is not to maximize the amount of generated code. The objective is to reduce ambiguity, preserve domain truth, make changes reversible, and produce evidence that the implementation satisfies the approved intent.

### Core principles

- Treat **Timeframe and Symbol Changes** as an explicit engineering contract, not an informal preference.
- Keep deinitialization reason, cache invalidation, history readiness, and cleanup traceable to project intent, domain rules, and measurable evidence.
...
- Do not assume history arrays are immediately complete after context change.

## 2. Required Procedure

1. Collect the minimum authoritative context required for deinitialization reason, cache invalidation, history readiness, and cleanup.
...
- A versioned record of deinitialization reason, cache invalidation, history readiness, and cleanup.
