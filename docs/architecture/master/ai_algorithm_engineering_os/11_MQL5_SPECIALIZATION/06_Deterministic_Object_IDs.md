---
id: AIEOS-E37D26E3BE
title: "Deterministic Object IDs"
type: guide
status: active
domain: mql5
version: 1.0.0
...
> [!abstract] Purpose
> Derive object names from immutable domain keys to prevent duplicates and stale collisions.
...
Derive object names from immutable domain keys to prevent duplicates and stale collisions. The objective is not to maximize the amount of generated code. The objective is to reduce ambiguity, preserve domain truth, make changes reversible, and produce evidence that the implementation satisfies the approved intent.

### Core principles

- Treat **Deterministic Object IDs** as an explicit engineering contract, not an informal preference.
- Keep namespace, symbol, timeframe, entity type, identity, and version traceable to project intent, domain rules, and measurable evidence.
...
- Display text and mutable price values do not belong in identity.

## 2. Required Procedure

1. Collect the minimum authoritative context required for namespace, symbol, timeframe, entity type, identity, and version.
...
- A versioned record of namespace, symbol, timeframe, entity type, identity, and version.
