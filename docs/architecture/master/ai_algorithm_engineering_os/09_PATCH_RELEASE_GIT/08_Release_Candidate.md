...
> [!abstract] Purpose
> Stabilize a candidate build under frozen scope before production.
...
Stabilize a candidate build under frozen scope before production. The objective is not to maximize the amount of generated code. The objective is to reduce ambiguity, preserve domain truth, make changes reversible, and produce evidence that the implementation satisfies the approved intent.

### Core principles

- Treat **Release Candidate** as an explicit engineering contract, not an informal preference.
- Keep versioned candidate, test freeze, issue triage, and promotion traceable to project intent, domain rules, and measurable evidence.
...
- Only blocker fixes enter an RC; new features return to the next version.

## 2. Required Procedure

1. Collect the minimum authoritative context required for versioned candidate, test freeze, issue triage, and promotion.
...
- A versioned record of versioned candidate, test freeze, issue triage, and promotion.
