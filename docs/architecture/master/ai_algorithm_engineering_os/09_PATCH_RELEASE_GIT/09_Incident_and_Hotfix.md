...
> [!abstract] Purpose
> Contain production defects through a fast but controlled emergency path.
...
Contain production defects through a fast but controlled emergency path. The objective is not to maximize the amount of generated code. The objective is to reduce ambiguity, preserve domain truth, make changes reversible, and produce evidence that the implementation satisfies the approved intent.

### Core principles

- Treat **Incident and Hotfix** as an explicit engineering contract, not an informal preference.
- Keep containment, minimal correction, verification, release, and retrospective traceable to project intent, domain rules, and measurable evidence.
...
- Urgency reduces scope, not evidence requirements for the affected path.

## 2. Required Procedure

1. Collect the minimum authoritative context required for containment, minimal correction, verification, release, and retrospective.
...
- A versioned record of containment, minimal correction, verification, release, and retrospective.
