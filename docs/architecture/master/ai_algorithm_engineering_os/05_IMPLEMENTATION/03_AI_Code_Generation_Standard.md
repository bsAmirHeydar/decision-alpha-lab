---
id: AIEOS-62FCA61D63
title: "AI Code Generation Standard"
type: guide
status: active
...
> [!abstract] Purpose
> Constrain AI-generated code to project conventions, contracts, and verifiable scope.
...
Constrain AI-generated code to project conventions, contracts, and verifiable scope. The objective is not to maximize the amount of generated code. The objective is to reduce ambiguity, preserve domain truth, make changes reversible, and produce evidence that the implementation satisfies the approved intent.

### Core principles

- Treat **AI Code Generation Standard** as an explicit engineering contract, not an informal preference.
- Keep input context, code quality, reporting, and prohibited shortcuts traceable to project intent, domain rules, and measurable evidence.
...
- Generated code is untrusted until compiled, tested, reviewed, and understood.

## 2. Required Procedure

1. Collect the minimum authoritative context required for input context, code quality, reporting, and prohibited shortcuts.
...
- A versioned record of input context, code quality, reporting, and prohibited shortcuts.
...
```text
Implement only the approved scope for ai code generation standard. First inspect the relevant files and contracts. State assumptions, files to modify, files not to modify, preserved invariants, risks, and verification commands. Produce the smallest safe patch; do not rewrite unrelated code.
```
