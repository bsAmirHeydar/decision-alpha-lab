...
> [!abstract] Purpose
> Define AI as a set of bounded engineering roles rather than a single omniscient coder.
...
Define AI as a set of bounded engineering roles rather than a single omniscient coder. The objective is not to maximize the amount of generated code. The objective is to reduce ambiguity, preserve domain truth, make changes reversible, and produce evidence that the implementation satisfies the approved intent.

### Core principles

- Treat **AI Role Model** as an explicit engineering contract, not an informal preference.
- Keep role separation, authority boundaries, and handoffs traceable to project intent, domain rules, and measurable evidence.
...
- Architect proposes structures; Builder implements approved scope; Reviewer attacks assumptions; Tester constructs evidence; Documenter persists decisions.

## 2. Required Procedure

1. Collect the minimum authoritative context required for role separation, authority boundaries, and handoffs.
...
- A versioned record of role separation, authority boundaries, and handoffs.
