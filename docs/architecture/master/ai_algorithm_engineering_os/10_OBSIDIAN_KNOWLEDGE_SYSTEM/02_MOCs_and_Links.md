---
id: AIEOS-848761A601
title: "Maps of Content and Links"
type: guide
status: active
...
tags:
  ...
  - guide
---
# Maps of Content and Links

> [!abstract] Purpose
> Create intentional navigation and dependency visibility through curated maps and semantic links.
...
Create intentional navigation and dependency visibility through curated maps and semantic links. The objective is not to maximize the amount of generated code. The objective is to reduce ambiguity, preserve domain truth, make changes reversible, and produce evidence that the implementation satisfies the approved intent.

### Core principles

- Treat **Maps of Content and Links** as an explicit engineering contract, not an informal preference.
- Keep MOCs, backlinks, related notes, and orphan control traceable to project intent, domain rules, and measurable evidence.
...
- A link should explain a useful relationship, not only increase graph density.

## 2. Required Procedure

1. Collect the minimum authoritative context required for MOCs, backlinks, related notes, and orphan control.
...
- A versioned record of MOCs, backlinks, related notes, and orphan control.
