...
tags:
  ...
  - guide
---
# Search, Tags, and Naming

> [!abstract] Purpose
> Make notes discoverable through predictable filenames, titles, aliases, tags, and vocabulary.
...
Make notes discoverable through predictable filenames, titles, aliases, tags, and vocabulary. The objective is not to maximize the amount of generated code. The objective is to reduce ambiguity, preserve domain truth, make changes reversible, and produce evidence that the implementation satisfies the approved intent.

### Core principles

- Treat **Search, Tags, and Naming** as an explicit engineering contract, not an informal preference.
- Keep retrieval for humans and AI agents traceable to project intent, domain rules, and measurable evidence.
...
- Use stable technical English filenames and clear human titles.

## 2. Required Procedure

1. Collect the minimum authoritative context required for retrieval for humans and AI agents.
...
- A versioned record of retrieval for humans and AI agents.
