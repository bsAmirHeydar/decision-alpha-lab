...
tags:
  ...
  - guide
---
# Atomic vs System Notes

> [!abstract] Purpose
> Balance small reusable concepts with complete operational playbooks.
...
Balance small reusable concepts with complete operational playbooks. The objective is not to maximize the amount of generated code. The objective is to reduce ambiguity, preserve domain truth, make changes reversible, and produce evidence that the implementation satisfies the approved intent.

### Core principles

- Treat **Atomic vs System Notes** as an explicit engineering contract, not an informal preference.
- Keep note granularity and composition traceable to project intent, domain rules, and measurable evidence.
...
- Split when a concept has independent lifecycle or reuse; keep together when sequence and context are essential.

## 2. Required Procedure

1. Collect the minimum authoritative context required for note granularity and composition.
...
- A versioned record of note granularity and composition.
