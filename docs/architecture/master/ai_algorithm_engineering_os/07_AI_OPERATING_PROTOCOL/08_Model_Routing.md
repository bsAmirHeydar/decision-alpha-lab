...
> [!abstract] Purpose
> Assign planning, coding, review, summarization, and repetitive work to appropriate model capabilities.
...
Assign planning, coding, review, summarization, and repetitive work to appropriate model capabilities. The objective is not to maximize the amount of generated code. The objective is to reduce ambiguity, preserve domain truth, make changes reversible, and produce evidence that the implementation satisfies the approved intent.

### Core principles

- Treat **Model Routing** as an explicit engineering contract, not an informal preference.
- Keep quality, latency, cost, and risk trade-offs traceable to project intent, domain rules, and measurable evidence.
...
- High-risk reasoning and code review deserve stronger models than mechanical formatting.

## 2. Required Procedure

1. Collect the minimum authoritative context required for quality, latency, cost, and risk trade-offs.
...
- A versioned record of quality, latency, cost, and risk trade-offs.
