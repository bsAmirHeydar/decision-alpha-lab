...
> [!abstract] Purpose
> Prevent AI from inventing APIs, files, domain rules, test results, or successful execution.
...
Prevent AI from inventing APIs, files, domain rules, test results, or successful execution. The objective is not to maximize the amount of generated code. The objective is to reduce ambiguity, preserve domain truth, make changes reversible, and produce evidence that the implementation satisfies the approved intent.

### Core principles

- Treat **Hallucination Control** as an explicit engineering contract, not an informal preference.
- Keep evidence requirements and uncertainty reporting traceable to project intent, domain rules, and measurable evidence.
...
- Require inspection or tool output before accepting repository-specific claims.

## 2. Required Procedure

1. Collect the minimum authoritative context required for evidence requirements and uncertainty reporting.
...
- A versioned record of evidence requirements and uncertainty reporting.
