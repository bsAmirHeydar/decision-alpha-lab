...
> [!abstract] Purpose
> Use independent critiques and reconciled decisions for high-risk work.
...
Use independent critiques and reconciled decisions for high-risk work. The objective is not to maximize the amount of generated code. The objective is to reduce ambiguity, preserve domain truth, make changes reversible, and produce evidence that the implementation satisfies the approved intent.

### Core principles

- Treat **Multi-Agent Review** as an explicit engineering contract, not an informal preference.
- Keep diverse review prompts, conflict resolution, and final authority traceable to project intent, domain rules, and measurable evidence.
...
- Multiple agents repeating the same context and prompt are not independent review.

## 2. Required Procedure

1. Collect the minimum authoritative context required for diverse review prompts, conflict resolution, and final authority.
...
- A versioned record of diverse review prompts, conflict resolution, and final authority.
