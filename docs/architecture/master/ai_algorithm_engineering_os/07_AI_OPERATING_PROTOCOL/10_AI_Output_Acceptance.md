...
> [!abstract] Purpose
> Define exactly when generated analysis, code, tests, or documentation may enter the project.
...
Define exactly when generated analysis, code, tests, or documentation may enter the project. The objective is not to maximize the amount of generated code. The objective is to reduce ambiguity, preserve domain truth, make changes reversible, and produce evidence that the implementation satisfies the approved intent.

### Core principles

- Treat **AI Output Acceptance** as an explicit engineering contract, not an informal preference.
- Keep human understanding, evidence, conventions, and gate results traceable to project intent, domain rules, and measurable evidence.
...
- Fluency and length are not acceptance criteria.

## 2. Required Procedure

1. Collect the minimum authoritative context required for human understanding, evidence, conventions, and gate results.
...
- A versioned record of human understanding, evidence, conventions, and gate results.
