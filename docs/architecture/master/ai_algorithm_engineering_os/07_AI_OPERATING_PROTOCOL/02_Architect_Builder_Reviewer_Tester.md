---
id: AIEOS-D4BF74E856
title: "Architect–Builder–Reviewer–Tester Protocol"
type: guide
status: active
domain: ai-protocol
version: 1.0.0
...
tags:
  ...
  - guide
---
# Architect–Builder–Reviewer–Tester Protocol

> [!abstract] Purpose
> Define handoffs and evidence between the four core engineering roles.
...
Define handoffs and evidence between the four core engineering roles. The objective is not to maximize the amount of generated code. The objective is to reduce ambiguity, preserve domain truth, make changes reversible, and produce evidence that the implementation satisfies the approved intent.

### Core principles

- Treat **Architect–Builder–Reviewer–Tester Protocol** as an explicit engineering contract, not an informal preference.
- Keep role-specific inputs, outputs, and stop conditions traceable to project intent, domain rules, and measurable evidence.
...
- Each role receives the approved artifacts, not the previous role’s unsupported confidence.

## 2. Required Procedure

1. Collect the minimum authoritative context required for role-specific inputs, outputs, and stop conditions.
...
- A versioned record of role-specific inputs, outputs, and stop conditions.
