...
2. `docs/standards/manifesto.md`, `docs/standards/principles.md`, and active domain doctrine.
3. This `AGENTS.md` and `docs/standards/engineering/ALPHA_LAB_ENGINEERING_HANDBOOK.md`.
...
Canonical handbook: `docs/standards/engineering/ALPHA_LAB_ENGINEERING_HANDBOOK.md`.
