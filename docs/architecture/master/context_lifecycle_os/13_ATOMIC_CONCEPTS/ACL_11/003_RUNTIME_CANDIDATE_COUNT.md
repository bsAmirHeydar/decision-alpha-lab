---
title: ACL-11 Atomic — Runtime Candidate Count
status: accepted-reference
version: 1.0.0
updated: 2026-07-18
tags: [acl-os, acl-11, atomic-concept]
---
# Runtime Candidate Count

## Definition

`Runtime Candidate Count` is an atomic ACL-11 concept used in runtime parity assessment and non-executable custody. Its identity and semantics are explicit, versioned and independently testable.
