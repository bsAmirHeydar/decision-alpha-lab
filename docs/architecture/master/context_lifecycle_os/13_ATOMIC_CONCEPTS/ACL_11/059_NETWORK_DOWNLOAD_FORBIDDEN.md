---
title: ACL-11 Atomic — Network Download Forbidden
status: accepted-reference
version: 1.0.0
updated: 2026-07-18
tags: [acl-os, acl-11, atomic-concept]
---
# Network Download Forbidden

## Definition

`Network Download Forbidden` is an atomic ACL-11 concept used in runtime parity assessment and non-executable custody. Its identity and semantics are explicit, versioned and independently testable.
