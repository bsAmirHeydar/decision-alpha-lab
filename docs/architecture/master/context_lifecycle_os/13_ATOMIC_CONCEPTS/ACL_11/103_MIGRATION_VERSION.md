---
title: ACL-11 Atomic — Migration Version
...
`Migration Version` is an atomic ACL-11 concept used in runtime parity assessment and non-executable custody. Its identity and semantics are explicit, versioned and independently testable.
