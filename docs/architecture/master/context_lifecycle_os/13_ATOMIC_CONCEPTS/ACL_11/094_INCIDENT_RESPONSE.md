---
title: ACL-11 Atomic — Incident Response
...
`Incident Response` is an atomic ACL-11 concept used in runtime parity assessment and non-executable custody. Its identity and semantics are explicit, versioned and independently testable.
