---
title: ACL-04 Baseline Diagnostic Oracle
status: accepted-reference
version: 1.0.0
updated: 2026-07-18
tags: [acl-os, acl-04, atomic-concept]
---
# Baseline Diagnostic Oracle

## Definition

`ACL04_BASELINE_DIAGNOSTIC_ORACLE` is the ACL-04 atomic concept for baseline diagnostic oracle. It is intentionally narrow so schemas, code, policies, tests, reason codes and operator documentation use one meaning.
