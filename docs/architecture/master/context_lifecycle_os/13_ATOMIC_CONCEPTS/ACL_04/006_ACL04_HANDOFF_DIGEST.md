...
`ACL04_HANDOFF_DIGEST` is the ACL-04 atomic concept for handoff digest. It is intentionally narrow so schemas, code, policies, tests, reason codes and operator documentation use one meaning.
