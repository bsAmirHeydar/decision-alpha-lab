...
`ACL04_GENERATION_SEED` is the ACL-04 atomic concept for generation seed. It is intentionally narrow so schemas, code, policies, tests, reason codes and operator documentation use one meaning.
