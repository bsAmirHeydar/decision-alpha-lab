...
`ACL04_BEHAVIOR_DIGEST` is the ACL-04 atomic concept for behavior digest. It is intentionally narrow so schemas, code, policies, tests, reason codes and operator documentation use one meaning.
