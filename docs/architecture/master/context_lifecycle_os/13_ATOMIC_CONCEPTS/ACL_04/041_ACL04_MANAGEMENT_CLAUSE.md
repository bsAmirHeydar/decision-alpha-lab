---
title: ACL-04 Management Clause
...
`ACL04_MANAGEMENT_CLAUSE` is the ACL-04 atomic concept for management clause. It is intentionally narrow so schemas, code, policies, tests, reason codes and operator documentation use one meaning.
