...
`ACL04_REFERENCE_REPLAY` is the ACL-04 atomic concept for reference replay. It is intentionally narrow so schemas, code, policies, tests, reason codes and operator documentation use one meaning.
