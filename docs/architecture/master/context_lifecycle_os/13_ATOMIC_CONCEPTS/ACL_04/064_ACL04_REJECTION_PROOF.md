...
`ACL04_REJECTION_PROOF` is the ACL-04 atomic concept for rejection proof. It is intentionally narrow so schemas, code, policies, tests, reason codes and operator documentation use one meaning.
