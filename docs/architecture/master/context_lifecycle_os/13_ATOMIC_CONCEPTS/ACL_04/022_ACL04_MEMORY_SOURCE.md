...
`ACL04_MEMORY_SOURCE` is the ACL-04 atomic concept for memory source. It is intentionally narrow so schemas, code, policies, tests, reason codes and operator documentation use one meaning.
