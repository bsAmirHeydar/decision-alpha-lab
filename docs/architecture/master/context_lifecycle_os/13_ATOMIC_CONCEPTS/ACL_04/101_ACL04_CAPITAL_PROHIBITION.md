---
title: ACL-04 Capital Prohibition
...
`ACL04_CAPITAL_PROHIBITION` is the ACL-04 atomic concept for capital prohibition. It is intentionally narrow so schemas, code, policies, tests, reason codes and operator documentation use one meaning.
