...
`ACL04_RISK_CONTRACT` is the ACL-04 atomic concept for risk contract. It is intentionally narrow so schemas, code, policies, tests, reason codes and operator documentation use one meaning.
