...
`ACL04_KNOWN_TIME_CLASS` is the ACL-04 atomic concept for known time class. It is intentionally narrow so schemas, code, policies, tests, reason codes and operator documentation use one meaning.
