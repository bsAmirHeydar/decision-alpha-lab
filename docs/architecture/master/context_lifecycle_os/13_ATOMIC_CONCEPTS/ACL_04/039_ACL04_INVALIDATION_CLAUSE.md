---
title: ACL-04 Invalidation Clause
...
`ACL04_INVALIDATION_CLAUSE` is the ACL-04 atomic concept for invalidation clause. It is intentionally narrow so schemas, code, policies, tests, reason codes and operator documentation use one meaning.
