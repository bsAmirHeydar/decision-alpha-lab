...
`ACL04_CANDIDATE_BUDGET` is the ACL-04 atomic concept for candidate budget. It is intentionally narrow so schemas, code, policies, tests, reason codes and operator documentation use one meaning.
