...
`ACL04_PHASE_ID` is the ACL-04 atomic concept for phase id. It is intentionally narrow so schemas, code, policies, tests, reason codes and operator documentation use one meaning.
