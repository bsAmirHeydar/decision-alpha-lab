---
title: ACL-04 Compatibility Range
...
`ACL04_COMPATIBILITY_RANGE` is the ACL-04 atomic concept for compatibility range. It is intentionally narrow so schemas, code, policies, tests, reason codes and operator documentation use one meaning.
