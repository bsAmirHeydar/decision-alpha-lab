...
`ACL04_CANDIDATE_DIGEST` is the ACL-04 atomic concept for candidate digest. It is intentionally narrow so schemas, code, policies, tests, reason codes and operator documentation use one meaning.
