...
`ACL04_REASON_CODE` is the ACL-04 atomic concept for reason code. It is intentionally narrow so schemas, code, policies, tests, reason codes and operator documentation use one meaning.
