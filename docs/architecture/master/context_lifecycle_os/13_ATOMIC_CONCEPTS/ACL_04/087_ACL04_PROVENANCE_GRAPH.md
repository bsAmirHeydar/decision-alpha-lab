...
`ACL04_PROVENANCE_GRAPH` is the ACL-04 atomic concept for provenance graph. It is intentionally narrow so schemas, code, policies, tests, reason codes and operator documentation use one meaning.
