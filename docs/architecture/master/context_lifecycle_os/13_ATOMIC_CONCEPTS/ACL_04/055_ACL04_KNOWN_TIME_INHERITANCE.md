---
title: ACL-04 Known Time Inheritance
status: accepted-reference
version: 1.0.0
updated: 2026-07-18
tags: [acl-os, acl-04, atomic-concept]
---
# Known Time Inheritance

## Definition

`ACL04_KNOWN_TIME_INHERITANCE` is the ACL-04 atomic concept for known time inheritance. It is intentionally narrow so schemas, code, policies, tests, reason codes and operator documentation use one meaning.
