---
title: ACL-04 Output Root Marker
...
`ACL04_OUTPUT_ROOT_MARKER` is the ACL-04 atomic concept for output root marker. It is intentionally narrow so schemas, code, policies, tests, reason codes and operator documentation use one meaning.
