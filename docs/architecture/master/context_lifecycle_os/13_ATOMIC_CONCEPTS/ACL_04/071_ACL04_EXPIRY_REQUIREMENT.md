---
title: ACL-04 Expiry Requirement
...
`ACL04_EXPIRY_REQUIREMENT` is the ACL-04 atomic concept for expiry requirement. It is intentionally narrow so schemas, code, policies, tests, reason codes and operator documentation use one meaning.
