...
`ACL04_ACTION_REGISTRY` is the ACL-04 atomic concept for action registry. It is intentionally narrow so schemas, code, policies, tests, reason codes and operator documentation use one meaning.
