---
title: ACL-04 Future Outcome Atom
...
`ACL04_FUTURE_OUTCOME_ATOM` is the ACL-04 atomic concept for future outcome atom. It is intentionally narrow so schemas, code, policies, tests, reason codes and operator documentation use one meaning.
