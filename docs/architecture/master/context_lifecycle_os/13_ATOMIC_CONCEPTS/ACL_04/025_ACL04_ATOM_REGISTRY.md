...
`ACL04_ATOM_REGISTRY` is the ACL-04 atomic concept for atom registry. It is intentionally narrow so schemas, code, policies, tests, reason codes and operator documentation use one meaning.
