---
title: ACL-04 Protective Reference
...
`ACL04_PROTECTIVE_REFERENCE` is the ACL-04 atomic concept for protective reference. It is intentionally narrow so schemas, code, policies, tests, reason codes and operator documentation use one meaning.
