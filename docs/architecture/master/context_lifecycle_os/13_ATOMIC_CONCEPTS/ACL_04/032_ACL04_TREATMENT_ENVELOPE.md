---
title: ACL-04 Treatment Envelope
...
`ACL04_TREATMENT_ENVELOPE` is the ACL-04 atomic concept for treatment envelope. It is intentionally narrow so schemas, code, policies, tests, reason codes and operator documentation use one meaning.
