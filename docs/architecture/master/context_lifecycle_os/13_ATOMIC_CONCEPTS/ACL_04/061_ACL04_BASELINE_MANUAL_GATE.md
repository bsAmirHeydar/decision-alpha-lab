---
title: ACL-04 Baseline Manual Gate
status: accepted-reference
version: 1.0.0
updated: 2026-07-18
tags: [acl-os, acl-04, atomic-concept]
---
# Baseline Manual Gate

## Definition

`ACL04_BASELINE_MANUAL_GATE` is the ACL-04 atomic concept for baseline manual gate. It is intentionally narrow so schemas, code, policies, tests, reason codes and operator documentation use one meaning.
