---
title: ACL-04 Abstention Clause
...
`ACL04_ABSTENTION_CLAUSE` is the ACL-04 atomic concept for abstention clause. It is intentionally narrow so schemas, code, policies, tests, reason codes and operator documentation use one meaning.
