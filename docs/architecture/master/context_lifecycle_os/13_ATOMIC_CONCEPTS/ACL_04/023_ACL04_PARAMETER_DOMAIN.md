...
`ACL04_PARAMETER_DOMAIN` is the ACL-04 atomic concept for parameter domain. It is intentionally narrow so schemas, code, policies, tests, reason codes and operator documentation use one meaning.
