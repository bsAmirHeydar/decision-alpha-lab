---
title: ACL-04 Secret Access Prohibition
status: accepted-reference
version: 1.0.0
updated: 2026-07-18
tags: [acl-os, acl-04, atomic-concept]
---
# Secret Access Prohibition

## Definition

`ACL04_SECRET_ACCESS_PROHIBITION` is the ACL-04 atomic concept for secret access prohibition. It is intentionally narrow so schemas, code, policies, tests, reason codes and operator documentation use one meaning.
