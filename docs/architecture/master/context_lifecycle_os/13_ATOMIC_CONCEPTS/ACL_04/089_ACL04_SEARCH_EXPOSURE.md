...
`ACL04_SEARCH_EXPOSURE` is the ACL-04 atomic concept for search exposure. It is intentionally narrow so schemas, code, policies, tests, reason codes and operator documentation use one meaning.
