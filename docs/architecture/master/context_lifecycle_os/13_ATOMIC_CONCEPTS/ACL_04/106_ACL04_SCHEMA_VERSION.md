...
`ACL04_SCHEMA_VERSION` is the ACL-04 atomic concept for schema version. It is intentionally narrow so schemas, code, policies, tests, reason codes and operator documentation use one meaning.
