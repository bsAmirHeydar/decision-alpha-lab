...
`ACL04_EXPOSURE_LEDGER` is the ACL-04 atomic concept for exposure ledger. It is intentionally narrow so schemas, code, policies, tests, reason codes and operator documentation use one meaning.
