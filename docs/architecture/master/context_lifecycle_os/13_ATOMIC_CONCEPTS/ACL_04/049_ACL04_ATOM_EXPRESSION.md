...
`ACL04_ATOM_EXPRESSION` is the ACL-04 atomic concept for atom expression. It is intentionally narrow so schemas, code, policies, tests, reason codes and operator documentation use one meaning.
