---
title: ACL-04 Machine Authority
...
`ACL04_MACHINE_AUTHORITY` is the ACL-04 atomic concept for machine authority. It is intentionally narrow so schemas, code, policies, tests, reason codes and operator documentation use one meaning.
