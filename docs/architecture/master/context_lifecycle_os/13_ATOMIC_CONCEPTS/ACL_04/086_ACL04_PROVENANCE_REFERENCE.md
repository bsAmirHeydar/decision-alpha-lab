---
title: ACL-04 Provenance Reference
...
`ACL04_PROVENANCE_REFERENCE` is the ACL-04 atomic concept for provenance reference. It is intentionally narrow so schemas, code, policies, tests, reason codes and operator documentation use one meaning.
