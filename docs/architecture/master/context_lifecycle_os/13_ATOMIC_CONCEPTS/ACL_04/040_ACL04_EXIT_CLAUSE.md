...
`ACL04_EXIT_CLAUSE` is the ACL-04 atomic concept for exit clause. It is intentionally narrow so schemas, code, policies, tests, reason codes and operator documentation use one meaning.
