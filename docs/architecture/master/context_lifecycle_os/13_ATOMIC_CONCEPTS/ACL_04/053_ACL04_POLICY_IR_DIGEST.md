...
`ACL04_POLICY_IR_DIGEST` is the ACL-04 atomic concept for policy ir digest. It is intentionally narrow so schemas, code, policies, tests, reason codes and operator documentation use one meaning.
