---
title: ACL-04 Canonical Representative
...
`ACL04_CANONICAL_REPRESENTATIVE` is the ACL-04 atomic concept for canonical representative. It is intentionally narrow so schemas, code, policies, tests, reason codes and operator documentation use one meaning.
