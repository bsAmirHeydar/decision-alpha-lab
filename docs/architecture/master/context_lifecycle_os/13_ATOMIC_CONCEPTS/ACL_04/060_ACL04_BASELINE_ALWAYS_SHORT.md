---
title: ACL-04 Baseline Always Short
...
`ACL04_BASELINE_ALWAYS_SHORT` is the ACL-04 atomic concept for baseline always short. It is intentionally narrow so schemas, code, policies, tests, reason codes and operator documentation use one meaning.
