...
`ACL04_BOOLEAN_NOT` is the ACL-04 atomic concept for boolean not. It is intentionally narrow so schemas, code, policies, tests, reason codes and operator documentation use one meaning.
