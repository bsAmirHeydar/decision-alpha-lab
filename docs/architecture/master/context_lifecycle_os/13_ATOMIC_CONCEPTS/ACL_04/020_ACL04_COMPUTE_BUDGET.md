...
`ACL04_COMPUTE_BUDGET` is the ACL-04 atomic concept for compute budget. It is intentionally narrow so schemas, code, policies, tests, reason codes and operator documentation use one meaning.
