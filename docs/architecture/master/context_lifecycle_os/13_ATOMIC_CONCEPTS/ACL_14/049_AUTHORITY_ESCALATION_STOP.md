---
title: ACL-14 Atomic Concept 049 — Authority Escalation Stop
...
`AUTHORITY_ESCALATION_STOP` is an atomic contract concept in ACL-14. It is represented explicitly in schemas, policies, reason codes, tests or immutable evidence artifacts.
