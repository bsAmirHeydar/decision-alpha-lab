---
title: ACL-14 Atomic Concept 113 — No Capital Authority
...
`NO_CAPITAL_AUTHORITY` is an atomic contract concept in ACL-14. It is represented explicitly in schemas, policies, reason codes, tests or immutable evidence artifacts.
