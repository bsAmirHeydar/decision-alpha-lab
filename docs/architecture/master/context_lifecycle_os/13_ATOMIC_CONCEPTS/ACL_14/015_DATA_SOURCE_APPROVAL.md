---
title: ACL-14 Atomic Concept 015 — Data Source Approval
...
`DATA_SOURCE_APPROVAL` is an atomic contract concept in ACL-14. It is represented explicitly in schemas, policies, reason codes, tests or immutable evidence artifacts.
