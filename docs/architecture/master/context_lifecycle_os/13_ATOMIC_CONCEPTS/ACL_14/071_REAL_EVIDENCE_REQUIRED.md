---
title: ACL-14 Atomic Concept 071 — Real Evidence Required
...
`REAL_EVIDENCE_REQUIRED` is an atomic contract concept in ACL-14. It is represented explicitly in schemas, policies, reason codes, tests or immutable evidence artifacts.
