---
title: ACL-14 Atomic Concept 025 — Late Correction Versioning
status: accepted-reference
version: 1.0.0
updated: 2026-07-18
tags: [acl-os, acl-14, atomic-concept]
---
# Late Correction Versioning

## Definition

`LATE_CORRECTION_VERSIONING` is an atomic contract concept in ACL-14. It is represented explicitly in schemas, policies, reason codes, tests or immutable evidence artifacts.
