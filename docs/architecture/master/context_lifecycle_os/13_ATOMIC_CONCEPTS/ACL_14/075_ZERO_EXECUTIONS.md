---
title: ACL-14 Atomic Concept 075 — Zero Executions
...
`ZERO_EXECUTIONS` is an atomic contract concept in ACL-14. It is represented explicitly in schemas, policies, reason codes, tests or immutable evidence artifacts.
