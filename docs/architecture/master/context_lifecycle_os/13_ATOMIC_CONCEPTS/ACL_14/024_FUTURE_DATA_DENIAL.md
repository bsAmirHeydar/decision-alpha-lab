---
title: ACL-14 Atomic Concept 024 — Future Data Denial
...
`FUTURE_DATA_DENIAL` is an atomic contract concept in ACL-14. It is represented explicitly in schemas, policies, reason codes, tests or immutable evidence artifacts.
