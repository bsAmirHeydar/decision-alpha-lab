---
title: ACL-14 Atomic Concept 101 — Mql5 Static Contract
...
`MQL5_STATIC_CONTRACT` is an atomic contract concept in ACL-14. It is represented explicitly in schemas, policies, reason codes, tests or immutable evidence artifacts.
