---
title: ACL-14 Atomic Concept 029 — Prospective No Send Mode
status: accepted-reference
version: 1.0.0
updated: 2026-07-18
tags: [acl-os, acl-14, atomic-concept]
---
# Prospective No Send Mode

## Definition

`PROSPECTIVE_NO_SEND_MODE` is an atomic contract concept in ACL-14. It is represented explicitly in schemas, policies, reason codes, tests or immutable evidence artifacts.
