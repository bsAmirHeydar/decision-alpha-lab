---
title: ACL-14 Atomic Concept 077 — Prospective Evidence Boundary
...
`PROSPECTIVE_EVIDENCE_BOUNDARY` is an atomic contract concept in ACL-14. It is represented explicitly in schemas, policies, reason codes, tests or immutable evidence artifacts.
