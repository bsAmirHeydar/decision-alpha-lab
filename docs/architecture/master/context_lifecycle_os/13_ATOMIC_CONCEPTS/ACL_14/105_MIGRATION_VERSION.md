---
title: ACL-14 Atomic Concept 105 — Migration Version
...
`MIGRATION_VERSION` is an atomic contract concept in ACL-14. It is represented explicitly in schemas, policies, reason codes, tests or immutable evidence artifacts.
