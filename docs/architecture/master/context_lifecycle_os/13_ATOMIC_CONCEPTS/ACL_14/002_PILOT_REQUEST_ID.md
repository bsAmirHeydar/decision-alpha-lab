---
title: ACL-14 Atomic Concept 002 — Pilot Request Id
...
`PILOT_REQUEST_ID` is an atomic contract concept in ACL-14. It is represented explicitly in schemas, policies, reason codes, tests or immutable evidence artifacts.
