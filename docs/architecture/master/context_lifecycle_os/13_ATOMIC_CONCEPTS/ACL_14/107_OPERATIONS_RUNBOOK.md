---
title: ACL-14 Atomic Concept 107 — Operations Runbook
...
`OPERATIONS_RUNBOOK` is an atomic contract concept in ACL-14. It is represented explicitly in schemas, policies, reason codes, tests or immutable evidence artifacts.
