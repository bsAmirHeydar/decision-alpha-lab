---
title: ACL-14 Atomic Concept 083 — Machine Report
...
`MACHINE_REPORT` is an atomic contract concept in ACL-14. It is represented explicitly in schemas, policies, reason codes, tests or immutable evidence artifacts.
