---
title: ACL-14 Atomic Concept 055 — Runtime Activation Denial
...
`RUNTIME_ACTIVATION_DENIAL` is an atomic contract concept in ACL-14. It is represented explicitly in schemas, policies, reason codes, tests or immutable evidence artifacts.
