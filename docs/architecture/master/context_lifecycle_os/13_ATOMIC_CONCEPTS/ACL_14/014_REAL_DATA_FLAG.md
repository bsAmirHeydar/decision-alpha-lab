---
title: ACL-14 Atomic Concept 014 — Real Data Flag
...
`REAL_DATA_FLAG` is an atomic contract concept in ACL-14. It is represented explicitly in schemas, policies, reason codes, tests or immutable evidence artifacts.
