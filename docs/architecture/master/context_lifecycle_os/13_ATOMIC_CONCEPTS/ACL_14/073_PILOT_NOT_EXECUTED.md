---
title: ACL-14 Atomic Concept 073 — Pilot Not Executed
...
`PILOT_NOT_EXECUTED` is an atomic contract concept in ACL-14. It is represented explicitly in schemas, policies, reason codes, tests or immutable evidence artifacts.
