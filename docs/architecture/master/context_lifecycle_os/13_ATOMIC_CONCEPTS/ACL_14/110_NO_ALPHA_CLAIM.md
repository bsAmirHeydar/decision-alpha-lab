---
title: ACL-14 Atomic Concept 110 — No Alpha Claim
...
`NO_ALPHA_CLAIM` is an atomic contract concept in ACL-14. It is represented explicitly in schemas, policies, reason codes, tests or immutable evidence artifacts.
