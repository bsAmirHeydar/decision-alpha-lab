---
title: ACL-14 Atomic Concept 012 — Data Source Id
...
`DATA_SOURCE_ID` is an atomic contract concept in ACL-14. It is represented explicitly in schemas, policies, reason codes, tests or immutable evidence artifacts.
