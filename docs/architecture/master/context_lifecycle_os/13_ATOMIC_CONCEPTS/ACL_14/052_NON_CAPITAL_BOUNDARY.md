---
title: ACL-14 Atomic Concept 052 — Non Capital Boundary
...
`NON_CAPITAL_BOUNDARY` is an atomic contract concept in ACL-14. It is represented explicitly in schemas, policies, reason codes, tests or immutable evidence artifacts.
