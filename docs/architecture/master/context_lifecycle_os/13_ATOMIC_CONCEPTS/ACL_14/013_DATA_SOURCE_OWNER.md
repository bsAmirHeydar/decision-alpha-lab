---
title: ACL-14 Atomic Concept 013 — Data Source Owner
...
`DATA_SOURCE_OWNER` is an atomic contract concept in ACL-14. It is represented explicitly in schemas, policies, reason codes, tests or immutable evidence artifacts.
