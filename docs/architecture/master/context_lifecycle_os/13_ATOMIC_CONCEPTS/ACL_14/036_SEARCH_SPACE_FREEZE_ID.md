---
title: ACL-14 Atomic Concept 036 — Search Space Freeze Id
status: accepted-reference
version: 1.0.0
updated: 2026-07-18
tags: [acl-os, acl-14, atomic-concept]
---
# Search Space Freeze Id

## Definition

`SEARCH_SPACE_FREEZE_ID` is an atomic contract concept in ACL-14. It is represented explicitly in schemas, policies, reason codes, tests or immutable evidence artifacts.
