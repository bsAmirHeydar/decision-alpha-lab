---
title: ACL-14 Atomic Concept 043 — Minimum Distinct Days
status: accepted-reference
version: 1.0.0
updated: 2026-07-18
tags: [acl-os, acl-14, atomic-concept]
---
# Minimum Distinct Days

## Definition

`MINIMUM_DISTINCT_DAYS` is an atomic contract concept in ACL-14. It is represented explicitly in schemas, policies, reason codes, tests or immutable evidence artifacts.
