---
title: ACL-14 Atomic Concept 095 — Destination Conflict
...
`DESTINATION_CONFLICT` is an atomic contract concept in ACL-14. It is represented explicitly in schemas, policies, reason codes, tests or immutable evidence artifacts.
