---
title: ACL-14 Atomic Concept 006 — Synthetic Reuse Denial
status: accepted-reference
version: 1.0.0
updated: 2026-07-18
tags: [acl-os, acl-14, atomic-concept]
---
# Synthetic Reuse Denial

## Definition

`SYNTHETIC_REUSE_DENIAL` is an atomic contract concept in ACL-14. It is represented explicitly in schemas, policies, reason codes, tests or immutable evidence artifacts.
