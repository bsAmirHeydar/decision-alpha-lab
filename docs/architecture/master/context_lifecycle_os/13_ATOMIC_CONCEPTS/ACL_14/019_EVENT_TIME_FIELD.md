---
title: ACL-14 Atomic Concept 019 — Event Time Field
...
`EVENT_TIME_FIELD` is an atomic contract concept in ACL-14. It is represented explicitly in schemas, policies, reason codes, tests or immutable evidence artifacts.
