---
title: ACL-14 Atomic Concept 044 — Minimum State Support
...
`MINIMUM_STATE_SUPPORT` is an atomic contract concept in ACL-14. It is represented explicitly in schemas, policies, reason codes, tests or immutable evidence artifacts.
