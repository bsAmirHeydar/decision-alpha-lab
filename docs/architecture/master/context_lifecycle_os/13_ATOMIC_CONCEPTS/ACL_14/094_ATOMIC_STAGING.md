---
title: ACL-14 Atomic Concept 094 — Atomic Staging
...
`ATOMIC_STAGING` is an atomic contract concept in ACL-14. It is represented explicitly in schemas, policies, reason codes, tests or immutable evidence artifacts.
