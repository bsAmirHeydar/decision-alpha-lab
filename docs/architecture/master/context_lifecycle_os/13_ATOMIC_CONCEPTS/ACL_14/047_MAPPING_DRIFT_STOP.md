---
title: ACL-14 Atomic Concept 047 — Mapping Drift Stop
...
`MAPPING_DRIFT_STOP` is an atomic contract concept in ACL-14. It is represented explicitly in schemas, policies, reason codes, tests or immutable evidence artifacts.
