---
title: ACL-14 Atomic Concept 081 — Production Not Ready
...
`PRODUCTION_NOT_READY` is an atomic contract concept in ACL-14. It is represented explicitly in schemas, policies, reason codes, tests or immutable evidence artifacts.
