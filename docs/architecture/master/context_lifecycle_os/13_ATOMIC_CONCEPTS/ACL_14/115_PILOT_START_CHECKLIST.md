---
title: ACL-14 Atomic Concept 115 — Pilot Start Checklist
...
`PILOT_START_CHECKLIST` is an atomic contract concept in ACL-14. It is represented explicitly in schemas, policies, reason codes, tests or immutable evidence artifacts.
