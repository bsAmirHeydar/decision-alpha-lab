---
title: ACL-14 Atomic Concept 033 — Metric Registry
...
`METRIC_REGISTRY` is an atomic contract concept in ACL-14. It is represented explicitly in schemas, policies, reason codes, tests or immutable evidence artifacts.
