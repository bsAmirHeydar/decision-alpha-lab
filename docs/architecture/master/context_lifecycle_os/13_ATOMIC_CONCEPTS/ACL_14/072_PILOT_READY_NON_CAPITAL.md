---
title: ACL-14 Atomic Concept 072 — Pilot Ready Non Capital
status: accepted-reference
version: 1.0.0
updated: 2026-07-18
tags: [acl-os, acl-14, atomic-concept]
---
# Pilot Ready Non Capital

## Definition

`PILOT_READY_NON_CAPITAL` is an atomic contract concept in ACL-14. It is represented explicitly in schemas, policies, reason codes, tests or immutable evidence artifacts.
