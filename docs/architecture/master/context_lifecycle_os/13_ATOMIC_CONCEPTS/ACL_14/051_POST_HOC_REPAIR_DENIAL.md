---
title: ACL-14 Atomic Concept 051 — Post Hoc Repair Denial
...
`POST_HOC_REPAIR_DENIAL` is an atomic contract concept in ACL-14. It is represented explicitly in schemas, policies, reason codes, tests or immutable evidence artifacts.
