---
title: ACL-14 Atomic Concept 076 — Zero Prospective Rows
...
`ZERO_PROSPECTIVE_ROWS` is an atomic contract concept in ACL-14. It is represented explicitly in schemas, policies, reason codes, tests or immutable evidence artifacts.
