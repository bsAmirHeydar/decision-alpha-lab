---
title: ACL-03 Domain Linter Extension
status: accepted-reference
version: 1.0.0
tags: [acl-os, acl-03, atomic-concept]
---
# Domain Linter Extension

## Definition

`ACL03_DOMAIN_LINTER_EXTENSION` is an atomic ACL-03 concept used by the Context Compiler and Onboarding Factory. It is defined narrowly so schemas, code, tests, policies, reason codes and operator documentation refer to the same behavior without semantic drift.
