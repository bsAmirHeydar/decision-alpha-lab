---
title: ACL-03 Capital Access Denial
status: accepted-reference
version: 1.0.0
tags: [acl-os, acl-03, atomic-concept]
---
# Capital Access Denial

## Definition

`ACL03_CAPITAL_ACCESS_DENIAL` is an atomic ACL-03 concept used by the Context Compiler and Onboarding Factory. It is defined narrowly so schemas, code, tests, policies, reason codes and operator documentation refer to the same behavior without semantic drift.
