---
title: ACL-03 Occurrence Id Recipe
status: accepted-reference
version: 1.0.0
tags: [acl-os, acl-03, atomic-concept]
---
# Occurrence Id Recipe

## Definition

`ACL03_OCCURRENCE_ID_RECIPE` is an atomic ACL-03 concept used by the Context Compiler and Onboarding Factory. It is defined narrowly so schemas, code, tests, policies, reason codes and operator documentation refer to the same behavior without semantic drift.
