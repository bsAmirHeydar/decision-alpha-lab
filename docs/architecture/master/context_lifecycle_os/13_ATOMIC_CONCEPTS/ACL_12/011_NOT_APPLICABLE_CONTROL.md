---
title: ACL-12 Atomic Concept — Not Applicable Control
...
`NOT_APPLICABLE_CONTROL` is an atomic ACL-12 security concept. It has one bounded meaning, one authority boundary and one deterministic representation.
