---
title: ACL-12 Atomic Concept — Required Acl13 Action
status: accepted-reference
version: 1.0.0
updated: 2026-07-18
tags: [acl-os, acl-12, atomic-concept]
---
# Required Acl13 Action

## Definition

`REQUIRED_ACL13_ACTION` is an atomic ACL-12 security concept. It has one bounded meaning, one authority boundary and one deterministic representation.
