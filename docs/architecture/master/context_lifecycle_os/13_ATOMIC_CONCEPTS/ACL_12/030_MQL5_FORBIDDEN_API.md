---
title: ACL-12 Atomic Concept — Mql5 Forbidden Api
...
`MQL5_FORBIDDEN_API` is an atomic ACL-12 security concept. It has one bounded meaning, one authority boundary and one deterministic representation.
