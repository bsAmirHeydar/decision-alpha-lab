---
title: ACL-12 Atomic Concept — Control Registry Digest
...
`CONTROL_REGISTRY_DIGEST` is an atomic ACL-12 security concept. It has one bounded meaning, one authority boundary and one deterministic representation.
