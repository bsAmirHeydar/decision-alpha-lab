---
title: ACL-12 Atomic Concept — Ci Branch Protection
...
`CI_BRANCH_PROTECTION` is an atomic ACL-12 security concept. It has one bounded meaning, one authority boundary and one deterministic representation.
