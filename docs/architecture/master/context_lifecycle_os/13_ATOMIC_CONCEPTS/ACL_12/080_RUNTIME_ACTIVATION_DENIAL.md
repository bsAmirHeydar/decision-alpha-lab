---
title: ACL-12 Atomic Concept — Runtime Activation Denial
...
`RUNTIME_ACTIVATION_DENIAL` is an atomic ACL-12 security concept. It has one bounded meaning, one authority boundary and one deterministic representation.
