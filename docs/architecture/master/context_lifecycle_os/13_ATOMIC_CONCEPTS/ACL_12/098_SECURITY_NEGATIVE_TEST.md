---
title: ACL-12 Atomic Concept — Security Negative Test
...
`SECURITY_NEGATIVE_TEST` is an atomic ACL-12 security concept. It has one bounded meaning, one authority boundary and one deterministic representation.
