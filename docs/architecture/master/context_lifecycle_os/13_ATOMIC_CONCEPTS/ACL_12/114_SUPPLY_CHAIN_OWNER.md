---
title: ACL-12 Atomic Concept — Supply Chain Owner
...
`SUPPLY_CHAIN_OWNER` is an atomic ACL-12 security concept. It has one bounded meaning, one authority boundary and one deterministic representation.
