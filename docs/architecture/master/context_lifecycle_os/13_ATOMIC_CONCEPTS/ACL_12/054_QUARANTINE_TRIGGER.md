---
title: ACL-12 Atomic Concept — Quarantine Trigger
...
`QUARANTINE_TRIGGER` is an atomic ACL-12 security concept. It has one bounded meaning, one authority boundary and one deterministic representation.
