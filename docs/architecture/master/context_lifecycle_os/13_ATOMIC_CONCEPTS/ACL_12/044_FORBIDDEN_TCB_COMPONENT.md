---
title: ACL-12 Atomic Concept — Forbidden Tcb Component
status: accepted-reference
version: 1.0.0
updated: 2026-07-18
tags: [acl-os, acl-12, atomic-concept]
---
# Forbidden Tcb Component

## Definition

`FORBIDDEN_TCB_COMPONENT` is an atomic ACL-12 security concept. It has one bounded meaning, one authority boundary and one deterministic representation.
