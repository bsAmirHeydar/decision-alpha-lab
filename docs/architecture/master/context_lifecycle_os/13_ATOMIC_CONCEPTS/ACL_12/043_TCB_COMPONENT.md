---
title: ACL-12 Atomic Concept — Tcb Component
...
`TCB_COMPONENT` is an atomic ACL-12 security concept. It has one bounded meaning, one authority boundary and one deterministic representation.
