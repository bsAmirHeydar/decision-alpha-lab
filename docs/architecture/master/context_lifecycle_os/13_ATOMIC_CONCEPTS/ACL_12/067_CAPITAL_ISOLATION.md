---
title: ACL-12 Atomic Concept — Capital Isolation
...
`CAPITAL_ISOLATION` is an atomic ACL-12 security concept. It has one bounded meaning, one authority boundary and one deterministic representation.
