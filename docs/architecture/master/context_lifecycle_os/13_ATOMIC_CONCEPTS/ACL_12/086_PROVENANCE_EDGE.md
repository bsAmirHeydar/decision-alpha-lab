---
title: ACL-12 Atomic Concept — Provenance Edge
...
`PROVENANCE_EDGE` is an atomic ACL-12 security concept. It has one bounded meaning, one authority boundary and one deterministic representation.
