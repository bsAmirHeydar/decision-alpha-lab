---
title: ACL-12 Atomic Concept — Static Scan Finding
...
`STATIC_SCAN_FINDING` is an atomic ACL-12 security concept. It has one bounded meaning, one authority boundary and one deterministic representation.
