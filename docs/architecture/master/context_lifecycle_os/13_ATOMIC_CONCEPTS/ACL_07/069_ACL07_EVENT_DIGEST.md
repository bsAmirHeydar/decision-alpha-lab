...
`ACL07_EVENT_DIGEST` is an atomic concept in ACL-07. It has one semantic owner and must not be silently redefined by reporting, execution or capital layers.
