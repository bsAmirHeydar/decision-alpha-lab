---
title: Forbidden Treatment Action
status: accepted-reference
version: 1.0.0
updated: 2026-07-17
tags: [acl-os, acl-02, atomic-concept]
---
# Forbidden Treatment Action

## Definition

**Forbidden Treatment Action** is a bounded ACL-02 concept used to make Context intake deterministic, inspectable, secure and evolvable. Its value is carried in closed machine contracts and referenced by stable artifact identity rather than by file location or informal interpretation.
