...
**Event Time** is a bounded ACL-02 concept used to make Context intake deterministic, inspectable, secure and evolvable. Its value is carried in closed machine contracts and referenced by stable artifact identity rather than by file location or informal interpretation.
