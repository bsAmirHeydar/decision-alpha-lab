---
title: Context Onboarding Factory
status: accepted-reference-implementation
version: 1.0.0
updated: 2026-07-17
tags: [acl-os, context-lifecycle]
---
# Context Onboarding Factory

Scaffolds canonical files, reserves identity, assigns owners and guides a Context to research readiness.

## Responsibility boundary

This component owns a narrow part of Context semantics, known-time correctness, occurrence identity and onboarding. It communicates through versioned contracts and immutable references. It may not infer adjacent authority, reach into private implementation folders, or create an alternative identity, security or evidence system.
...
The accepted reference implementation is delivered in `tools/strategy_factory/acl_os/acl_03/` with closed contracts under `registry/history/acl/acl_03/`, reference compilation evidence, full QA and the bounded `ACL03_TO_ACL04` handoff. See [[00_00_EXECUTIVE_DELIVERY_INDEX]] and [[ACL_03_STATUS]].
