---
title: Acl10 Responsibility Boundary
status: accepted-reference
version: 1.0.0
updated: 2026-07-18
tags: [acl-os, acl-10, promotion]
---
# Acl10 Responsibility Boundary

ACL-10 owns promotion-state evaluation only. It does not execute planner proposals, mutate memory, generate runtime code, submit orders or activate capital.
