---
title: Acl11 Runtime Trusted Computing Base
status: accepted-reference
version: 1.0.0
updated: 2026-07-18
tags: [acl-os, acl-11, runtime, custody]
---
# Acl11 Runtime Trusted Computing Base

Minimizes components allowed to influence runtime and forbids training, dynamic plugins and network downloads.
