---
title: ACL-01 — Alias and Tombstone Model
status: accepted-reference-implementation
version: 1.0.0
updated: 2026-07-17
tags: [acl-os, acl-01, repository, identity, lineage]
---
# ACL-01 — Alias and Tombstone Model

## Purpose

Provides explicit compatibility aliases while preventing cycles, mutable latest pointers and silent resurrection.
