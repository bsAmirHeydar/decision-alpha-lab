---
title: ACL-01 — Tenant and Namespace Isolation
status: accepted-reference-implementation
version: 1.0.0
updated: 2026-07-17
tags: [acl-os, acl-01, repository, identity, lineage]
---
# ACL-01 — Tenant and Namespace Isolation

## Purpose

Prevents unapproved cross-tenant dependencies and publication into reserved namespaces.
