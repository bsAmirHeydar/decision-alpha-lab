---
title: ACL-01 — Clean Checkout Reproduction
status: accepted-reference-implementation
version: 1.0.0
updated: 2026-07-17
tags: [acl-os, acl-01, repository, identity, lineage]
---
# ACL-01 — Clean Checkout Reproduction

## Purpose

Requires the installed patch to pass all QA in a fresh checkout without build-workspace dependencies.
