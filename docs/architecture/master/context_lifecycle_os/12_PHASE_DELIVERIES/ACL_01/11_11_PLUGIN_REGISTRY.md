---
title: ACL-01 — Plugin Registry
status: accepted-reference-implementation
version: 1.0.0
updated: 2026-07-17
tags: [acl-os, acl-01, repository, identity, lineage]
---
# ACL-01 — Plugin Registry

## Purpose

Requires capability allowlists, conformance suites, signatures for runtime use and private-kernel import prohibition.
