---
title: ACL-01 — Artifact Locator
status: accepted-reference-implementation
version: 1.0.0
updated: 2026-07-17
tags: [acl-os, acl-01, repository, identity, lineage]
---
# ACL-01 — Artifact Locator

## Purpose

Resolves exact IDs, aliases or constrained base IDs and verifies path confinement, status and content digest.
