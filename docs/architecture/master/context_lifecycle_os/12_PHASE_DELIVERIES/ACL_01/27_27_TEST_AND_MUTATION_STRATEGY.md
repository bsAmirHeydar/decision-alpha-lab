---
title: ACL-01 — Test and Mutation Strategy
status: accepted-reference-implementation
version: 1.0.0
updated: 2026-07-17
tags: [acl-os, acl-01, repository, identity, lineage]
---
# ACL-01 — Test and Mutation Strategy

## Purpose

Covers identities, ranges, graph cycles, path boundaries, integrity drift, compatibility and migration guards.
