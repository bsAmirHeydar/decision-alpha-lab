---
title: ACL-01 — Compatibility Resolution
status: accepted-reference-implementation
version: 1.0.0
updated: 2026-07-17
tags: [acl-os, acl-01, repository, identity, lineage]
---
# ACL-01 — Compatibility Resolution

## Purpose

Selects the highest provider satisfying artifact, interface, schema and security constraints.
