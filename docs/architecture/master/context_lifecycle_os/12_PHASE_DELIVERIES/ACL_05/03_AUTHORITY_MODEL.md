---
title: ACL-05 — Authority Permit and Capability Denial
status: accepted-reference
version: 1.0.0
updated: 2026-07-18
tags: [acl-os, acl-05, phase-delivery]
---
# Authority Permit and Capability Denial

## Decision

This delivery record fixes the ACL-05 reference behavior for **authority permit and capability denial**. The canonical implementation is versioned, deterministic and subordinate to the ACL-00 authority model, ACL-03 known-time semantics and ACL-04 candidate behavior.
...
The behavior is implemented under `tools/strategy_factory/acl_os/acl_05`, registered under `registry/history/acl/acl_05`, tested under `lab/11_strategy_factory/acl_os/tests_acl_05`, mirrored statically under the ACL05 MQL5 include folder and demonstrated by `fixtures/acl_05/reference_batch`.
