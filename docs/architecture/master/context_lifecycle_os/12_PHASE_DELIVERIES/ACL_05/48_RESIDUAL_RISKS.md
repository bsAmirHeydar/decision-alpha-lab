---
title: ACL-05 — Residual Risk Register
...
This delivery record fixes the ACL-05 reference behavior for **residual risk register**. The canonical implementation is versioned, deterministic and subordinate to the ACL-00 authority model, ACL-03 known-time semantics and ACL-04 candidate behavior.
