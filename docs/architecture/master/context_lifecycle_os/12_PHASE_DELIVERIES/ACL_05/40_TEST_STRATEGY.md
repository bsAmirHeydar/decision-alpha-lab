---
title: ACL-05 — Test Strategy and Coverage Matrix
...
This delivery record fixes the ACL-05 reference behavior for **test strategy and coverage matrix**. The canonical implementation is versioned, deterministic and subordinate to the ACL-00 authority model, ACL-03 known-time semantics and ACL-04 candidate behavior.
