---
title: ACL-05 — Byte Digest vs Semantic Digest
status: accepted-reference
version: 1.0.0
updated: 2026-07-18
tags: [acl-os, acl-05, phase-delivery]
---
# Byte Digest vs Semantic Digest

## Decision

This delivery record fixes the ACL-05 reference behavior for **byte digest vs semantic digest**. The canonical implementation is versioned, deterministic and subordinate to the ACL-00 authority model, ACL-03 known-time semantics and ACL-04 candidate behavior.
