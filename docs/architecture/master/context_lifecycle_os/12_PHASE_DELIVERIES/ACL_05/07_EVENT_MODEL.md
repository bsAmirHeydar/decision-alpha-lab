---
title: ACL-05 — Append-Only Event Model
...
This delivery record fixes the ACL-05 reference behavior for **append-only event model**. The canonical implementation is versioned, deterministic and subordinate to the ACL-00 authority model, ACL-03 known-time semantics and ACL-04 candidate behavior.
