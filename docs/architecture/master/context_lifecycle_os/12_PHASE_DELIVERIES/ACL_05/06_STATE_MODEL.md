---
title: ACL-05 — Batch State Machine
...
This delivery record fixes the ACL-05 reference behavior for **batch state machine**. The canonical implementation is versioned, deterministic and subordinate to the ACL-00 authority model, ACL-03 known-time semantics and ACL-04 candidate behavior.
