---
title: ACL-05 — Purged Walk-Forward Split
...
This delivery record fixes the ACL-05 reference behavior for **purged walk-forward split**. The canonical implementation is versioned, deterministic and subordinate to the ACL-00 authority model, ACL-03 known-time semantics and ACL-04 candidate behavior.
