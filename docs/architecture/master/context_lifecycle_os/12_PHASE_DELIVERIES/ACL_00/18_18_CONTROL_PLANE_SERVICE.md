---
title: ACL-00 — Control Plane Service
status: accepted-reference-implementation
version: 1.0.0
updated: 2026-07-17
tags: [acl-os, acl-00, governance, security]
---
# ACL-00 — Control Plane Service

## Purpose

Composes lifecycle, authority, evidence, approval, security, claim, waiver, state and audit evaluators into one atomic decision path.
