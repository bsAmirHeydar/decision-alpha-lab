---
title: ACL-00 — Tamper-Evident Audit Ledger
status: accepted-reference-implementation
version: 1.0.0
updated: 2026-07-17
tags: [acl-os, acl-00, governance, security]
---
# ACL-00 — Tamper-Evident Audit Ledger

## Purpose

Implements a canonical SHA-256 hash chain with sequence validation and clean replay.
