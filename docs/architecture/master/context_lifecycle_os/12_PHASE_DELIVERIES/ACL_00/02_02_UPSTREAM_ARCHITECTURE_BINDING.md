---
title: ACL-00 — Upstream Architecture Binding
status: accepted-reference-implementation
version: 1.0.0
updated: 2026-07-17
tags: [acl-os, acl-00, governance, security]
---
# ACL-00 — Upstream Architecture Binding

## Purpose

Binds the implementation to the ACL-OS architecture baseline, SAED evidence production and UCEE execution authority without duplicating their domains.
