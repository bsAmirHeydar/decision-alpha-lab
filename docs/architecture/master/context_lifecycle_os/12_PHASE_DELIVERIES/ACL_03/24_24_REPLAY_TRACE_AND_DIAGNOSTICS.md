---
title: ACL-03 — Replay Trace and Diagnostics
status: accepted-reference
version: 1.0.0
updated: 2026-07-17
tags: [acl-os, acl-03, context-compiler, onboarding]
---
# Replay Trace and Diagnostics

## Purpose

This note defines the enforceable ACL-03 treatment of **replay trace and diagnostics**. ACL-03 compiles an exact, semantically approved ACL-02 Context package into deterministic, closed-schema, non-trading intermediate representations and onboarding evidence. The compiler does not broaden Context doctrine, invent Treatment authority, train a model, establish statistical edge, generate unrestricted executable code, or authorize capital.
