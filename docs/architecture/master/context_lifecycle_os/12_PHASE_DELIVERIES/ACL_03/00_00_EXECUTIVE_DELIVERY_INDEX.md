...
| Policy-as-code | `registry/history/acl/acl_03/policies/v1/` | Fail-closed authority, security and evolution rules |
| Closed schemas | `registry/history/acl/acl_03/schemas/v1/` | Machine-enforced artifact contracts |
