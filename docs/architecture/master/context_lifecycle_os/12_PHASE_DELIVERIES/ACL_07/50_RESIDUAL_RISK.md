---
title: ACL-07 — Residual Risk
status: accepted-reference
version: 1.0.0
updated: 2026-07-18
tags: [acl-os, acl-07, validation]
---
# ACL-07 — Residual Risk

## Purpose

This note specifies residual risk for the accepted ACL-07 reference implementation. It is written as an operational Obsidian artifact rather than a superficial code summary.
