---
title: ACL-04 — Human DSL Compiler
...
ACL-04 implements human dsl compiler as part of the bounded Dual Setup Factory. The decision is accepted only at the `SETUP_DEFINITION_REFERENCE_ONLY` claim ceiling.
...
For this topic specifically, human dsl compiler must remain reproducible, independently testable and reversible. No local success can broaden the phase authority ceiling.
