---
title: ACL-04 — Behavior Digest and Stable IDs
status: accepted-reference
version: 1.0.0
updated: 2026-07-18
tags: [acl-os, acl-04, phase-delivery]
---
# Behavior Digest and Stable IDs

## Decision

ACL-04 implements behavior digest and stable ids as part of the bounded Dual Setup Factory. The decision is accepted only at the `SETUP_DEFINITION_REFERENCE_ONLY` claim ceiling.
...
For this topic specifically, behavior digest and stable ids must remain reproducible, independently testable and reversible. No local success can broaden the phase authority ceiling.
