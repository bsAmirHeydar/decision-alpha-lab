---
title: ACL-04 — Search Exposure Ledger
...
ACL-04 implements search exposure ledger as part of the bounded Dual Setup Factory. The decision is accepted only at the `SETUP_DEFINITION_REFERENCE_ONLY` claim ceiling.
...
For this topic specifically, search exposure ledger must remain reproducible, independently testable and reversible. No local success can broaden the phase authority ceiling.
