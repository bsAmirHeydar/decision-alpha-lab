---
title: ACL-04 — Cross-Lane Deduplication
...
ACL-04 implements cross-lane deduplication as part of the bounded Dual Setup Factory. The decision is accepted only at the `SETUP_DEFINITION_REFERENCE_ONLY` claim ceiling.
...
For this topic specifically, cross-lane deduplication must remain reproducible, independently testable and reversible. No local success can broaden the phase authority ceiling.
