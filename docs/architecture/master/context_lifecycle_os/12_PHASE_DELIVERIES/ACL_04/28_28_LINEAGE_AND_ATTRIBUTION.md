---
title: ACL-04 — Lineage and Attribution
...
ACL-04 implements lineage and attribution as part of the bounded Dual Setup Factory. The decision is accepted only at the `SETUP_DEFINITION_REFERENCE_ONLY` claim ceiling.
...
For this topic specifically, lineage and attribution must remain reproducible, independently testable and reversible. No local success can broaden the phase authority ceiling.
