---
title: ACL-04 — Setup Identity Model
...
ACL-04 implements setup identity model as part of the bounded Dual Setup Factory. The decision is accepted only at the `SETUP_DEFINITION_REFERENCE_ONLY` claim ceiling.
...
For this topic specifically, setup identity model must remain reproducible, independently testable and reversible. No local success can broaden the phase authority ceiling.
