---
title: ACL-04 — Unit and Contract Tests
...
ACL-04 implements unit and contract tests as part of the bounded Dual Setup Factory. The decision is accepted only at the `SETUP_DEFINITION_REFERENCE_ONLY` claim ceiling.
...
For this topic specifically, unit and contract tests must remain reproducible, independently testable and reversible. No local success can broaden the phase authority ceiling.
