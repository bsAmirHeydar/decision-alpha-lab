---
title: ACL-04 — Memory Source Boundary
...
ACL-04 implements memory source boundary as part of the bounded Dual Setup Factory. The decision is accepted only at the `SETUP_DEFINITION_REFERENCE_ONLY` claim ceiling.
...
For this topic specifically, memory source boundary must remain reproducible, independently testable and reversible. No local success can broaden the phase authority ceiling.
