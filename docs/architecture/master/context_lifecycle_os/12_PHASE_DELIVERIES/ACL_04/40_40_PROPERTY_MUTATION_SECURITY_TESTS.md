---
title: ACL-04 — Property, Mutation and Security Tests
status: accepted-reference
version: 1.0.0
updated: 2026-07-18
tags: [acl-os, acl-04, phase-delivery]
---
# Property, Mutation and Security Tests

## Decision

ACL-04 implements property, mutation and security tests as part of the bounded Dual Setup Factory. The decision is accepted only at the `SETUP_DEFINITION_REFERENCE_ONLY` claim ceiling.
...
For this topic specifically, property, mutation and security tests must remain reproducible, independently testable and reversible. No local success can broaden the phase authority ceiling.
