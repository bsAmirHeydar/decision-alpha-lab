---
title: ACL-10 — 16 Subject Projection
status: accepted-reference
version: 1.0.0
updated: 2026-07-18
tags: [acl-os, acl-10, promotion]
---
# ACL-10 — 16 Subject Projection

This artifact records the ACL-10 engineering decision for **16 Subject Projection**. It binds exact ACL-09 evidence to a closed promotion-state evaluation while preserving all authority denials.
