---
title: ACL-11 08 — Parity Status Semantics
status: accepted-reference
version: 1.0.0
updated: 2026-07-18
tags: [acl-os, acl-11, phase-delivery]
---
# ACL-11 08 — Parity Status Semantics

## Purpose

This delivery unit specifies parity status semantics within the runtime parity and custody boundary. It is independently reviewable and links machine contracts, failure semantics and evidence obligations.
