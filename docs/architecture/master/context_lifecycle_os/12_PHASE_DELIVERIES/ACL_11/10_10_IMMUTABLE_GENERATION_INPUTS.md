---
title: ACL-11 10 — Immutable Generation Inputs
status: accepted-reference
version: 1.0.0
updated: 2026-07-18
tags: [acl-os, acl-11, phase-delivery]
---
# ACL-11 10 — Immutable Generation Inputs

## Purpose

This delivery unit specifies immutable generation inputs within the runtime parity and custody boundary. It is independently reviewable and links machine contracts, failure semantics and evidence obligations.
