---
title: ACL-11 26 — Fail Closed Fallback
status: accepted-reference
version: 1.0.0
updated: 2026-07-18
tags: [acl-os, acl-11, phase-delivery]
---
# ACL-11 26 — Fail Closed Fallback

## Purpose

This delivery unit specifies fail closed fallback within the runtime parity and custody boundary. It is independently reviewable and links machine contracts, failure semantics and evidence obligations.
