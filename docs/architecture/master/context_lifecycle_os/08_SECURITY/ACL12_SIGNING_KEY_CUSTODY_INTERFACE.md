---
title: Acl12 Signing Key Custody Interface
status: accepted-reference
version: 1.0.0
updated: 2026-07-18
tags: [acl-os, acl-12, security]
---
# Acl12 Signing Key Custody Interface

## Purpose

Defines production key-custody ports while guaranteeing zero key material in reference mode.
...
Machine contracts live under `registry/history/acl/acl_12`. Reference evidence lives under `lab/11_strategy_factory/acl_os/fixtures/acl_12/reference_security_hardening`.
