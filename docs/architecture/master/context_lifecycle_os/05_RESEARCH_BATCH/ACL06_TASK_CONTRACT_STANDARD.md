---
title: ACL-06 Task Contract Standard
status: accepted-reference
version: 1.0.0
updated: 2026-07-18
tags: [acl-os, acl-06]
---
# ACL-06 Task Contract Standard

## Purpose

Every task has a stable identity, closed type, dependency set, input digests, deterministic executor, cache key, retry ceiling and explicit resource charge.
