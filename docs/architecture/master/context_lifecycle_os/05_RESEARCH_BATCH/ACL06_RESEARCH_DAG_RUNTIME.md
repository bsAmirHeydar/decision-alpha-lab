---
title: ACL-06 Research DAG Runtime
status: accepted-reference
version: 1.0.0
updated: 2026-07-18
tags: [acl-os, acl-06]
---
# ACL-06 Research DAG Runtime

## Purpose

Defines the deterministic runtime that consumes one immutable ACL-05 Batch and emits bounded research evidence. The runtime may schedule only registered task types and may not alter any frozen material.
