---
title: ACL-06 Diagnostic Lane Isolation
status: accepted-reference
version: 1.0.0
updated: 2026-07-18
tags: [acl-os, acl-06]
---
# ACL-06 Diagnostic Lane Isolation

## Purpose

Diagnostic candidates may use explicitly segregated future-path information only for error analysis. Their outputs are never selectable or promotable.
