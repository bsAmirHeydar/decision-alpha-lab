---
title: ACL-06 Run Artifact Store
status: accepted-reference
version: 1.0.0
updated: 2026-07-18
tags: [acl-os, acl-06]
---
# ACL-06 Run Artifact Store

## Purpose

Task outputs are written to a SHA-256 content-addressed run store. Overwrite, collision repair and mutable aliases are denied.
