---
title: ACL-06 Cache and Idempotency
status: accepted-reference
version: 1.0.0
updated: 2026-07-18
tags: [acl-os, acl-06]
---
# ACL-06 Cache and Idempotency

## Purpose

Cache keys bind task contract material and executor version. Cache objects are content addressed and immutable; filenames or mutable working directories are not identity.
