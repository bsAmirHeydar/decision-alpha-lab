...
This contract provides the public boundary for adding atoms and generators. It is part of ACL-04 and therefore operates only after an exact `ACL03_TO_ACL04` handoff has been validated.

## Ownership and authority boundary

Extensions cannot import private kernel modules, add execution capability, create alternative identity systems or silently widen Search Authority.
...
extension manifest, capability declaration, schema range, owner, tests and migration notes. Every material input carries an exact identity, semantic version and SHA-256 digest. Missing or ambiguous identities are blockers, not warnings.

## Produced artifacts

registered extension visible through public ports. Structured JSON is authoritative. Obsidian notes are generated or reviewed projections and cannot mutate behavior.
