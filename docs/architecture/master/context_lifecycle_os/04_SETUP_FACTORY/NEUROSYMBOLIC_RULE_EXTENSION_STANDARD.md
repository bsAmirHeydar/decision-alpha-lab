---
title: Neurosymbolic Rule Extension Standard
status: accepted-reference
version: 1.0.0
updated: 2026-07-18
tags: [acl-os, acl-04, setup-factory]
---
# Neurosymbolic Rule Extension Standard

## Purpose

This contract defines how learned scores may enter symbolic Setup clauses without escaping governance. It is part of ACL-04 and therefore operates only after an exact `ACL03_TO_ACL04` handoff has been validated.

## Ownership and authority boundary

A model score is evidence input. It cannot mutate doctrine, change active thresholds online, access future revisions, or bypass missingness and freshness controls.
...
registered score artifact, calibration metadata, known-time contract, atom extension manifest and capability declaration. Every material input carries an exact identity, semantic version and SHA-256 digest. Missing or ambiguous identities are blockers, not warnings.

## Produced artifacts

a versioned predicate atom that can be used only under Search Authority. Structured JSON is authoritative. Obsidian notes are generated or reviewed projections and cannot mutate behavior.
