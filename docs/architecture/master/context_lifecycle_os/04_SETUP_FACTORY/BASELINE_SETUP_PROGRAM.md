---
title: Baseline Setup Program
status: accepted-reference
version: 1.0.0
updated: 2026-07-18
tags: [acl-os, acl-04, setup-factory]
---
# Baseline Setup Program

## Purpose

This contract defines mandatory comparison and diagnostic Setup families. It is part of ACL-04 and therefore operates only after an exact `ACL03_TO_ACL04` handoff has been validated.

## Ownership and authority boundary

Baselines are controls, not competitors invented after seeing results. The diagnostic oracle may use future outcome information only when marked diagnostic-only and can never become execution eligible.
...
the bound Context identity, Treatment envelope and baseline policy version. Every material input carries an exact identity, semantic version and SHA-256 digest. Missing or ambiguous identities are blockers, not warnings.

## Produced artifacts

never-trade, always-take directional, manual-gate and diagnostic-oracle candidates. Structured JSON is authoritative. Obsidian notes are generated or reviewed projections and cannot mutate behavior.
