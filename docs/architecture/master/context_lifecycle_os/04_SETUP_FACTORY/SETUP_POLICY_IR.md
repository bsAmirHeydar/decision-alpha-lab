---
title: Setup Policy Intermediate Representation
status: accepted-reference
version: 1.0.0
updated: 2026-07-18
tags: [acl-os, acl-04, setup-factory]
---
# Setup Policy Intermediate Representation

## Purpose

This contract provides the language-neutral canonical behavior model shared by both lanes. It is part of ACL-04 and therefore operates only after an exact `ACL03_TO_ACL04` handoff has been validated.

## Ownership and authority boundary

Policy IR describes research behavior only. It does not contain broker commands, credentials, terminal operations or capital authority.
...
validated DSL or generated template plus Context and Treatment bindings. Every material input carries an exact identity, semantic version and SHA-256 digest. Missing or ambiguous identities are blockers, not warnings.

## Produced artifacts

ordered clauses, parameters, risk contract, diagnostic flag and immutable digest. Structured JSON is authoritative. Obsidian notes are generated or reviewed projections and cannot mutate behavior.
