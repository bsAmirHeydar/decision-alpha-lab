---
title: Dual-Lane Setup Factory
status: accepted-reference
version: 1.0.0
updated: 2026-07-18
tags: [acl-os, acl-04, setup-factory]
---
# Dual-Lane Setup Factory

## Purpose

This contract unifies human-authored and AI-generated Setups under one canonical behavior representation. It is part of ACL-04 and therefore operates only after an exact `ACL03_TO_ACL04` handoff has been validated.

## Ownership and authority boundary

Origin is provenance, not behavior identity. Equivalent human and AI behavior must collapse to one behavior digest while preserving every source lineage edge.
...
the immutable ACL03_TO_ACL04 handoff, ACL-00 permit, Search Authority, Treatment envelope, human DSL documents and bounded AI requests. Every material input carries an exact identity, semantic version and SHA-256 digest. Missing or ambiguous identities are blockers, not warnings.

## Produced artifacts

canonical candidates, deduplication groups, exposure ledger, provenance graph, projections, receipt and ACL04_TO_ACL05 handoff. Structured JSON is authoritative. Obsidian notes are generated or reviewed projections and cannot mutate behavior.
