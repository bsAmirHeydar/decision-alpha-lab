---
title: Setup Search Authority
status: accepted-reference
version: 1.0.0
updated: 2026-07-18
tags: [acl-os, acl-04, setup-factory]
---
# Setup Search Authority

## Purpose

This contract freezes the exact AI and human construction space. It is part of ACL-04 and therefore operates only after an exact `ACL03_TO_ACL04` handoff has been validated.

## Ownership and authority boundary

Any generation outside authority is invalid even when technically feasible. The authority cannot include execution or capital permissions.
...
Context and handoff binding, allowed lanes, atoms, actions, finite domains, generators, memory sources and budgets. Every material input carries an exact identity, semantic version and SHA-256 digest. Missing or ambiguous identities are blockers, not warnings.

## Produced artifacts

content-addressed authority artifact. Structured JSON is authoritative. Obsidian notes are generated or reviewed projections and cannot mutate behavior.
