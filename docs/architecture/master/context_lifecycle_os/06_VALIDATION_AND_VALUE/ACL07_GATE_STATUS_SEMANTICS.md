---
title: Acl07 Gate Status Semantics
status: accepted-reference
version: 1.0.0
updated: 2026-07-18
tags: [acl-os, acl-07, validation]
---
# Acl07 Gate Status Semantics

PASS means the declared gate cleared; FAIL means contrary evidence; UNKNOWN means required evidence is unavailable; NOT_APPLICABLE is limited to structurally excluded cases.
