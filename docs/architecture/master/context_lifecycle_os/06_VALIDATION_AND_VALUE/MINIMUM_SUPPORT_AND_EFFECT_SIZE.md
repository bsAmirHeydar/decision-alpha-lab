---
title: Minimum Support and Effect Size
status: proposed-reference
version: 1.0.0
updated: 2026-07-17
tags: [acl-os, context-lifecycle]
---
# Minimum Support and Effect Size

Requires adequate independent support and economically meaningful effects before inference.

## Responsibility boundary

This component owns a narrow part of data integrity, value, overfit control, generalization and economic qualification. It communicates through versioned contracts and immutable references. It may not infer adjacent authority, reach into private implementation folders, or create an alternative identity, security or evidence system.
...
ACL-07 separates minimum total/test support from effect and confidence. A candidate cannot compensate for low support with a high point estimate.
