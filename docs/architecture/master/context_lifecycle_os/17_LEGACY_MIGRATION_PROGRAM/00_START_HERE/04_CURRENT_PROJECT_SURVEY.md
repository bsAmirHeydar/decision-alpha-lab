...
2. Domain behavior remains distributed across `mql5/Experts`, `mql5/Include`, `docs/operations/execution`, Hook/NDS/Zone documentation and M-series modules.
...
4. Three documentation namespace pairs are byte-identical duplicates: `docs/history/aieos_legacy`, `docs/history/systems/strategy_factory` and `docs/history/systems/strategy_factory_v2` each duplicate a corresponding namespace under `docs/architecture/master`.
5. `docs/history/systems/ucee` is a superset of the master-architecture copy and cannot be deleted as a duplicate without reconciliation.
