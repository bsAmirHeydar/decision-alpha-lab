...
---
# Ambiguous Role Queue

## Definition

`AMBIGUOUS_ROLE_QUEUE` is a closed LCM-02 governance concept used to classify survey evidence without approving domain semantics.
