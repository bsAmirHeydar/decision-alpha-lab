...
---
# Time Semantics Surface

## Definition

`TIME_SEMANTICS_SURFACE` is a closed LCM-02 governance concept used to classify survey evidence without approving domain semantics.
