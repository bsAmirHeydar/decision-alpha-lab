---
title: "Move Without Semantic Change"
...
`MOVE_WITHOUT_SEMANTIC_CHANGE` is a closed LCM-02 governance concept used to classify survey evidence without approving domain semantics.
