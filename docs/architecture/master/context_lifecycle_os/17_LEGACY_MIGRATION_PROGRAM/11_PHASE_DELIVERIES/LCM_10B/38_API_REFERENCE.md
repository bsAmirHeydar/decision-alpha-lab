...
The public reference API is build_execution_intent, validate_execution_intent, translate_legacy_request, DisabledExecutionAdapter and TreatmentPackageRegistry.
