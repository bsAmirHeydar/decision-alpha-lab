---
title: "LCM-10B — Normalized Atom Contract"
status: accepted-reference
version: 1.0.0
updated: 2026-07-20
tags: [acl-os, lcm, lcm-10b]
---
# Normalized Atom Contract

## Contract

Each atom maps to a normalized intent field while its value and unit remain explicit-input requirements rather than inferred rules.
