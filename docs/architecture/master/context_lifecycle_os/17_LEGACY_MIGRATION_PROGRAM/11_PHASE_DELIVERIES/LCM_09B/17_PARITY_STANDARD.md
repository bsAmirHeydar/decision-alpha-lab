---
title: "LCM-09B — Behavioral Parity Standard"
...
phase_id: LCM-09B
---
# Behavioral Parity Standard

Exact event order, decision state, reason code and known-time comparison is required when evidence exists. Missing evidence is BLOCKED, never PASS.
