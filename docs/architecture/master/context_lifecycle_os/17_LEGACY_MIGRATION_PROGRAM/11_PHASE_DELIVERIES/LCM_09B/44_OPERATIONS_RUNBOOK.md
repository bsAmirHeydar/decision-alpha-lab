...
```powershell
python -m src.engine.tooling.strategy_factory.lcm.lcm_09b.cli build --repo-root . --output-root registry/history/lcm/setup_package_migrations/SETUPMIGRATION_8F5CED333AA143A8F2A798BA01D550D9
```
