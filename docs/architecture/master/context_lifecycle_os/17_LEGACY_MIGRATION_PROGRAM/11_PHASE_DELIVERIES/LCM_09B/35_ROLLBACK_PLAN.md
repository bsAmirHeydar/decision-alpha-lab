...
Rollback removes only paths in the patch index and restores modified roadmap documents from Git. Legacy sources require no restoration because they are untouched.
