---
title: "LCM-09B — Blocker Registry"
...
Every upstream blocker is copied into an append-only record with owner role, state and source evidence. LCM-09B adds its own implementation-denial blocker.
