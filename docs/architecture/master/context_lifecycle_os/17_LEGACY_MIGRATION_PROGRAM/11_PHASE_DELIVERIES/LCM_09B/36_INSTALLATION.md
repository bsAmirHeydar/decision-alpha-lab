---
title: "LCM-09B — Installation and Staging"
...
Apply from repository root with the supplied batch. Staging uses `git add --pathspec-from-file=LCM_09B_FILE_INDEX.txt`; broad staging is forbidden.
