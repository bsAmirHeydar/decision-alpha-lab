...
---
# Unresolved Queue Model

Owner, role, activity, security, duplicate and generated-projection queues are separate to prevent one resolution from masking another.
