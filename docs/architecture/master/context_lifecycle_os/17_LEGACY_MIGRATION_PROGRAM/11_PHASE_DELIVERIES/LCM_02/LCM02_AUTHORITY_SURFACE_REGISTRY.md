---
title: "Authority Surface Registry"
...
Order, capital, broker, persistence, network, model, dynamic code, global state, chart state and time semantics are recorded separately.
