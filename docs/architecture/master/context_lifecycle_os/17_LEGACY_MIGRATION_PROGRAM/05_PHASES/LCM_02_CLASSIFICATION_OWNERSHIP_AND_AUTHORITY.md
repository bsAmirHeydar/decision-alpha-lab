...
- `registry/history/lcm/artifacts/`
- `registry/history/lcm/owners/`
- `registry/history/lcm/unresolved/`
...
Reference implementation is delivered under `tools/strategy_factory/lcm/lcm_02`, machine registries under `registry/history/lcm/lcm_02`, and immutable classification packages under `registry/history/lcm/classifications`. See [[LCM02_DEFINITION_OF_DONE]] and [[LCM02_TO_LCM03_HANDOFF_CONTRACT]].
