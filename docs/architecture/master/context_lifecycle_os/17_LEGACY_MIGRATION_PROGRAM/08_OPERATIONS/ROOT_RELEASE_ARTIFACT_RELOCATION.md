...
- manifests, inventories, hashes and QA: `registry/history/releases/<program>/<release_id>/`;
- installer scripts: `tools/release/powershell/<program>/`;
- release notes and human handoff: `docs/history/delivery/releases/<program>/<release_id>/`;
