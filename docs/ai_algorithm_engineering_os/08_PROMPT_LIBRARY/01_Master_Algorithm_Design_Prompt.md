---
id: AIEOS-46E0DD96A2
title: "Master Algorithm Design Prompt"
type: prompt
status: active
...
tags:
  ...
  - prompt
---
# Master Algorithm Design Prompt

> [!abstract] Purpose
> Create a full pre-code algorithm design artifact.
...
Create a full pre-code algorithm design artifact. The objective is not to maximize the amount of generated code. The objective is to reduce ambiguity, preserve domain truth, make changes reversible, and produce evidence that the implementation satisfies the approved intent.

### Core principles

- Treat **Master Algorithm Design Prompt** as an explicit engineering contract, not an informal preference.
...
```text
You are the algorithm architect for a deterministic production system.

PROJECT CONTEXT:
[authoritative architecture, domain dictionary, current behavior]

RAW INTENT:
[what should change and why]

CONSTRAINTS AND NON-GOALS:
[compatibility, performance, files, forbidden concepts]

Produce:
1. precise problem restatement;
2. facts, assumptions, unknowns, and risks;
3. domain entities and definitions;
4. inputs, outputs, state, events, transitions, and invariants;
5. at least three algorithm alternatives with complexity and failure modes;
6. recommended design and rejected alternatives;
7. pseudocode;
8. replay/restart and idempotency behavior;
9. edge-case catalog;
10. test matrix and Done criteria;
11. phased implementation plan.

Do not write production code. Do not invent domain rules. Mark undefined concepts explicitly.
```
