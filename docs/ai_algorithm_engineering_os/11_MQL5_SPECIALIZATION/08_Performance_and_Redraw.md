---
id: AIEOS-F3D02B6C78
title: "MQL5 Performance and Redraw"
type: guide
status: active
domain: mql5
version: 1.0.0
...
tags:
  ...
  - guide
---
# MQL5 Performance and Redraw

> [!abstract] Purpose
> Minimize full-history scans, object churn, redraws, logging, and repeated external calls.
...
Minimize full-history scans, object churn, redraws, logging, and repeated external calls. The objective is not to maximize the amount of generated code. The objective is to reduce ambiguity, preserve domain truth, make changes reversible, and produce evidence that the implementation satisfies the approved intent.

### Core principles

- Treat **MQL5 Performance and Redraw** as an explicit engineering contract, not an informal preference.
- Keep incremental calculation and chart responsiveness traceable to project intent, domain rules, and measurable evidence.
...
- Use `prev_calculated`, last processed time, dirty sets, and batched redraw intentionally.

## 2. Required Procedure

1. Collect the minimum authoritative context required for incremental calculation and chart responsiveness.
...
- A versioned record of incremental calculation and chart responsiveness.
