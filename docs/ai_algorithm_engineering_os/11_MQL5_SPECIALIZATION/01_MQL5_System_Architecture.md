---
id: AIEOS-B07981401D
title: "MQL5 System Architecture"
type: guide
status: active
domain: mql5
version: 1.0.0
...
tags:
  ...
  - guide
---
# MQL5 System Architecture

> [!abstract] Purpose
> Structure MQL5 code into domain, state, adapter, rendering, diagnostics, and lifecycle layers.
...
Structure MQL5 code into domain, state, adapter, rendering, diagnostics, and lifecycle layers. The objective is not to maximize the amount of generated code. The objective is to reduce ambiguity, preserve domain truth, make changes reversible, and produce evidence that the implementation satisfies the approved intent.

### Core principles

- Treat **MQL5 System Architecture** as an explicit engineering contract, not an informal preference.
- Keep maintainable MQL5 modules under terminal event constraints traceable to project intent, domain rules, and measurable evidence.
...
- Keep `OnCalculate`, `OnTick`, `OnChartEvent`, and lifecycle callbacks thin.

## 2. Required Procedure

1. Collect the minimum authoritative context required for maintainable MQL5 modules under terminal event constraints.
...
- A versioned record of maintainable MQL5 modules under terminal event constraints.
