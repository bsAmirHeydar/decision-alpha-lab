---
title: "V4-21 Atomic Concept — Diversification Penalty"
status: implemented-reference
version: 1.0.0
phase: SAED_V4_21
tags: [saed-v4, atomic-concept, robust-optimization, regret]
---
# V4-21 Atomic Concept — Diversification Penalty

## Definition
**Diversification Penalty** is a canonical concept in the V4-21 deterministic synthetic reference implementation. Its representation is closed, hashable, known-time safe, budget-accounted, and explicitly research-only.
