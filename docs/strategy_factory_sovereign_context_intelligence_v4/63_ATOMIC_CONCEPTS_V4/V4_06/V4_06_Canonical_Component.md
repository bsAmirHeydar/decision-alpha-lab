...
An exact primitive instance bound to one slot, definition hash and normalized parameter payload.

## Why it exists

Its identity localizes semantic changes and prevents registry substitution.
