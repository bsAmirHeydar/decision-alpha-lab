...
A fail-closed analyzer result for a program that violates any error-level invariant.

## Why it exists

Rejected programs cannot be canonicalized into an accepted package.
