...
A finite typed relation over components, parameters, features, capabilities or transitions.

## Why it exists

It replaces arbitrary executable conditions with reviewable closed semantics.
