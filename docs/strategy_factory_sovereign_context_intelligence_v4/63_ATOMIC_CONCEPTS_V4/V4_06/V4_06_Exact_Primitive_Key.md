...
The tuple primitive_id@exact_version that selects one immutable semantic definition.

## Why it exists

It prevents range-based dependency drift and makes every component reviewable against one exact contract.
