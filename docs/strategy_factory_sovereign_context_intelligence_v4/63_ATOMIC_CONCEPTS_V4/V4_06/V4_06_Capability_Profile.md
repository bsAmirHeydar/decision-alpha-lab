...
An exact declaration of platform and execution features available to a Treatment program.

## Why it exists

The reference profile is diagnostic-only and is not broker qualification.
