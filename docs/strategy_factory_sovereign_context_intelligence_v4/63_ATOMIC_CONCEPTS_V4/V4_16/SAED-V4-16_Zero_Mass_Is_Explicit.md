...
# Zero Mass Is Explicit

## Purpose

No-fill and unavailable outcome mass is represented separately from the continuous outcome distribution. This note is normative for the deterministic synthetic-reference implementation and must be read together with the machine-readable contracts, frozen upstream evidence, source package, negative fixtures, QA report, claim ledger and authority boundary.
