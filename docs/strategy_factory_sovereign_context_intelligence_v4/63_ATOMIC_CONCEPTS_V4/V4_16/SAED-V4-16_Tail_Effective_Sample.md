...
# Tail Effective Sample

## Purpose

Tail claims require sufficient observed samples; otherwise the system routes to manual review. This note is normative for the deterministic synthetic-reference implementation and must be read together with the machine-readable contracts, frozen upstream evidence, source package, negative fixtures, QA report, claim ledger and authority boundary.
