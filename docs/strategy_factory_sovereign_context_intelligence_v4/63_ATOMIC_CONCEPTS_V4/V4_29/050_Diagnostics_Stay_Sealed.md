...
# Diagnostics Stay Sealed

## Atomic rule

**Diagnostics Stay Sealed.** The rule is evaluated as a closed binary invariant in [[V4_29_Hidden_Evaluation_Air_Gap]]. It is never inferred from a nearby field and it never grants authority beyond the research-control reference.
