---
title: SAED V4-11 — Outcome Input Exclusion
...
# Outcome Input Exclusion

## Definition

The absolute deny rule for outcome cube, execution twin, benchmark and economic labels as V4-11 inputs.
