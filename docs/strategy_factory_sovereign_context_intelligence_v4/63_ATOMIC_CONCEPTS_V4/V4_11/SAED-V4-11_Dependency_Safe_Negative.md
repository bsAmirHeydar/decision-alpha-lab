---
title: SAED V4-11 — Dependency-Safe Negative
...
# Dependency-Safe Negative

## Definition

A negative sample outside the anchor root and consistent with the declared temporal availability policy.
