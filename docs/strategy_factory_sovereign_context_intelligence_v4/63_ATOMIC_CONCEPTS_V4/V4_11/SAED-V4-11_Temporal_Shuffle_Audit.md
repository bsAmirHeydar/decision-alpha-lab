---
title: SAED V4-11 — Temporal Shuffle Audit
...
# Temporal Shuffle Audit

## Definition

A deterministic order perturbation used to detect trivial or order-insensitive representation behavior.
