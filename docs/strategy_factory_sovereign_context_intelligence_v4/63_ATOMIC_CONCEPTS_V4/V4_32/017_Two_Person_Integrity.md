---
title: "V4-32 Atomic — Two Person Integrity"
phase: V4-32
...
**Two Person Integrity** is a closed V4-32 research-governance primitive with deterministic identity, explicit known-time semantics, content-addressed evidence, and fail-closed behavior.
