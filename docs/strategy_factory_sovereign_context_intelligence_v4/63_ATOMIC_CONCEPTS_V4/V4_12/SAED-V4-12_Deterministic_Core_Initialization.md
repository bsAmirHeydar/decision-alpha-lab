---
title: SAED V4-12 — Deterministic Core Initialization
...
# SAED V4-12 — Deterministic Core Initialization

## Definition

Reference core parameters derive only from candidate identity and seed.
