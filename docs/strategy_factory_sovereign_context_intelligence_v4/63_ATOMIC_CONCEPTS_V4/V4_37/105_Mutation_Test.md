---
title: "V4-37 Atomic Concept 105 — Mutation Test"
...
---
# SAED V4-37 Atomic Concept — Mutation Test

## Definition

**Mutation Test** is an atomic portfolio or execution-economics concept. It has one deterministic responsibility and a closed evidence shape so that economics can be audited independently from signal discovery, treatment selection and live execution.
