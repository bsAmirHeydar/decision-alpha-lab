---
title: "V4-37 Atomic Concept 049 — Cluster Exposure"
...
---
# SAED V4-37 Atomic Concept — Cluster Exposure

## Definition

**Cluster Exposure** is an atomic portfolio or execution-economics concept. It has one deterministic responsibility and a closed evidence shape so that economics can be audited independently from signal discovery, treatment selection and live execution.
