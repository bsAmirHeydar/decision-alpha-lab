---
title: "V4-37 Atomic Concept 102 — Closed Contract"
...
---
# SAED V4-37 Atomic Concept — Closed Contract

## Definition

**Closed Contract** is an atomic portfolio or execution-economics concept. It has one deterministic responsibility and a closed evidence shape so that economics can be audited independently from signal discovery, treatment selection and live execution.
