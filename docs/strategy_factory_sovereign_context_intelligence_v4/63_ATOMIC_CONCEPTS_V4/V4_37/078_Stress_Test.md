---
title: "V4-37 Atomic Concept 078 — Stress Test"
...
---
# SAED V4-37 Atomic Concept — Stress Test

## Definition

**Stress Test** is an atomic portfolio or execution-economics concept. It has one deterministic responsibility and a closed evidence shape so that economics can be audited independently from signal discovery, treatment selection and live execution.
