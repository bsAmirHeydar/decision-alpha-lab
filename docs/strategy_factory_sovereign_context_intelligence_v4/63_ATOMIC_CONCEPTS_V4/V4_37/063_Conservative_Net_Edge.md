---
title: "V4-37 Atomic Concept 063 — Conservative Net Edge"
...
---
# SAED V4-37 Atomic Concept — Conservative Net Edge

## Definition

**Conservative Net Edge** is an atomic portfolio or execution-economics concept. It has one deterministic responsibility and a closed evidence shape so that economics can be audited independently from signal discovery, treatment selection and live execution.
