---
title: "V4-37 Atomic Concept 099 — Fail Closed"
...
---
# SAED V4-37 Atomic Concept — Fail Closed

## Definition

**Fail Closed** is an atomic portfolio or execution-economics concept. It has one deterministic responsibility and a closed evidence shape so that economics can be audited independently from signal discovery, treatment selection and live execution.
