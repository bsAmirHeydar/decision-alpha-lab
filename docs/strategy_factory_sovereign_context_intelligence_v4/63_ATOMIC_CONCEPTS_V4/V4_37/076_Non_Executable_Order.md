---
title: "V4-37 Atomic Concept 076 — Non-Executable Order"
...
---
# SAED V4-37 Atomic Concept — Non-Executable Order

## Definition

**Non-Executable Order** is an atomic portfolio or execution-economics concept. It has one deterministic responsibility and a closed evidence shape so that economics can be audited independently from signal discovery, treatment selection and live execution.
