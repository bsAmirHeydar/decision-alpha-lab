---
title: "V4-37 Atomic Concept 085 — Worst-Case Net"
...
---
# SAED V4-37 Atomic Concept — Worst-Case Net

## Definition

**Worst-Case Net** is an atomic portfolio or execution-economics concept. It has one deterministic responsibility and a closed evidence shape so that economics can be audited independently from signal discovery, treatment selection and live execution.
