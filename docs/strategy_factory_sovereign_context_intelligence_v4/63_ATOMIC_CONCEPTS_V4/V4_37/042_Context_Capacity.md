---
title: "V4-37 Atomic Concept 042 — Context Capacity"
...
---
# SAED V4-37 Atomic Concept — Context Capacity

## Definition

**Context Capacity** is an atomic portfolio or execution-economics concept. It has one deterministic responsibility and a closed evidence shape so that economics can be audited independently from signal discovery, treatment selection and live execution.
