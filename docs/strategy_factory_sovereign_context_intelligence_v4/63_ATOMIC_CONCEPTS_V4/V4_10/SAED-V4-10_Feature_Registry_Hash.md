---
title: SAED V4-10 Atomic — Feature Registry Hash
...
# SAED V4-10 Atomic — Feature Registry Hash

## Definition

The commitment to the exact known-time feature vocabulary available to a manual program.
