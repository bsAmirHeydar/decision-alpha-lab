---
title: Atomic Concept — Manual Override Denial
...
# Manual Override Denial

## Definition

**Manual Override Denial** is an atomic V4-30 control concept. It has one canonical meaning, a deterministic identity boundary, an explicit evidence producer and a fail-closed consumer.
