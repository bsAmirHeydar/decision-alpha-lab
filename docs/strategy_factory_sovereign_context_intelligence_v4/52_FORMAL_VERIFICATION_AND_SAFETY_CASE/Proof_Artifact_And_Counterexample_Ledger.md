---
title: Proof Artifact And Counterexample Ledger
status: canonical
version: 4.0.0
created: '2026-07-13'
updated: '2026-07-13'
...
tags:
  - saed-v4
  - 52_formal_verification_and_safety_case
  - institutional-v4
---

# Mandate

Produce machine-checkable assurance that bounded decision, fallback, risk and runtime properties hold for declared domains and failure modes.

**This specification:** **Proof Artifact And Counterexample Ledger**.
...
- SMT/MILP verification challengers
- abstract interpretation
- runtime verification
- assurance case graphs
...
- runtime monitor fallback
- no proof by test count alone
