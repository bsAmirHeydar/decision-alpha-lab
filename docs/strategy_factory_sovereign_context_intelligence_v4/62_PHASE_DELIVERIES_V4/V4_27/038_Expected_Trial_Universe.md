---
title: V4-27 Delivery 038 — Expected Trial Universe
...
# Expected Trial Universe

## Normative statement

**Expected Trial Universe** is a mandatory control in the V4-27 complete-search and exposure-accounting boundary. The control is evaluated over frozen V4-26 lineage, exact actor identities, exact data roles, immutable experiment manifests, terminal trial histories and append-only exposure events. Unknown, missing, stale, contradictory or non-replayable states resolve fail-closed.
...
- [[037_Parent_Experiment_Lineage]]
- [[039_Per_Experiment_Trial_Budget]]
