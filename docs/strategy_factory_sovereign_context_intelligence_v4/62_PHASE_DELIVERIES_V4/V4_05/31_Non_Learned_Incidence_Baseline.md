---
title: Non-Learned Incidence Baseline
status: implemented
version: 1.0.0
phase: V4-05
created: '2026-07-15'
...
# Non-Learned Incidence Baseline

## Purpose

The retained baseline is a deterministic edge-by-node incidence matrix. Active membership is encoded as 1, absent membership as 0, and masked-edge membership as -1. The -1 value is a mask marker, not a negative causal or economic relationship. This baseline remains available when later graph models are challenged.
