...
The bounded scope covers closed node and relation catalogs, exact-version semantic rules, bitemporal incidence, deterministic construction, support assessment, integrity, replay, semantic diff, bounded query, deterministic partitioning, a non-learned incidence projection, Python implementation, MQL5 diagnostics, schemas, examples, tests, and evidence. Training, edge learning, treatment generation, ranking, risk, runtime activation, and order placement remain prohibited.
