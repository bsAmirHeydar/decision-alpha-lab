...
When an externally approved Treatment descriptor exists in the V4-04 Treatment Descriptor View, V4-05 creates a read-only descriptor node and a binding hyperedge. The graph cannot generate candidates, expand the Treatment universe, score Treatments, or grant execution authority.
...
- Previous: [[22_Context_Ancestry_Relation]]
- Phase home: [[00_MOC_V4_05_Semantic_And_Temporal_Hypergraph]]
- Next: [[24_Missingness_Masks_And_Unknowns]]
