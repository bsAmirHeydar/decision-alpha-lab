---
title: Deterministic Hyperedge Identity
status: implemented
version: 1.0.0
phase: V4-05
created: '2026-07-15'
...
# Deterministic Hyperedge Identity

## Purpose

Edge IDs are content-derived from relation kind, sorted member node IDs, temporal interval, known time, Evidence Role, and source rule ID. Incidence order is non-semantic. Duplicate members are prohibited. Edge hashes bind active and mask state, quality, reason codes, and incidence.
...
- Previous: [[13_Deterministic_Node_Identity]]
- Phase home: [[00_MOC_V4_05_Semantic_And_Temporal_Hypergraph]]
- Next: [[15_Incidence_And_Arity]]
