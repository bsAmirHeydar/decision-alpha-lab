...
Queries require explicit seed nodes, allowed relation kinds, allowed node kinds, hop budget, result budget, and masked-edge policy. Unknown seeds and excessive budgets fail closed. Query results are deterministic and hash-bound; querying confers no new authority.
...
- Previous: [[31_Non_Learned_Incidence_Baseline]]
- Phase home: [[00_MOC_V4_05_Semantic_And_Temporal_Hypergraph]]
- Next: [[33_Deterministic_Partitioning]]
