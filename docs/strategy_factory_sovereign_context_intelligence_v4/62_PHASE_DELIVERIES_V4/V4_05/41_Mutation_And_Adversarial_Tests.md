---
title: Mutation And Adversarial Tests
status: implemented
version: 1.0.0
phase: V4-05
created: '2026-07-15'
...
Hostile tests inject future nodes, cross-role nodes, inverted intervals, unknown relations, duplicate definitions, outcome selectors, tampered package hashes, dangling incidence, duplicate members, node and edge hash mismatches, budget exhaustion, unknown query seeds, and forbidden authority flags. Expected behavior is reject or quarantine, never silent repair.
...
- Previous: [[40_Test_Strategy]]
- Phase home: [[00_MOC_V4_05_Semantic_And_Temporal_Hypergraph]]
- Next: [[42_Security_And_Threat_Model]]
