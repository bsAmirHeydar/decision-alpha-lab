---
title: Context Ancestry Relation
status: implemented
version: 1.0.0
phase: V4-05
created: '2026-07-15'
...
# Context Ancestry Relation

## Purpose

When the Context Ancestry View exposes an approved parent Context identifier, V4-05 creates a read-only external Context reference node and an ancestry hyperedge. The external node is explicitly a reference and cannot mutate or materialize the parent Context.
...
- Previous: [[21_Semantic_Family_Relation]]
- Phase home: [[00_MOC_V4_05_Semantic_And_Temporal_Hypergraph]]
- Next: [[23_Treatment_Descriptor_Binding]]
