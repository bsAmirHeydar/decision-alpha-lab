...
Graph diff reports added, removed, and changed node and edge identities plus status and support changes. It is intended for controlled registry, policy, or source-package change review. Diff evidence does not authorize promotion or execution.
...
- Previous: [[29_Deterministic_Replay]]
- Phase home: [[00_MOC_V4_05_Semantic_And_Temporal_Hypergraph]]
- Next: [[31_Non_Learned_Incidence_Baseline]]
