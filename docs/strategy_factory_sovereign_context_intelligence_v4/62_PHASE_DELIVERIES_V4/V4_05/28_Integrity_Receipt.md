...
The integrity receipt binds graph hash, source package hash, registry hash, policy hash, lineage root, all node hashes, and all edge hashes into a component Merkle root. Verification rebuilds the receipt and compares the complete immutable object, not only a subset of fields.
...
- Previous: [[27_Structural_And_Semantic_Validation]]
- Phase home: [[00_MOC_V4_05_Semantic_And_Temporal_Hypergraph]]
- Next: [[29_Deterministic_Replay]]
