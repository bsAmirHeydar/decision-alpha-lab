---
title: V4-04 Input Package Contract
status: implemented
version: 1.0.0
phase: V4-05
created: '2026-07-15'
...
# V4-04 Input Package Contract

## Purpose

The sole canonical build input is an integrity-valid V4-04 Multimodal View Package bound to one twin, one known_as_of, one event_as_of, one Evidence Role, exact View versions, View hashes, lineage root, explicit missingness, quality vectors, and compatibility status. A package hash mismatch, incompatible status, absent required View, or cross-role content is rejected before graph construction.
