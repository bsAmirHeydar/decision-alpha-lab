---
title: V4-30 Signing Key Independence
...
# Signing Key Independence

## Purpose

This note defines the **Signing Key Independence** boundary inside SAED V4-30 independent and multi-lab replication. The implementation is deterministic, additive, closed-contract, synthetic-reference-only, and subordinate to the existing UCEE authority model.
