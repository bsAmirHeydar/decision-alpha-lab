---
title: V4-30 Adjudication Identity
...
created: '2026-07-16'
updated: '2026-07-16'
tags: [saed-v4, v4-30, independent-replication, disagreement]
---
...
This note defines the **Adjudication Identity** boundary inside SAED V4-30 independent and multi-lab replication. The implementation is deterministic, additive, closed-contract, synthetic-reference-only, and subordinate to the existing UCEE authority model.
