---
title: V4-30 One Assignment Per Lab
status: accepted-reference
version: 1.0.0
phase: SAED_V4_30
section: Blinded Exchange
created: '2026-07-16'
updated: '2026-07-16'
tags: [saed-v4, v4-30, independent-replication, blinded-exchange]
---

# One Assignment Per Lab

## Purpose

This note defines the **One Assignment Per Lab** boundary inside SAED V4-30 independent and multi-lab replication. The implementation is deterministic, additive, closed-contract, synthetic-reference-only, and subordinate to the existing UCEE authority model.
