---
title: SAED V4-11 — Multiresolution Tokenization
...
# SAED V4-11 — Multiresolution Tokenization

## Decision

Represents price, structure, time, higher-timeframe, intermarket, liquidity, session and ancestry information without silent flattening. This control is implemented for the deterministic synthetic-reference path and is subordinate to the V4-10 evidence boundary and UCEE authority model.
...
- [[11_Tokenizer_Contract|Previous control]]
- [[13_View_Mask_Semantics|Next control]]
