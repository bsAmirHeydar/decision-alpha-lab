---
title: SAED V4-11 — Architecture Decisions
...
# SAED V4-11 — Architecture Decisions

## Decision

Records why JSON checkpoints, root-group splits, explicit masks, dependency-safe negatives and reference-only registration were selected. This control is implemented for the deterministic synthetic-reference path and is subordinate to the V4-10 evidence boundary and UCEE authority model.
...
- [[60_File_Inventory_And_Hash_Ledger|Previous control]]
- [[62_Change_Log|Next control]]
