---
title: SAED V4-11 — Software Bill of Materials
...
# SAED V4-11 — Software Bill of Materials

## Decision

Records runtime and QA dependencies, source files, serialization format and external-network requirements. This control is implemented for the deterministic synthetic-reference path and is subordinate to the V4-10 evidence boundary and UCEE authority model.
...
- [[31_Checkpoint_Provenance|Previous control]]
- [[33_Contamination_Audit|Next control]]
