---
title: SAED V4-11 — View Mask Semantics
...
# SAED V4-11 — View Mask Semantics

## Decision

Preserves missingness as an observed state rather than imputing unsupported feature values. This control is implemented for the deterministic synthetic-reference path and is subordinate to the V4-10 evidence boundary and UCEE authority model.
...
- [[12_Multiresolution_Tokenization|Previous control]]
- [[14_Hypergraph_Tokenization|Next control]]
