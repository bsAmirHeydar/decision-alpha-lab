---
title: SAED V4-11 — Tokenizer Contract
...
# SAED V4-11 — Tokenizer Contract

## Decision

Defines canonical scalar normalization, stable vocabulary order, explicit special tokens, unknown handling and tokenizer content addressing. This control is implemented for the deterministic synthetic-reference path and is subordinate to the V4-10 evidence boundary and UCEE authority model.
...
- [[10_Descendant_Leakage_Control|Previous control]]
- [[12_Multiresolution_Tokenization|Next control]]
