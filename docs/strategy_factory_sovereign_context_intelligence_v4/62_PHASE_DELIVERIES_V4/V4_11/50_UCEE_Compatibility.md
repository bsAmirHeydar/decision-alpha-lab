---
title: SAED V4-11 — UCEE Compatibility
...
# SAED V4-11 — UCEE Compatibility

## Decision

Keeps promotion, authority, runtime, portfolio and release powers subordinate to UCEE and outside V4-11. This control is implemented for the deterministic synthetic-reference path and is subordinate to the V4-10 evidence boundary and UCEE authority model.
...
- [[49_Model_Risk_Controls|Previous control]]
- [[51_MQL5_Static_Mirror|Next control]]
