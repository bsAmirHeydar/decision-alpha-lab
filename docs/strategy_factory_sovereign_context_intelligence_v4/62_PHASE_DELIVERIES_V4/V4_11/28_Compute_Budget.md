---
title: SAED V4-11 — Compute Budget
...
# SAED V4-11 — Compute Budget

## Decision

Caps training pairs, epochs, embedding dimension, wall envelope, network access and hardware assumptions. This control is implemented for the deterministic synthetic-reference path and is subordinate to the V4-10 evidence boundary and UCEE authority model.
...
- [[27_Optimizer_And_Numerics|Previous control]]
- [[29_Exposure_Accounting|Next control]]
