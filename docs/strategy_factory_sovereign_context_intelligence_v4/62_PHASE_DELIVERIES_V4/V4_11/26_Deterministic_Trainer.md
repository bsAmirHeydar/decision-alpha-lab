---
title: SAED V4-11 — Deterministic Trainer
...
# SAED V4-11 — Deterministic Trainer

## Decision

Uses stable initialization, ordering, pair generation, updates and canonical serialization to produce replay-equivalent checkpoints. This control is implemented for the deterministic synthetic-reference path and is subordinate to the V4-10 evidence boundary and UCEE authority model.
...
- [[25_Pretraining_Curriculum|Previous control]]
- [[27_Optimizer_And_Numerics|Next control]]
