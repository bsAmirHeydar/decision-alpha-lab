---
title: SAED V4-11 — Graph Relation Reconstruction
...
# SAED V4-11 — Graph Relation Reconstruction

## Decision

Trains relation tokens against compatible view tokens to preserve semantic-temporal structure. This control is implemented for the deterministic synthetic-reference path and is subordinate to the V4-10 evidence boundary and UCEE authority model.
...
- [[20_Cross_View_Alignment|Previous control]]
- [[22_Context_Transition_Objective|Next control]]
