---
title: SAED V4-11 — Identity and Time Splits
...
# SAED V4-11 — Identity and Time Splits

## Decision

Partitions root Context identities and time windows before training so descendants, duplicates and future suffixes cannot leak across roles. This control is implemented for the deterministic synthetic-reference path and is subordinate to the V4-10 evidence boundary and UCEE authority model.
...
- [[08_Known_Time_Semantics|Previous control]]
- [[10_Descendant_Leakage_Control|Next control]]
