---
title: SAED V4-11 — Masked Span Objective
...
# SAED V4-11 — Masked Span Objective

## Decision

Learns local semantic regularities by reconstructing withheld known-time tokens from visible Context tokens. This control is implemented for the deterministic synthetic-reference path and is subordinate to the V4-10 evidence boundary and UCEE authority model.
...
- [[16_Augmentation_Policy|Previous control]]
- [[18_Next_Event_Objective|Next control]]
