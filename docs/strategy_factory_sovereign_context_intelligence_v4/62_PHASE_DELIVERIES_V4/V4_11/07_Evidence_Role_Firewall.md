---
title: SAED V4-11 — Evidence Role Firewall
...
# SAED V4-11 — Evidence Role Firewall

## Decision

Prevents protected-final, prospective, shadow and live evidence from entering pretraining or evaluation. This control is implemented for the deterministic synthetic-reference path and is subordinate to the V4-10 evidence boundary and UCEE authority model.
...
- [[06_Corpus_Membership_Contract|Previous control]]
- [[08_Known_Time_Semantics|Next control]]
