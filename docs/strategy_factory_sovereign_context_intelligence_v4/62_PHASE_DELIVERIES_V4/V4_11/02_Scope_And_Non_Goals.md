---
title: SAED V4-11 — Scope and Non-Goals
...
# SAED V4-11 — Scope and Non-Goals

## Decision

Separates representation learning from outcome modeling, treatment ranking, policy value, portfolio allocation and execution. This control is implemented for the deterministic synthetic-reference path and is subordinate to the V4-10 evidence boundary and UCEE authority model.
...
- [[01_Executive_Architecture|Previous control]]
- [[03_Entry_Gates|Next control]]
