---
title: SAED V4-11 — Temporal Shuffle Test
...
# SAED V4-11 — Temporal Shuffle Test

## Decision

Applies a deterministic order perturbation as a diagnostic against order-insensitive or trivially memorized representations. This control is implemented for the deterministic synthetic-reference path and is subordinate to the V4-10 evidence boundary and UCEE authority model.
...
- [[34_Membership_Canaries|Previous control]]
- [[36_Representation_Collapse|Next control]]
