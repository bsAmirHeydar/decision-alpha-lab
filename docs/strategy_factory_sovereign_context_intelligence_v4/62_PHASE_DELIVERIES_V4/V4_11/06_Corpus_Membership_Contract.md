---
title: SAED V4-11 — Corpus Membership Contract
...
# SAED V4-11 — Corpus Membership Contract

## Decision

Makes every sample reconstructible by record identity, Context ancestry, domain, event time, known time, role and source hashes. This control is implemented for the deterministic synthetic-reference path and is subordinate to the V4-10 evidence boundary and UCEE authority model.
...
- [[05_V4_10_Handoff_Intake|Previous control]]
- [[07_Evidence_Role_Firewall|Next control]]
