---
title: SAED V4-11 — Representation Collapse
...
# SAED V4-11 — Representation Collapse

## Decision

Measures dimension variance, pairwise cosine concentration and unique embedding fraction before registry admission. This control is implemented for the deterministic synthetic-reference path and is subordinate to the V4-10 evidence boundary and UCEE authority model.
...
- [[35_Temporal_Shuffle_Test|Previous control]]
- [[37_Linear_Probe|Next control]]
