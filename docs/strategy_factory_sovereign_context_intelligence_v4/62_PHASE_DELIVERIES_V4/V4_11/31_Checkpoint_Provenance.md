---
title: SAED V4-11 — Checkpoint Provenance
...
# SAED V4-11 — Checkpoint Provenance

## Decision

Binds the checkpoint to corpus, split, tokenizer, objectives, compute budget, exposure ledger and training receipt hashes. This control is implemented for the deterministic synthetic-reference path and is subordinate to the V4-10 evidence boundary and UCEE authority model.
...
- [[30_Checkpoint_Format|Previous control]]
- [[32_Software_Bill_Of_Materials|Next control]]
