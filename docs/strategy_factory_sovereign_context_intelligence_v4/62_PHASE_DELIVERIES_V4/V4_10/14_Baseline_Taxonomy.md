---
title: SAED V4-10 — Baseline Taxonomy
...
# SAED V4-10 — Baseline Taxonomy

## Purpose

The registry includes a null abstain baseline and predeclared manual-doctrine baselines. Future phases may add challengers but may not mutate these identities.
