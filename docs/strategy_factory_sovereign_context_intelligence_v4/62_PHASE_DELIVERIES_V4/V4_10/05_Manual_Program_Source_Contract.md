---
title: SAED V4-10 — Manual Program Source Contract
...
# SAED V4-10 — Manual Program Source Contract

## Purpose

The source contract contains explicit version, evidence role, authoring basis, priority-ordered rules, known-time predicates, action-node references and an abstain/skip fallback.
