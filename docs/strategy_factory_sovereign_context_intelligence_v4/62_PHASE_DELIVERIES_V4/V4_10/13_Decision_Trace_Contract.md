---
title: SAED V4-10 — Decision Trace Contract
...
# SAED V4-10 — Decision Trace Contract

## Purpose

The trace records source hashes, times, matched rule, projected node, reason code and all evaluated checks. It is evidence of deterministic manual logic, not trading permission.
