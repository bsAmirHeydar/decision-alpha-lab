---
title: SAED V4-10 — Negative and Mutation Testing
...
# SAED V4-10 — Negative and Mutation Testing

## Purpose

Fixtures deliberately violate feature, node, fallback and priority invariants. Mutation testing verifies the validator rejects them before artifact generation.
