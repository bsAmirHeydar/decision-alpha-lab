---
title: SAED V4-10 — Test Evidence
...
# SAED V4-10 — Test Evidence

## Purpose

Evidence is separated into local Python/schema/static results and unavailable external MetaEditor, broker, prospective, shadow and live results.
