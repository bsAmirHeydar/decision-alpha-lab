---
title: SAED V4-10 — Exposure Accounting
...
# SAED V4-10 — Exposure Accounting

## Purpose

The exposure ledger compares expected registry keys with observed benchmark keys. Missing, duplicate or unexpected baselines fail the phase.
