---
title: SAED V4-10 — Scope and Non-Goals
...
# SAED V4-10 — Scope and Non-Goals

## Purpose

Scope is deterministic manual projection and baseline preservation. Non-goals include learned encoders, treatment ranking, policy value estimation, promotion, capital allocation, runtime activation and order transmission.
