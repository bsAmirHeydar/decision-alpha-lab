---
title: SAED V4-10 — Compiler Architecture
...
# SAED V4-10 — Compiler Architecture

## Purpose

Compilation validates evidence role, feature registry membership, forbidden tokens, node identity, node class, fallback class and authority flags, then emits a content-addressed program.
