---
title: SAED V4-10 — Integrity Receipt
...
# SAED V4-10 — Integrity Receipt

## Purpose

Compiled programs, traces, registry, benchmark, exposure, corpus and telemetry hashes are committed into a Merkle-root receipt.
