---
title: SAED V4-10 — Execution Stress Metrics
...
# SAED V4-10 — Execution Stress Metrics

## Purpose

Metrics include mean, median, p10 and worst adjusted net R, execution cost, fill fraction, rejection rate and per-scenario summaries. Synthetic watermarking is retained.
