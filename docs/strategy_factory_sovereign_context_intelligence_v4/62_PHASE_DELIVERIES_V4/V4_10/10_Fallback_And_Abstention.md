---
title: SAED V4-10 — Fallback and Abstention
...
# SAED V4-10 — Fallback and Abstention

## Purpose

Every program has a fail-closed fallback that resolves only to an action-lattice abstain or skip node. Ordinary treatment nodes cannot be used as implicit fallbacks.
