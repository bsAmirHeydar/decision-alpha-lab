---
title: V4-31 Terminal Semantics
status: canonical
version: 1.0.0
created: '2026-07-16'
updated: '2026-07-16'
...
This note specifies **Terminal Semantics** as a closed component of SAED_V4_31. It exists to make the formal-verification and safety-case evidence deterministic, reviewable, replayable and incapable of acquiring trading authority. The component is interpreted only inside the finite synthetic reference scope declared by the phase certificate.
...
- Previous: [[050_Reachable_Semantics]]
- Next: [[052_Transition_Always_Semantics]]
