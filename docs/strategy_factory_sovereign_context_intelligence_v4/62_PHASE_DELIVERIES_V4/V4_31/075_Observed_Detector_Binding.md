---
title: V4-31 Observed Detector Binding
status: canonical
version: 1.0.0
created: '2026-07-16'
updated: '2026-07-16'
...
# Observed Detector Binding

## Purpose

This note specifies **Observed Detector Binding** as a closed component of SAED_V4_31. It exists to make the formal-verification and safety-case evidence deterministic, reviewable, replayable and incapable of acquiring trading authority. The component is interpreted only inside the finite synthetic reference scope declared by the phase certificate.
...
- Previous: [[074_Expected_Detector_Binding]]
- Next: [[076_Mutation_Kill_Definition]]
