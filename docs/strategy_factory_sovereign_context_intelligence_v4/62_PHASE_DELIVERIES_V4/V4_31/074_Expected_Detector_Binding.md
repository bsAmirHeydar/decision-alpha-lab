---
title: V4-31 Expected Detector Binding
status: canonical
version: 1.0.0
created: '2026-07-16'
updated: '2026-07-16'
...
# Expected Detector Binding

## Purpose

This note specifies **Expected Detector Binding** as a closed component of SAED_V4_31. It exists to make the formal-verification and safety-case evidence deterministic, reviewable, replayable and incapable of acquiring trading authority. The component is interpreted only inside the finite synthetic reference scope declared by the phase certificate.
...
- Previous: [[073_Transition_Addition_Mutation]]
- Next: [[075_Observed_Detector_Binding]]
