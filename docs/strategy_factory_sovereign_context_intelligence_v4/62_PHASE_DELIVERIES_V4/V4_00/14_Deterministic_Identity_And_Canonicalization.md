---
title: Deterministic Identity And Canonicalization
status: implemented
version: 1.0.0
phase: V4-00
created: '2026-07-13'
...
> **Focus:** Canonical JSON, stable IDs and replay-independent timestamps.
...
Canonical JSON, stable IDs and replay-independent timestamps. This area is implemented as a closed, exact-version contract rather than an informal convention. Unknown fields are rejected, hashes are pinned and all decisions carry explicit reason codes.
