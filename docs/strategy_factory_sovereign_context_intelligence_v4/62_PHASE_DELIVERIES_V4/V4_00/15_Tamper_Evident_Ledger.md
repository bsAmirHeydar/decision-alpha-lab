...
> **Focus:** Hash-chain structure, sequence invariants and verification.
...
Hash-chain structure, sequence invariants and verification. This area is implemented as a closed, exact-version contract rather than an informal convention. Unknown fields are rejected, hashes are pinned and all decisions carry explicit reason codes.
