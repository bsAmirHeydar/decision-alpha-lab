...
> **Focus:** Unit, contract, mutation, replay and static-boundary testing.
...
Unit, contract, mutation, replay and static-boundary testing. This area is implemented as a closed, exact-version contract rather than an informal convention. Unknown fields are rejected, hashes are pinned and all decisions carry explicit reason codes.
