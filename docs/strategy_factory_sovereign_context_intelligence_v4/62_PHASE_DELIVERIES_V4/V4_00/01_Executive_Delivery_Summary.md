...
> **Focus:** What was built, what is enforced and what is not claimed.
...
What was built, what is enforced and what is not claimed. This area is implemented as a closed, exact-version contract rather than an informal convention. Unknown fields are rejected, hashes are pinned and all decisions carry explicit reason codes.
