---
title: Failure And Escalation Runbook
status: implemented
version: 1.0.0
phase: V4-00
created: '2026-07-13'
...
> **Focus:** What to do when a rule, hash, role or authority is violated.
...
What to do when a rule, hash, role or authority is violated. This area is implemented as a closed, exact-version contract rather than an informal convention. Unknown fields are rejected, hashes are pinned and all decisions carry explicit reason codes.
