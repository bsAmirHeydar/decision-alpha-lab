---
title: Golden Negative And Mutation Fixtures
status: implemented
version: 1.0.0
phase: V4-00
created: '2026-07-13'
...
# Golden Negative And Mutation Fixtures

> **Focus:** Positive fixtures, malformed contracts and forbidden-authority mutations.
...
Positive fixtures, malformed contracts and forbidden-authority mutations. This area is implemented as a closed, exact-version contract rather than an informal convention. Unknown fields are rejected, hashes are pinned and all decisions carry explicit reason codes.
