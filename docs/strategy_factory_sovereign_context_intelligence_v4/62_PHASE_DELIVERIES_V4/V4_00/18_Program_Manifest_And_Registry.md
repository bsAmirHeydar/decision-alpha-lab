---
title: Program Manifest And Exact-Version Registry
status: implemented
version: 1.0.0
phase: V4-00
created: '2026-07-13'
...
# Program Manifest And Exact-Version Registry

> **Focus:** Frozen hashes, owners, budgets and immutable exact-version keys.
...
Frozen hashes, owners, budgets and immutable exact-version keys. This area is implemented as a closed, exact-version contract rather than an informal convention. Unknown fields are rejected, hashes are pinned and all decisions carry explicit reason codes.
