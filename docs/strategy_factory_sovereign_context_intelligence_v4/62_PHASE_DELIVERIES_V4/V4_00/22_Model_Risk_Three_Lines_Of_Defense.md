---
title: Model Risk Three Lines Of Defense
status: implemented
version: 1.0.0
phase: V4-00
created: '2026-07-13'
...
# Model Risk Three Lines Of Defense

> **Focus:** Research ownership, independent validation and internal audit.
...
Research ownership, independent validation and internal audit. This area is implemented as a closed, exact-version contract rather than an informal convention. Unknown fields are rejected, hashes are pinned and all decisions carry explicit reason codes.
