...
> **Focus:** Read-only consumption, authority ownership and additive integration.
...
Read-only consumption, authority ownership and additive integration. This area is implemented as a closed, exact-version contract rather than an informal convention. Unknown fields are rejected, hashes are pinned and all decisions carry explicit reason codes.
