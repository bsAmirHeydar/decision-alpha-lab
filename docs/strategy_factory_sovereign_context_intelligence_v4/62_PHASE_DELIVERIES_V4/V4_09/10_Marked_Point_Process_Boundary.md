---
title: Marked Point Process Boundary
...
# Marked Point Process Boundary

## Institutional intent

Reserve advanced marked point-process calibration for governed challengers and prevent synthetic evidence from promotion claims. The implementation is subordinate to immutable Context truth, the V4-08 Executable Path Outcome Cube, protected evidence roles, UCEE promotion, hard risk, portfolio governance, runtime compilation, and I18 production qualification.
