---
title: Broker Calibration Qualification
...
# Broker Calibration Qualification

## Institutional intent

Define the future evidence needed for calibrated fill, latency, reject, impact, and adverse-selection claims. The implementation is subordinate to immutable Context truth, the V4-08 Executable Path Outcome Cube, protected evidence roles, UCEE promotion, hard risk, portfolio governance, runtime compilation, and I18 production qualification.
