---
title: Nonnegative Wealth Invariant
...
# Nonnegative Wealth Invariant

This note is part of the accepted V4-28 online-FDR reference. It specifies the **nonnegative wealth invariant** contract as a closed, deterministic, known-time research control. The implementation consumes only the immutable V4-27 completeness evidence and cannot access hidden evaluation data.
