---
title: One Shot Token Next Work
...
# One Shot Token Next Work

This note is part of the accepted V4-28 online-FDR reference. It specifies the **one shot token next work** contract as a closed, deterministic, known-time research control. The implementation consumes only the immutable V4-27 completeness evidence and cannot access hidden evaluation data.
