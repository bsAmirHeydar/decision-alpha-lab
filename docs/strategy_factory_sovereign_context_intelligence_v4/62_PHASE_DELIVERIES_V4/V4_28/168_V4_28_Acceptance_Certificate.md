---
title: V4 28 Acceptance Certificate
...
# V4 28 Acceptance Certificate

This note is part of the accepted V4-28 online-FDR reference. It specifies the **v4 28 acceptance certificate** contract as a closed, deterministic, known-time research control. The implementation consumes only the immutable V4-27 completeness evidence and cannot access hidden evaluation data.
