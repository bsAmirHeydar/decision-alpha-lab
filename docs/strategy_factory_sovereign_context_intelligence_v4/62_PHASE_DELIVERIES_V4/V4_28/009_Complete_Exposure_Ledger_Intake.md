---
title: Complete Exposure Ledger Intake
...
# Complete Exposure Ledger Intake

This note is part of the accepted V4-28 online-FDR reference. It specifies the **complete exposure ledger intake** contract as a closed, deterministic, known-time research control. The implementation consumes only the immutable V4-27 completeness evidence and cannot access hidden evaluation data.
