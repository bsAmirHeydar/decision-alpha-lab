...
# Gamma Sequence Registry

This note is part of the accepted V4-28 online-FDR reference. It specifies the **gamma sequence registry** contract as a closed, deterministic, known-time research control. The implementation consumes only the immutable V4-27 completeness evidence and cannot access hidden evaluation data.
