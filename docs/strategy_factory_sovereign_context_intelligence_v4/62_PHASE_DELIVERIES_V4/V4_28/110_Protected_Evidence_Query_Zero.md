---
title: Protected Evidence Query Zero
...
# Protected Evidence Query Zero

This note is part of the accepted V4-28 online-FDR reference. It specifies the **protected evidence query zero** contract as a closed, deterministic, known-time research control. The implementation consumes only the immutable V4-27 completeness evidence and cannot access hidden evaluation data.
