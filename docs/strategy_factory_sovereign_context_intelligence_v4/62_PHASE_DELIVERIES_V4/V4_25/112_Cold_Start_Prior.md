---
title: "V4-25 112 — Cold Start Prior"
...
The objective of **Cold Start Prior** is to make this boundary explicit, machine-checkable, and reproducible. The control is evaluated before any downstream artifact can be accepted. Unknown fields, missing identities, non-finite values, future-known inputs, protected-evidence access, or authority escalation invalidate the artifact rather than being silently coerced.
...
- Previous: [[111_Transfer_Graph_Contract]]
- Phase map: [[00_MOC_V4_25_Continual_Meta_And_Transfer]]
- Next: [[113_Weighted_Source_Prior]]
