---
title: "V4-25 161 — Downside Residual Definition"
...
The objective of **Downside Residual Definition** is to make this boundary explicit, machine-checkable, and reproducible. The control is evaluated before any downstream artifact can be accepted. Unknown fields, missing identities, non-finite values, future-known inputs, protected-evidence access, or authority escalation invalidate the artifact rather than being silently coerced.
...
- Previous: [[160_Residual_Pool_Construction]]
- Phase map: [[00_MOC_V4_25_Continual_Meta_And_Transfer]]
- Next: [[162_Finite_Sample_Rank_Correction]]
