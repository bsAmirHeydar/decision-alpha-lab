---
title: "V4-25 170 — Calibration Fail Closed"
...
The objective of **Calibration Fail Closed** is to make this boundary explicit, machine-checkable, and reproducible. The control is evaluated before any downstream artifact can be accepted. Unknown fields, missing identities, non-finite values, future-known inputs, protected-evidence access, or authority escalation invalidate the artifact rather than being silently coerced.
...
- Previous: [[169_No_Runtime_Mutation]]
- Phase map: [[00_MOC_V4_25_Continual_Meta_And_Transfer]]
- Next: [[171_Calibration_State_Replay]]
