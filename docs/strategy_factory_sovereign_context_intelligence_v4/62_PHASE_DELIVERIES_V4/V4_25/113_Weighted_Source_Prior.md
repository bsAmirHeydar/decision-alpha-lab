---
title: "V4-25 113 — Weighted Source Prior"
...
The objective of **Weighted Source Prior** is to make this boundary explicit, machine-checkable, and reproducible. The control is evaluated before any downstream artifact can be accepted. Unknown fields, missing identities, non-finite values, future-known inputs, protected-evidence access, or authority escalation invalidate the artifact rather than being silently coerced.
...
- Previous: [[112_Cold_Start_Prior]]
- Phase map: [[00_MOC_V4_25_Continual_Meta_And_Transfer]]
- Next: [[114_Scratch_Baseline_Fallback]]
