---
title: "V4-25 146 — Support Fisher Diagonal Approximation"
...
# Support Fisher Diagonal Approximation

## Control objective

Continual regularization estimates a diagonal importance vector from support features and applies a bounded quadratic anchor to baseline parameters. The mechanism limits destructive movement and creates an explicit forgetting-control receipt.

The objective of **Support Fisher Diagonal Approximation** is to make this boundary explicit, machine-checkable, and reproducible. The control is evaluated before any downstream artifact can be accepted. Unknown fields, missing identities, non-finite values, future-known inputs, protected-evidence access, or authority escalation invalidate the artifact rather than being silently coerced.
...
- Previous: [[145_Continual_Regularization_Contract]]
- Phase map: [[00_MOC_V4_25_Continual_Meta_And_Transfer]]
- Next: [[147_Parameter_Importance]]
