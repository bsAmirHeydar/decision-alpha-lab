---
title: "V4-25 009 — Decision Time Semantics"
...
The objective of **Decision Time Semantics** is to make this boundary explicit, machine-checkable, and reproducible. The control is evaluated before any downstream artifact can be accepted. Unknown fields, missing identities, non-finite values, future-known inputs, protected-evidence access, or authority escalation invalidate the artifact rather than being silently coerced.
...
- Previous: [[008_Known_Time_Constitution]]
- Phase map: [[00_MOC_V4_25_Continual_Meta_And_Transfer]]
- Next: [[010_Feature_Known_At_Semantics]]
