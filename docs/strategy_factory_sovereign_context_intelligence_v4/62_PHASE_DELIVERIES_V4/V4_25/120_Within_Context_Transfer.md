---
title: "V4-25 120 — Within Context Transfer"
...
The objective of **Within Context Transfer** is to make this boundary explicit, machine-checkable, and reproducible. The control is evaluated before any downstream artifact can be accepted. Unknown fields, missing identities, non-finite values, future-known inputs, protected-evidence access, or authority escalation invalidate the artifact rather than being silently coerced.
...
- Previous: [[119_Cross_Context_Transfer]]
- Phase map: [[00_MOC_V4_25_Continual_Meta_And_Transfer]]
- Next: [[121_Negative_Transfer_Risk]]
