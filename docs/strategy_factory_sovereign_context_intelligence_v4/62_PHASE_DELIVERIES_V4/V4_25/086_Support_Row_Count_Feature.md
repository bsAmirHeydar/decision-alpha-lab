---
title: "V4-25 086 — Support Row Count Feature"
...
The objective of **Support Row Count Feature** is to make this boundary explicit, machine-checkable, and reproducible. The control is evaluated before any downstream artifact can be accepted. Unknown fields, missing identities, non-finite values, future-known inputs, protected-evidence access, or authority escalation invalidate the artifact rather than being silently coerced.
...
- Previous: [[085_Support_Dispersion_Feature]]
- Phase map: [[00_MOC_V4_25_Continual_Meta_And_Transfer]]
- Next: [[087_Support_Quality_Feature]]
