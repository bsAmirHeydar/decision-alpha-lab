---
title: "V4-25 171 — Calibration State Replay"
...
The objective of **Calibration State Replay** is to make this boundary explicit, machine-checkable, and reproducible. The control is evaluated before any downstream artifact can be accepted. Unknown fields, missing identities, non-finite values, future-known inputs, protected-evidence access, or authority escalation invalidate the artifact rather than being silently coerced.
...
- Previous: [[170_Calibration_Fail_Closed]]
- Phase map: [[00_MOC_V4_25_Continual_Meta_And_Transfer]]
- Next: [[172_Calibration_Staleness_Risk]]
