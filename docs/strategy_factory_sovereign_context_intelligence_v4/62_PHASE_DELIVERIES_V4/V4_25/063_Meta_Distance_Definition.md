---
title: "V4-25 063 — Meta Distance Definition"
...
The objective of **Meta Distance Definition** is to make this boundary explicit, machine-checkable, and reproducible. The control is evaluated before any downstream artifact can be accepted. Unknown fields, missing identities, non-finite values, future-known inputs, protected-evidence access, or authority escalation invalidate the artifact rather than being silently coerced.
...
- Previous: [[062_Fail_Closed_Novel_Semantics]]
- Phase map: [[00_MOC_V4_25_Continual_Meta_And_Transfer]]
- Next: [[064_Stationary_Threshold]]
