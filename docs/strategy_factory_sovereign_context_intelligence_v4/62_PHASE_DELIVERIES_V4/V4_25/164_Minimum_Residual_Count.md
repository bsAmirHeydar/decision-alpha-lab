---
title: "V4-25 164 — Minimum Residual Count"
...
The objective of **Minimum Residual Count** is to make this boundary explicit, machine-checkable, and reproducible. The control is evaluated before any downstream artifact can be accepted. Unknown fields, missing identities, non-finite values, future-known inputs, protected-evidence access, or authority escalation invalidate the artifact rather than being silently coerced.
...
- Previous: [[163_Calibration_Alpha]]
- Phase map: [[00_MOC_V4_25_Continual_Meta_And_Transfer]]
- Next: [[165_Calibration_Readiness_Gate]]
