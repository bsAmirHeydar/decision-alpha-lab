---
title: SAED V4-18 — Negative-Control Outcome
...
---
# SAED V4-18 — Negative-Control Outcome

## Purpose

Falsification test for spurious policy value. This note is part of the closed implementation dossier for deterministic synthetic treatment-effect and policy-value research.
