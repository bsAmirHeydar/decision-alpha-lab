---
title: SAED V4-18 — Direct-Method Value
...
---
# SAED V4-18 — Direct-Method Value

## Purpose

Outcome-model policy value. This note is part of the closed implementation dossier for deterministic synthetic treatment-effect and policy-value research.
