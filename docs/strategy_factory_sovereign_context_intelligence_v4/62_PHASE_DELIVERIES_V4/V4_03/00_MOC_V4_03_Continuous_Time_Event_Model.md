---
title: V4-03 Continuous-Time Event Model
status: implemented
version: 1.0.0
phase: V4-03
created: '2026-07-13'
...
---
# V4-03 Continuous-Time Event Model

## Navigation

1. Read the authority and bitemporal chapters first.
2. Review stream identity, atomic ingestion and canonical ordering.
3. Review watermarks, corrections, gaps and asynchronous alignment.
4. Review projection DSL, replay, integrity and the V4-04 handoff.

## Related

- [[00_MOC_V4_02_Context_Digital_Twin_Kernel]]
- [[V4_03_Continuous_Time_Event_Model]]
- [[03_Continuous_Time_Event_Foundation_Blueprint]]
