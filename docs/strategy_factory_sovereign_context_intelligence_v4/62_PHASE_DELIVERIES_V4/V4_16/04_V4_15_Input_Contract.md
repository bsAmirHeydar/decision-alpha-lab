...
# V4-15 Input Contract

## Purpose

Immutable binding to frozen fusion features, registry hashes, integrity receipt and known-time identity from V4-15. This note is normative for the deterministic synthetic-reference implementation and must be read together with the machine-readable contracts, frozen upstream evidence, source package, negative fixtures, QA report, claim ledger and authority boundary.
