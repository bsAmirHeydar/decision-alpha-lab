...
Adversarial mutation that exchanges stop and target identity and must be detected as a registry/evidence change. This note is normative for the deterministic synthetic-reference implementation and must be read together with the machine-readable contracts, frozen upstream evidence, source package, negative fixtures, QA report, claim ledger and authority boundary.
