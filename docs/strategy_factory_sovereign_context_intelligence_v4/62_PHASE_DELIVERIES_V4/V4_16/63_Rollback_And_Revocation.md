...
Additive removal, registry revocation and downstream handoff invalidation without rewriting V4-15. This note is normative for the deterministic synthetic-reference implementation and must be read together with the machine-readable contracts, frozen upstream evidence, source package, negative fixtures, QA report, claim ledger and authority boundary.
