...
The local evidence scope, test classes, mutation coverage, and explicit external-evidence exclusions. This note is normative for the V4-14 reference implementation and must be read together with the machine-readable contracts, artifacts, tests, and authority boundary.
