---
title: Patching and Context Window
status: canonical
version: 1.0.0
phase: SAED_V4_14
created: '2026-07-16'
...
# Patching and Context Window

## Purpose

Bounded sequence length, patching, truncation, and context-window invariants. This note is normative for the V4-14 reference implementation and must be read together with the machine-readable contracts, artifacts, tests, and authority boundary.
