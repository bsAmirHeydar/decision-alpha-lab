...
Opaque corpus, overlap, benchmark artifact, domain shift, calibration, dependency, complexity, and false-oracle risk. This note is normative for the V4-14 reference implementation and must be read together with the machine-readable contracts, artifacts, tests, and authority boundary.
