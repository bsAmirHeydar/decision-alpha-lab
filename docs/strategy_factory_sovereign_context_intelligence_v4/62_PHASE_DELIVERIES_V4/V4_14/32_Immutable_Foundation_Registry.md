---
title: Immutable Foundation Registry
status: canonical
version: 1.0.0
phase: SAED_V4_14
created: '2026-07-16'
...
# Immutable Foundation Registry

## Purpose

Research checkpoint admission, immutability, revocation, and runtime-authority denial. This note is normative for the V4-14 reference implementation and must be read together with the machine-readable contracts, artifacts, tests, and authority boundary.
