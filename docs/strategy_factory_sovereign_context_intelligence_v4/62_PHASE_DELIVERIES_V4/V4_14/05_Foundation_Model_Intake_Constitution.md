---
title: Foundation Model Intake Constitution
status: canonical
version: 1.0.0
phase: SAED_V4_14
created: '2026-07-16'
...
# Foundation Model Intake Constitution

## Purpose

Closed intake semantics for family, release, provenance, code, weights, tokenizer, license, disclosure, and lifecycle. This note is normative for the V4-14 reference implementation and must be read together with the machine-readable contracts, artifacts, tests, and authority boundary.
