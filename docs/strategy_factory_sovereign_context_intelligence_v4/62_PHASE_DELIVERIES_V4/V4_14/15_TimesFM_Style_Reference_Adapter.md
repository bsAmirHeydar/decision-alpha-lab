---
title: TimesFM-Style Reference Adapter
status: canonical
version: 1.0.0
phase: SAED_V4_14
created: '2026-07-16'
...
# TimesFM-Style Reference Adapter

## Purpose

A local deterministic patch-embedding emulation, explicitly not a real TimesFM checkpoint evaluation. This note is normative for the V4-14 reference implementation and must be read together with the machine-readable contracts, artifacts, tests, and authority boundary.
