---
title: Conformance and Negative Vectors
status: canonical
version: 1.0.0
phase: SAED_V4_14
created: '2026-07-16'
...
Positive authority vectors and mutations for unknown fields, remote inference, future access, and budget breach. This note is normative for the V4-14 reference implementation and must be read together with the machine-readable contracts, artifacts, tests, and authority boundary.
