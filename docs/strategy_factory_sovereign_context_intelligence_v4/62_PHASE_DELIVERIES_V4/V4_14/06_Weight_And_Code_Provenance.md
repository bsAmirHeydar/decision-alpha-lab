---
title: Weight and Code Provenance
status: canonical
version: 1.0.0
phase: SAED_V4_14
created: '2026-07-16'
...
# Weight and Code Provenance

## Purpose

Digest, source, signature, reproducibility, custody, and revocation requirements for model artifacts. This note is normative for the V4-14 reference implementation and must be read together with the machine-readable contracts, artifacts, tests, and authority boundary.
