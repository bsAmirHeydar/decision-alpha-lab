...
# Adapter Mode Taxonomy

## Purpose

Causal linear, frozen embedding, zero-shot distribution, masked representation, probabilistic multiscale, and sparse-expert modes. This note is normative for the V4-14 reference implementation and must be read together with the machine-readable contracts, artifacts, tests, and authority boundary.
