---
title: Moirai-Style Reference Adapter
status: canonical
version: 1.0.0
phase: SAED_V4_14
created: '2026-07-16'
...
# Moirai-Style Reference Adapter

## Purpose

A local multiscale probabilistic feature emulation with no external checkpoint claim. This note is normative for the V4-14 reference implementation and must be read together with the machine-readable contracts, artifacts, tests, and authority boundary.
