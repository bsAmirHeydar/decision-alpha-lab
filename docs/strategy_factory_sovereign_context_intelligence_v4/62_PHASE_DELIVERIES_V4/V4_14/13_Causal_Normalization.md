...
Expanding-only statistics and the prohibition on fold-global or future-conditioned normalization. This note is normative for the V4-14 reference implementation and must be read together with the machine-readable contracts, artifacts, tests, and authority boundary.
