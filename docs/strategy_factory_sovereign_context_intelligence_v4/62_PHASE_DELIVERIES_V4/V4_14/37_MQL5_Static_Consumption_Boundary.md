...
MQL5 may validate and consume frozen feature envelopes; it cannot call remote models or issue orders. This note is normative for the V4-14 reference implementation and must be read together with the machine-readable contracts, artifacts, tests, and authority boundary.
