...
Patch-level file identity, SHA-256 ledger, manifest, and reproducible installation boundary. This note is normative for the V4-14 reference implementation and must be read together with the machine-readable contracts, artifacts, tests, and authority boundary.
