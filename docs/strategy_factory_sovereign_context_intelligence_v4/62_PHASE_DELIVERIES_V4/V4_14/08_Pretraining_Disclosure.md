...
Required declarations about training cutoff, market-data possibility, corpus opacity, and unresolved overlap risk. This note is normative for the V4-14 reference implementation and must be read together with the machine-readable contracts, artifacts, tests, and authority boundary.
