---
title: Constraint Declaration Grammar
status: implemented
version: 1.0.0
phase: V4-06
created: '2026-07-15'
...
# Constraint Declaration Grammar

## Purpose

Represent Treatment relationships as finite typed declarations rather than executable expressions.

## Contract

Supported kinds include requires_component, excludes_component, parameter_relation, feature_predicate, capability_required and state_transition_guard. Operators are closed and right-hand operands are either literal values or explicit references.
...
Reject arbitrary code, recursive evaluation, unknown references, unsupported operators and ambiguous right operands. The implementation returns an explicit rejected or quarantined artifact where applicable. It never substitutes the nearest primitive, widens a range, drops an unknown field, merges Evidence Roles, reuses a stale hash or falls back to an executable default.
...
- Previous: [[26_Static_Type_Checking]]
- Phase home: [[00_MOC_V4_06_Treatment_DSL]]
- Next: [[28_Feature_Reference_Grammar]]
