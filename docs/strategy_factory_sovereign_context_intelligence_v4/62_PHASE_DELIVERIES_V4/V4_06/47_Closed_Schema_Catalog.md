...
Publish Draft 2020-12 schemas for every material V4-06 artifact.

## Contract

Schemas cover authority, definitions, source and canonical programs, validation, binding, package, integrity, replay, diff, telemetry, partitions, exposure, conformance, handoff and catalog. Top-level additionalProperties is false and examples validate against exact contracts.
...
Reject schema drift, unknown properties and examples that validate only under permissive fallback behavior. The implementation returns an explicit rejected or quarantined artifact where applicable. It never substitutes the nearest primitive, widens a range, drops an unknown field, merges Evidence Roles, reuses a stale hash or falls back to an executable default.
...
- Previous: [[46_MQL5_Diagnostic_Mirror]]
- Phase home: [[00_MOC_V4_06_Treatment_DSL]]
- Next: [[48_Golden_Negative_And_Conformance_Fixtures]]
