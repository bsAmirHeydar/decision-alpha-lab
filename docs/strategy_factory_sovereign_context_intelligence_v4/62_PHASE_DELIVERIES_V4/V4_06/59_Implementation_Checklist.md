...
Close the phase through code, evidence, documentation and release controls.

## Contract

The checklist covers authority freeze, upstream handoff validation, registry/policy/profile, source grammar, canonicalization, static analysis, binding, state graph, integrity/replay/diff, partition/telemetry, schemas, fixtures, Python, MQL5, tests, Obsidian, QA, status, manifest, hashes and V4-07 handoff.
...
A checked item requires an inspectable artifact and passing evidence; prose alone is insufficient. The implementation returns an explicit rejected or quarantined artifact where applicable. It never substitutes the nearest primitive, widens a range, drops an unknown field, merges Evidence Roles, reuses a stale hash or falls back to an executable default.
...
- Previous: [[58_V4_07_Action_Lattice_Handoff]]
- Phase home: [[00_MOC_V4_06_Treatment_DSL]]
- Next: [[00_MOC_V4_06_Treatment_DSL]]
