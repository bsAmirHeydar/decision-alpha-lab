---
title: Cycle Rejection And Reachability
status: implemented
version: 1.0.0
phase: V4-06
created: '2026-07-15'
...
# Cycle Rejection And Reachability

## Purpose

Prevent ambiguous or non-terminating declarative lifecycle graphs.

## Contract

Static analysis proves acyclicity and verifies that declared states are reachable from an initial state and can resolve to a terminal state under the declaration topology. The check concerns structure, not runtime market behavior.
...
Reject any directed cycle, orphan state or impossible terminal path. The implementation returns an explicit rejected or quarantined artifact where applicable. It never substitutes the nearest primitive, widens a range, drops an unknown field, merges Evidence Roles, reuses a stale hash or falls back to an executable default.
...
- Previous: [[32_State_Machine_Declaration]]
- Phase home: [[00_MOC_V4_06_Treatment_DSL]]
- Next: [[34_Capability_Compatibility]]
