---
title: Target And Exit Primitives
status: implemented
version: 1.0.0
phase: V4-06
created: '2026-07-15'
...
# Target And Exit Primitives

## Purpose

Separate profit target declarations from path-terminal exit declarations.

## Contract

A target may express a fixed R multiple, while an exit may express a maximum holding horizon. Exact separation prevents target semantics from being overloaded with lifecycle or broker behavior and enables V4-07 to reason over independent dimensions.
...
Reject target/exit ambiguity, missing exact versions or invalid terminal semantics. The implementation returns an explicit rejected or quarantined artifact where applicable. It never substitutes the nearest primitive, widens a range, drops an unknown field, merges Evidence Roles, reuses a stale hash or falls back to an executable default.
...
- Previous: [[12_Stop_Primitives]]
- Phase home: [[00_MOC_V4_06_Treatment_DSL]]
- Next: [[14_Trail_Primitives]]
