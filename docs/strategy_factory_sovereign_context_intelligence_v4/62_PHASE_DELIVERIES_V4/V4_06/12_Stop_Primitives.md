...
Describe invalidation and protective boundaries without allocating risk.

## Contract

Reference stops include Context invalidation and fixed-distance forms. They may require a server-stop capability, define feature references and bounded offsets, and participate in program identity. They do not compute position size or authorize placement.
...
Reject non-positive fixed distances, unknown invalidation features, unsupported protection capabilities or hidden risk-cash parameters. The implementation returns an explicit rejected or quarantined artifact where applicable. It never substitutes the nearest primitive, widens a range, drops an unknown field, merges Evidence Roles, reuses a stale hash or falls back to an executable default.
...
- Previous: [[11_Trigger_Primitives]]
- Phase home: [[00_MOC_V4_06_Treatment_DSL]]
- Next: [[13_Target_And_Exit_Primitives]]
