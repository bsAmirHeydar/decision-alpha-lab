...
Perform complete deterministic analysis before a program can enter a package.

## Contract

The analyzer verifies exact primitives, closed parameters, types, ranges, required and singleton kinds, side compatibility, policy budgets, capability support, feature references, state-machine integrity, constraint references and prohibited semantics.
...
- Previous: [[25_Component_Identity]]
- Phase home: [[00_MOC_V4_06_Treatment_DSL]]
- Next: [[27_Constraint_Declaration_Grammar]]
