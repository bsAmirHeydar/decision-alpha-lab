---
title: Known-Time And Evidence Roles
status: implemented
version: 1.0.0
phase: V4-06
created: '2026-07-15'
...
# Known-Time And Evidence Roles

## Purpose

Preserve point-in-time correctness and role isolation throughout the DSL package.

## Contract

Every program, graph and handoff is bound to one Evidence Role and known-as-of timestamp. Allowed roles are frozen by policy. The package cannot blend development, locked-final, prospective, shadow or external evidence.
...
Reject role mismatch, known-time inconsistency and any use of later evidence to alter an earlier program. The implementation returns an explicit rejected or quarantined artifact where applicable. It never substitutes the nearest primitive, widens a range, drops an unknown field, merges Evidence Roles, reuses a stale hash or falls back to an executable default.
...
- Previous: [[28_Feature_Reference_Grammar]]
- Phase home: [[00_MOC_V4_06_Treatment_DSL]]
- Next: [[30_Descriptor_Binding]]
