---
title: Budgets And Explosion Controls
status: implemented
version: 1.0.0
phase: V4-06
created: '2026-07-15'
...
# Budgets And Explosion Controls

## Purpose

Bound program count, component count, parameters, constraints, states, transitions and partitions.

## Contract

Institutional policy limits packages to 4096 programs, 16 components per program, 128 parameters, 64 constraints, 32 states, 64 transitions and 8 deterministic partitions. These limits prevent accidental combinatorial expansion before V4-07.
...
Reject over-budget declarations instead of truncating, sampling or silently dropping semantics. The implementation returns an explicit rejected or quarantined artifact where applicable. It never substitutes the nearest primitive, widens a range, drops an unknown field, merges Evidence Roles, reuses a stale hash or falls back to an executable default.
...
- Previous: [[34_Capability_Compatibility]]
- Phase home: [[00_MOC_V4_06_Treatment_DSL]]
- Next: [[36_Prohibited_Sizing_And_Capital_Semantics]]
