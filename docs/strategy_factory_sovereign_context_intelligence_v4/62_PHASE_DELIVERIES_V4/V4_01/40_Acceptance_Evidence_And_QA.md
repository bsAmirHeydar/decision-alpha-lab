---
title: Acceptance Evidence And QA
status: implemented
version: 1.0.0
phase: V4-01
created: '2026-07-13'
...
Maps executable checks to phase acceptance gates and states actual external evidence limits.
...
Acceptance requires closed-schema validation, deterministic hashes, future-suffix invariance, role firewall tests, lineage-cycle rejection, exact replay, atomic ingestion, MQL5 static denial checks, clean-baseline patch verification and file-index/hash-ledger agreement. Actual MetaEditor compile remains `pending_local_windows` until a signed external log is attached.
