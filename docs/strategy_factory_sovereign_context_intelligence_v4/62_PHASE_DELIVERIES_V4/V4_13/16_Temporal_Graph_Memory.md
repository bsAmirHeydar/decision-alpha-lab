---
title: SAED V4-13 — Temporal Graph Memory
...
---
# SAED V4-13 — Temporal Graph Memory

Temporal decay is bounded and uses only known-time metadata already inside the cutoff.
