---
title: SAED V4-13 — Graph Contract Freeze
...
---
# SAED V4-13 — Graph Contract Freeze

The model graph has closed node, hyperedge, relation, feature, split and lineage contracts.
