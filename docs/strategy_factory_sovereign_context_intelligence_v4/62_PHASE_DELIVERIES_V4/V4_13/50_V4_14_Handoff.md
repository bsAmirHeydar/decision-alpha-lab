---
title: SAED V4-13 — V4-14 Handoff
...
---
# SAED V4-13 — V4-14 Handoff

The handoff grants read-only access to exact graph embeddings and registry hashes for foundation-model adapters.
