---
title: SAED V4-13 — Sequence-State Binding
...
---
# SAED V4-13 — Sequence-State Binding

Every node receives a deterministic reference binding to an immutable V4-12 distilled state.
