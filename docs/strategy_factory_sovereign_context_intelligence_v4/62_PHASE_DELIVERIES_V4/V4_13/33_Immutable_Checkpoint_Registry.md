---
title: SAED V4-13 — Immutable Checkpoint Registry
...
---
# SAED V4-13 — Immutable Checkpoint Registry

Only conformant reference checkpoints enter the append-only registry.
