---
title: Service SLOs, Backpressure, and Degradation
status: canonical
version: 4.0.0
created: '2026-07-13'
updated: '2026-07-13'
...
Keep research and runtime services bounded under load, dependency loss, and partial failure.
...
- Graceful degradation to simpler model/manual/skip.
...
- Research load affects runtime.
- Queue silently drops occurrences.
- Dependency timeout defaults trade.
