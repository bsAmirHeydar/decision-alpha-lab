---
title: GPU Cluster Topology and Parallelism
status: canonical
version: 4.0.0
created: '2026-07-13'
updated: '2026-07-13'
...
Define data, tensor, pipeline, expert, and sequence parallelism choices with reproducibility and failure recovery.
...
- Choose parallelism from model/data shape and communication profile.
- Checkpoint model, optimizer, scheduler, RNG, sampler, and data cursor.
- Topology changes require equivalence test.
...
- Hardware topology changes outcome silently.
- Partial checkpoint resume.
- Expert routing nondeterminism.
