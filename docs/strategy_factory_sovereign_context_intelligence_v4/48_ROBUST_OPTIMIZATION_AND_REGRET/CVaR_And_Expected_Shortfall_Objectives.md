---
title: CVaR And Expected Shortfall Objectives
status: canonical
version: 4.0.0
created: '2026-07-13'
updated: '2026-07-13'
...
tags:
  - saed-v4
  - 48_robust_optimization_and_regret
  - institutional-v4
---

# Mandate

Select treatments that remain economically acceptable under parameter, regime, cost, feed, broker and model uncertainty rather than maximizing a fragile point estimate.

**This specification:** **CVaR And Expected Shortfall Objectives**.
...
- over-conservatism benchmark
- worst-case attribution
- stress holdout
- utility lower bounds
- portfolio hard-risk precedence
