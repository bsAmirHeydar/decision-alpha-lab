---
title: SAED2-12 — Supervised Multi-Task Trainer
status: canonical
version: 4.0.0
created: '2026-07-13'
updated: '2026-07-13'
...
Implement eligibility, fill, competing risks, distributional outcomes, ranking, selection, trail, and regime heads.
...
Task DAG; OOF predictions; gradient audits; calibration.
...
A signed phase-status record enumerates delivered files, open blockers, local-Windows requirements, risks, and the exact handoff to SAED2-13 or operations.
