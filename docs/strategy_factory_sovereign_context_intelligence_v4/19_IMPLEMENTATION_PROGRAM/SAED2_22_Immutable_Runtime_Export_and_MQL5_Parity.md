---
title: SAED2-22 — Immutable Runtime Export and MQL5 Parity
status: canonical
version: 4.0.0
created: '2026-07-13'
updated: '2026-07-13'
...
Compile exact preprocessing, model, calibration, policy, treatment, monitoring, and rollback into I14 generation.
...
Runtime bundle; Python/export/MQL5 parity; latency evidence.
...
A signed phase-status record enumerates delivered files, open blockers, local-Windows requirements, risks, and the exact handoff to SAED2-23 or operations.
