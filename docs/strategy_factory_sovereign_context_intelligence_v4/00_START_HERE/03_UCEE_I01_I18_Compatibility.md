...
SAED V4 is an additive post-context architecture. It does not fork or replace UCEE. Every component binds to exact upstream hashes and emits artifacts accepted by the downstream phase.

| UCEE phase | SAED V4 usage |
|---|---|
