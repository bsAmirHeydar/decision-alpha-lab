---
title: Twin State Vector And Latent Hypotheses
status: canonical
version: 4.0.0
created: '2026-07-13'
updated: '2026-07-13'
...
tags:
  - saed-v4
  - 41_context_digital_twin
  - institutional-v4
---

# Mandate

Build a versioned digital twin of each Context that represents observable state, latent hypotheses, causal mechanisms, support, lifecycle, treatment affordances, execution constraints, and evidence history without mutating UCEE canonical truth.

**This specification:** **Twin State Vector And Latent Hypotheses**.
...
- reference and anatomy graph
- market path
- related-symbol views
- execution and broker observations
...
- state uncertainty decomposition
- versioned hypothesis overlays
...
- canonical truth remains read-only
- latent state is explicitly non-canonical
- all twin updates are hash chained
