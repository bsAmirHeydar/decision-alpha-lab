---
title: Multi Lab Multiplicity Reconciliation
status: canonical
version: 4.0.0
created: '2026-07-13'
updated: '2026-07-13'
...
tags:
  - saed-v4
  - 49_anytime_valid_scientific_inference
  - institutional-v4
---

# Mandate

Control false discoveries and optional stopping across an adaptive, long-lived research program where humans and agents repeatedly inspect results and launch new hypotheses.

**This specification:** **Multi Lab Multiplicity Reconciliation**.
...
- immutable ordering
- no hidden retries
- cross-team exposure accounting
- query budgets
- family definitions before results
- independent statistical owner
