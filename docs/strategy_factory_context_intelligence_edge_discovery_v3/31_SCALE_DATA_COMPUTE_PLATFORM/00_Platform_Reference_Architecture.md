...
Define the shared lakehouse, stores, orchestration, compute, evidence, registry, and serving platform used by all Context cells.
...
- Separate data, research control, evidence, and bounded runtime planes.
- Use content-addressed immutable artifacts and declarative manifests.
- Expose versioned APIs with deny-by-default identities.
...
- Shared service becomes hidden monolith.
- Role boundaries collapse in caches.
- Control plane can alter scientific gates.
