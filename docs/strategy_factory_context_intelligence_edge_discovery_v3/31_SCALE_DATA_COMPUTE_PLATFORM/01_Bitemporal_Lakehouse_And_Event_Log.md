---
title: Bitemporal Lakehouse and Event Log
status: canonical
version: 3.0.0
created: '2026-07-13'
updated: '2026-07-13'
...
Store raw, canonical, Context, feature, treatment, outcome, evidence, and telemetry data with event-time/system-time and immutable revisions.
...
- Bronze raw append-only feeds.
- Silver canonical normalized events.
- Gold Context/treatment/outcome tables.
- Event log drives deterministic replay and rebuild.
...
- Latest snapshot overwrites truth.
- Partition pruning changes semantics.
- Vendor correction leaks future.
