---
title: Embedding Store and Representation Registry
status: canonical
version: 3.0.0
created: '2026-07-13'
updated: '2026-07-13'
...
Version, retrieve, and govern embeddings from frozen encoders without mixing evidence roles or incompatible tokenizers.
...
- Key by encoder, tokenizer, data snapshot, occurrence, view, and known time.
- Track support and provenance.
- Never treat embedding as canonical truth.
...
- Final-role embedding reused in training.
- Encoder updated in place.
- Vector DB metadata leaks outcome.
