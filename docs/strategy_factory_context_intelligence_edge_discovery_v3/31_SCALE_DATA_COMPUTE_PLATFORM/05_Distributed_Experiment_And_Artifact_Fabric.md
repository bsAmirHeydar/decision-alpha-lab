---
title: Distributed Experiment and Artifact Fabric
status: canonical
version: 3.0.0
created: '2026-07-13'
updated: '2026-07-13'
...
Execute large experiment DAGs reproducibly across CPU/GPU clusters and preserve every trial state and artifact.
...
- Deterministic sharding and seed hierarchy.
- Idempotent task retries.
- Content-addressed artifacts and checkpoints.
...
- Preemption loses optimizer state.
- Worker writes mutable shared state.
