---
title: ADR-015 — Portfolio and Risk Authority Remain in I17
status: canonical
version: 3.0.0
created: '2026-07-13'
updated: '2026-07-13'
...
Setup models emit bounded utility and reservation requests; I17 owns allocation and risk.

## Rationale

Prevents local alpha models from creating systemic exposure.
...
- Some model-optimal trades are vetoed.
