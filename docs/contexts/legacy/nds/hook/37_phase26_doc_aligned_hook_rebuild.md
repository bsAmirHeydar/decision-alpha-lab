...
- `docs/contexts/legacy/flag_counting/engineering_pack_v5/02_definitions/ND_HOOK_DEFINITION.md`
- `docs/contexts/legacy/flag_counting/engineering_pack_v5/03_explanations/ND_HOOK_BRANCHING_EXPLAINED.md`
- `docs/contexts/legacy/flag_counting/engineering_pack_v5/04_algorithms/HOOK_BRANCH_ENGINE_ALGORITHM.md`
- `docs/contexts/legacy/flag_counting/phoenix_rebuild/hook_nd_branching/HOOK_ND_BRANCH_SEQUENCE_CONTRACT_V1.md`
- `docs/contexts/legacy/flag_counting/phoenix_rebuild/hook_nd_branching/HOOK_ND_BRANCH_ALGORITHM_V1.md`
- `docs/contexts/legacy/flag_counting/phoenix_rebuild/hook_nd_branching/HOOK_ND_VISUALIZATION_AND_LABEL_LAYOUT_V1.md`
- `docs/contexts/legacy/nds/hook/02_cyclehook_object_model.md`
- `docs/contexts/legacy/nds/hook/03_sequence_builder.md`
- `docs/contexts/legacy/nds/hook/05_visualization_and_diagnostics.md`
